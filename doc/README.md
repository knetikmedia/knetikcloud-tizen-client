...
Method | HTTP request | Description
------------- | ------------- | -------------
*getBREExpressionsSync* | *GET* /bre/expressions/lookup | Get a list of 'lookup' type expressions.
*getBREExpressionsASync* | *GET* /bre/expressions/lookup | Get a list of 'lookup' type expressions.
...
*receiveXsollaNotificationSync* | *POST* /payment/provider/xsolla/notifications | Receives payment response from Xsolla.
*receiveXsollaNotificationASync* | *POST* /payment/provider/xsolla/notifications | Receives payment response from Xsolla.
...
Method | HTTP request | Description
------------- | ------------- | -------------
*addSearchIndexSync* | *POST* /search/index/{type}/{id} | Add a new object to an index.
*addSearchIndexASync* | *POST* /search/index/{type}/{id} | Add a new object to an index.
*addSearchMappingsSync* | *POST* /search/mappings | Register reference mappings.
*addSearchMappingsASync* | *POST* /search/mappings | Register reference mappings.
*deleteSearchIndexSync* | *DELETE* /search/index/{type}/{id} | Delete an object.
*deleteSearchIndexASync* | *DELETE* /search/index/{type}/{id} | Delete an object.
*deleteSearchIndexesSync* | *DELETE* /search/index/{type} | Delete all objects in an index.
*deleteSearchIndexesASync* | *DELETE* /search/index/{type} | Delete all objects in an index.
...
*getStoreSync* | *GET* /store | Get a listing of store items.
*getStoreASync* | *GET* /store | Get a listing of store items.
...
*updateGroupsSync* | *GET* /users/groups | List and search groups.
*updateGroupsASync* | *GET* /users/groups | List and search groups.
