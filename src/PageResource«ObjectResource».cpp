...
void
PageResource«ObjectResource»::__init()
{
	//
...
void
PageResource«ObjectResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«ObjectResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<ObjectResource> new_list;
			ObjectResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("ObjectResource")) {
					jsonToValue(&inst, temp_json, "ObjectResource", "");
				} else {
...
PageResource«ObjectResource»::PageResource«ObjectResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«ObjectResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("ObjectResource")) {
		list<ObjectResource> new_list = static_cast<list <ObjectResource> > (getContent());
		node = converttoJson(&new_list, "ObjectResource", "array");
	} else {
		...
		for (list<ObjectResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			ObjectResource obj = *it;
...
std::list<ObjectResource>
PageResource«ObjectResource»::getContent()
{
	return content;
}

void
PageResource«ObjectResource»::setContent(std::list <ObjectResource> content)
{
	this->content = content;
}

bool
PageResource«ObjectResource»::getFirst()
{
	return first;
}

void
PageResource«ObjectResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«ObjectResource»::getLast()
{
	return last;
}

void
PageResource«ObjectResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«ObjectResource»::getNumber()
{
	return number;
}

void
PageResource«ObjectResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«ObjectResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«ObjectResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«ObjectResource»::getSize()
{
	return size;
}

void
PageResource«ObjectResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«ObjectResource»::getSort()
{
	return sort;
}

void
PageResource«ObjectResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«ObjectResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«ObjectResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«ObjectResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«ObjectResource»::setTotalPages(int  total_pages)
{
