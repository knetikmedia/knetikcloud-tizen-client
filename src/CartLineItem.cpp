...
CartLineItem::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("long long")) {
			jsonToValue(&line_total, node, "long long", "");
		} else {
	...
	if (node !=NULL) {
		...
		if (isprimitive("long long")) {
			jsonToValue(&original_line_total, node, "long long", "");
		} else {
...
CartLineItem::toJson()
{
	...
	if (isprimitive("long long")) {
		long long obj = getOriginalLineTotal();
		node = converttoJson(&obj, "long long", "");
	}
	else {
...
void
CartLineItem::setLineTotal(long long  line_total)
{
...
void
CartLineItem::setOriginalLineTotal(long long  original_line_total)
{
...
void
CartLineItem::setOriginalUnitPrice(long long  original_unit_price)
{
...
void
CartLineItem::setUnitPrice(long long  unit_price)
{
