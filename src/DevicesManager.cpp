...
static bool createDeviceTemplateProcessor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
...
static bool createDeviceTemplateHelper(char * accessToken,
	...
	, void* userData, bool isAsync)
{
	...
	if (isprimitive("TemplateResource")) {
		node = converttoJson(&deviceTemplateResource, "TemplateResource", "");
	}
	
	char *jsonStr =  deviceTemplateResource.toJson();
	node = json_from_string(jsonStr, NULL);
	g_free(static_cast<gpointer>(jsonStr));
	...
	if(!isAsync){
		NetClient::easycurl(DevicesManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg);
		bool retval = createDeviceTemplateProcessor(*p_chunk, code, errormsg, userData,reinterpret_cast<void(*)()>(handler));
		...
		requestInfo = new(nothrow) RequestInfo (DevicesManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), createDeviceTemplateProcessor);;
		if(requestInfo == NULL)
			return false;
...
bool DevicesManager::createDeviceTemplateAsync(char * accessToken,
	TemplateResource deviceTemplateResource, 
	void(* handler)(TemplateResource, Error, void* )
	, void* userData)
{
	return createDeviceTemplateHelper(accessToken,
	deviceTemplateResource, 
	handler, userData, true);
}

bool DevicesManager::createDeviceTemplateSync(char * accessToken,
	TemplateResource deviceTemplateResource, 
	void(* handler)(TemplateResource, Error, void* )
	, void* userData)
{
...
static bool deleteDeviceTemplateProcessor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
...
static bool deleteDeviceTemplateHelper(char * accessToken,
	...
	void(* handler)(Error, void* ) , void* userData, bool isAsync)
{
	...
	string url("/devices/templates/{id}");
	int pos;
	...
	if(!isAsync){
		NetClient::easycurl(DevicesManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg);
		bool retval = deleteDeviceTemplateProcessor(*p_chunk, code, errormsg, userData,reinterpret_cast<void(*)()>(handler));
		...
		requestInfo = new(nothrow) RequestInfo (DevicesManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), deleteDeviceTemplateProcessor);;
		if(requestInfo == NULL)
			return false;
...
bool DevicesManager::deleteDeviceTemplateAsync(char * accessToken,
	std::string id, std::string cascade, 
	
	void(* handler)(Error, void* ) , void* userData)
{
	return deleteDeviceTemplateHelper(accessToken,
	id, cascade, 
	handler, userData, true);
}

bool DevicesManager::deleteDeviceTemplateSync(char * accessToken,
	std::string id, std::string cascade, 
...
static bool getDeviceTemplateProcessor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
	void(* handler)(TemplateResource, Error, void* )
	= reinterpret_cast<void(*)(TemplateResource, Error, void* )> (voidHandler);
...
static bool getDeviceTemplateHelper(char * accessToken,
	std::string id, 
	void(* handler)(TemplateResource, Error, void* )
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(DevicesManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg);
		bool retval = getDeviceTemplateProcessor(*p_chunk, code, errormsg, userData,reinterpret_cast<void(*)()>(handler));
		...
		requestInfo = new(nothrow) RequestInfo (DevicesManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), getDeviceTemplateProcessor);;
		if(requestInfo == NULL)
			return false;
...
bool DevicesManager::getDeviceTemplateAsync(char * accessToken,
	std::string id, 
	void(* handler)(TemplateResource, Error, void* )
	, void* userData)
{
	return getDeviceTemplateHelper(accessToken,
	id, 
	handler, userData, true);
}

bool DevicesManager::getDeviceTemplateSync(char * accessToken,
	std::string id, 
	void(* handler)(TemplateResource, Error, void* )
	, void* userData)
{
...
static bool getDeviceTemplatesProcessor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
...
static bool getDeviceTemplatesHelper(char * accessToken,
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(DevicesManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg);
		bool retval = getDeviceTemplatesProcessor(*p_chunk, code, errormsg, userData,reinterpret_cast<void(*)()>(handler));
		...
		requestInfo = new(nothrow) RequestInfo (DevicesManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), getDeviceTemplatesProcessor);;
		if(requestInfo == NULL)
			return false;
...
bool DevicesManager::getDeviceTemplatesAsync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«TemplateResource», Error, void* )
	, void* userData)
{
	return getDeviceTemplatesHelper(accessToken,
	size, page, order, 
	handler, userData, true);
}

bool DevicesManager::getDeviceTemplatesSync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«TemplateResource», Error, void* )
	, void* userData)
{
	...
	, void* userData, bool isAsync)
{
	...
	itemAtq = stringify(&filterOs, "std::string");
	queryParams.insert(pair<string, string>("filter_os", itemAtq));
	if( itemAtq.empty()==true){
		queryParams.erase("filter_os");
	}


	itemAtq = stringify(&filterSerial, "std::string");
	queryParams.insert(pair<string, string>("filter_serial", itemAtq));
	if( itemAtq.empty()==true){
		queryParams.erase("filter_serial");
	}
	...
	, void* userData)
{
	...
	filterMake, filterModel, filterOs, filterSerial, filterType, filterTag, size, page, order, 
	handler, userData, true);
}
...
static bool updateDeviceTemplateProcessor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
	void(* handler)(TemplateResource, Error, void* )
	= reinterpret_cast<void(*)(TemplateResource, Error, void* )> (voidHandler);
...
static bool updateDeviceTemplateHelper(char * accessToken,
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(DevicesManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg);
		bool retval = updateDeviceTemplateProcessor(*p_chunk, code, errormsg, userData,reinterpret_cast<void(*)()>(handler));
		...
		requestInfo = new(nothrow) RequestInfo (DevicesManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), updateDeviceTemplateProcessor);;
		if(requestInfo == NULL)
			return false;
...
bool DevicesManager::updateDeviceTemplateAsync(char * accessToken,
	std::string id, TemplateResource deviceTemplateResource, 
	void(* handler)(TemplateResource, Error, void* )
	, void* userData)
{
	return updateDeviceTemplateHelper(accessToken,
	id, deviceTemplateResource, 
	handler, userData, true);
}

bool DevicesManager::updateDeviceTemplateSync(char * accessToken,
	std::string id, TemplateResource deviceTemplateResource, 
	void(* handler)(TemplateResource, Error, void* )
	, void* userData)
{
