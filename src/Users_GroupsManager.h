#ifndef _Users_GroupsManager_H_
#define _Users_GroupsManager_H_
...
/** \addtogroup Users_Groups Users_Groups
 * \ingroup Operations
 *  @{
 */
class Users_GroupsManager {
public:
	Users_GroupsManager();
	virtual ~Users_GroupsManager();
