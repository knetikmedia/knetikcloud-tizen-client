...
void
PageResource«PollResource»::__init()
{
	//
...
void
PageResource«PollResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«PollResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<PollResource> new_list;
			PollResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("PollResource")) {
					jsonToValue(&inst, temp_json, "PollResource", "");
				} else {
...
PageResource«PollResource»::PageResource«PollResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«PollResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("PollResource")) {
		list<PollResource> new_list = static_cast<list <PollResource> > (getContent());
		node = converttoJson(&new_list, "PollResource", "array");
	} else {
		...
		for (list<PollResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			PollResource obj = *it;
...
std::list<PollResource>
PageResource«PollResource»::getContent()
{
	return content;
}

void
PageResource«PollResource»::setContent(std::list <PollResource> content)
{
	this->content = content;
}

bool
PageResource«PollResource»::getFirst()
{
	return first;
}

void
PageResource«PollResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«PollResource»::getLast()
{
	return last;
}

void
PageResource«PollResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«PollResource»::getNumber()
{
	return number;
}

void
PageResource«PollResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«PollResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«PollResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«PollResource»::getSize()
{
	return size;
}

void
PageResource«PollResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«PollResource»::getSort()
{
	return sort;
}

void
PageResource«PollResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«PollResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«PollResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«PollResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«PollResource»::setTotalPages(int  total_pages)
{
