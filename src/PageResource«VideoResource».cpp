...
void
PageResource«VideoResource»::__init()
{
	//
...
void
PageResource«VideoResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«VideoResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<VideoResource> new_list;
			VideoResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("VideoResource")) {
					jsonToValue(&inst, temp_json, "VideoResource", "");
				} else {
...
PageResource«VideoResource»::PageResource«VideoResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«VideoResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("VideoResource")) {
		list<VideoResource> new_list = static_cast<list <VideoResource> > (getContent());
		node = converttoJson(&new_list, "VideoResource", "array");
	} else {
		...
		for (list<VideoResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			VideoResource obj = *it;
...
std::list<VideoResource>
PageResource«VideoResource»::getContent()
{
	return content;
}

void
PageResource«VideoResource»::setContent(std::list <VideoResource> content)
{
	this->content = content;
}

bool
PageResource«VideoResource»::getFirst()
{
	return first;
}

void
PageResource«VideoResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«VideoResource»::getLast()
{
	return last;
}

void
PageResource«VideoResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«VideoResource»::getNumber()
{
	return number;
}

void
PageResource«VideoResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«VideoResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«VideoResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«VideoResource»::getSize()
{
	return size;
}

void
PageResource«VideoResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«VideoResource»::getSort()
{
	return sort;
}

void
PageResource«VideoResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«VideoResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«VideoResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«VideoResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«VideoResource»::setTotalPages(int  total_pages)
{
