...
#ifndef _VideoGroupProperty_H_
#define _VideoGroupProperty_H_
...
class VideoGroupProperty : public Object {
public:
	/*! \brief Constructor.
	 */
	VideoGroupProperty();
	VideoGroupProperty(char* str);
