...
#include "TemplatesPropertiesManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
TemplatesPropertiesManager::TemplatesPropertiesManager()
{
...
static gboolean __TemplatesPropertiesManagerresponseHandler(gpointer data)
{
...
static gpointer __TemplatesPropertiesManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__TemplatesPropertiesManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(TemplatesPropertiesManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (TemplatesPropertiesManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), getTemplatePropertyTypeProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __TemplatesPropertiesManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool TemplatesPropertiesManager::getTemplatePropertyTypeAsync(char * accessToken,
	std::string type, 
	void(* handler)(PropertyFieldListResource, Error, void* )
	, void* userData)
{
...
bool TemplatesPropertiesManager::getTemplatePropertyTypeSync(char * accessToken,
	std::string type, 
	void(* handler)(PropertyFieldListResource, Error, void* )
	, void* userData)
{
...
bool TemplatesPropertiesManager::getTemplatePropertyTypesAsync(char * accessToken,
...
bool TemplatesPropertiesManager::getTemplatePropertyTypesSync(char * accessToken,
