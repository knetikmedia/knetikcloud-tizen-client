...
void
StoreItem::fromJson(char* jsonStr)
{
...
StoreItem::getAdditionalProperties()
{
	return additional_properties;
}

void
StoreItem::setAdditionalProperties(std::map <string, string> additional_properties)
{
	this->additional_properties = additional_properties;
}

std::list<Behavior>
StoreItem::getBehaviors()
{
	return behaviors;
}

void
StoreItem::setBehaviors(std::list <Behavior> behaviors)
{
	this->behaviors = behaviors;
}

std::string
StoreItem::getCategory()
{
	return category;
}

void
StoreItem::setCategory(std::string  category)
{
	this->category = category;
}

long long
StoreItem::getCreatedDate()
{
	return created_date;
}

void
StoreItem::setCreatedDate(long long  created_date)
{
...
void
StoreItem::setId(int  id)
{
	this->id = id;
}

std::string
StoreItem::getLongDescription()
{
	return long_description;
}

void
StoreItem::setLongDescription(std::string  long_description)
{
...
void
StoreItem::setName(std::string  name)
{
	this->name = name;
}

std::string
StoreItem::getShortDescription()
{
	return short_description;
}

void
StoreItem::setShortDescription(std::string  short_description)
{
...
void
StoreItem::setTags(std::list <std::string> tags)
{
	this->tags = tags;
}

std::string
StoreItem::getTemplate()
{
	return _template;
}

void
StoreItem::setTemplate(std::string  _template)
{
	this->_template = _template;
}

std::string
StoreItem::getTypeHint()
{
	return type_hint;
}

void
StoreItem::setTypeHint(std::string  type_hint)
{
	this->type_hint = type_hint;
}

std::string
StoreItem::getUniqueKey()
{
	return unique_key;
}

void
StoreItem::setUniqueKey(std::string  unique_key)
{
	this->unique_key = unique_key;
}

long long
StoreItem::getUpdatedDate()
{
	return updated_date;
}

void
StoreItem::setUpdatedDate(long long  updated_date)
{
	this->updated_date = updated_date;
}

bool
StoreItem::getDisplayable()
{
	return displayable;
}

void
StoreItem::setDisplayable(bool  displayable)
{
	this->displayable = displayable;
}

std::list<std::string>
StoreItem::getGeoCountryList()
{
	return geo_country_list;
}

void
StoreItem::setGeoCountryList(std::list <std::string> geo_country_list)
{
	this->geo_country_list = geo_country_list;
}

std::string
StoreItem::getGeoPolicyType()
{
	return geo_policy_type;
}

void
StoreItem::setGeoPolicyType(std::string  geo_policy_type)
{
	this->geo_policy_type = geo_policy_type;
}

int
StoreItem::getShippingTier()
{
	return shipping_tier;
}

void
StoreItem::setShippingTier(int  shipping_tier)
{
...
void
StoreItem::setSkus(std::list <Sku> skus)
{
	this->skus = skus;
}

long long
StoreItem::getStoreEnd()
{
	return store_end;
}

void
StoreItem::setStoreEnd(long long  store_end)
{
	this->store_end = store_end;
}

long long
StoreItem::getStoreStart()
{
	return store_start;
}

void
StoreItem::setStoreStart(long long  store_start)
{
	this->store_start = store_start;
}

int
StoreItem::getVendorId()
{
	return vendor_id;
}

void
StoreItem::setVendorId(int  vendor_id)
{
