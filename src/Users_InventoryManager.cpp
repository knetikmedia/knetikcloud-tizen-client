...
#include "Users_InventoryManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
Users_InventoryManager::Users_InventoryManager()
{
...
static gboolean __Users_InventoryManagerresponseHandler(gpointer data)
{
...
static gpointer __Users_InventoryManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__Users_InventoryManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(Users_InventoryManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (Users_InventoryManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), addItemToUserInventoryProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __Users_InventoryManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool Users_InventoryManager::addItemToUserInventoryAsync(char * accessToken,
	int id, UserInventoryAddRequest userInventoryAddRequest, 
	void(* handler)(InvoiceResource, Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::addItemToUserInventorySync(char * accessToken,
	int id, UserInventoryAddRequest userInventoryAddRequest, 
	void(* handler)(InvoiceResource, Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::checkUserEntitlementItemAsync(char * accessToken,
	std::string userId, int itemId, std::string sku, 
...
bool Users_InventoryManager::checkUserEntitlementItemSync(char * accessToken,
	std::string userId, int itemId, std::string sku, 
...
bool Users_InventoryManager::createEntitlementItemAsync(char * accessToken,
	bool cascade, EntitlementItem entitlementItem, 
	void(* handler)(EntitlementItem, Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::createEntitlementItemSync(char * accessToken,
	bool cascade, EntitlementItem entitlementItem, 
	void(* handler)(EntitlementItem, Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::createEntitlementTemplateAsync(char * accessToken,
	ItemTemplateResource _template, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::createEntitlementTemplateSync(char * accessToken,
	ItemTemplateResource _template, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::deleteEntitlementItemAsync(char * accessToken,
	int entitlementId, 
...
bool Users_InventoryManager::deleteEntitlementItemSync(char * accessToken,
	int entitlementId, 
...
bool Users_InventoryManager::deleteEntitlementTemplateAsync(char * accessToken,
	std::string id, std::string cascade, 
...
bool Users_InventoryManager::deleteEntitlementTemplateSync(char * accessToken,
	std::string id, std::string cascade, 
...
bool Users_InventoryManager::getEntitlementItemAsync(char * accessToken,
	int entitlementId, 
	void(* handler)(EntitlementItem, Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::getEntitlementItemSync(char * accessToken,
	int entitlementId, 
	void(* handler)(EntitlementItem, Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::getEntitlementItemsAsync(char * accessToken,
	std::string filterTemplate, int size, int page, std::string order, 
	void(* handler)(PageResource«EntitlementItem», Error, void* )
	, void* userData)
{
	return getEntitlementItemsHelper(accessToken,
	filterTemplate, size, page, order, 
	handler, userData, true);
}

bool Users_InventoryManager::getEntitlementItemsSync(char * accessToken,
	std::string filterTemplate, int size, int page, std::string order, 
	void(* handler)(PageResource«EntitlementItem», Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::getEntitlementTemplateAsync(char * accessToken,
	std::string id, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::getEntitlementTemplateSync(char * accessToken,
	std::string id, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::getEntitlementTemplatesAsync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«ItemTemplateResource», Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::getEntitlementTemplatesSync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«ItemTemplateResource», Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::getUserInventoriesAsync(char * accessToken,
	int id, bool inactive, int size, int page, std::string filterItemName, int filterItemId, std::string filterUsername, std::string filterGroup, std::string filterDate, 
	void(* handler)(PageResource«UserInventoryResource», Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::getUserInventoriesSync(char * accessToken,
	int id, bool inactive, int size, int page, std::string filterItemName, int filterItemId, std::string filterUsername, std::string filterGroup, std::string filterDate, 
	void(* handler)(PageResource«UserInventoryResource», Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::getUserInventoryAsync(char * accessToken,
	std::string userId, int id, 
	void(* handler)(UserInventoryResource, Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::getUserInventorySync(char * accessToken,
	std::string userId, int id, 
	void(* handler)(UserInventoryResource, Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::getUserInventoryLogAsync(char * accessToken,
	std::string userId, int id, int size, int page, 
	void(* handler)(PageResource«UserItemLogResource», Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::getUserInventoryLogSync(char * accessToken,
	std::string userId, int id, int size, int page, 
	void(* handler)(PageResource«UserItemLogResource», Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::getUsersInventoryAsync(char * accessToken,
	bool inactive, int size, int page, std::string filterItemName, int filterItemId, std::string filterUsername, std::string filterGroup, std::string filterDate, 
	void(* handler)(PageResource«UserInventoryResource», Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::getUsersInventorySync(char * accessToken,
	bool inactive, int size, int page, std::string filterItemName, int filterItemId, std::string filterUsername, std::string filterGroup, std::string filterDate, 
	void(* handler)(PageResource«UserInventoryResource», Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::grantUserEntitlementAsync(char * accessToken,
	int userId, EntitlementGrantRequest grantRequest, 
...
bool Users_InventoryManager::grantUserEntitlementSync(char * accessToken,
	int userId, EntitlementGrantRequest grantRequest, 
...
bool Users_InventoryManager::updateEntitlementItemAsync(char * accessToken,
	int entitlementId, bool cascade, EntitlementItem entitlementItem, 
...
bool Users_InventoryManager::updateEntitlementItemSync(char * accessToken,
	int entitlementId, bool cascade, EntitlementItem entitlementItem, 
...
bool Users_InventoryManager::updateEntitlementTemplateAsync(char * accessToken,
	std::string id, ItemTemplateResource _template, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::updateEntitlementTemplateSync(char * accessToken,
	std::string id, ItemTemplateResource _template, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
...
bool Users_InventoryManager::updateUserInventoryBehaviorDataAsync(char * accessToken,
	int userId, int id, std::string data, 
...
bool Users_InventoryManager::updateUserInventoryBehaviorDataSync(char * accessToken,
	int userId, int id, std::string data, 
...
bool Users_InventoryManager::updateUserInventoryExpiresAsync(char * accessToken,
	int userId, int id, long long timestamp, 
...
bool Users_InventoryManager::updateUserInventoryExpiresSync(char * accessToken,
	int userId, int id, long long timestamp, 
	...
	void(* handler)(Error, void* ) , void* userData, bool isAsync)
{
	...
	if (isprimitive("InventoryStatusWrapper")) {
		node = converttoJson(&inventoryStatus, "InventoryStatusWrapper", "");
	}
	
	char *jsonStr =  inventoryStatus.toJson();
	node = json_from_string(jsonStr, NULL);
	g_free(static_cast<gpointer>(jsonStr));
...
bool Users_InventoryManager::updateUserInventoryStatusAsync(char * accessToken,
	int userId, int id, InventoryStatusWrapper inventoryStatus, 
...
bool Users_InventoryManager::updateUserInventoryStatusSync(char * accessToken,
	int userId, int id, InventoryStatusWrapper inventoryStatus, 
...
bool Users_InventoryManager::useUserEntitlementItemAsync(char * accessToken,
	std::string userId, int itemId, std::string sku, std::string info, 
...
bool Users_InventoryManager::useUserEntitlementItemSync(char * accessToken,
	std::string userId, int itemId, std::string sku, std::string info, 
