...
Media_PollsManager::Media_PollsManager()
{
...
static gboolean __Media_PollsManagerresponseHandler(gpointer data)
{
...
static gpointer __Media_PollsManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__Media_PollsManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(Media_PollsManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (Media_PollsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), answerPollProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __Media_PollsManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool Media_PollsManager::answerPollAsync(char * accessToken,
	std::string id, StringWrapper answerKey, 
	void(* handler)(PollResponseResource, Error, void* )
	, void* userData)
{
...
bool Media_PollsManager::answerPollSync(char * accessToken,
	std::string id, StringWrapper answerKey, 
	void(* handler)(PollResponseResource, Error, void* )
	, void* userData)
{
...
bool Media_PollsManager::createPollAsync(char * accessToken,
	PollResource pollResource, 
	void(* handler)(PollResource, Error, void* )
	, void* userData)
{
...
bool Media_PollsManager::createPollSync(char * accessToken,
	PollResource pollResource, 
	void(* handler)(PollResource, Error, void* )
	, void* userData)
{
...
bool Media_PollsManager::createPollTemplateAsync(char * accessToken,
	TemplateResource pollTemplateResource, 
	void(* handler)(TemplateResource, Error, void* )
	, void* userData)
{
...
bool Media_PollsManager::createPollTemplateSync(char * accessToken,
	TemplateResource pollTemplateResource, 
	void(* handler)(TemplateResource, Error, void* )
	, void* userData)
{
...
bool Media_PollsManager::deletePollAsync(char * accessToken,
	std::string id, 
...
bool Media_PollsManager::deletePollSync(char * accessToken,
	std::string id, 
...
bool Media_PollsManager::deletePollTemplateAsync(char * accessToken,
	std::string id, std::string cascade, 
...
bool Media_PollsManager::deletePollTemplateSync(char * accessToken,
	std::string id, std::string cascade, 
...
bool Media_PollsManager::getPollAsync(char * accessToken,
	std::string id, 
	void(* handler)(PollResource, Error, void* )
	, void* userData)
{
...
bool Media_PollsManager::getPollSync(char * accessToken,
	std::string id, 
	void(* handler)(PollResource, Error, void* )
	, void* userData)
{
...
bool Media_PollsManager::getPollAnswerAsync(char * accessToken,
	std::string id, 
	void(* handler)(PollResponseResource, Error, void* )
	, void* userData)
{
...
bool Media_PollsManager::getPollAnswerSync(char * accessToken,
	std::string id, 
	void(* handler)(PollResponseResource, Error, void* )
	, void* userData)
{
...
bool Media_PollsManager::getPollTemplateAsync(char * accessToken,
	std::string id, 
	void(* handler)(TemplateResource, Error, void* )
	, void* userData)
{
...
bool Media_PollsManager::getPollTemplateSync(char * accessToken,
	std::string id, 
	void(* handler)(TemplateResource, Error, void* )
	, void* userData)
{
...
bool Media_PollsManager::getPollTemplatesAsync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«TemplateResource», Error, void* )
	, void* userData)
{
...
bool Media_PollsManager::getPollTemplatesSync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«TemplateResource», Error, void* )
	, void* userData)
{
...
bool Media_PollsManager::getPollsAsync(char * accessToken,
	std::string filterCategory, std::string filterTagset, std::string filterText, int size, int page, std::string order, 
	void(* handler)(PageResource«PollResource», Error, void* )
	, void* userData)
{
...
bool Media_PollsManager::getPollsSync(char * accessToken,
	std::string filterCategory, std::string filterTagset, std::string filterText, int size, int page, std::string order, 
	void(* handler)(PageResource«PollResource», Error, void* )
	, void* userData)
{
...
bool Media_PollsManager::updatePollAsync(char * accessToken,
	std::string id, PollResource pollResource, 
	void(* handler)(PollResource, Error, void* )
	, void* userData)
{
...
bool Media_PollsManager::updatePollSync(char * accessToken,
	std::string id, PollResource pollResource, 
	void(* handler)(PollResource, Error, void* )
	, void* userData)
{
...
bool Media_PollsManager::updatePollTemplateAsync(char * accessToken,
	std::string id, TemplateResource pollTemplateResource, 
	void(* handler)(TemplateResource, Error, void* )
	, void* userData)
{
...
bool Media_PollsManager::updatePollTemplateSync(char * accessToken,
	std::string id, TemplateResource pollTemplateResource, 
	void(* handler)(TemplateResource, Error, void* )
	, void* userData)
{
