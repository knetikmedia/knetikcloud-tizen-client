...
void
PageResource«GroupMemberResource»::__init()
{
	//
...
void
PageResource«GroupMemberResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«GroupMemberResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<GroupMemberResource> new_list;
			GroupMemberResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("GroupMemberResource")) {
					jsonToValue(&inst, temp_json, "GroupMemberResource", "");
				} else {
...
PageResource«GroupMemberResource»::PageResource«GroupMemberResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«GroupMemberResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("GroupMemberResource")) {
		list<GroupMemberResource> new_list = static_cast<list <GroupMemberResource> > (getContent());
		node = converttoJson(&new_list, "GroupMemberResource", "array");
	} else {
		...
		for (list<GroupMemberResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			GroupMemberResource obj = *it;
...
std::list<GroupMemberResource>
PageResource«GroupMemberResource»::getContent()
{
	return content;
}

void
PageResource«GroupMemberResource»::setContent(std::list <GroupMemberResource> content)
{
	this->content = content;
}

bool
PageResource«GroupMemberResource»::getFirst()
{
	return first;
}

void
PageResource«GroupMemberResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«GroupMemberResource»::getLast()
{
	return last;
}

void
PageResource«GroupMemberResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«GroupMemberResource»::getNumber()
{
	return number;
}

void
PageResource«GroupMemberResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«GroupMemberResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«GroupMemberResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«GroupMemberResource»::getSize()
{
	return size;
}

void
PageResource«GroupMemberResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«GroupMemberResource»::getSort()
{
	return sort;
}

void
PageResource«GroupMemberResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«GroupMemberResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«GroupMemberResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«GroupMemberResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«GroupMemberResource»::setTotalPages(int  total_pages)
{
