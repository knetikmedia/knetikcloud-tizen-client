...
void
PageResource«MessageTemplateResource»::__init()
{
	//
...
void
PageResource«MessageTemplateResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«MessageTemplateResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<MessageTemplateResource> new_list;
			MessageTemplateResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("MessageTemplateResource")) {
					jsonToValue(&inst, temp_json, "MessageTemplateResource", "");
				} else {
...
PageResource«MessageTemplateResource»::PageResource«MessageTemplateResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«MessageTemplateResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("MessageTemplateResource")) {
		list<MessageTemplateResource> new_list = static_cast<list <MessageTemplateResource> > (getContent());
		node = converttoJson(&new_list, "MessageTemplateResource", "array");
	} else {
		...
		for (list<MessageTemplateResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			MessageTemplateResource obj = *it;
...
std::list<MessageTemplateResource>
PageResource«MessageTemplateResource»::getContent()
{
	return content;
}

void
PageResource«MessageTemplateResource»::setContent(std::list <MessageTemplateResource> content)
{
	this->content = content;
}

bool
PageResource«MessageTemplateResource»::getFirst()
{
	return first;
}

void
PageResource«MessageTemplateResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«MessageTemplateResource»::getLast()
{
	return last;
}

void
PageResource«MessageTemplateResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«MessageTemplateResource»::getNumber()
{
	return number;
}

void
PageResource«MessageTemplateResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«MessageTemplateResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«MessageTemplateResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«MessageTemplateResource»::getSize()
{
	return size;
}

void
PageResource«MessageTemplateResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«MessageTemplateResource»::getSort()
{
	return sort;
}

void
PageResource«MessageTemplateResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«MessageTemplateResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«MessageTemplateResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«MessageTemplateResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«MessageTemplateResource»::setTotalPages(int  total_pages)
{
