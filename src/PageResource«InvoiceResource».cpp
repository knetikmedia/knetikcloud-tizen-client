...
void
PageResource«InvoiceResource»::__init()
{
	//
...
void
PageResource«InvoiceResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«InvoiceResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<InvoiceResource> new_list;
			InvoiceResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("InvoiceResource")) {
					jsonToValue(&inst, temp_json, "InvoiceResource", "");
				} else {
...
PageResource«InvoiceResource»::PageResource«InvoiceResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«InvoiceResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("InvoiceResource")) {
		list<InvoiceResource> new_list = static_cast<list <InvoiceResource> > (getContent());
		node = converttoJson(&new_list, "InvoiceResource", "array");
	} else {
		...
		for (list<InvoiceResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			InvoiceResource obj = *it;
...
std::list<InvoiceResource>
PageResource«InvoiceResource»::getContent()
{
	return content;
}

void
PageResource«InvoiceResource»::setContent(std::list <InvoiceResource> content)
{
	this->content = content;
}

bool
PageResource«InvoiceResource»::getFirst()
{
	return first;
}

void
PageResource«InvoiceResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«InvoiceResource»::getLast()
{
	return last;
}

void
PageResource«InvoiceResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«InvoiceResource»::getNumber()
{
	return number;
}

void
PageResource«InvoiceResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«InvoiceResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«InvoiceResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«InvoiceResource»::getSize()
{
	return size;
}

void
PageResource«InvoiceResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«InvoiceResource»::getSort()
{
	return sort;
}

void
PageResource«InvoiceResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«InvoiceResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«InvoiceResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«InvoiceResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«InvoiceResource»::setTotalPages(int  total_pages)
{
