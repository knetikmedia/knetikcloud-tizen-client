...
void
PageResource«ChallengeEventResource»::__init()
{
	//
...
void
PageResource«ChallengeEventResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«ChallengeEventResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<ChallengeEventResource> new_list;
			ChallengeEventResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("ChallengeEventResource")) {
					jsonToValue(&inst, temp_json, "ChallengeEventResource", "");
				} else {
...
PageResource«ChallengeEventResource»::PageResource«ChallengeEventResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«ChallengeEventResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("ChallengeEventResource")) {
		list<ChallengeEventResource> new_list = static_cast<list <ChallengeEventResource> > (getContent());
		node = converttoJson(&new_list, "ChallengeEventResource", "array");
	} else {
		...
		for (list<ChallengeEventResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			ChallengeEventResource obj = *it;
...
std::list<ChallengeEventResource>
PageResource«ChallengeEventResource»::getContent()
{
	return content;
}

void
PageResource«ChallengeEventResource»::setContent(std::list <ChallengeEventResource> content)
{
	this->content = content;
}

bool
PageResource«ChallengeEventResource»::getFirst()
{
	return first;
}

void
PageResource«ChallengeEventResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«ChallengeEventResource»::getLast()
{
	return last;
}

void
PageResource«ChallengeEventResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«ChallengeEventResource»::getNumber()
{
	return number;
}

void
PageResource«ChallengeEventResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«ChallengeEventResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«ChallengeEventResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«ChallengeEventResource»::getSize()
{
	return size;
}

void
PageResource«ChallengeEventResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«ChallengeEventResource»::getSort()
{
	return sort;
}

void
PageResource«ChallengeEventResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«ChallengeEventResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«ChallengeEventResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«ChallengeEventResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«ChallengeEventResource»::setTotalPages(int  total_pages)
{
