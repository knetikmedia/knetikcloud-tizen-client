...
void
PageResource«OauthAccessTokenResource»::__init()
{
	//
...
void
PageResource«OauthAccessTokenResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«OauthAccessTokenResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<OauthAccessTokenResource> new_list;
			OauthAccessTokenResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("OauthAccessTokenResource")) {
					jsonToValue(&inst, temp_json, "OauthAccessTokenResource", "");
				} else {
...
PageResource«OauthAccessTokenResource»::PageResource«OauthAccessTokenResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«OauthAccessTokenResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("OauthAccessTokenResource")) {
		list<OauthAccessTokenResource> new_list = static_cast<list <OauthAccessTokenResource> > (getContent());
		node = converttoJson(&new_list, "OauthAccessTokenResource", "array");
	} else {
		...
		for (list<OauthAccessTokenResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			OauthAccessTokenResource obj = *it;
...
std::list<OauthAccessTokenResource>
PageResource«OauthAccessTokenResource»::getContent()
{
	return content;
}

void
PageResource«OauthAccessTokenResource»::setContent(std::list <OauthAccessTokenResource> content)
{
	this->content = content;
}

bool
PageResource«OauthAccessTokenResource»::getFirst()
{
	return first;
}

void
PageResource«OauthAccessTokenResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«OauthAccessTokenResource»::getLast()
{
	return last;
}

void
PageResource«OauthAccessTokenResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«OauthAccessTokenResource»::getNumber()
{
	return number;
}

void
PageResource«OauthAccessTokenResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«OauthAccessTokenResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«OauthAccessTokenResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«OauthAccessTokenResource»::getSize()
{
	return size;
}

void
PageResource«OauthAccessTokenResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«OauthAccessTokenResource»::getSort()
{
	return sort;
}

void
PageResource«OauthAccessTokenResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«OauthAccessTokenResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«OauthAccessTokenResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«OauthAccessTokenResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«OauthAccessTokenResource»::setTotalPages(int  total_pages)
{
