...
public:
	...
	/*! \brief Get 
	 */
	std::list<SubscriptionPlan> getSubscriptionPlans();

	/*! \brief Set 
	 */
	void setSubscriptionPlans(std::list <SubscriptionPlan> subscription_plans);
...
private:
	...
	std::list <SubscriptionPlan>subscription_plans;
	void __init();
	void __cleanup();
