...
#include "UsersFriendshipsManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
UsersFriendshipsManager::UsersFriendshipsManager()
{
...
static gboolean __UsersFriendshipsManagerresponseHandler(gpointer data)
{
...
static gpointer __UsersFriendshipsManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__UsersFriendshipsManagerresponseHandler, static_cast<gpointer>(request));
	...
	void(* handler)(Error, void* ) , void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(UsersFriendshipsManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (UsersFriendshipsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), addFriendProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __UsersFriendshipsManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool UsersFriendshipsManager::addFriendAsync(char * accessToken,
	std::string userId, int id, 
...
bool UsersFriendshipsManager::addFriendSync(char * accessToken,
	std::string userId, int id, 
...
bool UsersFriendshipsManager::getFriendsAsync(char * accessToken,
	std::string userId, std::string filterUsername, int filterUserId, int size, int page, 
	void(* handler)(PageResource«SimpleUserResource», Error, void* )
	, void* userData)
{
...
bool UsersFriendshipsManager::getFriendsSync(char * accessToken,
	std::string userId, std::string filterUsername, int filterUserId, int size, int page, 
	void(* handler)(PageResource«SimpleUserResource», Error, void* )
	, void* userData)
{
...
bool UsersFriendshipsManager::getInviteTokenAsync(char * accessToken,
	std::string userId, 
	void(* handler)(std::string, Error, void* )
	, void* userData)
{
...
bool UsersFriendshipsManager::getInviteTokenSync(char * accessToken,
	std::string userId, 
	void(* handler)(std::string, Error, void* )
	, void* userData)
{
...
bool UsersFriendshipsManager::getInvitesAsync(char * accessToken,
	std::string userId, int size, int page, 
	void(* handler)(PageResource«SimpleUserResource», Error, void* )
	, void* userData)
{
...
bool UsersFriendshipsManager::getInvitesSync(char * accessToken,
	std::string userId, int size, int page, 
	void(* handler)(PageResource«SimpleUserResource», Error, void* )
	, void* userData)
{
...
bool UsersFriendshipsManager::redeemFriendshipTokenAsync(char * accessToken,
	std::string userId, StringWrapper token, 
...
bool UsersFriendshipsManager::redeemFriendshipTokenSync(char * accessToken,
	std::string userId, StringWrapper token, 
...
bool UsersFriendshipsManager::removeOrDeclineFriendAsync(char * accessToken,
	std::string userId, int id, 
...
bool UsersFriendshipsManager::removeOrDeclineFriendSync(char * accessToken,
	std::string userId, int id, 
