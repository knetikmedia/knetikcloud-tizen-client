...
#include "ReportingChallengesManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
ReportingChallengesManager::ReportingChallengesManager()
{
...
static gboolean __ReportingChallengesManagerresponseHandler(gpointer data)
{
...
static gpointer __ReportingChallengesManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__ReportingChallengesManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(ReportingChallengesManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (ReportingChallengesManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), getChallengeEventLeaderboardProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __ReportingChallengesManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool ReportingChallengesManager::getChallengeEventLeaderboardAsync(char * accessToken,
	long long filterEvent, int size, int page, std::string order, 
	void(* handler)(PageResource«ChallengeEventParticipantResource», Error, void* )
	, void* userData)
{
...
bool ReportingChallengesManager::getChallengeEventLeaderboardSync(char * accessToken,
	long long filterEvent, int size, int page, std::string order, 
	void(* handler)(PageResource«ChallengeEventParticipantResource», Error, void* )
	, void* userData)
{
...
bool ReportingChallengesManager::getChallengeEventParticipantsAsync(char * accessToken,
	long long filterEvent, int size, int page, std::string order, 
	void(* handler)(PageResource«ChallengeEventParticipantResource», Error, void* )
	, void* userData)
{
...
bool ReportingChallengesManager::getChallengeEventParticipantsSync(char * accessToken,
	long long filterEvent, int size, int page, std::string order, 
	void(* handler)(PageResource«ChallengeEventParticipantResource», Error, void* )
	, void* userData)
{
