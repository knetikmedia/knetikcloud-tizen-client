...
void
PageResource«SimpleUserResource»::__init()
{
	//
...
void
PageResource«SimpleUserResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«SimpleUserResource»::fromJson(char* jsonStr)
{
...
PageResource«SimpleUserResource»::PageResource«SimpleUserResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«SimpleUserResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("SimpleUserResource")) {
		list<SimpleUserResource> new_list = static_cast<list <SimpleUserResource> > (getContent());
...
PageResource«SimpleUserResource»::getContent()
{
	return content;
}

void
PageResource«SimpleUserResource»::setContent(std::list <SimpleUserResource> content)
{
	this->content = content;
}

bool
PageResource«SimpleUserResource»::getFirst()
{
	return first;
}

void
PageResource«SimpleUserResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«SimpleUserResource»::getLast()
{
	return last;
}

void
PageResource«SimpleUserResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«SimpleUserResource»::getNumber()
{
	return number;
}

void
PageResource«SimpleUserResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«SimpleUserResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«SimpleUserResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«SimpleUserResource»::getSize()
{
	return size;
}

void
PageResource«SimpleUserResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«SimpleUserResource»::getSort()
{
	return sort;
}

void
PageResource«SimpleUserResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«SimpleUserResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«SimpleUserResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«SimpleUserResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«SimpleUserResource»::setTotalPages(int  total_pages)
{
