...
void
PageResource«PermissionResource»::__init()
{
	//
...
void
PageResource«PermissionResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«PermissionResource»::fromJson(char* jsonStr)
{
...
PageResource«PermissionResource»::PageResource«PermissionResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«PermissionResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("PermissionResource")) {
		list<PermissionResource> new_list = static_cast<list <PermissionResource> > (getContent());
...
PageResource«PermissionResource»::getContent()
{
	return content;
}

void
PageResource«PermissionResource»::setContent(std::list <PermissionResource> content)
{
	this->content = content;
}

bool
PageResource«PermissionResource»::getFirst()
{
	return first;
}

void
PageResource«PermissionResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«PermissionResource»::getLast()
{
	return last;
}

void
PageResource«PermissionResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«PermissionResource»::getNumber()
{
	return number;
}

void
PageResource«PermissionResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«PermissionResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«PermissionResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«PermissionResource»::getSize()
{
	return size;
}

void
PageResource«PermissionResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«PermissionResource»::getSort()
{
	return sort;
}

void
PageResource«PermissionResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«PermissionResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«PermissionResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«PermissionResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«PermissionResource»::setTotalPages(int  total_pages)
{
