...
Auth_RolesManager::Auth_RolesManager()
{
...
static gboolean __Auth_RolesManagerresponseHandler(gpointer data)
{
...
static gpointer __Auth_RolesManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__Auth_RolesManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(Auth_RolesManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (Auth_RolesManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), createRoleProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __Auth_RolesManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool Auth_RolesManager::createRoleAsync(char * accessToken,
	RoleResource roleResource, 
	void(* handler)(RoleResource, Error, void* )
	, void* userData)
{
...
bool Auth_RolesManager::createRoleSync(char * accessToken,
	RoleResource roleResource, 
	void(* handler)(RoleResource, Error, void* )
	, void* userData)
{
...
bool Auth_RolesManager::deleteRoleAsync(char * accessToken,
	std::string role, bool force, 
...
bool Auth_RolesManager::deleteRoleSync(char * accessToken,
	std::string role, bool force, 
...
bool Auth_RolesManager::getClientRolesAsync(char * accessToken,
	std::string clientKey, 
	void(* handler)(std::list<RoleResource>, Error, void* )
	, void* userData)
{
...
bool Auth_RolesManager::getClientRolesSync(char * accessToken,
	std::string clientKey, 
	void(* handler)(std::list<RoleResource>, Error, void* )
	, void* userData)
{
...
bool Auth_RolesManager::getRoleAsync(char * accessToken,
	std::string role, 
	void(* handler)(RoleResource, Error, void* )
	, void* userData)
{
...
bool Auth_RolesManager::getRoleSync(char * accessToken,
	std::string role, 
	void(* handler)(RoleResource, Error, void* )
	, void* userData)
{
...
bool Auth_RolesManager::getRolesAsync(char * accessToken,
	std::string filterName, std::string filterRole, int size, int page, std::string order, 
	void(* handler)(PageResource«RoleResource», Error, void* )
	, void* userData)
{
...
bool Auth_RolesManager::getRolesSync(char * accessToken,
	std::string filterName, std::string filterRole, int size, int page, std::string order, 
	void(* handler)(PageResource«RoleResource», Error, void* )
	, void* userData)
{
...
bool Auth_RolesManager::getUserRolesAsync(char * accessToken,
	int userId, 
	void(* handler)(std::list<RoleResource>, Error, void* )
	, void* userData)
{
...
bool Auth_RolesManager::getUserRolesSync(char * accessToken,
	int userId, 
	void(* handler)(std::list<RoleResource>, Error, void* )
	, void* userData)
{
...
bool Auth_RolesManager::setClientRolesAsync(char * accessToken,
	std::string clientKey, std::list<> rolesList, 
	void(* handler)(ClientResource, Error, void* )
	, void* userData)
{
...
bool Auth_RolesManager::setClientRolesSync(char * accessToken,
	std::string clientKey, std::list<> rolesList, 
	void(* handler)(ClientResource, Error, void* )
	, void* userData)
{
...
bool Auth_RolesManager::setPermissionsForRoleAsync(char * accessToken,
	std::string role, std::list<> permissionsList, 
	void(* handler)(RoleResource, Error, void* )
	, void* userData)
{
...
bool Auth_RolesManager::setPermissionsForRoleSync(char * accessToken,
	std::string role, std::list<> permissionsList, 
	void(* handler)(RoleResource, Error, void* )
	, void* userData)
{
...
bool Auth_RolesManager::setUserRolesAsync(char * accessToken,
	int userId, std::list<> rolesList, 
	void(* handler)(UserResource, Error, void* )
	, void* userData)
{
...
bool Auth_RolesManager::setUserRolesSync(char * accessToken,
	int userId, std::list<> rolesList, 
	void(* handler)(UserResource, Error, void* )
	, void* userData)
{
...
bool Auth_RolesManager::updateRoleAsync(char * accessToken,
	std::string role, RoleResource roleResource, 
	void(* handler)(RoleResource, Error, void* )
	, void* userData)
{
...
bool Auth_RolesManager::updateRoleSync(char * accessToken,
	std::string role, RoleResource roleResource, 
	void(* handler)(RoleResource, Error, void* )
	, void* userData)
{
