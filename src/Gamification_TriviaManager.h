#ifndef _Gamification_TriviaManager_H_
#define _Gamification_TriviaManager_H_
...
/** \addtogroup Gamification_Trivia Gamification_Trivia
 * \ingroup Operations
 *  @{
 */
class Gamification_TriviaManager {
public:
	Gamification_TriviaManager();
	virtual ~Gamification_TriviaManager();
...
#endif /* Gamification_TriviaManager_H_ */
