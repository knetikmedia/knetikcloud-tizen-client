...
void
PageResource«StoreItemTemplateResource»::__init()
{
	//
...
void
PageResource«StoreItemTemplateResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«StoreItemTemplateResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<StoreItemTemplateResource> new_list;
			StoreItemTemplateResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("StoreItemTemplateResource")) {
					jsonToValue(&inst, temp_json, "StoreItemTemplateResource", "");
				} else {
...
PageResource«StoreItemTemplateResource»::PageResource«StoreItemTemplateResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«StoreItemTemplateResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("StoreItemTemplateResource")) {
		list<StoreItemTemplateResource> new_list = static_cast<list <StoreItemTemplateResource> > (getContent());
		node = converttoJson(&new_list, "StoreItemTemplateResource", "array");
	} else {
		...
		for (list<StoreItemTemplateResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			StoreItemTemplateResource obj = *it;
...
std::list<StoreItemTemplateResource>
PageResource«StoreItemTemplateResource»::getContent()
{
	return content;
}

void
PageResource«StoreItemTemplateResource»::setContent(std::list <StoreItemTemplateResource> content)
{
	this->content = content;
}

bool
PageResource«StoreItemTemplateResource»::getFirst()
{
	return first;
}

void
PageResource«StoreItemTemplateResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«StoreItemTemplateResource»::getLast()
{
	return last;
}

void
PageResource«StoreItemTemplateResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«StoreItemTemplateResource»::getNumber()
{
	return number;
}

void
PageResource«StoreItemTemplateResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«StoreItemTemplateResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«StoreItemTemplateResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«StoreItemTemplateResource»::getSize()
{
	return size;
}

void
PageResource«StoreItemTemplateResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«StoreItemTemplateResource»::getSort()
{
	return sort;
}

void
PageResource«StoreItemTemplateResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«StoreItemTemplateResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«StoreItemTemplateResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«StoreItemTemplateResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«StoreItemTemplateResource»::setTotalPages(int  total_pages)
{
