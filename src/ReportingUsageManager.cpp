...
#include "ReportingUsageManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
ReportingUsageManager::ReportingUsageManager()
{
...
static gboolean __ReportingUsageManagerresponseHandler(gpointer data)
{
...
static gpointer __ReportingUsageManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__ReportingUsageManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(ReportingUsageManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (ReportingUsageManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), getUsageByDayProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __ReportingUsageManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool ReportingUsageManager::getUsageByDayAsync(char * accessToken,
	long long startDate, long long endDate, bool combineEndpoints, std::string method, std::string url, int size, int page, 
	void(* handler)(PageResource«UsageInfo», Error, void* )
	, void* userData)
{
...
bool ReportingUsageManager::getUsageByDaySync(char * accessToken,
	long long startDate, long long endDate, bool combineEndpoints, std::string method, std::string url, int size, int page, 
	void(* handler)(PageResource«UsageInfo», Error, void* )
	, void* userData)
{
...
bool ReportingUsageManager::getUsageByHourAsync(char * accessToken,
	long long startDate, long long endDate, bool combineEndpoints, std::string method, std::string url, int size, int page, 
	void(* handler)(PageResource«UsageInfo», Error, void* )
	, void* userData)
{
...
bool ReportingUsageManager::getUsageByHourSync(char * accessToken,
	long long startDate, long long endDate, bool combineEndpoints, std::string method, std::string url, int size, int page, 
	void(* handler)(PageResource«UsageInfo», Error, void* )
	, void* userData)
{
...
bool ReportingUsageManager::getUsageByMinuteAsync(char * accessToken,
	long long startDate, long long endDate, bool combineEndpoints, std::string method, std::string url, int size, int page, 
	void(* handler)(PageResource«UsageInfo», Error, void* )
	, void* userData)
{
...
bool ReportingUsageManager::getUsageByMinuteSync(char * accessToken,
	long long startDate, long long endDate, bool combineEndpoints, std::string method, std::string url, int size, int page, 
	void(* handler)(PageResource«UsageInfo», Error, void* )
	, void* userData)
{
...
bool ReportingUsageManager::getUsageByMonthAsync(char * accessToken,
	long long startDate, long long endDate, bool combineEndpoints, std::string method, std::string url, int size, int page, 
	void(* handler)(PageResource«UsageInfo», Error, void* )
	, void* userData)
{
...
bool ReportingUsageManager::getUsageByMonthSync(char * accessToken,
	long long startDate, long long endDate, bool combineEndpoints, std::string method, std::string url, int size, int page, 
	void(* handler)(PageResource«UsageInfo», Error, void* )
	, void* userData)
{
...
bool ReportingUsageManager::getUsageByYearAsync(char * accessToken,
	long long startDate, long long endDate, bool combineEndpoints, std::string method, std::string url, int size, int page, 
	void(* handler)(PageResource«UsageInfo», Error, void* )
	, void* userData)
{
...
bool ReportingUsageManager::getUsageByYearSync(char * accessToken,
	long long startDate, long long endDate, bool combineEndpoints, std::string method, std::string url, int size, int page, 
	void(* handler)(PageResource«UsageInfo», Error, void* )
	, void* userData)
{
...
bool ReportingUsageManager::getUsageEndpointsAsync(char * accessToken,
	long long startDate, long long endDate, 
	void(* handler)(std::list<std::string>, Error, void* )
	, void* userData)
{
...
bool ReportingUsageManager::getUsageEndpointsSync(char * accessToken,
	long long startDate, long long endDate, 
	void(* handler)(std::list<std::string>, Error, void* )
	, void* userData)
{
