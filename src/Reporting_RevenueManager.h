#ifndef _Reporting_RevenueManager_H_
#define _Reporting_RevenueManager_H_
...
/** \addtogroup Reporting_Revenue Reporting_Revenue
 * \ingroup Operations
 *  @{
 */
class Reporting_RevenueManager {
public:
	Reporting_RevenueManager();
	virtual ~Reporting_RevenueManager();
...
#endif /* Reporting_RevenueManager_H_ */
