...
void
PageResource«ImportJobResource»::__init()
{
	//
...
void
PageResource«ImportJobResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«ImportJobResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<ImportJobResource> new_list;
			ImportJobResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("ImportJobResource")) {
					jsonToValue(&inst, temp_json, "ImportJobResource", "");
				} else {
...
PageResource«ImportJobResource»::PageResource«ImportJobResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«ImportJobResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("ImportJobResource")) {
		list<ImportJobResource> new_list = static_cast<list <ImportJobResource> > (getContent());
		node = converttoJson(&new_list, "ImportJobResource", "array");
	} else {
		...
		for (list<ImportJobResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			ImportJobResource obj = *it;
...
std::list<ImportJobResource>
PageResource«ImportJobResource»::getContent()
{
	return content;
}

void
PageResource«ImportJobResource»::setContent(std::list <ImportJobResource> content)
{
	this->content = content;
}

bool
PageResource«ImportJobResource»::getFirst()
{
	return first;
}

void
PageResource«ImportJobResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«ImportJobResource»::getLast()
{
	return last;
}

void
PageResource«ImportJobResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«ImportJobResource»::getNumber()
{
	return number;
}

void
PageResource«ImportJobResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«ImportJobResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«ImportJobResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«ImportJobResource»::getSize()
{
	return size;
}

void
PageResource«ImportJobResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«ImportJobResource»::getSort()
{
	return sort;
}

void
PageResource«ImportJobResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«ImportJobResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«ImportJobResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«ImportJobResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«ImportJobResource»::setTotalPages(int  total_pages)
{
