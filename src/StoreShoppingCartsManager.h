#ifndef _StoreShoppingCartsManager_H_
#define _StoreShoppingCartsManager_H_
...
/** \addtogroup StoreShoppingCarts StoreShoppingCarts
 * \ingroup Operations
 *  @{
 */
class StoreShoppingCartsManager {
public:
	StoreShoppingCartsManager();
	virtual ~StoreShoppingCartsManager();
...
#endif /* StoreShoppingCartsManager_H_ */
