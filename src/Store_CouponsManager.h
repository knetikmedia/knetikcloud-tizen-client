#ifndef _Store_CouponsManager_H_
#define _Store_CouponsManager_H_
...
/** \addtogroup Store_Coupons Store_Coupons
 * \ingroup Operations
 *  @{
 */
class Store_CouponsManager {
public:
	Store_CouponsManager();
	virtual ~Store_CouponsManager();
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool getCouponItemBySkuSync(char * accessToken,
	std::string sku, 
	void(* handler)(CouponItem, Error, void* )
	, void* userData);
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool getCouponItemBySkuAsync(char * accessToken,
	std::string sku, 
	void(* handler)(CouponItem, Error, void* )
	, void* userData);
