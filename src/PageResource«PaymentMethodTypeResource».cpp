...
void
PageResource«PaymentMethodTypeResource»::__init()
{
	//
...
void
PageResource«PaymentMethodTypeResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«PaymentMethodTypeResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<PaymentMethodTypeResource> new_list;
			PaymentMethodTypeResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("PaymentMethodTypeResource")) {
					jsonToValue(&inst, temp_json, "PaymentMethodTypeResource", "");
				} else {
...
PageResource«PaymentMethodTypeResource»::PageResource«PaymentMethodTypeResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«PaymentMethodTypeResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("PaymentMethodTypeResource")) {
		list<PaymentMethodTypeResource> new_list = static_cast<list <PaymentMethodTypeResource> > (getContent());
		node = converttoJson(&new_list, "PaymentMethodTypeResource", "array");
	} else {
		...
		for (list<PaymentMethodTypeResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			PaymentMethodTypeResource obj = *it;
...
std::list<PaymentMethodTypeResource>
PageResource«PaymentMethodTypeResource»::getContent()
{
	return content;
}

void
PageResource«PaymentMethodTypeResource»::setContent(std::list <PaymentMethodTypeResource> content)
{
	this->content = content;
}

bool
PageResource«PaymentMethodTypeResource»::getFirst()
{
	return first;
}

void
PageResource«PaymentMethodTypeResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«PaymentMethodTypeResource»::getLast()
{
	return last;
}

void
PageResource«PaymentMethodTypeResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«PaymentMethodTypeResource»::getNumber()
{
	return number;
}

void
PageResource«PaymentMethodTypeResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«PaymentMethodTypeResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«PaymentMethodTypeResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«PaymentMethodTypeResource»::getSize()
{
	return size;
}

void
PageResource«PaymentMethodTypeResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«PaymentMethodTypeResource»::getSort()
{
	return sort;
}

void
PageResource«PaymentMethodTypeResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«PaymentMethodTypeResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«PaymentMethodTypeResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«PaymentMethodTypeResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«PaymentMethodTypeResource»::setTotalPages(int  total_pages)
{
