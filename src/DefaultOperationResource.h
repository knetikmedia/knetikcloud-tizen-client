...
#ifndef _DefaultOperationResource_H_
#define _DefaultOperationResource_H_
...
class DefaultOperationResource : public Object {
public:
	/*! \brief Constructor.
	 */
	DefaultOperationResource();
	DefaultOperationResource(char* str);
...
#endif /* _DefaultOperationResource_H_ */
