...
CouponDefinition::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("long long")) {
			jsonToValue(&max_discount, node, "long long", "");
		} else {
	...
	if (node !=NULL) {
		...
		if (isprimitive("long long")) {
			jsonToValue(&min_cart_total, node, "long long", "");
		} else {
...
void
CouponDefinition::setMaxDiscount(long long  max_discount)
{
...
void
CouponDefinition::setMinCartTotal(long long  min_cart_total)
{
...
void
CouponDefinition::setValue(long long  value)
{
	this->value = value;
}
