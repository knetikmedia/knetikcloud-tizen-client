...
#include "UsersSubscriptionsManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
UsersSubscriptionsManager::UsersSubscriptionsManager()
{
...
static gboolean __UsersSubscriptionsManagerresponseHandler(gpointer data)
{
...
static gpointer __UsersSubscriptionsManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__UsersSubscriptionsManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(UsersSubscriptionsManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (UsersSubscriptionsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), getUserSubscriptionDetailsProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __UsersSubscriptionsManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool UsersSubscriptionsManager::getUserSubscriptionDetailsAsync(char * accessToken,
	int userId, int inventoryId, 
	void(* handler)(InventorySubscriptionResource, Error, void* )
	, void* userData)
{
...
bool UsersSubscriptionsManager::getUserSubscriptionDetailsSync(char * accessToken,
	int userId, int inventoryId, 
	void(* handler)(InventorySubscriptionResource, Error, void* )
	, void* userData)
{
...
bool UsersSubscriptionsManager::getUsersSubscriptionDetailsAsync(char * accessToken,
	int userId, 
	void(* handler)(std::list<InventorySubscriptionResource>, Error, void* )
	, void* userData)
{
...
bool UsersSubscriptionsManager::getUsersSubscriptionDetailsSync(char * accessToken,
	int userId, 
	void(* handler)(std::list<InventorySubscriptionResource>, Error, void* )
	, void* userData)
{
...
bool UsersSubscriptionsManager::reactivateUserSubscriptionAsync(char * accessToken,
	int userId, int inventoryId, ReactivateSubscriptionRequest reactivateSubscriptionRequest, 
	void(* handler)(InvoiceResource, Error, void* )
	, void* userData)
{
...
bool UsersSubscriptionsManager::reactivateUserSubscriptionSync(char * accessToken,
	int userId, int inventoryId, ReactivateSubscriptionRequest reactivateSubscriptionRequest, 
	void(* handler)(InvoiceResource, Error, void* )
	, void* userData)
{
...
bool UsersSubscriptionsManager::setSubscriptionBillDateAsync(char * accessToken,
	int userId, int inventoryId, long long billDate, 
...
bool UsersSubscriptionsManager::setSubscriptionBillDateSync(char * accessToken,
	int userId, int inventoryId, long long billDate, 
...
bool UsersSubscriptionsManager::setSubscriptionPaymentMethodAsync(char * accessToken,
	int userId, int inventoryId, IntWrapper paymentMethodId, 
...
bool UsersSubscriptionsManager::setSubscriptionPaymentMethodSync(char * accessToken,
	int userId, int inventoryId, IntWrapper paymentMethodId, 
...
bool UsersSubscriptionsManager::setSubscriptionStatusAsync(char * accessToken,
	int userId, int inventoryId, StringWrapper status, 
...
bool UsersSubscriptionsManager::setSubscriptionStatusSync(char * accessToken,
	int userId, int inventoryId, StringWrapper status, 
...
bool UsersSubscriptionsManager::setUserSubscriptionPlanAsync(char * accessToken,
	int userId, int inventoryId, StringWrapper planId, 
...
bool UsersSubscriptionsManager::setUserSubscriptionPlanSync(char * accessToken,
	int userId, int inventoryId, StringWrapper planId, 
...
bool UsersSubscriptionsManager::setUserSubscriptionPriceAsync(char * accessToken,
	int userId, int inventoryId, SubscriptionPriceOverrideRequest the override details, 
...
bool UsersSubscriptionsManager::setUserSubscriptionPriceSync(char * accessToken,
	int userId, int inventoryId, SubscriptionPriceOverrideRequest the override details, 
