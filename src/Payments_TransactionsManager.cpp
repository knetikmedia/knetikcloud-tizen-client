...
#include "Payments_TransactionsManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
Payments_TransactionsManager::Payments_TransactionsManager()
{
...
static gboolean __Payments_TransactionsManagerresponseHandler(gpointer data)
{
...
static gpointer __Payments_TransactionsManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__Payments_TransactionsManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(Payments_TransactionsManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (Payments_TransactionsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), getTransactionProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __Payments_TransactionsManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool Payments_TransactionsManager::getTransactionAsync(char * accessToken,
	int id, 
	void(* handler)(TransactionResource, Error, void* )
	, void* userData)
{
...
bool Payments_TransactionsManager::getTransactionSync(char * accessToken,
	int id, 
	void(* handler)(TransactionResource, Error, void* )
	, void* userData)
{
...
bool Payments_TransactionsManager::getTransactionsAsync(char * accessToken,
	int filterInvoice, int size, int page, std::string order, 
	void(* handler)(PageResource«TransactionResource», Error, void* )
	, void* userData)
{
...
bool Payments_TransactionsManager::getTransactionsSync(char * accessToken,
	int filterInvoice, int size, int page, std::string order, 
	void(* handler)(PageResource«TransactionResource», Error, void* )
	, void* userData)
{
...
bool Payments_TransactionsManager::refundTransactionAsync(char * accessToken,
	int id, RefundRequest request, 
	void(* handler)(RefundResource, Error, void* )
	, void* userData)
{
...
bool Payments_TransactionsManager::refundTransactionSync(char * accessToken,
	int id, RefundRequest request, 
	void(* handler)(RefundResource, Error, void* )
	, void* userData)
{
