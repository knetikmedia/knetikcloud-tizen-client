...
void
PageResource«BillingReport»::__init()
{
	//
...
void
PageResource«BillingReport»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«BillingReport»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<BillingReport> new_list;
			BillingReport inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("BillingReport")) {
					jsonToValue(&inst, temp_json, "BillingReport", "");
				} else {
...
PageResource«BillingReport»::PageResource«BillingReport»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«BillingReport»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("BillingReport")) {
		list<BillingReport> new_list = static_cast<list <BillingReport> > (getContent());
		node = converttoJson(&new_list, "BillingReport", "array");
	} else {
		...
		for (list<BillingReport>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			BillingReport obj = *it;
...
std::list<BillingReport>
PageResource«BillingReport»::getContent()
{
	return content;
}

void
PageResource«BillingReport»::setContent(std::list <BillingReport> content)
{
	this->content = content;
}

bool
PageResource«BillingReport»::getFirst()
{
	return first;
}

void
PageResource«BillingReport»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«BillingReport»::getLast()
{
	return last;
}

void
PageResource«BillingReport»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«BillingReport»::getNumber()
{
	return number;
}

void
PageResource«BillingReport»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«BillingReport»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«BillingReport»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«BillingReport»::getSize()
{
	return size;
}

void
PageResource«BillingReport»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«BillingReport»::getSort()
{
	return sort;
}

void
PageResource«BillingReport»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«BillingReport»::getTotalElements()
{
	return total_elements;
}

void
PageResource«BillingReport»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«BillingReport»::getTotalPages()
{
	return total_pages;
}

void
PageResource«BillingReport»::setTotalPages(int  total_pages)
{
