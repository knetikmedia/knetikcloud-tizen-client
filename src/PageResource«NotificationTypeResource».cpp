...
void
PageResource«NotificationTypeResource»::__init()
{
	//
...
void
PageResource«NotificationTypeResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«NotificationTypeResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<NotificationTypeResource> new_list;
			NotificationTypeResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("NotificationTypeResource")) {
					jsonToValue(&inst, temp_json, "NotificationTypeResource", "");
				} else {
...
PageResource«NotificationTypeResource»::PageResource«NotificationTypeResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«NotificationTypeResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("NotificationTypeResource")) {
		list<NotificationTypeResource> new_list = static_cast<list <NotificationTypeResource> > (getContent());
		node = converttoJson(&new_list, "NotificationTypeResource", "array");
	} else {
		...
		for (list<NotificationTypeResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			NotificationTypeResource obj = *it;
...
std::list<NotificationTypeResource>
PageResource«NotificationTypeResource»::getContent()
{
	return content;
}

void
PageResource«NotificationTypeResource»::setContent(std::list <NotificationTypeResource> content)
{
	this->content = content;
}

bool
PageResource«NotificationTypeResource»::getFirst()
{
	return first;
}

void
PageResource«NotificationTypeResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«NotificationTypeResource»::getLast()
{
	return last;
}

void
PageResource«NotificationTypeResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«NotificationTypeResource»::getNumber()
{
	return number;
}

void
PageResource«NotificationTypeResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«NotificationTypeResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«NotificationTypeResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«NotificationTypeResource»::getSize()
{
	return size;
}

void
PageResource«NotificationTypeResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«NotificationTypeResource»::getSort()
{
	return sort;
}

void
PageResource«NotificationTypeResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«NotificationTypeResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«NotificationTypeResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«NotificationTypeResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«NotificationTypeResource»::setTotalPages(int  total_pages)
{
