...
void
PageResource«CategoryResource»::__init()
{
	//
...
void
PageResource«CategoryResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«CategoryResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<CategoryResource> new_list;
			CategoryResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("CategoryResource")) {
					jsonToValue(&inst, temp_json, "CategoryResource", "");
				} else {
...
PageResource«CategoryResource»::PageResource«CategoryResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«CategoryResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("CategoryResource")) {
		list<CategoryResource> new_list = static_cast<list <CategoryResource> > (getContent());
		node = converttoJson(&new_list, "CategoryResource", "array");
	} else {
		...
		for (list<CategoryResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			CategoryResource obj = *it;
...
std::list<CategoryResource>
PageResource«CategoryResource»::getContent()
{
	return content;
}

void
PageResource«CategoryResource»::setContent(std::list <CategoryResource> content)
{
	this->content = content;
}

bool
PageResource«CategoryResource»::getFirst()
{
	return first;
}

void
PageResource«CategoryResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«CategoryResource»::getLast()
{
	return last;
}

void
PageResource«CategoryResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«CategoryResource»::getNumber()
{
	return number;
}

void
PageResource«CategoryResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«CategoryResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«CategoryResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«CategoryResource»::getSize()
{
	return size;
}

void
PageResource«CategoryResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«CategoryResource»::getSort()
{
	return sort;
}

void
PageResource«CategoryResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«CategoryResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«CategoryResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«CategoryResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«CategoryResource»::setTotalPages(int  total_pages)
{
