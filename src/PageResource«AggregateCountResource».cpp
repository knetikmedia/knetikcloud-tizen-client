...
void
PageResource«AggregateCountResource»::__init()
{
	//
...
void
PageResource«AggregateCountResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«AggregateCountResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<AggregateCountResource> new_list;
			AggregateCountResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("AggregateCountResource")) {
					jsonToValue(&inst, temp_json, "AggregateCountResource", "");
				} else {
...
PageResource«AggregateCountResource»::PageResource«AggregateCountResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«AggregateCountResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("AggregateCountResource")) {
		list<AggregateCountResource> new_list = static_cast<list <AggregateCountResource> > (getContent());
		node = converttoJson(&new_list, "AggregateCountResource", "array");
	} else {
		...
		for (list<AggregateCountResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			AggregateCountResource obj = *it;
...
std::list<AggregateCountResource>
PageResource«AggregateCountResource»::getContent()
{
	return content;
}

void
PageResource«AggregateCountResource»::setContent(std::list <AggregateCountResource> content)
{
	this->content = content;
}

bool
PageResource«AggregateCountResource»::getFirst()
{
	return first;
}

void
PageResource«AggregateCountResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«AggregateCountResource»::getLast()
{
	return last;
}

void
PageResource«AggregateCountResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«AggregateCountResource»::getNumber()
{
	return number;
}

void
PageResource«AggregateCountResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«AggregateCountResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«AggregateCountResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«AggregateCountResource»::getSize()
{
	return size;
}

void
PageResource«AggregateCountResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«AggregateCountResource»::getSort()
{
	return sort;
}

void
PageResource«AggregateCountResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«AggregateCountResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«AggregateCountResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«AggregateCountResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«AggregateCountResource»::setTotalPages(int  total_pages)
{
