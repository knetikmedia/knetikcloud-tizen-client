...
#ifndef _AudioPropertyDefinitionResource_H_
#define _AudioPropertyDefinitionResource_H_
...
class AudioPropertyDefinitionResource : public Object {
public:
	/*! \brief Constructor.
	 */
	AudioPropertyDefinitionResource();
	AudioPropertyDefinitionResource(char* str);
	...
	/*! \brief Get If provided, a file type the property must match
	 */
	std::string getFileType();

	/*! \brief Set If provided, a file type the property must match
	 */
...
#endif /* _AudioPropertyDefinitionResource_H_ */
