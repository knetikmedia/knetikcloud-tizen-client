...
#include "BRERuleEngineRulesManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
BRERuleEngineRulesManager::BRERuleEngineRulesManager()
{
...
static gboolean __BRERuleEngineRulesManagerresponseHandler(gpointer data)
{
...
static gpointer __BRERuleEngineRulesManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__BRERuleEngineRulesManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(BRERuleEngineRulesManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (BRERuleEngineRulesManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), createBRERuleProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __BRERuleEngineRulesManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool BRERuleEngineRulesManager::createBRERuleAsync(char * accessToken,
	BreRule breRule, 
	void(* handler)(BreRule, Error, void* )
	, void* userData)
{
...
bool BRERuleEngineRulesManager::createBRERuleSync(char * accessToken,
	BreRule breRule, 
	void(* handler)(BreRule, Error, void* )
	, void* userData)
{
...
bool BRERuleEngineRulesManager::deleteBRERuleAsync(char * accessToken,
	std::string id, 
...
bool BRERuleEngineRulesManager::deleteBRERuleSync(char * accessToken,
	std::string id, 
...
bool BRERuleEngineRulesManager::getBREExpressionAsStringAsync(char * accessToken,
	Expression«object» expression, 
	void(* handler)(std::string, Error, void* )
	, void* userData)
{
...
bool BRERuleEngineRulesManager::getBREExpressionAsStringSync(char * accessToken,
	Expression«object» expression, 
	void(* handler)(std::string, Error, void* )
	, void* userData)
{
...
bool BRERuleEngineRulesManager::getBRERuleAsync(char * accessToken,
	std::string id, 
	void(* handler)(BreRule, Error, void* )
	, void* userData)
{
...
bool BRERuleEngineRulesManager::getBRERuleSync(char * accessToken,
	std::string id, 
	void(* handler)(BreRule, Error, void* )
	, void* userData)
{
...
bool BRERuleEngineRulesManager::getBRERulesAsync(char * accessToken,
	std::string filterName, bool filterEnabled, bool filterSystem, std::string filterTrigger, std::string filterAction, std::string filterCondition, int size, int page, 
	void(* handler)(PageResource«BreRule», Error, void* )
	, void* userData)
{
...
bool BRERuleEngineRulesManager::getBRERulesSync(char * accessToken,
	std::string filterName, bool filterEnabled, bool filterSystem, std::string filterTrigger, std::string filterAction, std::string filterCondition, int size, int page, 
	void(* handler)(PageResource«BreRule», Error, void* )
	, void* userData)
{
...
bool BRERuleEngineRulesManager::setBRERuleAsync(char * accessToken,
	std::string id, BooleanResource enabled, 
...
bool BRERuleEngineRulesManager::setBRERuleSync(char * accessToken,
	std::string id, BooleanResource enabled, 
...
bool BRERuleEngineRulesManager::updateBRERuleAsync(char * accessToken,
	std::string id, BreRule breRule, 
	void(* handler)(BreRule, Error, void* )
	, void* userData)
{
...
bool BRERuleEngineRulesManager::updateBRERuleSync(char * accessToken,
	std::string id, BreRule breRule, 
	void(* handler)(BreRule, Error, void* )
	, void* userData)
{
