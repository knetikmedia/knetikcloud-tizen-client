...
#ifndef _WebsocketUnsubscribeEvent_H_
#define _WebsocketUnsubscribeEvent_H_
...
class WebsocketUnsubscribeEvent : public Object {
public:
	/*! \brief Constructor.
	 */
	WebsocketUnsubscribeEvent();
	WebsocketUnsubscribeEvent(char* str);
	...
	/*! \brief Set 
	 */
	void setTopicSubscriber(TopicSubscriber  topic_subscriber);
...
#endif /* _WebsocketUnsubscribeEvent_H_ */
