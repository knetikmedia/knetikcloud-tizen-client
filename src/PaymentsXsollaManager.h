...
/*! \brief Receives payment response from Xsolla. *Synchronous*
 *
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool receiveXsollaNotificationSync(char * accessToken,
	
	
	void(* handler)(Error, void* ) , void* userData);

/*! \brief Receives payment response from Xsolla. *Asynchronous*
 *
 * Only used by Xsolla to call back to JSAPI after processing user payment action
 * \param handler The callback function to be invoked on completion. *Required*
 * \param accessToken The Authorization token. *Required*
 * \param userData The user data to be passed to the callback function.
 */
bool receiveXsollaNotificationAsync(char * accessToken,
