...
void
OperationResource::fromJson(char* jsonStr)
{
...
OperationResource::OperationResource(char* json)
{
	this->fromJson(json);
}

char*
OperationResource::toJson()
{
...
OperationResource::getArgs()
{
	return args;
}

void
OperationResource::setArgs(std::list <ExpressionResource> args)
{
	this->args = args;
}

std::string
OperationResource::getDefinition()
{
	return definition;
}

void
OperationResource::setDefinition(std::string  definition)
{
	this->definition = definition;
}

std::string
OperationResource::getOp()
{
	return op;
}

void
OperationResource::setOp(std::string  op)
{
	this->op = op;
}

std::string
OperationResource::getReturnType()
{
	return return_type;
}

void
OperationResource::setReturnType(std::string  return_type)
{
	this->return_type = return_type;
}

std::list<OperationDefinitionResource>
OperationResource::getSupportedOperators()
{
	return supported_operators;
}

void
OperationResource::setSupportedOperators(std::list <OperationDefinitionResource> supported_operators)
{
	this->supported_operators = supported_operators;
}

std::string
OperationResource::getType()
{
	return type;
}

void
OperationResource::setType(std::string  type)
{
	this->type = type;
}
