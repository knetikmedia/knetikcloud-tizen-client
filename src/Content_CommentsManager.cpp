...
#include "Content_CommentsManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
Content_CommentsManager::Content_CommentsManager()
{
...
static gboolean __Content_CommentsManagerresponseHandler(gpointer data)
{
...
static gpointer __Content_CommentsManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__Content_CommentsManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(Content_CommentsManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (Content_CommentsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), addCommentProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __Content_CommentsManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool Content_CommentsManager::addCommentAsync(char * accessToken,
	CommentResource commentResource, 
	void(* handler)(CommentResource, Error, void* )
	, void* userData)
{
...
bool Content_CommentsManager::addCommentSync(char * accessToken,
	CommentResource commentResource, 
	void(* handler)(CommentResource, Error, void* )
	, void* userData)
{
...
bool Content_CommentsManager::deleteCommentAsync(char * accessToken,
	long long id, 
...
bool Content_CommentsManager::deleteCommentSync(char * accessToken,
	long long id, 
...
bool Content_CommentsManager::getCommentAsync(char * accessToken,
	long long id, 
	void(* handler)(CommentResource, Error, void* )
	, void* userData)
{
...
bool Content_CommentsManager::getCommentSync(char * accessToken,
	long long id, 
	void(* handler)(CommentResource, Error, void* )
	, void* userData)
{
...
bool Content_CommentsManager::getCommentsAsync(char * accessToken,
	std::string context, int contextId, int size, int page, 
	void(* handler)(PageResource«CommentResource», Error, void* )
	, void* userData)
{
...
bool Content_CommentsManager::getCommentsSync(char * accessToken,
	std::string context, int contextId, int size, int page, 
	void(* handler)(PageResource«CommentResource», Error, void* )
	, void* userData)
{
...
bool Content_CommentsManager::updateCommentAsync(char * accessToken,
	long long id, StringWrapper content, 
...
bool Content_CommentsManager::updateCommentSync(char * accessToken,
	long long id, StringWrapper content, 
