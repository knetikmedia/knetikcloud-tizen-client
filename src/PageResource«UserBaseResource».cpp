...
void
PageResource«UserBaseResource»::__init()
{
	//
...
void
PageResource«UserBaseResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«UserBaseResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<UserBaseResource> new_list;
			UserBaseResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("UserBaseResource")) {
					jsonToValue(&inst, temp_json, "UserBaseResource", "");
				} else {
...
PageResource«UserBaseResource»::PageResource«UserBaseResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«UserBaseResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("UserBaseResource")) {
		list<UserBaseResource> new_list = static_cast<list <UserBaseResource> > (getContent());
		node = converttoJson(&new_list, "UserBaseResource", "array");
	} else {
		...
		for (list<UserBaseResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			UserBaseResource obj = *it;
...
std::list<UserBaseResource>
PageResource«UserBaseResource»::getContent()
{
	return content;
}

void
PageResource«UserBaseResource»::setContent(std::list <UserBaseResource> content)
{
	this->content = content;
}

bool
PageResource«UserBaseResource»::getFirst()
{
	return first;
}

void
PageResource«UserBaseResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«UserBaseResource»::getLast()
{
	return last;
}

void
PageResource«UserBaseResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«UserBaseResource»::getNumber()
{
	return number;
}

void
PageResource«UserBaseResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«UserBaseResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«UserBaseResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«UserBaseResource»::getSize()
{
	return size;
}

void
PageResource«UserBaseResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«UserBaseResource»::getSort()
{
	return sort;
}

void
PageResource«UserBaseResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«UserBaseResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«UserBaseResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«UserBaseResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«UserBaseResource»::setTotalPages(int  total_pages)
{
