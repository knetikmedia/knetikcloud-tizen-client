...
#ifndef _BooleanPropertyDefinitionResource_H_
#define _BooleanPropertyDefinitionResource_H_
...
class BooleanPropertyDefinitionResource : public Object {
public:
	/*! \brief Constructor.
	 */
	BooleanPropertyDefinitionResource();
	BooleanPropertyDefinitionResource(char* str);
...
#endif /* _BooleanPropertyDefinitionResource_H_ */
