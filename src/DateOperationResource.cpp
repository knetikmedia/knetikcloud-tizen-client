...
std::string
DateOperationResource::getDefinition()
{
	return definition;
}

void
DateOperationResource::setDefinition(std::string  definition)
{
...
std::string
DateOperationResource::getReturnType()
{
	return return_type;
}

void
DateOperationResource::setReturnType(std::string  return_type)
{
	this->return_type = return_type;
}

std::list<OperationDefinitionResource>
DateOperationResource::getSupportedOperators()
{
	return supported_operators;
}

void
DateOperationResource::setSupportedOperators(std::list <OperationDefinitionResource> supported_operators)
{
