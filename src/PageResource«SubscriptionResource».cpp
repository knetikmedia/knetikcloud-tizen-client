...
void
PageResource«SubscriptionResource»::__init()
{
	//
...
void
PageResource«SubscriptionResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«SubscriptionResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<SubscriptionResource> new_list;
			SubscriptionResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("SubscriptionResource")) {
					jsonToValue(&inst, temp_json, "SubscriptionResource", "");
				} else {
...
PageResource«SubscriptionResource»::PageResource«SubscriptionResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«SubscriptionResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("SubscriptionResource")) {
		list<SubscriptionResource> new_list = static_cast<list <SubscriptionResource> > (getContent());
		node = converttoJson(&new_list, "SubscriptionResource", "array");
	} else {
		...
		for (list<SubscriptionResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			SubscriptionResource obj = *it;
...
std::list<SubscriptionResource>
PageResource«SubscriptionResource»::getContent()
{
	return content;
}

void
PageResource«SubscriptionResource»::setContent(std::list <SubscriptionResource> content)
{
	this->content = content;
}

bool
PageResource«SubscriptionResource»::getFirst()
{
	return first;
}

void
PageResource«SubscriptionResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«SubscriptionResource»::getLast()
{
	return last;
}

void
PageResource«SubscriptionResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«SubscriptionResource»::getNumber()
{
	return number;
}

void
PageResource«SubscriptionResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«SubscriptionResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«SubscriptionResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«SubscriptionResource»::getSize()
{
	return size;
}

void
PageResource«SubscriptionResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«SubscriptionResource»::getSort()
{
	return sort;
}

void
PageResource«SubscriptionResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«SubscriptionResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«SubscriptionResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«SubscriptionResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«SubscriptionResource»::setTotalPages(int  total_pages)
{
