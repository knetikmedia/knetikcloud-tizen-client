#ifndef _Reporting_UsageManager_H_
#define _Reporting_UsageManager_H_
...
/** \addtogroup Reporting_Usage Reporting_Usage
 * \ingroup Operations
 *  @{
 */
class Reporting_UsageManager {
public:
	Reporting_UsageManager();
	virtual ~Reporting_UsageManager();
...
#endif /* Reporting_UsageManager_H_ */
