#ifndef _Amazon_Web_Services_S3Manager_H_
#define _Amazon_Web_Services_S3Manager_H_
...
/** \addtogroup Amazon_Web_Services_S3 Amazon_Web_Services_S3
 * \ingroup Operations
 *  @{
 */
class Amazon_Web_Services_S3Manager {
public:
	Amazon_Web_Services_S3Manager();
	virtual ~Amazon_Web_Services_S3Manager();
...
#endif /* Amazon_Web_Services_S3Manager_H_ */
