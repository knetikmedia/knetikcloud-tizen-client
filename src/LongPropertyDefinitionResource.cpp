...
std::string
LongPropertyDefinitionResource::getDescription()
{
	return description;
}

void
LongPropertyDefinitionResource::setDescription(std::string  description)
{
...
std::string
LongPropertyDefinitionResource::getFriendlyName()
{
	return friendly_name;
}

void
LongPropertyDefinitionResource::setFriendlyName(std::string  friendly_name)
{
...
std::string
LongPropertyDefinitionResource::getOptionLabelPath()
{
	return option_label_path;
}

void
LongPropertyDefinitionResource::setOptionLabelPath(std::string  option_label_path)
{
	this->option_label_path = option_label_path;
}

std::string
LongPropertyDefinitionResource::getOptionValuePath()
{
	return option_value_path;
}

void
LongPropertyDefinitionResource::setOptionValuePath(std::string  option_value_path)
{
	this->option_value_path = option_value_path;
}

std::string
LongPropertyDefinitionResource::getOptionsUrl()
{
	return options_url;
}

void
LongPropertyDefinitionResource::setOptionsUrl(std::string  options_url)
{
