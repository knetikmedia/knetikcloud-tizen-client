...
public:
	...
	/*! \brief Get Whether this parameter is implicitely derived from another. Internal use only.
	 */
	bool getImplicit();

	/*! \brief Set Whether this parameter is implicitely derived from another. Internal use only.
	 */
