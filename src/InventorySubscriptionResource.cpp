...
InventorySubscriptionResource::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("long long")) {
			jsonToValue(&credit, node, "long long", "");
		} else {
	...
	if (node !=NULL) {
		...
		if (isprimitive("long long")) {
			jsonToValue(&recurring_price, node, "long long", "");
		} else {
...
InventorySubscriptionResource::toJson()
{
	...
	if (isprimitive("long long")) {
		long long obj = getRecurringPrice();
		node = converttoJson(&obj, "long long", "");
	}
	else {
...
void
InventorySubscriptionResource::setCredit(long long  credit)
{
	this->credit = credit;
}
...
void
InventorySubscriptionResource::setPriceOverride(long long  price_override)
{
...
void
InventorySubscriptionResource::setRecurringPrice(long long  recurring_price)
{
