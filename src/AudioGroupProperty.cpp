...
void
AudioGroupProperty::fromJson(char* jsonStr)
{
...
AudioGroupProperty::AudioGroupProperty(char* json)
{
	this->fromJson(json);
}

char*
AudioGroupProperty::toJson()
{
...
std::string
AudioGroupProperty::getType()
{
	return type;
}

void
AudioGroupProperty::setType(std::string  type)
{
	this->type = type;
}

std::list<FileProperty>
AudioGroupProperty::getFiles()
{
	return files;
}

void
AudioGroupProperty::setFiles(std::list <FileProperty> files)
{
	this->files = files;
}
