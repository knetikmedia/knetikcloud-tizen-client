...
void
ItemTemplateResource::__cleanup()
{
...
void
ItemTemplateResource::fromJson(char* jsonStr)
{
...
ItemTemplateResource::ItemTemplateResource(char* json)
{
	this->fromJson(json);
}

char*
ItemTemplateResource::toJson()
{
...
bool
ItemTemplateResource::getAllowAdditional()
{
	return allow_additional;
}

void
ItemTemplateResource::setAllowAdditional(bool  allow_additional)
{
	this->allow_additional = allow_additional;
}

std::list<ItemBehaviorDefinitionResource>
ItemTemplateResource::getBehaviors()
{
	return behaviors;
}

void
ItemTemplateResource::setBehaviors(std::list <ItemBehaviorDefinitionResource> behaviors)
{
	this->behaviors = behaviors;
}

long long
ItemTemplateResource::getCreatedDate()
{
	return created_date;
}

void
ItemTemplateResource::setCreatedDate(long long  created_date)
{
	this->created_date = created_date;
}

std::string
ItemTemplateResource::getId()
{
	return id;
}

void
ItemTemplateResource::setId(std::string  id)
{
	this->id = id;
}

std::string
ItemTemplateResource::getName()
{
	return name;
}

void
ItemTemplateResource::setName(std::string  name)
{
	this->name = name;
}

std::list<PropertyDefinitionResource>
ItemTemplateResource::getProperties()
{
	return properties;
}

void
ItemTemplateResource::setProperties(std::list <PropertyDefinitionResource> properties)
{
	this->properties = properties;
}

long long
ItemTemplateResource::getUpdatedDate()
{
	return updated_date;
}

void
ItemTemplateResource::setUpdatedDate(long long  updated_date)
{
