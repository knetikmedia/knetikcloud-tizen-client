...
#ifndef _WebsocketSubscribeEvent_H_
#define _WebsocketSubscribeEvent_H_
...
class WebsocketSubscribeEvent : public Object {
public:
	/*! \brief Constructor.
	 */
	WebsocketSubscribeEvent();
	WebsocketSubscribeEvent(char* str);
	...
	/*! \brief Set 
	 */
	void setUserResource(UserResource  user_resource);
...
#endif /* _WebsocketSubscribeEvent_H_ */
