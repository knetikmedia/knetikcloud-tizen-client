#ifndef _Util_MaintenanceManager_H_
#define _Util_MaintenanceManager_H_
...
/** \addtogroup Util_Maintenance Util_Maintenance
 * \ingroup Operations
 *  @{
 */
class Util_MaintenanceManager {
public:
	Util_MaintenanceManager();
	virtual ~Util_MaintenanceManager();
...
#endif /* Util_MaintenanceManager_H_ */
