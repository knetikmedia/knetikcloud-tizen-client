...
public:
	 ...
	 */
	void setDiscountValue(long long  discount_value);
...
private:
	...
	long long discount_max;
	long long discount_min_cart_value;
	std::string discount_type;
	long long discount_value;
	bool exclusive;
	int item_id;
	int max_quantity;
	bool self_exclusive;
