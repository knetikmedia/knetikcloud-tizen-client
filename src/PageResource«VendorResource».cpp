...
void
PageResource«VendorResource»::__init()
{
	//
...
void
PageResource«VendorResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«VendorResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<VendorResource> new_list;
			VendorResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("VendorResource")) {
					jsonToValue(&inst, temp_json, "VendorResource", "");
				} else {
...
PageResource«VendorResource»::PageResource«VendorResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«VendorResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("VendorResource")) {
		list<VendorResource> new_list = static_cast<list <VendorResource> > (getContent());
		node = converttoJson(&new_list, "VendorResource", "array");
	} else {
		...
		for (list<VendorResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			VendorResource obj = *it;
...
std::list<VendorResource>
PageResource«VendorResource»::getContent()
{
	return content;
}

void
PageResource«VendorResource»::setContent(std::list <VendorResource> content)
{
	this->content = content;
}

bool
PageResource«VendorResource»::getFirst()
{
	return first;
}

void
PageResource«VendorResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«VendorResource»::getLast()
{
	return last;
}

void
PageResource«VendorResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«VendorResource»::getNumber()
{
	return number;
}

void
PageResource«VendorResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«VendorResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«VendorResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«VendorResource»::getSize()
{
	return size;
}

void
PageResource«VendorResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«VendorResource»::getSort()
{
	return sort;
}

void
PageResource«VendorResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«VendorResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«VendorResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«VendorResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«VendorResource»::setTotalPages(int  total_pages)
{
