...
void
PageResource«EntitlementItem»::__init()
{
	//
...
void
PageResource«EntitlementItem»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«EntitlementItem»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<EntitlementItem> new_list;
			EntitlementItem inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("EntitlementItem")) {
					jsonToValue(&inst, temp_json, "EntitlementItem", "");
				} else {
...
PageResource«EntitlementItem»::PageResource«EntitlementItem»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«EntitlementItem»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("EntitlementItem")) {
		list<EntitlementItem> new_list = static_cast<list <EntitlementItem> > (getContent());
		node = converttoJson(&new_list, "EntitlementItem", "array");
	} else {
		...
		for (list<EntitlementItem>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			EntitlementItem obj = *it;
...
std::list<EntitlementItem>
PageResource«EntitlementItem»::getContent()
{
	return content;
}

void
PageResource«EntitlementItem»::setContent(std::list <EntitlementItem> content)
{
	this->content = content;
}

bool
PageResource«EntitlementItem»::getFirst()
{
	return first;
}

void
PageResource«EntitlementItem»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«EntitlementItem»::getLast()
{
	return last;
}

void
PageResource«EntitlementItem»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«EntitlementItem»::getNumber()
{
	return number;
}

void
PageResource«EntitlementItem»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«EntitlementItem»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«EntitlementItem»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«EntitlementItem»::getSize()
{
	return size;
}

void
PageResource«EntitlementItem»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«EntitlementItem»::getSort()
{
	return sort;
}

void
PageResource«EntitlementItem»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«EntitlementItem»::getTotalElements()
{
	return total_elements;
}

void
PageResource«EntitlementItem»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«EntitlementItem»::getTotalPages()
{
	return total_pages;
}

void
PageResource«EntitlementItem»::setTotalPages(int  total_pages)
{
