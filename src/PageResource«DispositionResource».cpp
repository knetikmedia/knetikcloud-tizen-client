...
void
PageResource«DispositionResource»::__init()
{
	//
...
void
PageResource«DispositionResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«DispositionResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<DispositionResource> new_list;
			DispositionResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("DispositionResource")) {
					jsonToValue(&inst, temp_json, "DispositionResource", "");
				} else {
...
PageResource«DispositionResource»::PageResource«DispositionResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«DispositionResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("DispositionResource")) {
		list<DispositionResource> new_list = static_cast<list <DispositionResource> > (getContent());
		node = converttoJson(&new_list, "DispositionResource", "array");
	} else {
		...
		for (list<DispositionResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			DispositionResource obj = *it;
...
std::list<DispositionResource>
PageResource«DispositionResource»::getContent()
{
	return content;
}

void
PageResource«DispositionResource»::setContent(std::list <DispositionResource> content)
{
	this->content = content;
}

bool
PageResource«DispositionResource»::getFirst()
{
	return first;
}

void
PageResource«DispositionResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«DispositionResource»::getLast()
{
	return last;
}

void
PageResource«DispositionResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«DispositionResource»::getNumber()
{
	return number;
}

void
PageResource«DispositionResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«DispositionResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«DispositionResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«DispositionResource»::getSize()
{
	return size;
}

void
PageResource«DispositionResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«DispositionResource»::getSort()
{
	return sort;
}

void
PageResource«DispositionResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«DispositionResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«DispositionResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«DispositionResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«DispositionResource»::setTotalPages(int  total_pages)
{
