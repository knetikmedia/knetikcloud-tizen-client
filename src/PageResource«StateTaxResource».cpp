...
void
PageResource«StateTaxResource»::__init()
{
	//
...
void
PageResource«StateTaxResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«StateTaxResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<StateTaxResource> new_list;
			StateTaxResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("StateTaxResource")) {
					jsonToValue(&inst, temp_json, "StateTaxResource", "");
				} else {
...
PageResource«StateTaxResource»::PageResource«StateTaxResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«StateTaxResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("StateTaxResource")) {
		list<StateTaxResource> new_list = static_cast<list <StateTaxResource> > (getContent());
		node = converttoJson(&new_list, "StateTaxResource", "array");
	} else {
		...
		for (list<StateTaxResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			StateTaxResource obj = *it;
...
std::list<StateTaxResource>
PageResource«StateTaxResource»::getContent()
{
	return content;
}

void
PageResource«StateTaxResource»::setContent(std::list <StateTaxResource> content)
{
	this->content = content;
}

bool
PageResource«StateTaxResource»::getFirst()
{
	return first;
}

void
PageResource«StateTaxResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«StateTaxResource»::getLast()
{
	return last;
}

void
PageResource«StateTaxResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«StateTaxResource»::getNumber()
{
	return number;
}

void
PageResource«StateTaxResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«StateTaxResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«StateTaxResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«StateTaxResource»::getSize()
{
	return size;
}

void
PageResource«StateTaxResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«StateTaxResource»::getSort()
{
	return sort;
}

void
PageResource«StateTaxResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«StateTaxResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«StateTaxResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«StateTaxResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«StateTaxResource»::setTotalPages(int  total_pages)
{
