#ifndef _GamificationLeaderboardsManager_H_
#define _GamificationLeaderboardsManager_H_
...
/** \addtogroup GamificationLeaderboards GamificationLeaderboards
 * \ingroup Operations
 *  @{
 */
class GamificationLeaderboardsManager {
public:
	GamificationLeaderboardsManager();
	virtual ~GamificationLeaderboardsManager();
...
#endif /* GamificationLeaderboardsManager_H_ */
