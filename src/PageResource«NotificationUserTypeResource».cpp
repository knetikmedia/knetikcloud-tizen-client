...
void
PageResource«NotificationUserTypeResource»::__init()
{
	//
...
void
PageResource«NotificationUserTypeResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«NotificationUserTypeResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<NotificationUserTypeResource> new_list;
			NotificationUserTypeResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("NotificationUserTypeResource")) {
					jsonToValue(&inst, temp_json, "NotificationUserTypeResource", "");
				} else {
...
PageResource«NotificationUserTypeResource»::PageResource«NotificationUserTypeResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«NotificationUserTypeResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("NotificationUserTypeResource")) {
		list<NotificationUserTypeResource> new_list = static_cast<list <NotificationUserTypeResource> > (getContent());
		node = converttoJson(&new_list, "NotificationUserTypeResource", "array");
	} else {
		...
		for (list<NotificationUserTypeResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			NotificationUserTypeResource obj = *it;
...
std::list<NotificationUserTypeResource>
PageResource«NotificationUserTypeResource»::getContent()
{
	return content;
}

void
PageResource«NotificationUserTypeResource»::setContent(std::list <NotificationUserTypeResource> content)
{
	this->content = content;
}

bool
PageResource«NotificationUserTypeResource»::getFirst()
{
	return first;
}

void
PageResource«NotificationUserTypeResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«NotificationUserTypeResource»::getLast()
{
	return last;
}

void
PageResource«NotificationUserTypeResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«NotificationUserTypeResource»::getNumber()
{
	return number;
}

void
PageResource«NotificationUserTypeResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«NotificationUserTypeResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«NotificationUserTypeResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«NotificationUserTypeResource»::getSize()
{
	return size;
}

void
PageResource«NotificationUserTypeResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«NotificationUserTypeResource»::getSort()
{
	return sort;
}

void
PageResource«NotificationUserTypeResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«NotificationUserTypeResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«NotificationUserTypeResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«NotificationUserTypeResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«NotificationUserTypeResource»::setTotalPages(int  total_pages)
{
