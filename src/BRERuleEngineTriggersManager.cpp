...
#include "BRERuleEngineTriggersManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
BRERuleEngineTriggersManager::BRERuleEngineTriggersManager()
{
...
static gboolean __BRERuleEngineTriggersManagerresponseHandler(gpointer data)
{
...
static gpointer __BRERuleEngineTriggersManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__BRERuleEngineTriggersManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(BRERuleEngineTriggersManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (BRERuleEngineTriggersManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), createBRETriggerProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __BRERuleEngineTriggersManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool BRERuleEngineTriggersManager::createBRETriggerAsync(char * accessToken,
	BreTriggerResource breTriggerResource, 
	void(* handler)(BreTriggerResource, Error, void* )
	, void* userData)
{
...
bool BRERuleEngineTriggersManager::createBRETriggerSync(char * accessToken,
	BreTriggerResource breTriggerResource, 
	void(* handler)(BreTriggerResource, Error, void* )
	, void* userData)
{
...
bool BRERuleEngineTriggersManager::deleteBRETriggerAsync(char * accessToken,
	std::string eventName, 
...
bool BRERuleEngineTriggersManager::deleteBRETriggerSync(char * accessToken,
	std::string eventName, 
...
bool BRERuleEngineTriggersManager::getBRETriggerAsync(char * accessToken,
	std::string eventName, 
	void(* handler)(BreTriggerResource, Error, void* )
	, void* userData)
{
...
bool BRERuleEngineTriggersManager::getBRETriggerSync(char * accessToken,
	std::string eventName, 
	void(* handler)(BreTriggerResource, Error, void* )
	, void* userData)
{
...
bool BRERuleEngineTriggersManager::getBRETriggersAsync(char * accessToken,
	bool filterSystem, std::string filterCategory, std::string filterTags, std::string filterName, std::string filterSearch, int size, int page, 
	void(* handler)(PageResource«BreTriggerResource», Error, void* )
	, void* userData)
{
...
bool BRERuleEngineTriggersManager::getBRETriggersSync(char * accessToken,
	bool filterSystem, std::string filterCategory, std::string filterTags, std::string filterName, std::string filterSearch, int size, int page, 
	void(* handler)(PageResource«BreTriggerResource», Error, void* )
	, void* userData)
{
...
bool BRERuleEngineTriggersManager::updateBRETriggerAsync(char * accessToken,
	std::string eventName, BreTriggerResource breTriggerResource, 
	void(* handler)(BreTriggerResource, Error, void* )
	, void* userData)
{
...
bool BRERuleEngineTriggersManager::updateBRETriggerSync(char * accessToken,
	std::string eventName, BreTriggerResource breTriggerResource, 
	void(* handler)(BreTriggerResource, Error, void* )
	, void* userData)
{
