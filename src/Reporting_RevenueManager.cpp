...
#include "Reporting_RevenueManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
Reporting_RevenueManager::Reporting_RevenueManager()
{
...
static gboolean __Reporting_RevenueManagerresponseHandler(gpointer data)
{
...
static gpointer __Reporting_RevenueManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__Reporting_RevenueManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(Reporting_RevenueManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (Reporting_RevenueManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), getItemRevenueProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __Reporting_RevenueManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool Reporting_RevenueManager::getItemRevenueAsync(char * accessToken,
	std::string currencyCode, long long startDate, long long endDate, 
	void(* handler)(RevenueReportResource, Error, void* )
	, void* userData)
{
...
bool Reporting_RevenueManager::getItemRevenueSync(char * accessToken,
	std::string currencyCode, long long startDate, long long endDate, 
	void(* handler)(RevenueReportResource, Error, void* )
	, void* userData)
{
...
bool Reporting_RevenueManager::getRefundRevenueAsync(char * accessToken,
	std::string currencyCode, long long startDate, long long endDate, 
	void(* handler)(RevenueReportResource, Error, void* )
	, void* userData)
{
...
bool Reporting_RevenueManager::getRefundRevenueSync(char * accessToken,
	std::string currencyCode, long long startDate, long long endDate, 
	void(* handler)(RevenueReportResource, Error, void* )
	, void* userData)
{
...
bool Reporting_RevenueManager::getRevenueByCountryAsync(char * accessToken,
	std::string currencyCode, long long startDate, long long endDate, int size, int page, 
	void(* handler)(PageResource«RevenueCountryReportResource», Error, void* )
	, void* userData)
{
...
bool Reporting_RevenueManager::getRevenueByCountrySync(char * accessToken,
	std::string currencyCode, long long startDate, long long endDate, int size, int page, 
	void(* handler)(PageResource«RevenueCountryReportResource», Error, void* )
	, void* userData)
{
...
bool Reporting_RevenueManager::getRevenueByItemAsync(char * accessToken,
	std::string currencyCode, long long startDate, long long endDate, int size, int page, 
	void(* handler)(PageResource«RevenueProductReportResource», Error, void* )
	, void* userData)
{
...
bool Reporting_RevenueManager::getRevenueByItemSync(char * accessToken,
	std::string currencyCode, long long startDate, long long endDate, int size, int page, 
	void(* handler)(PageResource«RevenueProductReportResource», Error, void* )
	, void* userData)
{
...
bool Reporting_RevenueManager::getSubscriptionRevenueAsync(char * accessToken,
	std::string currencyCode, long long startDate, long long endDate, 
	void(* handler)(RevenueReportResource, Error, void* )
	, void* userData)
{
...
bool Reporting_RevenueManager::getSubscriptionRevenueSync(char * accessToken,
	std::string currencyCode, long long startDate, long long endDate, 
	void(* handler)(RevenueReportResource, Error, void* )
	, void* userData)
{
