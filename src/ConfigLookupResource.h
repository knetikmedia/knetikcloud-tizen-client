...
#ifndef _ConfigLookupResource_H_
#define _ConfigLookupResource_H_
...
class ConfigLookupResource : public Object {
public:
	/*! \brief Constructor.
	 */
	ConfigLookupResource();
	ConfigLookupResource(char* str);
...
#endif /* _ConfigLookupResource_H_ */
