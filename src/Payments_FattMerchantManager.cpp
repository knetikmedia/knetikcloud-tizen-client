...
#include "Payments_FattMerchantManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
Payments_FattMerchantManager::Payments_FattMerchantManager()
{
...
static gboolean __Payments_FattMerchantManagerresponseHandler(gpointer data)
{
...
static gpointer __Payments_FattMerchantManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__Payments_FattMerchantManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(Payments_FattMerchantManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (Payments_FattMerchantManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		thread = g_thread_new(NULL, __Payments_FattMerchantManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool Payments_FattMerchantManager::createOrUpdateFattMerchantPaymentMethodAsync(char * accessToken,
	FattMerchantPaymentMethodRequest request, 
	void(* handler)(PaymentMethodResource, Error, void* )
	, void* userData)
{
...
bool Payments_FattMerchantManager::createOrUpdateFattMerchantPaymentMethodSync(char * accessToken,
	FattMerchantPaymentMethodRequest request, 
	void(* handler)(PaymentMethodResource, Error, void* )
	, void* userData)
{
