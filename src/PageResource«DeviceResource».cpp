...
void
PageResource«DeviceResource»::__init()
{
	//
...
void
PageResource«DeviceResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«DeviceResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<DeviceResource> new_list;
			DeviceResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("DeviceResource")) {
					jsonToValue(&inst, temp_json, "DeviceResource", "");
				} else {
...
PageResource«DeviceResource»::PageResource«DeviceResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«DeviceResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("DeviceResource")) {
		list<DeviceResource> new_list = static_cast<list <DeviceResource> > (getContent());
		node = converttoJson(&new_list, "DeviceResource", "array");
	} else {
		...
		for (list<DeviceResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			DeviceResource obj = *it;
...
std::list<DeviceResource>
PageResource«DeviceResource»::getContent()
{
	return content;
}

void
PageResource«DeviceResource»::setContent(std::list <DeviceResource> content)
{
	this->content = content;
}

bool
PageResource«DeviceResource»::getFirst()
{
	return first;
}

void
PageResource«DeviceResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«DeviceResource»::getLast()
{
	return last;
}

void
PageResource«DeviceResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«DeviceResource»::getNumber()
{
	return number;
}

void
PageResource«DeviceResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«DeviceResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«DeviceResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«DeviceResource»::getSize()
{
	return size;
}

void
PageResource«DeviceResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«DeviceResource»::getSort()
{
	return sort;
}

void
PageResource«DeviceResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«DeviceResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«DeviceResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«DeviceResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«DeviceResource»::setTotalPages(int  total_pages)
{
