...
void
PageResource«QuestionResource»::__init()
{
	//
...
void
PageResource«QuestionResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«QuestionResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<QuestionResource> new_list;
			QuestionResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("QuestionResource")) {
					jsonToValue(&inst, temp_json, "QuestionResource", "");
				} else {
...
PageResource«QuestionResource»::PageResource«QuestionResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«QuestionResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("QuestionResource")) {
		list<QuestionResource> new_list = static_cast<list <QuestionResource> > (getContent());
		node = converttoJson(&new_list, "QuestionResource", "array");
	} else {
		...
		for (list<QuestionResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			QuestionResource obj = *it;
...
std::list<QuestionResource>
PageResource«QuestionResource»::getContent()
{
	return content;
}

void
PageResource«QuestionResource»::setContent(std::list <QuestionResource> content)
{
	this->content = content;
}

bool
PageResource«QuestionResource»::getFirst()
{
	return first;
}

void
PageResource«QuestionResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«QuestionResource»::getLast()
{
	return last;
}

void
PageResource«QuestionResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«QuestionResource»::getNumber()
{
	return number;
}

void
PageResource«QuestionResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«QuestionResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«QuestionResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«QuestionResource»::getSize()
{
	return size;
}

void
PageResource«QuestionResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«QuestionResource»::getSort()
{
	return sort;
}

void
PageResource«QuestionResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«QuestionResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«QuestionResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«QuestionResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«QuestionResource»::setTotalPages(int  total_pages)
{
