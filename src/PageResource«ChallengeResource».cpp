...
void
PageResource«ChallengeResource»::__init()
{
	//
...
void
PageResource«ChallengeResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«ChallengeResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<ChallengeResource> new_list;
			ChallengeResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("ChallengeResource")) {
					jsonToValue(&inst, temp_json, "ChallengeResource", "");
				} else {
...
PageResource«ChallengeResource»::PageResource«ChallengeResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«ChallengeResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("ChallengeResource")) {
		list<ChallengeResource> new_list = static_cast<list <ChallengeResource> > (getContent());
		node = converttoJson(&new_list, "ChallengeResource", "array");
	} else {
		...
		for (list<ChallengeResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			ChallengeResource obj = *it;
...
std::list<ChallengeResource>
PageResource«ChallengeResource»::getContent()
{
	return content;
}

void
PageResource«ChallengeResource»::setContent(std::list <ChallengeResource> content)
{
	this->content = content;
}

bool
PageResource«ChallengeResource»::getFirst()
{
	return first;
}

void
PageResource«ChallengeResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«ChallengeResource»::getLast()
{
	return last;
}

void
PageResource«ChallengeResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«ChallengeResource»::getNumber()
{
	return number;
}

void
PageResource«ChallengeResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«ChallengeResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«ChallengeResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«ChallengeResource»::getSize()
{
	return size;
}

void
PageResource«ChallengeResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«ChallengeResource»::getSort()
{
	return sort;
}

void
PageResource«ChallengeResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«ChallengeResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«ChallengeResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«ChallengeResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«ChallengeResource»::setTotalPages(int  total_pages)
{
