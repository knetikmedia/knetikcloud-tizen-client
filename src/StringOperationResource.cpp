...
void
StringOperationResource::__init()
{
	//
...
void
StringOperationResource::__cleanup()
{
	//if(args != NULL) {
	//args.RemoveAll(true);
	//delete args;
...
void
StringOperationResource::fromJson(char* jsonStr)
{
...
StringOperationResource::StringOperationResource(char* json)
{
	this->fromJson(json);
}

char*
StringOperationResource::toJson()
{
...
StringOperationResource::getArgs()
{
	return args;
}

void
StringOperationResource::setArgs(std::list <ExpressionResource> args)
{
	this->args = args;
}

std::string
StringOperationResource::getDefinition()
{
	return definition;
}

void
StringOperationResource::setDefinition(std::string  definition)
{
	this->definition = definition;
}

std::string
StringOperationResource::getOp()
{
	return op;
}

void
StringOperationResource::setOp(std::string  op)
{
	this->op = op;
}

std::string
StringOperationResource::getReturnType()
{
	return return_type;
}

void
StringOperationResource::setReturnType(std::string  return_type)
{
	this->return_type = return_type;
}

std::list<OperationDefinitionResource>
StringOperationResource::getSupportedOperators()
{
	return supported_operators;
}

void
StringOperationResource::setSupportedOperators(std::list <OperationDefinitionResource> supported_operators)
{
	this->supported_operators = supported_operators;
}

std::string
StringOperationResource::getType()
{
	return type;
}

void
StringOperationResource::setType(std::string  type)
{
	this->type = type;
}
