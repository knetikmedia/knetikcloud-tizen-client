...
#ifndef _PageResource«ArtistResource»_H_
#define _PageResource«ArtistResource»_H_
...
class PageResource«ArtistResource» : public Object {
public:
	/*! \brief Constructor.
	 */
	PageResource«ArtistResource»();
	PageResource«ArtistResource»(char* str);
	...
	/*! \brief Get 
	 */
	std::list<ArtistResource> getContent();

	/*! \brief Set 
	 */
	void setContent(std::list <ArtistResource> content);
	/*! \brief Get 
	 */
	bool getFirst();
...
private:
	std::list <ArtistResource>content;
	bool first;
	bool last;
	int number;
...
#endif /* _PageResource«ArtistResource»_H_ */
