...
#include "StoreShoppingCartsManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
StoreShoppingCartsManager::StoreShoppingCartsManager()
{
...
static gboolean __StoreShoppingCartsManagerresponseHandler(gpointer data)
{
...
static gpointer __StoreShoppingCartsManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__StoreShoppingCartsManagerresponseHandler, static_cast<gpointer>(request));
	...
	void(* handler)(Error, void* ) , void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(StoreShoppingCartsManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (StoreShoppingCartsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), addCustomDiscountProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __StoreShoppingCartsManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool StoreShoppingCartsManager::addCustomDiscountAsync(char * accessToken,
	std::string id, CouponDefinition customDiscount, 
...
bool StoreShoppingCartsManager::addCustomDiscountSync(char * accessToken,
	std::string id, CouponDefinition customDiscount, 
...
bool StoreShoppingCartsManager::addDiscountToCartAsync(char * accessToken,
	std::string id, SkuRequest skuRequest, 
...
bool StoreShoppingCartsManager::addDiscountToCartSync(char * accessToken,
	std::string id, SkuRequest skuRequest, 
...
bool StoreShoppingCartsManager::addItemToCartAsync(char * accessToken,
	std::string id, CartItemRequest cartItemRequest, 
...
bool StoreShoppingCartsManager::addItemToCartSync(char * accessToken,
	std::string id, CartItemRequest cartItemRequest, 
...
bool StoreShoppingCartsManager::createCartAsync(char * accessToken,
	int owner, std::string currencyCode, 
	void(* handler)(std::string, Error, void* )
	, void* userData)
{
...
bool StoreShoppingCartsManager::createCartSync(char * accessToken,
	int owner, std::string currencyCode, 
	void(* handler)(std::string, Error, void* )
	, void* userData)
{
...
bool StoreShoppingCartsManager::getCartAsync(char * accessToken,
	std::string id, 
	void(* handler)(Cart, Error, void* )
	, void* userData)
{
...
bool StoreShoppingCartsManager::getCartSync(char * accessToken,
	std::string id, 
	void(* handler)(Cart, Error, void* )
	, void* userData)
{
...
bool StoreShoppingCartsManager::getCartsAsync(char * accessToken,
	int filterOwnerId, int size, int page, std::string order, 
	void(* handler)(PageResource«CartSummary», Error, void* )
	, void* userData)
{
...
bool StoreShoppingCartsManager::getCartsSync(char * accessToken,
	int filterOwnerId, int size, int page, std::string order, 
	void(* handler)(PageResource«CartSummary», Error, void* )
	, void* userData)
{
...
bool StoreShoppingCartsManager::getShippableAsync(char * accessToken,
	std::string id, 
	void(* handler)(CartShippableResponse, Error, void* )
	, void* userData)
{
...
bool StoreShoppingCartsManager::getShippableSync(char * accessToken,
	std::string id, 
	void(* handler)(CartShippableResponse, Error, void* )
	, void* userData)
{
...
bool StoreShoppingCartsManager::getShippingCountriesAsync(char * accessToken,
	std::string id, 
	void(* handler)(SampleCountriesResponse, Error, void* )
	, void* userData)
{
...
bool StoreShoppingCartsManager::getShippingCountriesSync(char * accessToken,
	std::string id, 
	void(* handler)(SampleCountriesResponse, Error, void* )
	, void* userData)
{
...
bool StoreShoppingCartsManager::removeDiscountFromCartAsync(char * accessToken,
	std::string id, std::string code, 
...
bool StoreShoppingCartsManager::removeDiscountFromCartSync(char * accessToken,
	std::string id, std::string code, 
...
bool StoreShoppingCartsManager::setCartCurrencyAsync(char * accessToken,
	std::string id, StringWrapper currencyCode, 
...
bool StoreShoppingCartsManager::setCartCurrencySync(char * accessToken,
	std::string id, StringWrapper currencyCode, 
...
bool StoreShoppingCartsManager::setCartOwnerAsync(char * accessToken,
	std::string id, IntWrapper userId, 
...
bool StoreShoppingCartsManager::setCartOwnerSync(char * accessToken,
	std::string id, IntWrapper userId, 
...
bool StoreShoppingCartsManager::updateItemInCartAsync(char * accessToken,
	std::string id, CartItemRequest cartItemRequest, 
...
bool StoreShoppingCartsManager::updateItemInCartSync(char * accessToken,
	std::string id, CartItemRequest cartItemRequest, 
...
bool StoreShoppingCartsManager::updateShippingAddressAsync(char * accessToken,
	std::string id, CartShippingAddressRequest cartShippingAddressRequest, 
...
bool StoreShoppingCartsManager::updateShippingAddressSync(char * accessToken,
	std::string id, CartShippingAddressRequest cartShippingAddressRequest, 
