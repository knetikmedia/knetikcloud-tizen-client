...
void
PageResource«TopicSubscriberResource»::__init()
{
	//
...
void
PageResource«TopicSubscriberResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«TopicSubscriberResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<TopicSubscriberResource> new_list;
			TopicSubscriberResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("TopicSubscriberResource")) {
					jsonToValue(&inst, temp_json, "TopicSubscriberResource", "");
				} else {
...
PageResource«TopicSubscriberResource»::PageResource«TopicSubscriberResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«TopicSubscriberResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("TopicSubscriberResource")) {
		list<TopicSubscriberResource> new_list = static_cast<list <TopicSubscriberResource> > (getContent());
		node = converttoJson(&new_list, "TopicSubscriberResource", "array");
	} else {
		...
		for (list<TopicSubscriberResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			TopicSubscriberResource obj = *it;
...
std::list<TopicSubscriberResource>
PageResource«TopicSubscriberResource»::getContent()
{
	return content;
}

void
PageResource«TopicSubscriberResource»::setContent(std::list <TopicSubscriberResource> content)
{
	this->content = content;
}

bool
PageResource«TopicSubscriberResource»::getFirst()
{
	return first;
}

void
PageResource«TopicSubscriberResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«TopicSubscriberResource»::getLast()
{
	return last;
}

void
PageResource«TopicSubscriberResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«TopicSubscriberResource»::getNumber()
{
	return number;
}

void
PageResource«TopicSubscriberResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«TopicSubscriberResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«TopicSubscriberResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«TopicSubscriberResource»::getSize()
{
	return size;
}

void
PageResource«TopicSubscriberResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«TopicSubscriberResource»::getSort()
{
	return sort;
}

void
PageResource«TopicSubscriberResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«TopicSubscriberResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«TopicSubscriberResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«TopicSubscriberResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«TopicSubscriberResource»::setTotalPages(int  total_pages)
{
