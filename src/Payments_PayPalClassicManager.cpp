...
#include "Payments_PayPalClassicManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
Payments_PayPalClassicManager::Payments_PayPalClassicManager()
{
...
static gboolean __Payments_PayPalClassicManagerresponseHandler(gpointer data)
{
...
static gpointer __Payments_PayPalClassicManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__Payments_PayPalClassicManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(Payments_PayPalClassicManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (Payments_PayPalClassicManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), createPayPalBillingAgreementUrlProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __Payments_PayPalClassicManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool Payments_PayPalClassicManager::createPayPalBillingAgreementUrlAsync(char * accessToken,
	CreateBillingAgreementRequest request, 
	void(* handler)(std::string, Error, void* )
	, void* userData)
{
...
bool Payments_PayPalClassicManager::createPayPalBillingAgreementUrlSync(char * accessToken,
	CreateBillingAgreementRequest request, 
	void(* handler)(std::string, Error, void* )
	, void* userData)
{
...
bool Payments_PayPalClassicManager::createPayPalExpressCheckoutAsync(char * accessToken,
	CreatePayPalPaymentRequest request, 
	void(* handler)(std::string, Error, void* )
	, void* userData)
{
...
bool Payments_PayPalClassicManager::createPayPalExpressCheckoutSync(char * accessToken,
	CreatePayPalPaymentRequest request, 
	void(* handler)(std::string, Error, void* )
	, void* userData)
{
...
bool Payments_PayPalClassicManager::finalizePayPalBillingAgreementAsync(char * accessToken,
	FinalizeBillingAgreementRequest request, 
	void(* handler)(int, Error, void* )
	, void* userData)
{
...
bool Payments_PayPalClassicManager::finalizePayPalBillingAgreementSync(char * accessToken,
	FinalizeBillingAgreementRequest request, 
	void(* handler)(int, Error, void* )
	, void* userData)
{
...
bool Payments_PayPalClassicManager::finalizePayPalCheckoutAsync(char * accessToken,
	FinalizePayPalPaymentRequest request, 
...
bool Payments_PayPalClassicManager::finalizePayPalCheckoutSync(char * accessToken,
	FinalizePayPalPaymentRequest request, 
