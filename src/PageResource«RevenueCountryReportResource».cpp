...
void
PageResource«RevenueCountryReportResource»::__init()
{
	//
...
void
PageResource«RevenueCountryReportResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«RevenueCountryReportResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<RevenueCountryReportResource> new_list;
			RevenueCountryReportResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("RevenueCountryReportResource")) {
					jsonToValue(&inst, temp_json, "RevenueCountryReportResource", "");
				} else {
...
PageResource«RevenueCountryReportResource»::PageResource«RevenueCountryReportResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«RevenueCountryReportResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("RevenueCountryReportResource")) {
		list<RevenueCountryReportResource> new_list = static_cast<list <RevenueCountryReportResource> > (getContent());
		node = converttoJson(&new_list, "RevenueCountryReportResource", "array");
	} else {
		...
		for (list<RevenueCountryReportResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			RevenueCountryReportResource obj = *it;
...
std::list<RevenueCountryReportResource>
PageResource«RevenueCountryReportResource»::getContent()
{
	return content;
}

void
PageResource«RevenueCountryReportResource»::setContent(std::list <RevenueCountryReportResource> content)
{
	this->content = content;
}

bool
PageResource«RevenueCountryReportResource»::getFirst()
{
	return first;
}

void
PageResource«RevenueCountryReportResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«RevenueCountryReportResource»::getLast()
{
	return last;
}

void
PageResource«RevenueCountryReportResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«RevenueCountryReportResource»::getNumber()
{
	return number;
}

void
PageResource«RevenueCountryReportResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«RevenueCountryReportResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«RevenueCountryReportResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«RevenueCountryReportResource»::getSize()
{
	return size;
}

void
PageResource«RevenueCountryReportResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«RevenueCountryReportResource»::getSort()
{
	return sort;
}

void
PageResource«RevenueCountryReportResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«RevenueCountryReportResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«RevenueCountryReportResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«RevenueCountryReportResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«RevenueCountryReportResource»::setTotalPages(int  total_pages)
{
