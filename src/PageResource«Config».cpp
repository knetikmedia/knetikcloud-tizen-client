...
void
PageResource«Config»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<Config> new_list;
			Config inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("Config")) {
					jsonToValue(&inst, temp_json, "Config", "");
				} else {
...
PageResource«Config»::PageResource«Config»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«Config»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("Config")) {
		list<Config> new_list = static_cast<list <Config> > (getContent());
		node = converttoJson(&new_list, "Config", "array");
	} else {
		...
		for (list<Config>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			Config obj = *it;
...
std::list<Config>
PageResource«Config»::getContent()
{
	return content;
}

void
PageResource«Config»::setContent(std::list <Config> content)
{
	this->content = content;
}

bool
PageResource«Config»::getFirst()
{
	return first;
}

void
PageResource«Config»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«Config»::getLast()
{
	return last;
}

void
PageResource«Config»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«Config»::getNumber()
{
	return number;
}

void
PageResource«Config»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«Config»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«Config»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«Config»::getSize()
{
	return size;
}

void
PageResource«Config»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«Config»::getSort()
{
	return sort;
}

void
PageResource«Config»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«Config»::getTotalElements()
{
	return total_elements;
}

void
PageResource«Config»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«Config»::getTotalPages()
{
	return total_pages;
}

void
PageResource«Config»::setTotalPages(int  total_pages)
{
