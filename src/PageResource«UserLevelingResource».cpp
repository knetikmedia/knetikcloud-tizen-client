...
void
PageResource«UserLevelingResource»::__init()
{
	//
...
void
PageResource«UserLevelingResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«UserLevelingResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<UserLevelingResource> new_list;
			UserLevelingResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("UserLevelingResource")) {
					jsonToValue(&inst, temp_json, "UserLevelingResource", "");
				} else {
...
PageResource«UserLevelingResource»::PageResource«UserLevelingResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«UserLevelingResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("UserLevelingResource")) {
		list<UserLevelingResource> new_list = static_cast<list <UserLevelingResource> > (getContent());
		node = converttoJson(&new_list, "UserLevelingResource", "array");
	} else {
		...
		for (list<UserLevelingResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			UserLevelingResource obj = *it;
...
std::list<UserLevelingResource>
PageResource«UserLevelingResource»::getContent()
{
	return content;
}

void
PageResource«UserLevelingResource»::setContent(std::list <UserLevelingResource> content)
{
	this->content = content;
}

bool
PageResource«UserLevelingResource»::getFirst()
{
	return first;
}

void
PageResource«UserLevelingResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«UserLevelingResource»::getLast()
{
	return last;
}

void
PageResource«UserLevelingResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«UserLevelingResource»::getNumber()
{
	return number;
}

void
PageResource«UserLevelingResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«UserLevelingResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«UserLevelingResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«UserLevelingResource»::getSize()
{
	return size;
}

void
PageResource«UserLevelingResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«UserLevelingResource»::getSort()
{
	return sort;
}

void
PageResource«UserLevelingResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«UserLevelingResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«UserLevelingResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«UserLevelingResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«UserLevelingResource»::setTotalPages(int  total_pages)
{
