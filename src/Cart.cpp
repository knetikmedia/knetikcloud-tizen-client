...
Cart::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("double")) {
			jsonToValue(&country_tax, node, "double", "");
		} else {
	...
	if (node !=NULL) {
		...
		if (isprimitive("double")) {
			jsonToValue(&discount_total, node, "double", "");
		} else {
	...
	if (node !=NULL) {
		...
		if (isprimitive("double")) {
			jsonToValue(&grand_total, node, "double", "");
		} else {
	...
	if (node !=NULL) {
		...
		if (isprimitive("double")) {
			jsonToValue(&invoice_id, node, "double", "");
		} else {
	...
	if (node !=NULL) {
		...
		if (isprimitive("double")) {
			jsonToValue(&shipping_cost, node, "double", "");
		} else {
	...
	if (node !=NULL) {
		...
		if (isprimitive("double")) {
			jsonToValue(&state_tax, node, "double", "");
		} else {
	...
	if (node !=NULL) {
		...
		if (isprimitive("double")) {
			jsonToValue(&subtotal, node, "double", "");
		} else {
...
void
Cart::setCountryTax(double  country_tax)
{
...
void
Cart::setDiscountTotal(double  discount_total)
{
...
void
Cart::setGrandTotal(double  grand_total)
{
...
void
Cart::setInvoiceId(double  invoice_id)
{
...
void
Cart::setShippingCost(double  shipping_cost)
{
...
void
Cart::setStateTax(double  state_tax)
{
...
void
Cart::setSubtotal(double  subtotal)
{
