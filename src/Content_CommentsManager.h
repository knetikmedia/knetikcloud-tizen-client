#ifndef _Content_CommentsManager_H_
#define _Content_CommentsManager_H_
...
/** \addtogroup Content_Comments Content_Comments
 * \ingroup Operations
 *  @{
 */
class Content_CommentsManager {
public:
	Content_CommentsManager();
	virtual ~Content_CommentsManager();
...
#endif /* Content_CommentsManager_H_ */
