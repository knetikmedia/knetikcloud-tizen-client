...
void
PageResource«BreTriggerResource»::__init()
{
	//
...
void
PageResource«BreTriggerResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«BreTriggerResource»::fromJson(char* jsonStr)
{
...
PageResource«BreTriggerResource»::PageResource«BreTriggerResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«BreTriggerResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("BreTriggerResource")) {
		list<BreTriggerResource> new_list = static_cast<list <BreTriggerResource> > (getContent());
...
PageResource«BreTriggerResource»::getContent()
{
	return content;
}

void
PageResource«BreTriggerResource»::setContent(std::list <BreTriggerResource> content)
{
	this->content = content;
}

bool
PageResource«BreTriggerResource»::getFirst()
{
	return first;
}

void
PageResource«BreTriggerResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«BreTriggerResource»::getLast()
{
	return last;
}

void
PageResource«BreTriggerResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«BreTriggerResource»::getNumber()
{
	return number;
}

void
PageResource«BreTriggerResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«BreTriggerResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«BreTriggerResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«BreTriggerResource»::getSize()
{
	return size;
}

void
PageResource«BreTriggerResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«BreTriggerResource»::getSort()
{
	return sort;
}

void
PageResource«BreTriggerResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«BreTriggerResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«BreTriggerResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«BreTriggerResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«BreTriggerResource»::setTotalPages(int  total_pages)
{
