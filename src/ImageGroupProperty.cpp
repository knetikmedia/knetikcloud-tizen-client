...
void
ImageGroupProperty::fromJson(char* jsonStr)
{
...
ImageGroupProperty::ImageGroupProperty(char* json)
{
	this->fromJson(json);
}

char*
ImageGroupProperty::toJson()
{
...
std::string
ImageGroupProperty::getType()
{
	return type;
}

void
ImageGroupProperty::setType(std::string  type)
{
	this->type = type;
}

std::list<FileProperty>
ImageGroupProperty::getFiles()
{
	return files;
}

void
ImageGroupProperty::setFiles(std::list <FileProperty> files)
{
	this->files = files;
}
