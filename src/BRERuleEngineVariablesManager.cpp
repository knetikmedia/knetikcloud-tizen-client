...
#include "BRERuleEngineVariablesManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
BRERuleEngineVariablesManager::BRERuleEngineVariablesManager()
{
...
static gboolean __BRERuleEngineVariablesManagerresponseHandler(gpointer data)
{
...
static gpointer __BRERuleEngineVariablesManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__BRERuleEngineVariablesManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(BRERuleEngineVariablesManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (BRERuleEngineVariablesManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), getBREVariableTypesProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __BRERuleEngineVariablesManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool BRERuleEngineVariablesManager::getBREVariableTypesAsync(char * accessToken,
...
bool BRERuleEngineVariablesManager::getBREVariableTypesSync(char * accessToken,
...
bool BRERuleEngineVariablesManager::getBREVariableValuesAsync(char * accessToken,
	std::string name, std::string filterName, int size, int page, 
	void(* handler)(PageResource«SimpleReferenceResource«object»», Error, void* )
	, void* userData)
{
...
bool BRERuleEngineVariablesManager::getBREVariableValuesSync(char * accessToken,
	std::string name, std::string filterName, int size, int page, 
	void(* handler)(PageResource«SimpleReferenceResource«object»», Error, void* )
	, void* userData)
{
