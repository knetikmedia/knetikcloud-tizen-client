...
void
PageResource«UserNotificationResource»::__init()
{
	//
...
void
PageResource«UserNotificationResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«UserNotificationResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<UserNotificationResource> new_list;
			UserNotificationResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("UserNotificationResource")) {
					jsonToValue(&inst, temp_json, "UserNotificationResource", "");
				} else {
...
PageResource«UserNotificationResource»::PageResource«UserNotificationResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«UserNotificationResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("UserNotificationResource")) {
		list<UserNotificationResource> new_list = static_cast<list <UserNotificationResource> > (getContent());
		node = converttoJson(&new_list, "UserNotificationResource", "array");
	} else {
		...
		for (list<UserNotificationResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			UserNotificationResource obj = *it;
...
std::list<UserNotificationResource>
PageResource«UserNotificationResource»::getContent()
{
	return content;
}

void
PageResource«UserNotificationResource»::setContent(std::list <UserNotificationResource> content)
{
	this->content = content;
}

bool
PageResource«UserNotificationResource»::getFirst()
{
	return first;
}

void
PageResource«UserNotificationResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«UserNotificationResource»::getLast()
{
	return last;
}

void
PageResource«UserNotificationResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«UserNotificationResource»::getNumber()
{
	return number;
}

void
PageResource«UserNotificationResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«UserNotificationResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«UserNotificationResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«UserNotificationResource»::getSize()
{
	return size;
}

void
PageResource«UserNotificationResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«UserNotificationResource»::getSort()
{
	return sort;
}

void
PageResource«UserNotificationResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«UserNotificationResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«UserNotificationResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«UserNotificationResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«UserNotificationResource»::setTotalPages(int  total_pages)
{
