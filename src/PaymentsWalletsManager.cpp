...
#include "PaymentsWalletsManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
PaymentsWalletsManager::PaymentsWalletsManager()
{
...
static gboolean __PaymentsWalletsManagerresponseHandler(gpointer data)
{
...
static gpointer __PaymentsWalletsManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__PaymentsWalletsManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(PaymentsWalletsManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (PaymentsWalletsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), getUserWalletProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __PaymentsWalletsManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool PaymentsWalletsManager::getUserWalletAsync(char * accessToken,
	int userId, std::string currencyCode, 
	void(* handler)(SimpleWallet, Error, void* )
	, void* userData)
{
...
bool PaymentsWalletsManager::getUserWalletSync(char * accessToken,
	int userId, std::string currencyCode, 
	void(* handler)(SimpleWallet, Error, void* )
	, void* userData)
{
...
bool PaymentsWalletsManager::getUserWalletTransactionsAsync(char * accessToken,
	int userId, std::string currencyCode, std::string filterType, long long filterMaxDate, long long filterMinDate, std::string filterSign, int size, int page, std::string order, 
	void(* handler)(PageResource«WalletTransactionResource», Error, void* )
	, void* userData)
{
...
bool PaymentsWalletsManager::getUserWalletTransactionsSync(char * accessToken,
	int userId, std::string currencyCode, std::string filterType, long long filterMaxDate, long long filterMinDate, std::string filterSign, int size, int page, std::string order, 
	void(* handler)(PageResource«WalletTransactionResource», Error, void* )
	, void* userData)
{
...
bool PaymentsWalletsManager::getUserWalletsAsync(char * accessToken,
	int userId, 
	void(* handler)(std::list<SimpleWallet>, Error, void* )
	, void* userData)
{
...
bool PaymentsWalletsManager::getUserWalletsSync(char * accessToken,
	int userId, 
	void(* handler)(std::list<SimpleWallet>, Error, void* )
	, void* userData)
{
...
bool PaymentsWalletsManager::getWalletBalancesAsync(char * accessToken,
...
bool PaymentsWalletsManager::getWalletBalancesSync(char * accessToken,
...
bool PaymentsWalletsManager::getWalletTransactionsAsync(char * accessToken,
	int filterInvoice, std::string filterType, std::string filterDate, std::string filterSign, int filterUserId, std::string filterUsername, std::string filterDetails, std::string filterCurrencyCode, int size, int page, std::string order, 
	void(* handler)(PageResource«WalletTransactionResource», Error, void* )
	, void* userData)
{
...
bool PaymentsWalletsManager::getWalletTransactionsSync(char * accessToken,
	int filterInvoice, std::string filterType, std::string filterDate, std::string filterSign, int filterUserId, std::string filterUsername, std::string filterDetails, std::string filterCurrencyCode, int size, int page, std::string order, 
	void(* handler)(PageResource«WalletTransactionResource», Error, void* )
	, void* userData)
{
...
bool PaymentsWalletsManager::getWalletsAsync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«SimpleWallet», Error, void* )
	, void* userData)
{
...
bool PaymentsWalletsManager::getWalletsSync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«SimpleWallet», Error, void* )
	, void* userData)
{
...
bool PaymentsWalletsManager::updateWalletBalanceAsync(char * accessToken,
	int userId, std::string currencyCode, WalletAlterRequest request, 
	void(* handler)(WalletTransactionResource, Error, void* )
	, void* userData)
{
...
bool PaymentsWalletsManager::updateWalletBalanceSync(char * accessToken,
	int userId, std::string currencyCode, WalletAlterRequest request, 
	void(* handler)(WalletTransactionResource, Error, void* )
	, void* userData)
{
