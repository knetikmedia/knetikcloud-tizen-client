#ifndef _Util_BatchManager_H_
#define _Util_BatchManager_H_
...
/** \addtogroup Util_Batch Util_Batch
 * \ingroup Operations
 *  @{
 */
class Util_BatchManager {
public:
	Util_BatchManager();
	virtual ~Util_BatchManager();
