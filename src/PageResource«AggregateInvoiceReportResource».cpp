...
void
PageResource«AggregateInvoiceReportResource»::__init()
{
	//
...
void
PageResource«AggregateInvoiceReportResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«AggregateInvoiceReportResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<AggregateInvoiceReportResource> new_list;
			AggregateInvoiceReportResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("AggregateInvoiceReportResource")) {
					jsonToValue(&inst, temp_json, "AggregateInvoiceReportResource", "");
				} else {
...
PageResource«AggregateInvoiceReportResource»::PageResource«AggregateInvoiceReportResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«AggregateInvoiceReportResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("AggregateInvoiceReportResource")) {
		list<AggregateInvoiceReportResource> new_list = static_cast<list <AggregateInvoiceReportResource> > (getContent());
		node = converttoJson(&new_list, "AggregateInvoiceReportResource", "array");
	} else {
		...
		for (list<AggregateInvoiceReportResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			AggregateInvoiceReportResource obj = *it;
...
std::list<AggregateInvoiceReportResource>
PageResource«AggregateInvoiceReportResource»::getContent()
{
	return content;
}

void
PageResource«AggregateInvoiceReportResource»::setContent(std::list <AggregateInvoiceReportResource> content)
{
	this->content = content;
}

bool
PageResource«AggregateInvoiceReportResource»::getFirst()
{
	return first;
}

void
PageResource«AggregateInvoiceReportResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«AggregateInvoiceReportResource»::getLast()
{
	return last;
}

void
PageResource«AggregateInvoiceReportResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«AggregateInvoiceReportResource»::getNumber()
{
	return number;
}

void
PageResource«AggregateInvoiceReportResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«AggregateInvoiceReportResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«AggregateInvoiceReportResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«AggregateInvoiceReportResource»::getSize()
{
	return size;
}

void
PageResource«AggregateInvoiceReportResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«AggregateInvoiceReportResource»::getSort()
{
	return sort;
}

void
PageResource«AggregateInvoiceReportResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«AggregateInvoiceReportResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«AggregateInvoiceReportResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«AggregateInvoiceReportResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«AggregateInvoiceReportResource»::setTotalPages(int  total_pages)
{
