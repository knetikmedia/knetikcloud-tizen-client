...
#include "AuthPermissionsManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
AuthPermissionsManager::AuthPermissionsManager()
{
...
static gboolean __AuthPermissionsManagerresponseHandler(gpointer data)
{
...
static gpointer __AuthPermissionsManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__AuthPermissionsManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(AuthPermissionsManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (AuthPermissionsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), createPermissionProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __AuthPermissionsManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool AuthPermissionsManager::createPermissionAsync(char * accessToken,
	PermissionResource permissionResource, 
	void(* handler)(PermissionResource, Error, void* )
	, void* userData)
{
...
bool AuthPermissionsManager::createPermissionSync(char * accessToken,
	PermissionResource permissionResource, 
	void(* handler)(PermissionResource, Error, void* )
	, void* userData)
{
...
bool AuthPermissionsManager::deletePermissionAsync(char * accessToken,
	std::string permission, bool force, 
...
bool AuthPermissionsManager::deletePermissionSync(char * accessToken,
	std::string permission, bool force, 
...
bool AuthPermissionsManager::getPermissionAsync(char * accessToken,
	std::string permission, 
	void(* handler)(PermissionResource, Error, void* )
	, void* userData)
{
...
bool AuthPermissionsManager::getPermissionSync(char * accessToken,
	std::string permission, 
	void(* handler)(PermissionResource, Error, void* )
	, void* userData)
{
...
bool AuthPermissionsManager::getPermissionsAsync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«PermissionResource», Error, void* )
	, void* userData)
{
...
bool AuthPermissionsManager::getPermissionsSync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«PermissionResource», Error, void* )
	, void* userData)
{
...
bool AuthPermissionsManager::updatePermissionAsync(char * accessToken,
	std::string permission, PermissionResource permissionResource, 
	void(* handler)(PermissionResource, Error, void* )
	, void* userData)
{
...
bool AuthPermissionsManager::updatePermissionSync(char * accessToken,
	std::string permission, PermissionResource permissionResource, 
	void(* handler)(PermissionResource, Error, void* )
	, void* userData)
{
