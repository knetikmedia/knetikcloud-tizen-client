...
#include "Util_MaintenanceManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
Util_MaintenanceManager::Util_MaintenanceManager()
{
...
static gboolean __Util_MaintenanceManagerresponseHandler(gpointer data)
{
...
static gpointer __Util_MaintenanceManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__Util_MaintenanceManagerresponseHandler, static_cast<gpointer>(request));
	...
	void(* handler)(Error, void* ) , void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(Util_MaintenanceManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (Util_MaintenanceManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), deleteMaintenanceProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __Util_MaintenanceManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool Util_MaintenanceManager::deleteMaintenanceAsync(char * accessToken,
...
bool Util_MaintenanceManager::deleteMaintenanceSync(char * accessToken,
...
bool Util_MaintenanceManager::getMaintenanceAsync(char * accessToken,
...
bool Util_MaintenanceManager::getMaintenanceSync(char * accessToken,
...
bool Util_MaintenanceManager::setMaintenanceAsync(char * accessToken,
	Maintenance maintenance, 
...
bool Util_MaintenanceManager::setMaintenanceSync(char * accessToken,
	Maintenance maintenance, 
...
bool Util_MaintenanceManager::updateMaintenanceAsync(char * accessToken,
	Maintenance maintenance, 
...
bool Util_MaintenanceManager::updateMaintenanceSync(char * accessToken,
	Maintenance maintenance, 
