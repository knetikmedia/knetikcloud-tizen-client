#ifndef _Store_VendorsManager_H_
#define _Store_VendorsManager_H_
...
/** \addtogroup Store_Vendors Store_Vendors
 * \ingroup Operations
 *  @{
 */
class Store_VendorsManager {
public:
	Store_VendorsManager();
	virtual ~Store_VendorsManager();
