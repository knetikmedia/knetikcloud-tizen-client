...
static bool getChallengesHelper(char * accessToken,
	bool filterTemplate, bool filterActiveCampaign, std::string filterStartDate, std::string filterEndDate, int size, int page, std::string order, 
	void(* handler)(PageResource«ChallengeResource», Error, void* )
	, void* userData, bool isAsync)
{
	...
	, void* userData)
{
	...
	filterTemplate, filterActiveCampaign, filterStartDate, filterEndDate, size, page, order, 
	handler, userData, true);
}
