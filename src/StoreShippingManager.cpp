...
#include "StoreShippingManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
StoreShippingManager::StoreShippingManager()
{
...
static gboolean __StoreShippingManagerresponseHandler(gpointer data)
{
...
static gpointer __StoreShippingManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__StoreShippingManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(StoreShippingManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (StoreShippingManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), createShippingItemProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __StoreShippingManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool StoreShippingManager::createShippingItemAsync(char * accessToken,
	bool cascade, ShippingItem shippingItem, 
	void(* handler)(ShippingItem, Error, void* )
	, void* userData)
{
...
bool StoreShippingManager::createShippingItemSync(char * accessToken,
	bool cascade, ShippingItem shippingItem, 
	void(* handler)(ShippingItem, Error, void* )
	, void* userData)
{
...
bool StoreShippingManager::createShippingTemplateAsync(char * accessToken,
	ItemTemplateResource shippingTemplateResource, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
...
bool StoreShippingManager::createShippingTemplateSync(char * accessToken,
	ItemTemplateResource shippingTemplateResource, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
...
bool StoreShippingManager::deleteShippingItemAsync(char * accessToken,
	int id, 
...
bool StoreShippingManager::deleteShippingItemSync(char * accessToken,
	int id, 
...
bool StoreShippingManager::deleteShippingTemplateAsync(char * accessToken,
	std::string id, std::string cascade, 
...
bool StoreShippingManager::deleteShippingTemplateSync(char * accessToken,
	std::string id, std::string cascade, 
...
bool StoreShippingManager::getShippingItemAsync(char * accessToken,
	int id, 
	void(* handler)(ShippingItem, Error, void* )
	, void* userData)
{
...
bool StoreShippingManager::getShippingItemSync(char * accessToken,
	int id, 
	void(* handler)(ShippingItem, Error, void* )
	, void* userData)
{
...
bool StoreShippingManager::getShippingTemplateAsync(char * accessToken,
	std::string id, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
...
bool StoreShippingManager::getShippingTemplateSync(char * accessToken,
	std::string id, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
...
bool StoreShippingManager::getShippingTemplatesAsync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«ItemTemplateResource», Error, void* )
	, void* userData)
{
...
bool StoreShippingManager::getShippingTemplatesSync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«ItemTemplateResource», Error, void* )
	, void* userData)
{
...
bool StoreShippingManager::updateShippingItemAsync(char * accessToken,
	int id, bool cascade, ShippingItem shippingItem, 
	void(* handler)(ShippingItem, Error, void* )
	, void* userData)
{
...
bool StoreShippingManager::updateShippingItemSync(char * accessToken,
	int id, bool cascade, ShippingItem shippingItem, 
	void(* handler)(ShippingItem, Error, void* )
	, void* userData)
{
...
bool StoreShippingManager::updateShippingTemplateAsync(char * accessToken,
	std::string id, ItemTemplateResource shippingTemplateResource, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
...
bool StoreShippingManager::updateShippingTemplateSync(char * accessToken,
	std::string id, ItemTemplateResource shippingTemplateResource, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
