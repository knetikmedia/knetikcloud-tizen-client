...
void
IntegerOperationResource::__init()
{
	//
...
void
IntegerOperationResource::__cleanup()
{
	//if(args != NULL) {
	//args.RemoveAll(true);
	//delete args;
...
void
IntegerOperationResource::fromJson(char* jsonStr)
{
...
IntegerOperationResource::IntegerOperationResource(char* json)
{
	this->fromJson(json);
}

char*
IntegerOperationResource::toJson()
{
...
IntegerOperationResource::getArgs()
{
	return args;
}

void
IntegerOperationResource::setArgs(std::list <ExpressionResource> args)
{
	this->args = args;
}

std::string
IntegerOperationResource::getDefinition()
{
	return definition;
}

void
IntegerOperationResource::setDefinition(std::string  definition)
{
	this->definition = definition;
}

std::string
IntegerOperationResource::getOp()
{
	return op;
}

void
IntegerOperationResource::setOp(std::string  op)
{
	this->op = op;
}

std::string
IntegerOperationResource::getReturnType()
{
	return return_type;
}

void
IntegerOperationResource::setReturnType(std::string  return_type)
{
	this->return_type = return_type;
}

std::list<OperationDefinitionResource>
IntegerOperationResource::getSupportedOperators()
{
	return supported_operators;
}

void
IntegerOperationResource::setSupportedOperators(std::list <OperationDefinitionResource> supported_operators)
{
	this->supported_operators = supported_operators;
}

std::string
IntegerOperationResource::getType()
{
	return type;
}

void
IntegerOperationResource::setType(std::string  type)
{
	this->type = type;
}
