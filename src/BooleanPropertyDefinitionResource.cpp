...
std::string
BooleanPropertyDefinitionResource::getDescription()
{
	return description;
}

void
BooleanPropertyDefinitionResource::setDescription(std::string  description)
{
...
std::string
BooleanPropertyDefinitionResource::getFriendlyName()
{
	return friendly_name;
}

void
BooleanPropertyDefinitionResource::setFriendlyName(std::string  friendly_name)
{
...
std::string
BooleanPropertyDefinitionResource::getOptionLabelPath()
{
	return option_label_path;
}

void
BooleanPropertyDefinitionResource::setOptionLabelPath(std::string  option_label_path)
{
	this->option_label_path = option_label_path;
}

std::string
BooleanPropertyDefinitionResource::getOptionValuePath()
{
	return option_value_path;
}

void
BooleanPropertyDefinitionResource::setOptionValuePath(std::string  option_value_path)
{
	this->option_value_path = option_value_path;
}

std::string
BooleanPropertyDefinitionResource::getOptionsUrl()
{
	return options_url;
}

void
BooleanPropertyDefinitionResource::setOptionsUrl(std::string  options_url)
{
