...
void
PageResource«UserRelationshipResource»::__init()
{
	//
...
void
PageResource«UserRelationshipResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«UserRelationshipResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<UserRelationshipResource> new_list;
			UserRelationshipResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("UserRelationshipResource")) {
					jsonToValue(&inst, temp_json, "UserRelationshipResource", "");
				} else {
...
PageResource«UserRelationshipResource»::PageResource«UserRelationshipResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«UserRelationshipResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("UserRelationshipResource")) {
		list<UserRelationshipResource> new_list = static_cast<list <UserRelationshipResource> > (getContent());
		node = converttoJson(&new_list, "UserRelationshipResource", "array");
	} else {
		...
		for (list<UserRelationshipResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			UserRelationshipResource obj = *it;
...
std::list<UserRelationshipResource>
PageResource«UserRelationshipResource»::getContent()
{
	return content;
}

void
PageResource«UserRelationshipResource»::setContent(std::list <UserRelationshipResource> content)
{
	this->content = content;
}

bool
PageResource«UserRelationshipResource»::getFirst()
{
	return first;
}

void
PageResource«UserRelationshipResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«UserRelationshipResource»::getLast()
{
	return last;
}

void
PageResource«UserRelationshipResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«UserRelationshipResource»::getNumber()
{
	return number;
}

void
PageResource«UserRelationshipResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«UserRelationshipResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«UserRelationshipResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«UserRelationshipResource»::getSize()
{
	return size;
}

void
PageResource«UserRelationshipResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«UserRelationshipResource»::getSort()
{
	return sort;
}

void
PageResource«UserRelationshipResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«UserRelationshipResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«UserRelationshipResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«UserRelationshipResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«UserRelationshipResource»::setTotalPages(int  total_pages)
{
