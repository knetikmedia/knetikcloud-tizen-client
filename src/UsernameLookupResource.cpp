...
std::string
UsernameLookupResource::getDefinition()
{
	return definition;
}

void
UsernameLookupResource::setDefinition(std::string  definition)
{
...
std::string
UsernameLookupResource::getRequiredKeyType()
{
	return required_key_type;
}

void
UsernameLookupResource::setRequiredKeyType(std::string  required_key_type)
{
