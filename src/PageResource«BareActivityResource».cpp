...
void
PageResource«BareActivityResource»::__init()
{
	//
...
void
PageResource«BareActivityResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«BareActivityResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<BareActivityResource> new_list;
			BareActivityResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("BareActivityResource")) {
					jsonToValue(&inst, temp_json, "BareActivityResource", "");
				} else {
...
PageResource«BareActivityResource»::PageResource«BareActivityResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«BareActivityResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("BareActivityResource")) {
		list<BareActivityResource> new_list = static_cast<list <BareActivityResource> > (getContent());
		node = converttoJson(&new_list, "BareActivityResource", "array");
	} else {
		...
		for (list<BareActivityResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			BareActivityResource obj = *it;
...
std::list<BareActivityResource>
PageResource«BareActivityResource»::getContent()
{
	return content;
}

void
PageResource«BareActivityResource»::setContent(std::list <BareActivityResource> content)
{
	this->content = content;
}

bool
PageResource«BareActivityResource»::getFirst()
{
	return first;
}

void
PageResource«BareActivityResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«BareActivityResource»::getLast()
{
	return last;
}

void
PageResource«BareActivityResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«BareActivityResource»::getNumber()
{
	return number;
}

void
PageResource«BareActivityResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«BareActivityResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«BareActivityResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«BareActivityResource»::getSize()
{
	return size;
}

void
PageResource«BareActivityResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«BareActivityResource»::getSort()
{
	return sort;
}

void
PageResource«BareActivityResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«BareActivityResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«BareActivityResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«BareActivityResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«BareActivityResource»::setTotalPages(int  total_pages)
{
