...
public:
	...
	/*! \brief Get URL for accessing the resource. Will use a CDN if configured, or direct to S3 if not
	 */
	std::string getCdnUrl();

	/*! \brief Set URL for accessing the resource. Will use a CDN if configured, or direct to S3 if not
	 */
	...
	/*! \brief Get URL that one can PUT the file to, to upload it to S3
	 */
	std::string getUrl();

	/*! \brief Set URL that one can PUT the file to, to upload it to S3
	 */
