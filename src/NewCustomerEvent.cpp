...
void
NewCustomerEvent::fromJson(char* jsonStr)
{
...
NewCustomerEvent::NewCustomerEvent(char* json)
{
	this->fromJson(json);
}

char*
NewCustomerEvent::toJson()
{
...
std::string
NewCustomerEvent::getClient()
{
	return client;
}

void
NewCustomerEvent::setClient(std::string  client)
{
	this->client = client;
}

std::string
NewCustomerEvent::getCustomer()
{
	return customer;
}

void
NewCustomerEvent::setCustomer(std::string  customer)
{
	this->customer = customer;
}

bool
NewCustomerEvent::getDoNotBroadcast()
{
	return do_not_broadcast;
}

void
NewCustomerEvent::setDoNotBroadcast(bool  do_not_broadcast)
{
	this->do_not_broadcast = do_not_broadcast;
}

std::string
NewCustomerEvent::getSection()
{
	return section;
}

void
NewCustomerEvent::setSection(std::string  section)
{
	this->section = section;
}

std::string
NewCustomerEvent::getSource()
{
	return source;
}

void
NewCustomerEvent::setSource(std::string  source)
{
	this->source = source;
}

std::string
NewCustomerEvent::getSpecifics()
{
	return specifics;
}

void
NewCustomerEvent::setSpecifics(std::string  specifics)
{
	this->specifics = specifics;
}

bool
NewCustomerEvent::getSynchronous()
{
	return synchronous;
}

void
NewCustomerEvent::setSynchronous(bool  synchronous)
{
	this->synchronous = synchronous;
}

long long
NewCustomerEvent::getTimestamp()
{
	return timestamp;
}

void
NewCustomerEvent::setTimestamp(long long  timestamp)
{
	this->timestamp = timestamp;
}

std::string
NewCustomerEvent::getType()
{
	return type;
}

void
NewCustomerEvent::setType(std::string  type)
{
	this->type = type;
}

CustomerConfig
NewCustomerEvent::getCustomerConfig()
{
	return customer_config;
}

void
NewCustomerEvent::setCustomerConfig(CustomerConfig  customer_config)
{
