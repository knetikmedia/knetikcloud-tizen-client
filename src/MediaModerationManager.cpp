...
#include "MediaModerationManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
MediaModerationManager::MediaModerationManager()
{
...
static gboolean __MediaModerationManagerresponseHandler(gpointer data)
{
...
static gpointer __MediaModerationManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__MediaModerationManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(MediaModerationManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (MediaModerationManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), addFlagProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __MediaModerationManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool MediaModerationManager::addFlagAsync(char * accessToken,
	FlagResource flagResource, 
	void(* handler)(FlagResource, Error, void* )
	, void* userData)
{
...
bool MediaModerationManager::addFlagSync(char * accessToken,
	FlagResource flagResource, 
	void(* handler)(FlagResource, Error, void* )
	, void* userData)
{
...
bool MediaModerationManager::deleteFlagAsync(char * accessToken,
	std::string contextName, std::string contextId, int userId, 
...
bool MediaModerationManager::deleteFlagSync(char * accessToken,
	std::string contextName, std::string contextId, int userId, 
...
bool MediaModerationManager::getFlagsAsync(char * accessToken,
	std::string filterContext, std::string filterContextId, int filterUserId, int size, int page, 
	void(* handler)(PageResource«FlagResource», Error, void* )
	, void* userData)
{
...
bool MediaModerationManager::getFlagsSync(char * accessToken,
	std::string filterContext, std::string filterContextId, int filterUserId, int size, int page, 
	void(* handler)(PageResource«FlagResource», Error, void* )
	, void* userData)
{
...
bool MediaModerationManager::getModerationReportAsync(char * accessToken,
	long long id, 
	void(* handler)(FlagReportResource, Error, void* )
	, void* userData)
{
...
bool MediaModerationManager::getModerationReportSync(char * accessToken,
	long long id, 
	void(* handler)(FlagReportResource, Error, void* )
	, void* userData)
{
...
bool MediaModerationManager::getModerationReportsAsync(char * accessToken,
	bool excludeResolved, std::string filterContext, std::string filterContextId, int size, int page, 
	void(* handler)(PageResource«FlagReportResource», Error, void* )
	, void* userData)
{
	return getModerationReportsHelper(accessToken,
	excludeResolved, filterContext, filterContextId, size, page, 
	handler, userData, true);
}

bool MediaModerationManager::getModerationReportsSync(char * accessToken,
	bool excludeResolved, std::string filterContext, std::string filterContextId, int size, int page, 
	void(* handler)(PageResource«FlagReportResource», Error, void* )
	, void* userData)
{
...
bool MediaModerationManager::updateModerationReportAsync(char * accessToken,
	long long id, FlagReportResource flagReportResource, 
...
bool MediaModerationManager::updateModerationReportSync(char * accessToken,
	long long id, FlagReportResource flagReportResource, 
