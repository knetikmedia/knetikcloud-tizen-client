...
void
PageResource«SavedAddressResource»::__init()
{
	//
...
void
PageResource«SavedAddressResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«SavedAddressResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<SavedAddressResource> new_list;
			SavedAddressResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("SavedAddressResource")) {
					jsonToValue(&inst, temp_json, "SavedAddressResource", "");
				} else {
...
PageResource«SavedAddressResource»::PageResource«SavedAddressResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«SavedAddressResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("SavedAddressResource")) {
		list<SavedAddressResource> new_list = static_cast<list <SavedAddressResource> > (getContent());
		node = converttoJson(&new_list, "SavedAddressResource", "array");
	} else {
		...
		for (list<SavedAddressResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			SavedAddressResource obj = *it;
...
std::list<SavedAddressResource>
PageResource«SavedAddressResource»::getContent()
{
	return content;
}

void
PageResource«SavedAddressResource»::setContent(std::list <SavedAddressResource> content)
{
	this->content = content;
}

bool
PageResource«SavedAddressResource»::getFirst()
{
	return first;
}

void
PageResource«SavedAddressResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«SavedAddressResource»::getLast()
{
	return last;
}

void
PageResource«SavedAddressResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«SavedAddressResource»::getNumber()
{
	return number;
}

void
PageResource«SavedAddressResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«SavedAddressResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«SavedAddressResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«SavedAddressResource»::getSize()
{
	return size;
}

void
PageResource«SavedAddressResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«SavedAddressResource»::getSort()
{
	return sort;
}

void
PageResource«SavedAddressResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«SavedAddressResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«SavedAddressResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«SavedAddressResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«SavedAddressResource»::setTotalPages(int  total_pages)
{
