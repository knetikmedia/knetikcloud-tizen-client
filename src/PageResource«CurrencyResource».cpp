...
void
PageResource«CurrencyResource»::__init()
{
	//
...
void
PageResource«CurrencyResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«CurrencyResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<CurrencyResource> new_list;
			CurrencyResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("CurrencyResource")) {
					jsonToValue(&inst, temp_json, "CurrencyResource", "");
				} else {
...
PageResource«CurrencyResource»::PageResource«CurrencyResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«CurrencyResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("CurrencyResource")) {
		list<CurrencyResource> new_list = static_cast<list <CurrencyResource> > (getContent());
		node = converttoJson(&new_list, "CurrencyResource", "array");
	} else {
		...
		for (list<CurrencyResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			CurrencyResource obj = *it;
...
std::list<CurrencyResource>
PageResource«CurrencyResource»::getContent()
{
	return content;
}

void
PageResource«CurrencyResource»::setContent(std::list <CurrencyResource> content)
{
	this->content = content;
}

bool
PageResource«CurrencyResource»::getFirst()
{
	return first;
}

void
PageResource«CurrencyResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«CurrencyResource»::getLast()
{
	return last;
}

void
PageResource«CurrencyResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«CurrencyResource»::getNumber()
{
	return number;
}

void
PageResource«CurrencyResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«CurrencyResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«CurrencyResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«CurrencyResource»::getSize()
{
	return size;
}

void
PageResource«CurrencyResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«CurrencyResource»::getSort()
{
	return sort;
}

void
PageResource«CurrencyResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«CurrencyResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«CurrencyResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«CurrencyResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«CurrencyResource»::setTotalPages(int  total_pages)
{
