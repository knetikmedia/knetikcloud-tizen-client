#ifndef _Store_ShippingManager_H_
#define _Store_ShippingManager_H_
...
/** \addtogroup Store_Shipping Store_Shipping
 * \ingroup Operations
 *  @{
 */
class Store_ShippingManager {
public:
	Store_ShippingManager();
	virtual ~Store_ShippingManager();
...
#endif /* Store_ShippingManager_H_ */
