...
#include "GamificationLevelingManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
GamificationLevelingManager::GamificationLevelingManager()
{
...
static gboolean __GamificationLevelingManagerresponseHandler(gpointer data)
{
...
static gpointer __GamificationLevelingManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__GamificationLevelingManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(GamificationLevelingManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (GamificationLevelingManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), createLevelProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __GamificationLevelingManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool GamificationLevelingManager::createLevelAsync(char * accessToken,
	LevelingResource level, 
	void(* handler)(LevelingResource, Error, void* )
	, void* userData)
{
...
bool GamificationLevelingManager::createLevelSync(char * accessToken,
	LevelingResource level, 
	void(* handler)(LevelingResource, Error, void* )
	, void* userData)
{
...
bool GamificationLevelingManager::deleteLevelAsync(char * accessToken,
	std::string name, 
...
bool GamificationLevelingManager::deleteLevelSync(char * accessToken,
	std::string name, 
...
bool GamificationLevelingManager::getLevelAsync(char * accessToken,
	std::string name, 
	void(* handler)(LevelingResource, Error, void* )
	, void* userData)
{
...
bool GamificationLevelingManager::getLevelSync(char * accessToken,
	std::string name, 
	void(* handler)(LevelingResource, Error, void* )
	, void* userData)
{
...
bool GamificationLevelingManager::getLevelTriggersAsync(char * accessToken,
...
bool GamificationLevelingManager::getLevelTriggersSync(char * accessToken,
...
bool GamificationLevelingManager::getLevelsAsync(char * accessToken,
	std::string filterName, int size, int page, std::string order, 
	void(* handler)(PageResource«LevelingResource», Error, void* )
	, void* userData)
{
...
bool GamificationLevelingManager::getLevelsSync(char * accessToken,
	std::string filterName, int size, int page, std::string order, 
	void(* handler)(PageResource«LevelingResource», Error, void* )
	, void* userData)
{
...
bool GamificationLevelingManager::getUserLevelAsync(char * accessToken,
	int userId, std::string name, 
	void(* handler)(UserLevelingResource, Error, void* )
	, void* userData)
{
...
bool GamificationLevelingManager::getUserLevelSync(char * accessToken,
	int userId, std::string name, 
	void(* handler)(UserLevelingResource, Error, void* )
	, void* userData)
{
...
bool GamificationLevelingManager::getUserLevelsAsync(char * accessToken,
	int userId, std::string filterName, int size, int page, std::string order, 
	void(* handler)(PageResource«UserLevelingResource», Error, void* )
	, void* userData)
{
...
bool GamificationLevelingManager::getUserLevelsSync(char * accessToken,
	int userId, std::string filterName, int size, int page, std::string order, 
	void(* handler)(PageResource«UserLevelingResource», Error, void* )
	, void* userData)
{
...
bool GamificationLevelingManager::incrementProgressAsync(char * accessToken,
	int userId, std::string name, IntWrapper progress, 
...
bool GamificationLevelingManager::incrementProgressSync(char * accessToken,
	int userId, std::string name, IntWrapper progress, 
...
bool GamificationLevelingManager::setProgressAsync(char * accessToken,
	int userId, std::string name, IntWrapper progress, 
...
bool GamificationLevelingManager::setProgressSync(char * accessToken,
	int userId, std::string name, IntWrapper progress, 
...
bool GamificationLevelingManager::updateLevelAsync(char * accessToken,
	std::string name, LevelingResource newLevel, 
	void(* handler)(LevelingResource, Error, void* )
	, void* userData)
{
...
bool GamificationLevelingManager::updateLevelSync(char * accessToken,
	std::string name, LevelingResource newLevel, 
	void(* handler)(LevelingResource, Error, void* )
	, void* userData)
{
