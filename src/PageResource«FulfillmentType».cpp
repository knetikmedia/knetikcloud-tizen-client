...
void
PageResource«FulfillmentType»::__init()
{
	//
...
void
PageResource«FulfillmentType»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«FulfillmentType»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<FulfillmentType> new_list;
			FulfillmentType inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("FulfillmentType")) {
					jsonToValue(&inst, temp_json, "FulfillmentType", "");
				} else {
...
PageResource«FulfillmentType»::PageResource«FulfillmentType»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«FulfillmentType»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("FulfillmentType")) {
		list<FulfillmentType> new_list = static_cast<list <FulfillmentType> > (getContent());
		node = converttoJson(&new_list, "FulfillmentType", "array");
	} else {
		...
		for (list<FulfillmentType>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			FulfillmentType obj = *it;
...
std::list<FulfillmentType>
PageResource«FulfillmentType»::getContent()
{
	return content;
}

void
PageResource«FulfillmentType»::setContent(std::list <FulfillmentType> content)
{
	this->content = content;
}

bool
PageResource«FulfillmentType»::getFirst()
{
	return first;
}

void
PageResource«FulfillmentType»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«FulfillmentType»::getLast()
{
	return last;
}

void
PageResource«FulfillmentType»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«FulfillmentType»::getNumber()
{
	return number;
}

void
PageResource«FulfillmentType»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«FulfillmentType»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«FulfillmentType»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«FulfillmentType»::getSize()
{
	return size;
}

void
PageResource«FulfillmentType»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«FulfillmentType»::getSort()
{
	return sort;
}

void
PageResource«FulfillmentType»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«FulfillmentType»::getTotalElements()
{
	return total_elements;
}

void
PageResource«FulfillmentType»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«FulfillmentType»::getTotalPages()
{
	return total_pages;
}

void
PageResource«FulfillmentType»::setTotalPages(int  total_pages)
{
