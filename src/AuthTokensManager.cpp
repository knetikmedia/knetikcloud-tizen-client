...
static gboolean __AuthTokensManagerresponseHandler(gpointer data)
{
...
static gpointer __AuthTokensManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__AuthTokensManagerresponseHandler, static_cast<gpointer>(request));
	...
	void(* handler)(Error, void* ) , void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(AuthTokensManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (AuthTokensManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), deleteTokensProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __AuthTokensManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool AuthTokensManager::deleteTokensAsync(char * accessToken,
	std::string username, std::string clientId, 
...
bool AuthTokensManager::deleteTokensSync(char * accessToken,
	std::string username, std::string clientId, 
...
bool AuthTokensManager::getTokenAsync(char * accessToken,
	std::string username, std::string clientId, 
	void(* handler)(OauthAccessTokenResource, Error, void* )
	, void* userData)
{
...
bool AuthTokensManager::getTokenSync(char * accessToken,
	std::string username, std::string clientId, 
	void(* handler)(OauthAccessTokenResource, Error, void* )
	, void* userData)
{
...
bool AuthTokensManager::getTokensAsync(char * accessToken,
	std::string filterClientId, std::string filterUsername, int size, int page, std::string order, 
	void(* handler)(PageResource«OauthAccessTokenResource», Error, void* )
	, void* userData)
{
...
bool AuthTokensManager::getTokensSync(char * accessToken,
	std::string filterClientId, std::string filterUsername, int size, int page, std::string order, 
	void(* handler)(PageResource«OauthAccessTokenResource», Error, void* )
	, void* userData)
{
