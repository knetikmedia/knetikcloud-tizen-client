...
void
PageResource«CartSummary»::__init()
{
	//
...
void
PageResource«CartSummary»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«CartSummary»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<CartSummary> new_list;
			CartSummary inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("CartSummary")) {
					jsonToValue(&inst, temp_json, "CartSummary", "");
				} else {
...
PageResource«CartSummary»::PageResource«CartSummary»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«CartSummary»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("CartSummary")) {
		list<CartSummary> new_list = static_cast<list <CartSummary> > (getContent());
		node = converttoJson(&new_list, "CartSummary", "array");
	} else {
		...
		for (list<CartSummary>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			CartSummary obj = *it;
...
std::list<CartSummary>
PageResource«CartSummary»::getContent()
{
	return content;
}

void
PageResource«CartSummary»::setContent(std::list <CartSummary> content)
{
	this->content = content;
}

bool
PageResource«CartSummary»::getFirst()
{
	return first;
}

void
PageResource«CartSummary»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«CartSummary»::getLast()
{
	return last;
}

void
PageResource«CartSummary»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«CartSummary»::getNumber()
{
	return number;
}

void
PageResource«CartSummary»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«CartSummary»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«CartSummary»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«CartSummary»::getSize()
{
	return size;
}

void
PageResource«CartSummary»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«CartSummary»::getSort()
{
	return sort;
}

void
PageResource«CartSummary»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«CartSummary»::getTotalElements()
{
	return total_elements;
}

void
PageResource«CartSummary»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«CartSummary»::getTotalPages()
{
	return total_pages;
}

void
PageResource«CartSummary»::setTotalPages(int  total_pages)
{
