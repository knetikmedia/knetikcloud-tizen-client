...
#include "BRERuleEngineExpressionsManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
BRERuleEngineExpressionsManager::BRERuleEngineExpressionsManager()
{
...
static gboolean __BRERuleEngineExpressionsManagerresponseHandler(gpointer data)
{
...
static gpointer __BRERuleEngineExpressionsManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__BRERuleEngineExpressionsManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(BRERuleEngineExpressionsManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (BRERuleEngineExpressionsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), getBREExpressionProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __BRERuleEngineExpressionsManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool BRERuleEngineExpressionsManager::getBREExpressionAsync(char * accessToken,
	std::string type, 
	void(* handler)(ExpressionResource, Error, void* )
	, void* userData)
{
...
bool BRERuleEngineExpressionsManager::getBREExpressionSync(char * accessToken,
	std::string type, 
	void(* handler)(ExpressionResource, Error, void* )
	, void* userData)
{
...
bool BRERuleEngineExpressionsManager::getBREExpressionsAsync(char * accessToken,
	std::string filterTypeGroup, 
	void(* handler)(std::list<ExpressionResource>, Error, void* )
	, void* userData)
{
...
bool BRERuleEngineExpressionsManager::getBREExpressionsSync(char * accessToken,
	std::string filterTypeGroup, 
	void(* handler)(std::list<ExpressionResource>, Error, void* )
	, void* userData)
{
...
bool BRERuleEngineExpressionsManager::getExpressionAsTextAsync(char * accessToken,
	ExpressionResource expression, 
	void(* handler)(StringWrapper, Error, void* )
	, void* userData)
{
...
bool BRERuleEngineExpressionsManager::getExpressionAsTextSync(char * accessToken,
	ExpressionResource expression, 
	void(* handler)(StringWrapper, Error, void* )
	, void* userData)
{
