#ifndef _Auth_TokensManager_H_
#define _Auth_TokensManager_H_
...
/** \addtogroup Auth_Tokens Auth_Tokens
 * \ingroup Operations
 *  @{
 */
class Auth_TokensManager {
public:
	Auth_TokensManager();
	virtual ~Auth_TokensManager();
