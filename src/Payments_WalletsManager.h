#ifndef _Payments_WalletsManager_H_
#define _Payments_WalletsManager_H_
...
/** \addtogroup Payments_Wallets Payments_Wallets
 * \ingroup Operations
 *  @{
 */
class Payments_WalletsManager {
public:
	Payments_WalletsManager();
	virtual ~Payments_WalletsManager();
...
#endif /* Payments_WalletsManager_H_ */
