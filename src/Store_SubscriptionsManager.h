#ifndef _Store_SubscriptionsManager_H_
#define _Store_SubscriptionsManager_H_
...
/** \addtogroup Store_Subscriptions Store_Subscriptions
 * \ingroup Operations
 *  @{
 */
class Store_SubscriptionsManager {
public:
	Store_SubscriptionsManager();
	virtual ~Store_SubscriptionsManager();
...
#endif /* Store_SubscriptionsManager_H_ */
