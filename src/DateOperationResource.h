...
#ifndef _DateOperationResource_H_
#define _DateOperationResource_H_
...
class DateOperationResource : public Object {
public:
	/*! \brief Constructor.
	 */
	DateOperationResource();
	DateOperationResource(char* str);
...
#endif /* _DateOperationResource_H_ */
