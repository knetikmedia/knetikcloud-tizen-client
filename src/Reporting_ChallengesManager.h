#ifndef _Reporting_ChallengesManager_H_
#define _Reporting_ChallengesManager_H_
...
/** \addtogroup Reporting_Challenges Reporting_Challenges
 * \ingroup Operations
 *  @{
 */
class Reporting_ChallengesManager {
public:
	Reporting_ChallengesManager();
	virtual ~Reporting_ChallengesManager();
...
#endif /* Reporting_ChallengesManager_H_ */
