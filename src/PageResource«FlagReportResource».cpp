...
void
PageResource«FlagReportResource»::__init()
{
	//
...
void
PageResource«FlagReportResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«FlagReportResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<FlagReportResource> new_list;
			FlagReportResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("FlagReportResource")) {
					jsonToValue(&inst, temp_json, "FlagReportResource", "");
				} else {
...
PageResource«FlagReportResource»::PageResource«FlagReportResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«FlagReportResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("FlagReportResource")) {
		list<FlagReportResource> new_list = static_cast<list <FlagReportResource> > (getContent());
		node = converttoJson(&new_list, "FlagReportResource", "array");
	} else {
		...
		for (list<FlagReportResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			FlagReportResource obj = *it;
...
std::list<FlagReportResource>
PageResource«FlagReportResource»::getContent()
{
	return content;
}

void
PageResource«FlagReportResource»::setContent(std::list <FlagReportResource> content)
{
	this->content = content;
}

bool
PageResource«FlagReportResource»::getFirst()
{
	return first;
}

void
PageResource«FlagReportResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«FlagReportResource»::getLast()
{
	return last;
}

void
PageResource«FlagReportResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«FlagReportResource»::getNumber()
{
	return number;
}

void
PageResource«FlagReportResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«FlagReportResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«FlagReportResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«FlagReportResource»::getSize()
{
	return size;
}

void
PageResource«FlagReportResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«FlagReportResource»::getSort()
{
	return sort;
}

void
PageResource«FlagReportResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«FlagReportResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«FlagReportResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«FlagReportResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«FlagReportResource»::setTotalPages(int  total_pages)
{
