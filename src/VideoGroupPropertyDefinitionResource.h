...
#ifndef _VideoGroupPropertyDefinitionResource_H_
#define _VideoGroupPropertyDefinitionResource_H_
...
class VideoGroupPropertyDefinitionResource : public Object {
public:
	/*! \brief Constructor.
	 */
	VideoGroupPropertyDefinitionResource();
	VideoGroupPropertyDefinitionResource(char* str);
	...
	/*! \brief Get If provided, the maximum height of each video
	 */
	int getMaxHeight();

	/*! \brief Set If provided, the maximum height of each video
	 */
	void setMaxHeight(int  max_height);
	/*! \brief Get If provided, the maximum length of each video
	 */
	int getMaxLength();

	/*! \brief Set If provided, the maximum length of each video
	 */
	void setMaxLength(int  max_length);
	/*! \brief Get If provided, the maximum width of each video
	 */
	int getMaxWidth();

	/*! \brief Set If provided, the maximum width of each video
	 */
	void setMaxWidth(int  max_width);
	/*! \brief Get If provided, the minimum height of each video
	 */
	int getMinHeight();

	/*! \brief Set If provided, the minimum height of each video
	 */
	void setMinHeight(int  min_height);
	/*! \brief Get If provided, the minimum length of each video
	 */
	int getMinLength();

	/*! \brief Set If provided, the minimum length of each video
	 */
	void setMinLength(int  min_length);
	/*! \brief Get If provided, the minimum width of each video
	 */
	int getMinWidth();

	/*! \brief Set If provided, the minimum width of each video
	 */
...
#endif /* _VideoGroupPropertyDefinitionResource_H_ */
