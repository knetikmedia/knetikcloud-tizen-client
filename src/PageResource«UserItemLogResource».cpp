...
void
PageResource«UserItemLogResource»::__init()
{
	//
...
void
PageResource«UserItemLogResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«UserItemLogResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<UserItemLogResource> new_list;
			UserItemLogResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("UserItemLogResource")) {
					jsonToValue(&inst, temp_json, "UserItemLogResource", "");
				} else {
...
PageResource«UserItemLogResource»::PageResource«UserItemLogResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«UserItemLogResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("UserItemLogResource")) {
		list<UserItemLogResource> new_list = static_cast<list <UserItemLogResource> > (getContent());
		node = converttoJson(&new_list, "UserItemLogResource", "array");
	} else {
		...
		for (list<UserItemLogResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			UserItemLogResource obj = *it;
...
std::list<UserItemLogResource>
PageResource«UserItemLogResource»::getContent()
{
	return content;
}

void
PageResource«UserItemLogResource»::setContent(std::list <UserItemLogResource> content)
{
	this->content = content;
}

bool
PageResource«UserItemLogResource»::getFirst()
{
	return first;
}

void
PageResource«UserItemLogResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«UserItemLogResource»::getLast()
{
	return last;
}

void
PageResource«UserItemLogResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«UserItemLogResource»::getNumber()
{
	return number;
}

void
PageResource«UserItemLogResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«UserItemLogResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«UserItemLogResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«UserItemLogResource»::getSize()
{
	return size;
}

void
PageResource«UserItemLogResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«UserItemLogResource»::getSort()
{
	return sort;
}

void
PageResource«UserItemLogResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«UserItemLogResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«UserItemLogResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«UserItemLogResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«UserItemLogResource»::setTotalPages(int  total_pages)
{
