...
UtilSecurityManager::UtilSecurityManager()
{
...
static gboolean __UtilSecurityManagerresponseHandler(gpointer data)
{
...
static gpointer __UtilSecurityManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__UtilSecurityManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(UtilSecurityManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (UtilSecurityManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), getUserLocationLogProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __UtilSecurityManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool UtilSecurityManager::getUserLocationLogAsync(char * accessToken,
	int userId, int size, int page, std::string order, 
	void(* handler)(PageResource«LocationLogResource», Error, void* )
	, void* userData)
{
...
bool UtilSecurityManager::getUserLocationLogSync(char * accessToken,
	int userId, int size, int page, std::string order, 
	void(* handler)(PageResource«LocationLogResource», Error, void* )
	, void* userData)
{
...
bool UtilSecurityManager::getUserTokenDetailsAsync(char * accessToken,
...
bool UtilSecurityManager::getUserTokenDetailsSync(char * accessToken,
