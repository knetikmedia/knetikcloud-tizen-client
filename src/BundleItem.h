...
#ifndef _BundleItem_H_
#define _BundleItem_H_
...
class BundleItem : public Object {
public:
	/*! \brief Constructor.
	 */
	BundleItem();
	...
	/*! \brief Get The skus of items to be included in this bundle, and how they influence the bundle total price.  Must have at least one SKU
	 */
	std::list<BundledSku> getBundledSkus();

	/*! \brief Set The skus of items to be included in this bundle, and how they influence the bundle total price.  Must have at least one SKU
	 */
	void setBundledSkus(std::list <BundledSku> bundled_skus);
...
private:
	...
	int vendor_id;
	std::list <BundledSku>bundled_skus;
	void __init();
	void __cleanup();
