...
public:
	...
	/*! \brief Get The name of an event that will add one progress to this level when fired
	 */
	std::string getTriggerEventName();

	/*! \brief Set The name of an event that will add one progress to this level when fired
	 */
