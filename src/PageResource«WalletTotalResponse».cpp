...
void
PageResource«WalletTotalResponse»::__init()
{
	//
...
void
PageResource«WalletTotalResponse»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«WalletTotalResponse»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<WalletTotalResponse> new_list;
			WalletTotalResponse inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("WalletTotalResponse")) {
					jsonToValue(&inst, temp_json, "WalletTotalResponse", "");
				} else {
...
PageResource«WalletTotalResponse»::PageResource«WalletTotalResponse»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«WalletTotalResponse»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("WalletTotalResponse")) {
		list<WalletTotalResponse> new_list = static_cast<list <WalletTotalResponse> > (getContent());
		node = converttoJson(&new_list, "WalletTotalResponse", "array");
	} else {
		...
		for (list<WalletTotalResponse>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			WalletTotalResponse obj = *it;
...
std::list<WalletTotalResponse>
PageResource«WalletTotalResponse»::getContent()
{
	return content;
}

void
PageResource«WalletTotalResponse»::setContent(std::list <WalletTotalResponse> content)
{
	this->content = content;
}

bool
PageResource«WalletTotalResponse»::getFirst()
{
	return first;
}

void
PageResource«WalletTotalResponse»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«WalletTotalResponse»::getLast()
{
	return last;
}

void
PageResource«WalletTotalResponse»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«WalletTotalResponse»::getNumber()
{
	return number;
}

void
PageResource«WalletTotalResponse»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«WalletTotalResponse»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«WalletTotalResponse»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«WalletTotalResponse»::getSize()
{
	return size;
}

void
PageResource«WalletTotalResponse»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«WalletTotalResponse»::getSort()
{
	return sort;
}

void
PageResource«WalletTotalResponse»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«WalletTotalResponse»::getTotalElements()
{
	return total_elements;
}

void
PageResource«WalletTotalResponse»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«WalletTotalResponse»::getTotalPages()
{
	return total_pages;
}

void
PageResource«WalletTotalResponse»::setTotalPages(int  total_pages)
{
