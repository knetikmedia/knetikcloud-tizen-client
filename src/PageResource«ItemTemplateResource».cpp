...
void
PageResource«ItemTemplateResource»::__init()
{
	//
...
void
PageResource«ItemTemplateResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«ItemTemplateResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<ItemTemplateResource> new_list;
			ItemTemplateResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("ItemTemplateResource")) {
					jsonToValue(&inst, temp_json, "ItemTemplateResource", "");
				} else {
...
PageResource«ItemTemplateResource»::PageResource«ItemTemplateResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«ItemTemplateResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("ItemTemplateResource")) {
		list<ItemTemplateResource> new_list = static_cast<list <ItemTemplateResource> > (getContent());
		node = converttoJson(&new_list, "ItemTemplateResource", "array");
	} else {
		...
		for (list<ItemTemplateResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			ItemTemplateResource obj = *it;
...
std::list<ItemTemplateResource>
PageResource«ItemTemplateResource»::getContent()
{
	return content;
}

void
PageResource«ItemTemplateResource»::setContent(std::list <ItemTemplateResource> content)
{
	this->content = content;
}

bool
PageResource«ItemTemplateResource»::getFirst()
{
	return first;
}

void
PageResource«ItemTemplateResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«ItemTemplateResource»::getLast()
{
	return last;
}

void
PageResource«ItemTemplateResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«ItemTemplateResource»::getNumber()
{
	return number;
}

void
PageResource«ItemTemplateResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«ItemTemplateResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«ItemTemplateResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«ItemTemplateResource»::getSize()
{
	return size;
}

void
PageResource«ItemTemplateResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«ItemTemplateResource»::getSort()
{
	return sort;
}

void
PageResource«ItemTemplateResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«ItemTemplateResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«ItemTemplateResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«ItemTemplateResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«ItemTemplateResource»::setTotalPages(int  total_pages)
{
