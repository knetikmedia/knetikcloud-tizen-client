...
void
PageResource«LevelingResource»::__init()
{
	//
...
void
PageResource«LevelingResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«LevelingResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<LevelingResource> new_list;
			LevelingResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("LevelingResource")) {
					jsonToValue(&inst, temp_json, "LevelingResource", "");
				} else {
...
PageResource«LevelingResource»::PageResource«LevelingResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«LevelingResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("LevelingResource")) {
		list<LevelingResource> new_list = static_cast<list <LevelingResource> > (getContent());
		node = converttoJson(&new_list, "LevelingResource", "array");
	} else {
		...
		for (list<LevelingResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			LevelingResource obj = *it;
...
std::list<LevelingResource>
PageResource«LevelingResource»::getContent()
{
	return content;
}

void
PageResource«LevelingResource»::setContent(std::list <LevelingResource> content)
{
	this->content = content;
}

bool
PageResource«LevelingResource»::getFirst()
{
	return first;
}

void
PageResource«LevelingResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«LevelingResource»::getLast()
{
	return last;
}

void
PageResource«LevelingResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«LevelingResource»::getNumber()
{
	return number;
}

void
PageResource«LevelingResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«LevelingResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«LevelingResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«LevelingResource»::getSize()
{
	return size;
}

void
PageResource«LevelingResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«LevelingResource»::getSort()
{
	return sort;
}

void
PageResource«LevelingResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«LevelingResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«LevelingResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«LevelingResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«LevelingResource»::setTotalPages(int  total_pages)
{
