...
void
PredicateResource::fromJson(char* jsonStr)
{
...
PredicateResource::PredicateResource(char* json)
{
	this->fromJson(json);
}

char*
PredicateResource::toJson()
{
...
PredicateResource::getArgs()
{
	return args;
}

void
PredicateResource::setArgs(std::list <ExpressionResource> args)
{
	this->args = args;
}

std::string
PredicateResource::getDefinition()
{
	return definition;
}

void
PredicateResource::setDefinition(std::string  definition)
{
	this->definition = definition;
}

std::string
PredicateResource::getOp()
{
	return op;
}

void
PredicateResource::setOp(std::string  op)
{
	this->op = op;
}

std::string
PredicateResource::getReturnType()
{
	return return_type;
}

void
PredicateResource::setReturnType(std::string  return_type)
{
	this->return_type = return_type;
}

std::list<OperationDefinitionResource>
PredicateResource::getSupportedOperators()
{
	return supported_operators;
}

void
PredicateResource::setSupportedOperators(std::list <OperationDefinitionResource> supported_operators)
{
	this->supported_operators = supported_operators;
}

std::string
PredicateResource::getType()
{
	return type;
}

void
PredicateResource::setType(std::string  type)
{
	this->type = type;
}
