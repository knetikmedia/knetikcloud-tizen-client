...
#include "StoreSubscriptionsManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
StoreSubscriptionsManager::StoreSubscriptionsManager()
{
...
static gboolean __StoreSubscriptionsManagerresponseHandler(gpointer data)
{
...
static gpointer __StoreSubscriptionsManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__StoreSubscriptionsManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(StoreSubscriptionsManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (StoreSubscriptionsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), createSubscriptionProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __StoreSubscriptionsManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool StoreSubscriptionsManager::createSubscriptionAsync(char * accessToken,
	SubscriptionResource subscriptionResource, 
	void(* handler)(SubscriptionResource, Error, void* )
	, void* userData)
{
...
bool StoreSubscriptionsManager::createSubscriptionSync(char * accessToken,
	SubscriptionResource subscriptionResource, 
	void(* handler)(SubscriptionResource, Error, void* )
	, void* userData)
{
...
bool StoreSubscriptionsManager::createSubscriptionTemplateAsync(char * accessToken,
	SubscriptionTemplateResource subscriptionTemplateResource, 
	void(* handler)(SubscriptionTemplateResource, Error, void* )
	, void* userData)
{
...
bool StoreSubscriptionsManager::createSubscriptionTemplateSync(char * accessToken,
	SubscriptionTemplateResource subscriptionTemplateResource, 
	void(* handler)(SubscriptionTemplateResource, Error, void* )
	, void* userData)
{
...
bool StoreSubscriptionsManager::deleteSubscriptionAsync(char * accessToken,
	int id, std::string planId, 
...
bool StoreSubscriptionsManager::deleteSubscriptionSync(char * accessToken,
	int id, std::string planId, 
...
bool StoreSubscriptionsManager::deleteSubscriptionTemplateAsync(char * accessToken,
	std::string id, std::string cascade, 
...
bool StoreSubscriptionsManager::deleteSubscriptionTemplateSync(char * accessToken,
	std::string id, std::string cascade, 
...
bool StoreSubscriptionsManager::getSubscriptionAsync(char * accessToken,
	int id, 
	void(* handler)(SubscriptionResource, Error, void* )
	, void* userData)
{
...
bool StoreSubscriptionsManager::getSubscriptionSync(char * accessToken,
	int id, 
	void(* handler)(SubscriptionResource, Error, void* )
	, void* userData)
{
...
bool StoreSubscriptionsManager::getSubscriptionTemplateAsync(char * accessToken,
	std::string id, 
	void(* handler)(SubscriptionTemplateResource, Error, void* )
	, void* userData)
{
...
bool StoreSubscriptionsManager::getSubscriptionTemplateSync(char * accessToken,
	std::string id, 
	void(* handler)(SubscriptionTemplateResource, Error, void* )
	, void* userData)
{
...
bool StoreSubscriptionsManager::getSubscriptionTemplatesAsync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«SubscriptionTemplateResource», Error, void* )
	, void* userData)
{
...
bool StoreSubscriptionsManager::getSubscriptionTemplatesSync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«SubscriptionTemplateResource», Error, void* )
	, void* userData)
{
...
bool StoreSubscriptionsManager::getSubscriptionsAsync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«SubscriptionResource», Error, void* )
	, void* userData)
{
...
bool StoreSubscriptionsManager::getSubscriptionsSync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«SubscriptionResource», Error, void* )
	, void* userData)
{
...
bool StoreSubscriptionsManager::processSubscriptionsAsync(char * accessToken,
...
bool StoreSubscriptionsManager::processSubscriptionsSync(char * accessToken,
...
bool StoreSubscriptionsManager::updateSubscriptionAsync(char * accessToken,
	int id, SubscriptionResource subscriptionResource, 
...
bool StoreSubscriptionsManager::updateSubscriptionSync(char * accessToken,
	int id, SubscriptionResource subscriptionResource, 
...
bool StoreSubscriptionsManager::updateSubscriptionTemplateAsync(char * accessToken,
	std::string id, SubscriptionTemplateResource subscriptionTemplateResource, 
	void(* handler)(SubscriptionTemplateResource, Error, void* )
	, void* userData)
{
...
bool StoreSubscriptionsManager::updateSubscriptionTemplateSync(char * accessToken,
	std::string id, SubscriptionTemplateResource subscriptionTemplateResource, 
	void(* handler)(SubscriptionTemplateResource, Error, void* )
	, void* userData)
{
