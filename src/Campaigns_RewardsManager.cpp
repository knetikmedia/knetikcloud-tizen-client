...
#include "Campaigns_RewardsManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
Campaigns_RewardsManager::Campaigns_RewardsManager()
{
...
static gboolean __Campaigns_RewardsManagerresponseHandler(gpointer data)
{
...
static gpointer __Campaigns_RewardsManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__Campaigns_RewardsManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(Campaigns_RewardsManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (Campaigns_RewardsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), createRewardSetProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __Campaigns_RewardsManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool Campaigns_RewardsManager::createRewardSetAsync(char * accessToken,
	RewardSetResource rewardSetResource, 
	void(* handler)(RewardSetResource, Error, void* )
	, void* userData)
{
...
bool Campaigns_RewardsManager::createRewardSetSync(char * accessToken,
	RewardSetResource rewardSetResource, 
	void(* handler)(RewardSetResource, Error, void* )
	, void* userData)
{
...
bool Campaigns_RewardsManager::deleteRewardSetAsync(char * accessToken,
	int id, 
...
bool Campaigns_RewardsManager::deleteRewardSetSync(char * accessToken,
	int id, 
...
bool Campaigns_RewardsManager::getRewardSetAsync(char * accessToken,
	int id, 
	void(* handler)(RewardSetResource, Error, void* )
	, void* userData)
{
...
bool Campaigns_RewardsManager::getRewardSetSync(char * accessToken,
	int id, 
	void(* handler)(RewardSetResource, Error, void* )
	, void* userData)
{
...
bool Campaigns_RewardsManager::getRewardSetsAsync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«RewardSetResource», Error, void* )
	, void* userData)
{
...
bool Campaigns_RewardsManager::getRewardSetsSync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«RewardSetResource», Error, void* )
	, void* userData)
{
...
bool Campaigns_RewardsManager::updateRewardSetAsync(char * accessToken,
	int id, RewardSetResource rewardSetResource, 
	void(* handler)(RewardSetResource, Error, void* )
	, void* userData)
{
...
bool Campaigns_RewardsManager::updateRewardSetSync(char * accessToken,
	int id, RewardSetResource rewardSetResource, 
	void(* handler)(RewardSetResource, Error, void* )
	, void* userData)
{
