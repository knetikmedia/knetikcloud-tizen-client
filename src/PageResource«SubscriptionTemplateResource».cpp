...
void
PageResource«SubscriptionTemplateResource»::__init()
{
	//
...
void
PageResource«SubscriptionTemplateResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«SubscriptionTemplateResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<SubscriptionTemplateResource> new_list;
			SubscriptionTemplateResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("SubscriptionTemplateResource")) {
					jsonToValue(&inst, temp_json, "SubscriptionTemplateResource", "");
				} else {
...
PageResource«SubscriptionTemplateResource»::PageResource«SubscriptionTemplateResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«SubscriptionTemplateResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("SubscriptionTemplateResource")) {
		list<SubscriptionTemplateResource> new_list = static_cast<list <SubscriptionTemplateResource> > (getContent());
		node = converttoJson(&new_list, "SubscriptionTemplateResource", "array");
	} else {
		...
		for (list<SubscriptionTemplateResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			SubscriptionTemplateResource obj = *it;
...
std::list<SubscriptionTemplateResource>
PageResource«SubscriptionTemplateResource»::getContent()
{
	return content;
}

void
PageResource«SubscriptionTemplateResource»::setContent(std::list <SubscriptionTemplateResource> content)
{
	this->content = content;
}

bool
PageResource«SubscriptionTemplateResource»::getFirst()
{
	return first;
}

void
PageResource«SubscriptionTemplateResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«SubscriptionTemplateResource»::getLast()
{
	return last;
}

void
PageResource«SubscriptionTemplateResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«SubscriptionTemplateResource»::getNumber()
{
	return number;
}

void
PageResource«SubscriptionTemplateResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«SubscriptionTemplateResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«SubscriptionTemplateResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«SubscriptionTemplateResource»::getSize()
{
	return size;
}

void
PageResource«SubscriptionTemplateResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«SubscriptionTemplateResource»::getSort()
{
	return sort;
}

void
PageResource«SubscriptionTemplateResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«SubscriptionTemplateResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«SubscriptionTemplateResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«SubscriptionTemplateResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«SubscriptionTemplateResource»::setTotalPages(int  total_pages)
{
