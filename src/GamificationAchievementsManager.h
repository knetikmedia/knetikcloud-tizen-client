#ifndef _GamificationAchievementsManager_H_
#define _GamificationAchievementsManager_H_
...
/** \addtogroup GamificationAchievements GamificationAchievements
 * \ingroup Operations
 *  @{
 */
class GamificationAchievementsManager {
public:
	GamificationAchievementsManager();
	virtual ~GamificationAchievementsManager();
...
#endif /* GamificationAchievementsManager_H_ */
