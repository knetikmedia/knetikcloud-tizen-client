...
void
PageResource«CatalogSale»::__init()
{
	//
...
void
PageResource«CatalogSale»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«CatalogSale»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<CatalogSale> new_list;
			CatalogSale inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("CatalogSale")) {
					jsonToValue(&inst, temp_json, "CatalogSale", "");
				} else {
...
PageResource«CatalogSale»::PageResource«CatalogSale»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«CatalogSale»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("CatalogSale")) {
		list<CatalogSale> new_list = static_cast<list <CatalogSale> > (getContent());
		node = converttoJson(&new_list, "CatalogSale", "array");
	} else {
		...
		for (list<CatalogSale>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			CatalogSale obj = *it;
...
std::list<CatalogSale>
PageResource«CatalogSale»::getContent()
{
	return content;
}

void
PageResource«CatalogSale»::setContent(std::list <CatalogSale> content)
{
	this->content = content;
}

bool
PageResource«CatalogSale»::getFirst()
{
	return first;
}

void
PageResource«CatalogSale»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«CatalogSale»::getLast()
{
	return last;
}

void
PageResource«CatalogSale»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«CatalogSale»::getNumber()
{
	return number;
}

void
PageResource«CatalogSale»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«CatalogSale»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«CatalogSale»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«CatalogSale»::getSize()
{
	return size;
}

void
PageResource«CatalogSale»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«CatalogSale»::getSort()
{
	return sort;
}

void
PageResource«CatalogSale»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«CatalogSale»::getTotalElements()
{
	return total_elements;
}

void
PageResource«CatalogSale»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«CatalogSale»::getTotalPages()
{
	return total_pages;
}

void
PageResource«CatalogSale»::setTotalPages(int  total_pages)
{
