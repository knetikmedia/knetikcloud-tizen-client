...
void
EntitlementItem::fromJson(char* jsonStr)
{
...
EntitlementItem::EntitlementItem(char* json)
{
	this->fromJson(json);
}

char*
EntitlementItem::toJson()
{
...
EntitlementItem::getAdditionalProperties()
{
	return additional_properties;
}

void
EntitlementItem::setAdditionalProperties(std::map <string, string> additional_properties)
{
	this->additional_properties = additional_properties;
}

std::list<Behavior>
EntitlementItem::getBehaviors()
{
	return behaviors;
}

void
EntitlementItem::setBehaviors(std::list <Behavior> behaviors)
{
	this->behaviors = behaviors;
}

std::string
EntitlementItem::getCategory()
{
	return category;
}

void
EntitlementItem::setCategory(std::string  category)
{
	this->category = category;
}

long long
EntitlementItem::getCreatedDate()
{
	return created_date;
}

void
EntitlementItem::setCreatedDate(long long  created_date)
{
	this->created_date = created_date;
}

int
EntitlementItem::getId()
{
	return id;
}

void
EntitlementItem::setId(int  id)
{
	this->id = id;
}

std::string
EntitlementItem::getLongDescription()
{
	return long_description;
}

void
EntitlementItem::setLongDescription(std::string  long_description)
{
	this->long_description = long_description;
}

std::string
EntitlementItem::getName()
{
	return name;
}

void
EntitlementItem::setName(std::string  name)
{
	this->name = name;
}

std::string
EntitlementItem::getShortDescription()
{
	return short_description;
}

void
EntitlementItem::setShortDescription(std::string  short_description)
{
	this->short_description = short_description;
}

int
EntitlementItem::getSort()
{
	return sort;
}

void
EntitlementItem::setSort(int  sort)
{
	this->sort = sort;
}

std::list<std::string>
EntitlementItem::getTags()
{
	return tags;
}

void
EntitlementItem::setTags(std::list <std::string> tags)
{
	this->tags = tags;
}

std::string
EntitlementItem::getTemplate()
{
	return _template;
}

void
EntitlementItem::setTemplate(std::string  _template)
{
	this->_template = _template;
}

std::string
EntitlementItem::getTypeHint()
{
	return type_hint;
}

void
EntitlementItem::setTypeHint(std::string  type_hint)
{
	this->type_hint = type_hint;
}

std::string
EntitlementItem::getUniqueKey()
{
	return unique_key;
}

void
EntitlementItem::setUniqueKey(std::string  unique_key)
{
	this->unique_key = unique_key;
}

long long
EntitlementItem::getUpdatedDate()
{
	return updated_date;
}

void
EntitlementItem::setUpdatedDate(long long  updated_date)
{
