...
CouponItem::__init()
{
	...
	//
	//
	//discount_max = double(0);
	//
	//
	//discount_min_cart_value = double(0);
	//
	//
...
CouponItem::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("double")) {
			jsonToValue(&discount_max, node, "double", "");
		} else {
	...
	if (node !=NULL) {
		...
		if (isprimitive("double")) {
			jsonToValue(&discount_min_cart_value, node, "double", "");
		} else {
...
CouponItem::toJson()
{
	...
	if (isprimitive("double")) {
		double obj = getDiscountMinCartValue();
		node = converttoJson(&obj, "double", "");
	}
	else {
...
void
CouponItem::setDiscountMax(double  discount_max)
{
...
void
CouponItem::setDiscountMinCartValue(double  discount_min_cart_value)
{
...
void
CouponItem::setDiscountValue(double  discount_value)
{
