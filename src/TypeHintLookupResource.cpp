...
void
TypeHintLookupResource::__cleanup()
{
	//if(definition != NULL) {
	//
	//delete definition;
...
void
TypeHintLookupResource::fromJson(char* jsonStr)
{
...
TypeHintLookupResource::TypeHintLookupResource(char* json)
{
	this->fromJson(json);
}

char*
TypeHintLookupResource::toJson()
{
...
std::string
TypeHintLookupResource::getDefinition()
{
	return definition;
}

void
TypeHintLookupResource::setDefinition(std::string  definition)
{
	this->definition = definition;
}

ExpressionResource
TypeHintLookupResource::getLookupKey()
{
	return lookup_key;
}

void
TypeHintLookupResource::setLookupKey(ExpressionResource  lookup_key)
{
	this->lookup_key = lookup_key;
}

std::string
TypeHintLookupResource::getRequiredKeyType()
{
	return required_key_type;
}

void
TypeHintLookupResource::setRequiredKeyType(std::string  required_key_type)
{
	this->required_key_type = required_key_type;
}

std::string
TypeHintLookupResource::getType()
{
	return type;
}

void
TypeHintLookupResource::setType(std::string  type)
{
	this->type = type;
}

std::string
TypeHintLookupResource::getValueType()
{
	return value_type;
}

void
TypeHintLookupResource::setValueType(std::string  value_type)
{
