...
#ifndef _FormattedTextPropertyDefinitionResource_H_
#define _FormattedTextPropertyDefinitionResource_H_
...
class FormattedTextPropertyDefinitionResource : public Object {
public:
	/*! \brief Constructor.
	 */
	FormattedTextPropertyDefinitionResource();
	FormattedTextPropertyDefinitionResource(char* str);
...
#endif /* _FormattedTextPropertyDefinitionResource_H_ */
