...
void
PageResource«ChatMessageResource»::__init()
{
	//
...
void
PageResource«ChatMessageResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«ChatMessageResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<ChatMessageResource> new_list;
			ChatMessageResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("ChatMessageResource")) {
					jsonToValue(&inst, temp_json, "ChatMessageResource", "");
				} else {
...
PageResource«ChatMessageResource»::PageResource«ChatMessageResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«ChatMessageResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("ChatMessageResource")) {
		list<ChatMessageResource> new_list = static_cast<list <ChatMessageResource> > (getContent());
		node = converttoJson(&new_list, "ChatMessageResource", "array");
	} else {
		...
		for (list<ChatMessageResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			ChatMessageResource obj = *it;
...
std::list<ChatMessageResource>
PageResource«ChatMessageResource»::getContent()
{
	return content;
}

void
PageResource«ChatMessageResource»::setContent(std::list <ChatMessageResource> content)
{
	this->content = content;
}

bool
PageResource«ChatMessageResource»::getFirst()
{
	return first;
}

void
PageResource«ChatMessageResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«ChatMessageResource»::getLast()
{
	return last;
}

void
PageResource«ChatMessageResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«ChatMessageResource»::getNumber()
{
	return number;
}

void
PageResource«ChatMessageResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«ChatMessageResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«ChatMessageResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«ChatMessageResource»::getSize()
{
	return size;
}

void
PageResource«ChatMessageResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«ChatMessageResource»::getSort()
{
	return sort;
}

void
PageResource«ChatMessageResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«ChatMessageResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«ChatMessageResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«ChatMessageResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«ChatMessageResource»::setTotalPages(int  total_pages)
{
