...
void
PageResource«UserActionLog»::__init()
{
	//
...
void
PageResource«UserActionLog»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«UserActionLog»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<UserActionLog> new_list;
			UserActionLog inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("UserActionLog")) {
					jsonToValue(&inst, temp_json, "UserActionLog", "");
				} else {
...
PageResource«UserActionLog»::PageResource«UserActionLog»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«UserActionLog»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("UserActionLog")) {
		list<UserActionLog> new_list = static_cast<list <UserActionLog> > (getContent());
		node = converttoJson(&new_list, "UserActionLog", "array");
	} else {
		...
		for (list<UserActionLog>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			UserActionLog obj = *it;
...
std::list<UserActionLog>
PageResource«UserActionLog»::getContent()
{
	return content;
}

void
PageResource«UserActionLog»::setContent(std::list <UserActionLog> content)
{
	this->content = content;
}

bool
PageResource«UserActionLog»::getFirst()
{
	return first;
}

void
PageResource«UserActionLog»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«UserActionLog»::getLast()
{
	return last;
}

void
PageResource«UserActionLog»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«UserActionLog»::getNumber()
{
	return number;
}

void
PageResource«UserActionLog»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«UserActionLog»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«UserActionLog»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«UserActionLog»::getSize()
{
	return size;
}

void
PageResource«UserActionLog»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«UserActionLog»::getSort()
{
	return sort;
}

void
PageResource«UserActionLog»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«UserActionLog»::getTotalElements()
{
	return total_elements;
}

void
PageResource«UserActionLog»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«UserActionLog»::getTotalPages()
{
	return total_pages;
}

void
PageResource«UserActionLog»::setTotalPages(int  total_pages)
{
