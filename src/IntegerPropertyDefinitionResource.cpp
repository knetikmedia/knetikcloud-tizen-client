...
std::string
IntegerPropertyDefinitionResource::getDescription()
{
	return description;
}

void
IntegerPropertyDefinitionResource::setDescription(std::string  description)
{
...
std::string
IntegerPropertyDefinitionResource::getFriendlyName()
{
	return friendly_name;
}

void
IntegerPropertyDefinitionResource::setFriendlyName(std::string  friendly_name)
{
...
std::string
IntegerPropertyDefinitionResource::getOptionLabelPath()
{
	return option_label_path;
}

void
IntegerPropertyDefinitionResource::setOptionLabelPath(std::string  option_label_path)
{
	this->option_label_path = option_label_path;
}

std::string
IntegerPropertyDefinitionResource::getOptionValuePath()
{
	return option_value_path;
}

void
IntegerPropertyDefinitionResource::setOptionValuePath(std::string  option_value_path)
{
	this->option_value_path = option_value_path;
}

std::string
IntegerPropertyDefinitionResource::getOptionsUrl()
{
	return options_url;
}

void
IntegerPropertyDefinitionResource::setOptionsUrl(std::string  options_url)
{
