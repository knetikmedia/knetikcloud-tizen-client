...
void
PageResource«CampaignResource»::__init()
{
	//
...
void
PageResource«CampaignResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«CampaignResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<CampaignResource> new_list;
			CampaignResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("CampaignResource")) {
					jsonToValue(&inst, temp_json, "CampaignResource", "");
				} else {
...
PageResource«CampaignResource»::PageResource«CampaignResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«CampaignResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("CampaignResource")) {
		list<CampaignResource> new_list = static_cast<list <CampaignResource> > (getContent());
		node = converttoJson(&new_list, "CampaignResource", "array");
	} else {
		...
		for (list<CampaignResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			CampaignResource obj = *it;
...
std::list<CampaignResource>
PageResource«CampaignResource»::getContent()
{
	return content;
}

void
PageResource«CampaignResource»::setContent(std::list <CampaignResource> content)
{
	this->content = content;
}

bool
PageResource«CampaignResource»::getFirst()
{
	return first;
}

void
PageResource«CampaignResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«CampaignResource»::getLast()
{
	return last;
}

void
PageResource«CampaignResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«CampaignResource»::getNumber()
{
	return number;
}

void
PageResource«CampaignResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«CampaignResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«CampaignResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«CampaignResource»::getSize()
{
	return size;
}

void
PageResource«CampaignResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«CampaignResource»::getSort()
{
	return sort;
}

void
PageResource«CampaignResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«CampaignResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«CampaignResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«CampaignResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«CampaignResource»::setTotalPages(int  total_pages)
{
