...
#include "UsersRelationshipsManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
UsersRelationshipsManager::UsersRelationshipsManager()
{
...
static gboolean __UsersRelationshipsManagerresponseHandler(gpointer data)
{
...
static gpointer __UsersRelationshipsManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__UsersRelationshipsManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(UsersRelationshipsManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (UsersRelationshipsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), createUserRelationshipProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __UsersRelationshipsManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool UsersRelationshipsManager::createUserRelationshipAsync(char * accessToken,
	UserRelationshipResource relationship, 
	void(* handler)(UserRelationshipResource, Error, void* )
	, void* userData)
{
...
bool UsersRelationshipsManager::createUserRelationshipSync(char * accessToken,
	UserRelationshipResource relationship, 
	void(* handler)(UserRelationshipResource, Error, void* )
	, void* userData)
{
...
bool UsersRelationshipsManager::deleteUserRelationshipAsync(char * accessToken,
	long long id, 
...
bool UsersRelationshipsManager::deleteUserRelationshipSync(char * accessToken,
	long long id, 
...
bool UsersRelationshipsManager::getUserRelationshipAsync(char * accessToken,
	long long id, 
	void(* handler)(UserRelationshipResource, Error, void* )
	, void* userData)
{
...
bool UsersRelationshipsManager::getUserRelationshipSync(char * accessToken,
	long long id, 
	void(* handler)(UserRelationshipResource, Error, void* )
	, void* userData)
{
...
bool UsersRelationshipsManager::getUserRelationshipsAsync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«UserRelationshipResource», Error, void* )
	, void* userData)
{
...
bool UsersRelationshipsManager::getUserRelationshipsSync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«UserRelationshipResource», Error, void* )
	, void* userData)
{
...
bool UsersRelationshipsManager::updateUserRelationshipAsync(char * accessToken,
	long long id, UserRelationshipResource relationship, 
	void(* handler)(UserRelationshipResource, Error, void* )
	, void* userData)
{
...
bool UsersRelationshipsManager::updateUserRelationshipSync(char * accessToken,
	long long id, UserRelationshipResource relationship, 
	void(* handler)(UserRelationshipResource, Error, void* )
	, void* userData)
{
