...
void
PageResource«ChatUserThreadResource»::__init()
{
	//
...
void
PageResource«ChatUserThreadResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«ChatUserThreadResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<ChatUserThreadResource> new_list;
			ChatUserThreadResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("ChatUserThreadResource")) {
					jsonToValue(&inst, temp_json, "ChatUserThreadResource", "");
				} else {
...
PageResource«ChatUserThreadResource»::PageResource«ChatUserThreadResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«ChatUserThreadResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("ChatUserThreadResource")) {
		list<ChatUserThreadResource> new_list = static_cast<list <ChatUserThreadResource> > (getContent());
		node = converttoJson(&new_list, "ChatUserThreadResource", "array");
	} else {
		...
		for (list<ChatUserThreadResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			ChatUserThreadResource obj = *it;
...
std::list<ChatUserThreadResource>
PageResource«ChatUserThreadResource»::getContent()
{
	return content;
}

void
PageResource«ChatUserThreadResource»::setContent(std::list <ChatUserThreadResource> content)
{
	this->content = content;
}

bool
PageResource«ChatUserThreadResource»::getFirst()
{
	return first;
}

void
PageResource«ChatUserThreadResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«ChatUserThreadResource»::getLast()
{
	return last;
}

void
PageResource«ChatUserThreadResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«ChatUserThreadResource»::getNumber()
{
	return number;
}

void
PageResource«ChatUserThreadResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«ChatUserThreadResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«ChatUserThreadResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«ChatUserThreadResource»::getSize()
{
	return size;
}

void
PageResource«ChatUserThreadResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«ChatUserThreadResource»::getSort()
{
	return sort;
}

void
PageResource«ChatUserThreadResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«ChatUserThreadResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«ChatUserThreadResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«ChatUserThreadResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«ChatUserThreadResource»::setTotalPages(int  total_pages)
{
