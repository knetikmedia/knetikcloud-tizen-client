...
void
PageResource«ActivityOccurrenceResource»::__init()
{
	//
...
void
PageResource«ActivityOccurrenceResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«ActivityOccurrenceResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<ActivityOccurrenceResource> new_list;
			ActivityOccurrenceResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("ActivityOccurrenceResource")) {
					jsonToValue(&inst, temp_json, "ActivityOccurrenceResource", "");
				} else {
...
PageResource«ActivityOccurrenceResource»::PageResource«ActivityOccurrenceResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«ActivityOccurrenceResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("ActivityOccurrenceResource")) {
		list<ActivityOccurrenceResource> new_list = static_cast<list <ActivityOccurrenceResource> > (getContent());
		node = converttoJson(&new_list, "ActivityOccurrenceResource", "array");
	} else {
		...
		for (list<ActivityOccurrenceResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			ActivityOccurrenceResource obj = *it;
...
std::list<ActivityOccurrenceResource>
PageResource«ActivityOccurrenceResource»::getContent()
{
	return content;
}

void
PageResource«ActivityOccurrenceResource»::setContent(std::list <ActivityOccurrenceResource> content)
{
	this->content = content;
}

bool
PageResource«ActivityOccurrenceResource»::getFirst()
{
	return first;
}

void
PageResource«ActivityOccurrenceResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«ActivityOccurrenceResource»::getLast()
{
	return last;
}

void
PageResource«ActivityOccurrenceResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«ActivityOccurrenceResource»::getNumber()
{
	return number;
}

void
PageResource«ActivityOccurrenceResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«ActivityOccurrenceResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«ActivityOccurrenceResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«ActivityOccurrenceResource»::getSize()
{
	return size;
}

void
PageResource«ActivityOccurrenceResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«ActivityOccurrenceResource»::getSort()
{
	return sort;
}

void
PageResource«ActivityOccurrenceResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«ActivityOccurrenceResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«ActivityOccurrenceResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«ActivityOccurrenceResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«ActivityOccurrenceResource»::setTotalPages(int  total_pages)
{
