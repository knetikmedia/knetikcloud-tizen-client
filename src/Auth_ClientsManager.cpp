...
Auth_ClientsManager::Auth_ClientsManager()
{
...
static gboolean __Auth_ClientsManagerresponseHandler(gpointer data)
{
...
static gpointer __Auth_ClientsManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__Auth_ClientsManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(Auth_ClientsManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (Auth_ClientsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), createClientProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __Auth_ClientsManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool Auth_ClientsManager::createClientAsync(char * accessToken,
	ClientResource clientResource, 
	void(* handler)(ClientResource, Error, void* )
	, void* userData)
{
...
bool Auth_ClientsManager::createClientSync(char * accessToken,
	ClientResource clientResource, 
	void(* handler)(ClientResource, Error, void* )
	, void* userData)
{
...
bool Auth_ClientsManager::deleteClientAsync(char * accessToken,
	std::string clientKey, 
...
bool Auth_ClientsManager::deleteClientSync(char * accessToken,
	std::string clientKey, 
...
bool Auth_ClientsManager::getClientAsync(char * accessToken,
	std::string clientKey, 
	void(* handler)(ClientResource, Error, void* )
	, void* userData)
{
...
bool Auth_ClientsManager::getClientSync(char * accessToken,
	std::string clientKey, 
	void(* handler)(ClientResource, Error, void* )
	, void* userData)
{
...
bool Auth_ClientsManager::getClientGrantTypesAsync(char * accessToken,
...
bool Auth_ClientsManager::getClientGrantTypesSync(char * accessToken,
...
bool Auth_ClientsManager::getClientsAsync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«ClientResource», Error, void* )
	, void* userData)
{
...
bool Auth_ClientsManager::getClientsSync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«ClientResource», Error, void* )
	, void* userData)
{
...
bool Auth_ClientsManager::setClientGrantTypesAsync(char * accessToken,
	std::string clientKey, std::list<> grantList, 
...
bool Auth_ClientsManager::setClientGrantTypesSync(char * accessToken,
	std::string clientKey, std::list<> grantList, 
...
bool Auth_ClientsManager::setClientRedirectUrisAsync(char * accessToken,
	std::string clientKey, std::list<> redirectList, 
...
bool Auth_ClientsManager::setClientRedirectUrisSync(char * accessToken,
	std::string clientKey, std::list<> redirectList, 
...
bool Auth_ClientsManager::updateClientAsync(char * accessToken,
	std::string clientKey, ClientResource clientResource, 
	void(* handler)(ClientResource, Error, void* )
	, void* userData)
{
...
bool Auth_ClientsManager::updateClientSync(char * accessToken,
	std::string clientKey, ClientResource clientResource, 
	void(* handler)(ClientResource, Error, void* )
	, void* userData)
{
