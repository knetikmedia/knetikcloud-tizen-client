...
void
PageResource«RewardSetResource»::__init()
{
	//
...
void
PageResource«RewardSetResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«RewardSetResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<RewardSetResource> new_list;
			RewardSetResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("RewardSetResource")) {
					jsonToValue(&inst, temp_json, "RewardSetResource", "");
				} else {
...
PageResource«RewardSetResource»::PageResource«RewardSetResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«RewardSetResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("RewardSetResource")) {
		list<RewardSetResource> new_list = static_cast<list <RewardSetResource> > (getContent());
		node = converttoJson(&new_list, "RewardSetResource", "array");
	} else {
		...
		for (list<RewardSetResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			RewardSetResource obj = *it;
...
std::list<RewardSetResource>
PageResource«RewardSetResource»::getContent()
{
	return content;
}

void
PageResource«RewardSetResource»::setContent(std::list <RewardSetResource> content)
{
	this->content = content;
}

bool
PageResource«RewardSetResource»::getFirst()
{
	return first;
}

void
PageResource«RewardSetResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«RewardSetResource»::getLast()
{
	return last;
}

void
PageResource«RewardSetResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«RewardSetResource»::getNumber()
{
	return number;
}

void
PageResource«RewardSetResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«RewardSetResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«RewardSetResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«RewardSetResource»::getSize()
{
	return size;
}

void
PageResource«RewardSetResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«RewardSetResource»::getSort()
{
	return sort;
}

void
PageResource«RewardSetResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«RewardSetResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«RewardSetResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«RewardSetResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«RewardSetResource»::setTotalPages(int  total_pages)
{
