#ifndef _Campaigns_ChallengesManager_H_
#define _Campaigns_ChallengesManager_H_
...
/** \addtogroup Campaigns_Challenges Campaigns_Challenges
 * \ingroup Operations
 *  @{
 */
class Campaigns_ChallengesManager {
public:
	Campaigns_ChallengesManager();
	virtual ~Campaigns_ChallengesManager();
...
#endif /* Campaigns_ChallengesManager_H_ */
