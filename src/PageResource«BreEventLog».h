...
#ifndef _PageResource«BreEventLog»_H_
#define _PageResource«BreEventLog»_H_
...
class PageResource«BreEventLog» : public Object {
public:
	/*! \brief Constructor.
	 */
	PageResource«BreEventLog»();
	PageResource«BreEventLog»(char* str);
	...
	/*! \brief Get 
	 */
	std::list<BreEventLog> getContent();

	/*! \brief Set 
	 */
	void setContent(std::list <BreEventLog> content);
	/*! \brief Get 
	 */
	bool getFirst();
...
#endif /* _PageResource«BreEventLog»_H_ */
