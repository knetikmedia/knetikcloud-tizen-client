...
void
PageResource«ClientResource»::__init()
{
	//
...
void
PageResource«ClientResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«ClientResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<ClientResource> new_list;
			ClientResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("ClientResource")) {
					jsonToValue(&inst, temp_json, "ClientResource", "");
				} else {
...
PageResource«ClientResource»::PageResource«ClientResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«ClientResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("ClientResource")) {
		list<ClientResource> new_list = static_cast<list <ClientResource> > (getContent());
		node = converttoJson(&new_list, "ClientResource", "array");
	} else {
		...
		for (list<ClientResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			ClientResource obj = *it;
...
std::list<ClientResource>
PageResource«ClientResource»::getContent()
{
	return content;
}

void
PageResource«ClientResource»::setContent(std::list <ClientResource> content)
{
	this->content = content;
}

bool
PageResource«ClientResource»::getFirst()
{
	return first;
}

void
PageResource«ClientResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«ClientResource»::getLast()
{
	return last;
}

void
PageResource«ClientResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«ClientResource»::getNumber()
{
	return number;
}

void
PageResource«ClientResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«ClientResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«ClientResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«ClientResource»::getSize()
{
	return size;
}

void
PageResource«ClientResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«ClientResource»::getSort()
{
	return sort;
}

void
PageResource«ClientResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«ClientResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«ClientResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«ClientResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«ClientResource»::setTotalPages(int  total_pages)
{
