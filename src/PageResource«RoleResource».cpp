...
void
PageResource«RoleResource»::__init()
{
	//
...
void
PageResource«RoleResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«RoleResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<RoleResource> new_list;
			RoleResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("RoleResource")) {
					jsonToValue(&inst, temp_json, "RoleResource", "");
				} else {
...
PageResource«RoleResource»::PageResource«RoleResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«RoleResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("RoleResource")) {
		list<RoleResource> new_list = static_cast<list <RoleResource> > (getContent());
		node = converttoJson(&new_list, "RoleResource", "array");
	} else {
		...
		for (list<RoleResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			RoleResource obj = *it;
...
std::list<RoleResource>
PageResource«RoleResource»::getContent()
{
	return content;
}

void
PageResource«RoleResource»::setContent(std::list <RoleResource> content)
{
	this->content = content;
}

bool
PageResource«RoleResource»::getFirst()
{
	return first;
}

void
PageResource«RoleResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«RoleResource»::getLast()
{
	return last;
}

void
PageResource«RoleResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«RoleResource»::getNumber()
{
	return number;
}

void
PageResource«RoleResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«RoleResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«RoleResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«RoleResource»::getSize()
{
	return size;
}

void
PageResource«RoleResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«RoleResource»::getSort()
{
	return sort;
}

void
PageResource«RoleResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«RoleResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«RoleResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«RoleResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«RoleResource»::setTotalPages(int  total_pages)
{
