#ifndef _Store_BundlesManager_H_
#define _Store_BundlesManager_H_
...
/** \addtogroup Store_Bundles Store_Bundles
 * \ingroup Operations
 *  @{
 */
class Store_BundlesManager {
public:
	Store_BundlesManager();
	virtual ~Store_BundlesManager();
