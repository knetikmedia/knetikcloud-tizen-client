...
void
PageResource«WalletTransactionResource»::__init()
{
	//
...
void
PageResource«WalletTransactionResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«WalletTransactionResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<WalletTransactionResource> new_list;
			WalletTransactionResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("WalletTransactionResource")) {
					jsonToValue(&inst, temp_json, "WalletTransactionResource", "");
				} else {
...
PageResource«WalletTransactionResource»::PageResource«WalletTransactionResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«WalletTransactionResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("WalletTransactionResource")) {
		list<WalletTransactionResource> new_list = static_cast<list <WalletTransactionResource> > (getContent());
		node = converttoJson(&new_list, "WalletTransactionResource", "array");
	} else {
		...
		for (list<WalletTransactionResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			WalletTransactionResource obj = *it;
...
std::list<WalletTransactionResource>
PageResource«WalletTransactionResource»::getContent()
{
	return content;
}

void
PageResource«WalletTransactionResource»::setContent(std::list <WalletTransactionResource> content)
{
	this->content = content;
}

bool
PageResource«WalletTransactionResource»::getFirst()
{
	return first;
}

void
PageResource«WalletTransactionResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«WalletTransactionResource»::getLast()
{
	return last;
}

void
PageResource«WalletTransactionResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«WalletTransactionResource»::getNumber()
{
	return number;
}

void
PageResource«WalletTransactionResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«WalletTransactionResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«WalletTransactionResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«WalletTransactionResource»::getSize()
{
	return size;
}

void
PageResource«WalletTransactionResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«WalletTransactionResource»::getSort()
{
	return sort;
}

void
PageResource«WalletTransactionResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«WalletTransactionResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«WalletTransactionResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«WalletTransactionResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«WalletTransactionResource»::setTotalPages(int  total_pages)
{
