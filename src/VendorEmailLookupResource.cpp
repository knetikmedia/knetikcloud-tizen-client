...
std::string
VendorEmailLookupResource::getDefinition()
{
	return definition;
}

void
VendorEmailLookupResource::setDefinition(std::string  definition)
{
...
std::string
VendorEmailLookupResource::getRequiredKeyType()
{
	return required_key_type;
}

void
VendorEmailLookupResource::setRequiredKeyType(std::string  required_key_type)
{
