...
void
PageResource«BreCategoryResource»::__init()
{
	//
...
void
PageResource«BreCategoryResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«BreCategoryResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<BreCategoryResource> new_list;
			BreCategoryResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("BreCategoryResource")) {
					jsonToValue(&inst, temp_json, "BreCategoryResource", "");
				} else {
...
PageResource«BreCategoryResource»::PageResource«BreCategoryResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«BreCategoryResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("BreCategoryResource")) {
		list<BreCategoryResource> new_list = static_cast<list <BreCategoryResource> > (getContent());
		node = converttoJson(&new_list, "BreCategoryResource", "array");
	} else {
		...
		for (list<BreCategoryResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			BreCategoryResource obj = *it;
...
std::list<BreCategoryResource>
PageResource«BreCategoryResource»::getContent()
{
	return content;
}

void
PageResource«BreCategoryResource»::setContent(std::list <BreCategoryResource> content)
{
	this->content = content;
}

bool
PageResource«BreCategoryResource»::getFirst()
{
	return first;
}

void
PageResource«BreCategoryResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«BreCategoryResource»::getLast()
{
	return last;
}

void
PageResource«BreCategoryResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«BreCategoryResource»::getNumber()
{
	return number;
}

void
PageResource«BreCategoryResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«BreCategoryResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«BreCategoryResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«BreCategoryResource»::getSize()
{
	return size;
}

void
PageResource«BreCategoryResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«BreCategoryResource»::getSort()
{
	return sort;
}

void
PageResource«BreCategoryResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«BreCategoryResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«BreCategoryResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«BreCategoryResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«BreCategoryResource»::setTotalPages(int  total_pages)
{
