...
StoreBundlesManager::StoreBundlesManager()
{
...
static gboolean __StoreBundlesManagerresponseHandler(gpointer data)
{
...
static gpointer __StoreBundlesManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__StoreBundlesManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(StoreBundlesManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (StoreBundlesManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), createBundleItemProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __StoreBundlesManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool StoreBundlesManager::createBundleItemAsync(char * accessToken,
	bool cascade, BundleItem bundleItem, 
	void(* handler)(BundleItem, Error, void* )
	, void* userData)
{
...
bool StoreBundlesManager::createBundleItemSync(char * accessToken,
	bool cascade, BundleItem bundleItem, 
	void(* handler)(BundleItem, Error, void* )
	, void* userData)
{
...
bool StoreBundlesManager::createBundleTemplateAsync(char * accessToken,
	ItemTemplateResource bundleTemplateResource, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
...
bool StoreBundlesManager::createBundleTemplateSync(char * accessToken,
	ItemTemplateResource bundleTemplateResource, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
...
bool StoreBundlesManager::deleteBundleItemAsync(char * accessToken,
	int id, 
...
bool StoreBundlesManager::deleteBundleItemSync(char * accessToken,
	int id, 
...
bool StoreBundlesManager::deleteBundleTemplateAsync(char * accessToken,
	std::string id, std::string cascade, 
...
bool StoreBundlesManager::deleteBundleTemplateSync(char * accessToken,
	std::string id, std::string cascade, 
...
bool StoreBundlesManager::getBundleItemAsync(char * accessToken,
	int id, 
	void(* handler)(BundleItem, Error, void* )
	, void* userData)
{
...
bool StoreBundlesManager::getBundleItemSync(char * accessToken,
	int id, 
	void(* handler)(BundleItem, Error, void* )
	, void* userData)
{
...
bool StoreBundlesManager::getBundleTemplateAsync(char * accessToken,
	std::string id, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
...
bool StoreBundlesManager::getBundleTemplateSync(char * accessToken,
	std::string id, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
...
bool StoreBundlesManager::getBundleTemplatesAsync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«ItemTemplateResource», Error, void* )
	, void* userData)
{
...
bool StoreBundlesManager::getBundleTemplatesSync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«ItemTemplateResource», Error, void* )
	, void* userData)
{
...
bool StoreBundlesManager::updateBundleItemAsync(char * accessToken,
	int id, bool cascade, BundleItem bundleItem, 
	void(* handler)(BundleItem, Error, void* )
	, void* userData)
{
...
bool StoreBundlesManager::updateBundleItemSync(char * accessToken,
	int id, bool cascade, BundleItem bundleItem, 
	void(* handler)(BundleItem, Error, void* )
	, void* userData)
{
...
bool StoreBundlesManager::updateBundleTemplateAsync(char * accessToken,
	std::string id, ItemTemplateResource bundleTemplateResource, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
...
bool StoreBundlesManager::updateBundleTemplateSync(char * accessToken,
	std::string id, ItemTemplateResource bundleTemplateResource, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
