...
void
PageResource«TemplateResource»::__init()
{
	//
...
void
PageResource«TemplateResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«TemplateResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<TemplateResource> new_list;
			TemplateResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("TemplateResource")) {
					jsonToValue(&inst, temp_json, "TemplateResource", "");
				} else {
...
PageResource«TemplateResource»::PageResource«TemplateResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«TemplateResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("TemplateResource")) {
		list<TemplateResource> new_list = static_cast<list <TemplateResource> > (getContent());
		node = converttoJson(&new_list, "TemplateResource", "array");
	} else {
		...
		for (list<TemplateResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			TemplateResource obj = *it;
...
std::list<TemplateResource>
PageResource«TemplateResource»::getContent()
{
	return content;
}

void
PageResource«TemplateResource»::setContent(std::list <TemplateResource> content)
{
	this->content = content;
}

bool
PageResource«TemplateResource»::getFirst()
{
	return first;
}

void
PageResource«TemplateResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«TemplateResource»::getLast()
{
	return last;
}

void
PageResource«TemplateResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«TemplateResource»::getNumber()
{
	return number;
}

void
PageResource«TemplateResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«TemplateResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«TemplateResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«TemplateResource»::getSize()
{
	return size;
}

void
PageResource«TemplateResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«TemplateResource»::getSort()
{
	return sort;
}

void
PageResource«TemplateResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«TemplateResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«TemplateResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«TemplateResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«TemplateResource»::setTotalPages(int  total_pages)
{
