...
void
PropertyDefinitionResource::__init()
{
	//
	//
...
void
PropertyDefinitionResource::__cleanup()
{
	//if(description != NULL) {
	//
	//delete description;
...
void
PropertyDefinitionResource::fromJson(char* jsonStr)
{
...
PropertyDefinitionResource::PropertyDefinitionResource(char* json)
{
	this->fromJson(json);
}

char*
PropertyDefinitionResource::toJson()
{
...
std::string
PropertyDefinitionResource::getDescription()
{
	return description;
}

void
PropertyDefinitionResource::setDescription(std::string  description)
{
	this->description = description;
}

PropertyFieldListResource
PropertyDefinitionResource::getFieldList()
{
	return field_list;
}

void
PropertyDefinitionResource::setFieldList(PropertyFieldListResource  field_list)
{
	this->field_list = field_list;
}

std::string
PropertyDefinitionResource::getFriendlyName()
{
	return friendly_name;
}

void
PropertyDefinitionResource::setFriendlyName(std::string  friendly_name)
{
	this->friendly_name = friendly_name;
}

std::string
PropertyDefinitionResource::getName()
{
	return name;
}

void
PropertyDefinitionResource::setName(std::string  name)
{
	this->name = name;
}

std::string
PropertyDefinitionResource::getOptionLabelPath()
{
	return option_label_path;
}

void
PropertyDefinitionResource::setOptionLabelPath(std::string  option_label_path)
{
	this->option_label_path = option_label_path;
}

std::string
PropertyDefinitionResource::getOptionValuePath()
{
	return option_value_path;
}

void
PropertyDefinitionResource::setOptionValuePath(std::string  option_value_path)
{
	this->option_value_path = option_value_path;
}

std::string
PropertyDefinitionResource::getOptionsUrl()
{
	return options_url;
}

void
PropertyDefinitionResource::setOptionsUrl(std::string  options_url)
{
	this->options_url = options_url;
}

bool
PropertyDefinitionResource::getRequired()
{
	return required;
}

void
PropertyDefinitionResource::setRequired(bool  required)
{
	this->required = required;
}

std::string
PropertyDefinitionResource::getType()
{
	return type;
}

void
PropertyDefinitionResource::setType(std::string  type)
{
	this->type = type;
}
