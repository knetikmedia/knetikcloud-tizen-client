...
#include "Users_AddressesManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
Users_AddressesManager::Users_AddressesManager()
{
...
static gboolean __Users_AddressesManagerresponseHandler(gpointer data)
{
...
static gpointer __Users_AddressesManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__Users_AddressesManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(Users_AddressesManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (Users_AddressesManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), createAddressProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __Users_AddressesManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool Users_AddressesManager::createAddressAsync(char * accessToken,
	std::string userId, SavedAddressResource savedAddressResource, 
	void(* handler)(SavedAddressResource, Error, void* )
	, void* userData)
{
...
bool Users_AddressesManager::createAddressSync(char * accessToken,
	std::string userId, SavedAddressResource savedAddressResource, 
	void(* handler)(SavedAddressResource, Error, void* )
	, void* userData)
{
...
bool Users_AddressesManager::deleteAddressAsync(char * accessToken,
	std::string userId, int id, 
...
bool Users_AddressesManager::deleteAddressSync(char * accessToken,
	std::string userId, int id, 
...
bool Users_AddressesManager::getAddressAsync(char * accessToken,
	std::string userId, int id, 
	void(* handler)(SavedAddressResource, Error, void* )
	, void* userData)
{
...
bool Users_AddressesManager::getAddressSync(char * accessToken,
	std::string userId, int id, 
	void(* handler)(SavedAddressResource, Error, void* )
	, void* userData)
{
...
bool Users_AddressesManager::getAddressesAsync(char * accessToken,
	std::string userId, int size, int page, std::string order, 
	void(* handler)(PageResource«SavedAddressResource», Error, void* )
	, void* userData)
{
...
bool Users_AddressesManager::getAddressesSync(char * accessToken,
	std::string userId, int size, int page, std::string order, 
	void(* handler)(PageResource«SavedAddressResource», Error, void* )
	, void* userData)
{
...
bool Users_AddressesManager::updateAddressAsync(char * accessToken,
	std::string userId, int id, SavedAddressResource savedAddressResource, 
	void(* handler)(SavedAddressResource, Error, void* )
	, void* userData)
{
...
bool Users_AddressesManager::updateAddressSync(char * accessToken,
	std::string userId, int id, SavedAddressResource savedAddressResource, 
	void(* handler)(SavedAddressResource, Error, void* )
	, void* userData)
{
