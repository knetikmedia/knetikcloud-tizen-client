#ifndef _Users_FriendshipsManager_H_
#define _Users_FriendshipsManager_H_
...
/** \addtogroup Users_Friendships Users_Friendships
 * \ingroup Operations
 *  @{
 */
class Users_FriendshipsManager {
public:
	Users_FriendshipsManager();
	virtual ~Users_FriendshipsManager();
...
#endif /* Users_FriendshipsManager_H_ */
