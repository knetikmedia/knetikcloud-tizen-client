...
void
PageResource«string»::fromJson(char* jsonStr)
{
...
PageResource«string»::PageResource«string»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«string»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("std::string")) {
		list<std::string> new_list = static_cast<list <std::string> > (getContent());
...
std::list<std::string>
PageResource«string»::getContent()
{
	return content;
}

void
PageResource«string»::setContent(std::list <std::string> content)
{
	this->content = content;
}

bool
PageResource«string»::getFirst()
{
	return first;
}

void
PageResource«string»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«string»::getLast()
{
	return last;
}

void
PageResource«string»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«string»::getNumber()
{
	return number;
}

void
PageResource«string»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«string»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«string»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«string»::getSize()
{
	return size;
}

void
PageResource«string»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«string»::getSort()
{
	return sort;
}

void
PageResource«string»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«string»::getTotalElements()
{
	return total_elements;
}

void
PageResource«string»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«string»::getTotalPages()
{
	return total_pages;
}

void
PageResource«string»::setTotalPages(int  total_pages)
{
