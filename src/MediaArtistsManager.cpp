...
MediaArtistsManager::MediaArtistsManager()
{
...
static gboolean __MediaArtistsManagerresponseHandler(gpointer data)
{
...
static gpointer __MediaArtistsManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__MediaArtistsManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(MediaArtistsManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (MediaArtistsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), addArtistProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __MediaArtistsManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool MediaArtistsManager::addArtistAsync(char * accessToken,
	ArtistResource artistResource, 
	void(* handler)(ArtistResource, Error, void* )
	, void* userData)
{
...
bool MediaArtistsManager::addArtistSync(char * accessToken,
	ArtistResource artistResource, 
	void(* handler)(ArtistResource, Error, void* )
	, void* userData)
{
...
bool MediaArtistsManager::createArtistTemplateAsync(char * accessToken,
	TemplateResource artistTemplateResource, 
	void(* handler)(TemplateResource, Error, void* )
	, void* userData)
{
...
bool MediaArtistsManager::createArtistTemplateSync(char * accessToken,
	TemplateResource artistTemplateResource, 
	void(* handler)(TemplateResource, Error, void* )
	, void* userData)
{
...
bool MediaArtistsManager::deleteArtistAsync(char * accessToken,
	long long id, 
...
bool MediaArtistsManager::deleteArtistSync(char * accessToken,
	long long id, 
...
bool MediaArtistsManager::deleteArtistTemplateAsync(char * accessToken,
	std::string id, std::string cascade, 
...
bool MediaArtistsManager::deleteArtistTemplateSync(char * accessToken,
	std::string id, std::string cascade, 
...
bool MediaArtistsManager::getArtistAsync(char * accessToken,
	long long id, int showContributions, 
	void(* handler)(ArtistResource, Error, void* )
	, void* userData)
{
...
bool MediaArtistsManager::getArtistSync(char * accessToken,
	long long id, int showContributions, 
	void(* handler)(ArtistResource, Error, void* )
	, void* userData)
{
...
bool MediaArtistsManager::getArtistTemplateAsync(char * accessToken,
	std::string id, 
	void(* handler)(TemplateResource, Error, void* )
	, void* userData)
{
...
bool MediaArtistsManager::getArtistTemplateSync(char * accessToken,
	std::string id, 
	void(* handler)(TemplateResource, Error, void* )
	, void* userData)
{
...
bool MediaArtistsManager::getArtistTemplatesAsync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«TemplateResource», Error, void* )
	, void* userData)
{
...
bool MediaArtistsManager::getArtistTemplatesSync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«TemplateResource», Error, void* )
	, void* userData)
{
...
bool MediaArtistsManager::getArtistsAsync(char * accessToken,
	std::string filterArtistsByName, int size, int page, std::string order, 
	void(* handler)(PageResource«ArtistResource», Error, void* )
	, void* userData)
{
...
bool MediaArtistsManager::getArtistsSync(char * accessToken,
	std::string filterArtistsByName, int size, int page, std::string order, 
	void(* handler)(PageResource«ArtistResource», Error, void* )
	, void* userData)
{
...
bool MediaArtistsManager::updateArtistAsync(char * accessToken,
	long long id, ArtistResource artistResource, 
...
bool MediaArtistsManager::updateArtistSync(char * accessToken,
	long long id, ArtistResource artistResource, 
...
bool MediaArtistsManager::updateArtistTemplateAsync(char * accessToken,
	std::string id, TemplateResource artistTemplateResource, 
	void(* handler)(TemplateResource, Error, void* )
	, void* userData)
{
...
bool MediaArtistsManager::updateArtistTemplateSync(char * accessToken,
	std::string id, TemplateResource artistTemplateResource, 
	void(* handler)(TemplateResource, Error, void* )
	, void* userData)
{
