...
SubscriptionPlanResource::__init()
{
	...
	//
	//
	//reactivation_fee = long(0);
	//
	//
	//reactivation_sku = std::string();
	//
	//
	//recurring_fee = long(0);
	//
	//
...
SubscriptionPlanResource::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("long long")) {
			jsonToValue(&initial_fee, node, "long long", "");
		} else {
	...
	if (node !=NULL) {
		...
		if (isprimitive("long long")) {
			jsonToValue(&late_payment_fee, node, "long long", "");
		} else {
	...
	if (node !=NULL) {
		...
		if (isprimitive("long long")) {
			jsonToValue(&reactivation_fee, node, "long long", "");
		} else {
	...
	if (node !=NULL) {
		...
		if (isprimitive("long long")) {
			jsonToValue(&recurring_fee, node, "long long", "");
		} else {
...
SubscriptionPlanResource::toJson()
{
	...
	if (isprimitive("long long")) {
		long long obj = getLatePaymentFee();
		node = converttoJson(&obj, "long long", "");
	}
	else {
	...
	if (isprimitive("long long")) {
		long long obj = getReactivationFee();
		node = converttoJson(&obj, "long long", "");
	}
	else {
...
void
SubscriptionPlanResource::setInitialFee(long long  initial_fee)
{
...
void
SubscriptionPlanResource::setLatePaymentFee(long long  late_payment_fee)
{
...
void
SubscriptionPlanResource::setReactivationFee(long long  reactivation_fee)
{
...
void
SubscriptionPlanResource::setRecurringFee(long long  recurring_fee)
{
