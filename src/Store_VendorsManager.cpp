...
#include "Store_VendorsManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
Store_VendorsManager::Store_VendorsManager()
{
...
static gboolean __Store_VendorsManagerresponseHandler(gpointer data)
{
...
static gpointer __Store_VendorsManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__Store_VendorsManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(Store_VendorsManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (Store_VendorsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), createVendorProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __Store_VendorsManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool Store_VendorsManager::createVendorAsync(char * accessToken,
	VendorResource vendor, 
	void(* handler)(VendorResource, Error, void* )
	, void* userData)
{
...
bool Store_VendorsManager::createVendorSync(char * accessToken,
	VendorResource vendor, 
	void(* handler)(VendorResource, Error, void* )
	, void* userData)
{
...
bool Store_VendorsManager::createVendorTemplateAsync(char * accessToken,
	ItemTemplateResource vendorTemplateResource, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
...
bool Store_VendorsManager::createVendorTemplateSync(char * accessToken,
	ItemTemplateResource vendorTemplateResource, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
...
bool Store_VendorsManager::deleteVendorAsync(char * accessToken,
	int id, 
...
bool Store_VendorsManager::deleteVendorSync(char * accessToken,
	int id, 
...
bool Store_VendorsManager::deleteVendorTemplateAsync(char * accessToken,
	std::string id, std::string cascade, 
...
bool Store_VendorsManager::deleteVendorTemplateSync(char * accessToken,
	std::string id, std::string cascade, 
...
bool Store_VendorsManager::getVendorAsync(char * accessToken,
	int id, 
	void(* handler)(VendorResource, Error, void* )
	, void* userData)
{
...
bool Store_VendorsManager::getVendorSync(char * accessToken,
	int id, 
	void(* handler)(VendorResource, Error, void* )
	, void* userData)
{
...
bool Store_VendorsManager::getVendorTemplateAsync(char * accessToken,
	std::string id, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
...
bool Store_VendorsManager::getVendorTemplateSync(char * accessToken,
	std::string id, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
...
bool Store_VendorsManager::getVendorTemplatesAsync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«ItemTemplateResource», Error, void* )
	, void* userData)
{
...
bool Store_VendorsManager::getVendorTemplatesSync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«ItemTemplateResource», Error, void* )
	, void* userData)
{
...
bool Store_VendorsManager::getVendorsAsync(char * accessToken,
	std::string filterName, int size, int page, std::string order, 
	void(* handler)(PageResource«VendorResource», Error, void* )
	, void* userData)
{
...
bool Store_VendorsManager::getVendorsSync(char * accessToken,
	std::string filterName, int size, int page, std::string order, 
	void(* handler)(PageResource«VendorResource», Error, void* )
	, void* userData)
{
...
bool Store_VendorsManager::updateVendorAsync(char * accessToken,
	int id, VendorResource vendor, 
	void(* handler)(VendorResource, Error, void* )
	, void* userData)
{
...
bool Store_VendorsManager::updateVendorSync(char * accessToken,
	int id, VendorResource vendor, 
	void(* handler)(VendorResource, Error, void* )
	, void* userData)
{
...
bool Store_VendorsManager::updateVendorTemplateAsync(char * accessToken,
	std::string id, ItemTemplateResource vendorTemplateResource, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
...
bool Store_VendorsManager::updateVendorTemplateSync(char * accessToken,
	std::string id, ItemTemplateResource vendorTemplateResource, 
	void(* handler)(ItemTemplateResource, Error, void* )
	, void* userData)
{
