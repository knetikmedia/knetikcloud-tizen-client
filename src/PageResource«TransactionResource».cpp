...
void
PageResource«TransactionResource»::__init()
{
	//
...
void
PageResource«TransactionResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«TransactionResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<TransactionResource> new_list;
			TransactionResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("TransactionResource")) {
					jsonToValue(&inst, temp_json, "TransactionResource", "");
				} else {
...
PageResource«TransactionResource»::PageResource«TransactionResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«TransactionResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("TransactionResource")) {
		list<TransactionResource> new_list = static_cast<list <TransactionResource> > (getContent());
		node = converttoJson(&new_list, "TransactionResource", "array");
	} else {
		...
		for (list<TransactionResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			TransactionResource obj = *it;
...
std::list<TransactionResource>
PageResource«TransactionResource»::getContent()
{
	return content;
}

void
PageResource«TransactionResource»::setContent(std::list <TransactionResource> content)
{
	this->content = content;
}

bool
PageResource«TransactionResource»::getFirst()
{
	return first;
}

void
PageResource«TransactionResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«TransactionResource»::getLast()
{
	return last;
}

void
PageResource«TransactionResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«TransactionResource»::getNumber()
{
	return number;
}

void
PageResource«TransactionResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«TransactionResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«TransactionResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«TransactionResource»::getSize()
{
	return size;
}

void
PageResource«TransactionResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«TransactionResource»::getSort()
{
	return sort;
}

void
PageResource«TransactionResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«TransactionResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«TransactionResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«TransactionResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«TransactionResource»::setTotalPages(int  total_pages)
{
