...
public:
	...
	/*! \brief Get Whether or not the SKU is currently published
	 */
	bool getPublished();

	/*! \brief Set Whether or not the SKU is currently published
	 */
	...
	/*! \brief Get The date the sku becomes available, unix timestamp in seconds.  If set to null, sku will become available immediately
	 */
	long long getStartDate();

	/*! \brief Set The date the sku becomes available, unix timestamp in seconds.  If set to null, sku will become available immediately
	 */
	void setStartDate(long long  start_date);
	/*! \brief Get The date the sku becomes unavailable, unix timestamp in seconds.  If set to null, sku is always available
	 */
	long long getStopDate();

	/*! \brief Set The date the sku becomes unavailable, unix timestamp in seconds.  If set to null, sku is always available
	 */
