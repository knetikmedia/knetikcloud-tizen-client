...
#ifndef _ItemTemplateResource_H_
#define _ItemTemplateResource_H_
...
class ItemTemplateResource : public Object {
public:
	/*! \brief Constructor.
	 */
	ItemTemplateResource();
	ItemTemplateResource(char* str);
...
#endif /* _ItemTemplateResource_H_ */
