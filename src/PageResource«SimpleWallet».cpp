...
void
PageResource«SimpleWallet»::__init()
{
	//
...
void
PageResource«SimpleWallet»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«SimpleWallet»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<SimpleWallet> new_list;
			SimpleWallet inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("SimpleWallet")) {
					jsonToValue(&inst, temp_json, "SimpleWallet", "");
				} else {
...
PageResource«SimpleWallet»::PageResource«SimpleWallet»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«SimpleWallet»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("SimpleWallet")) {
		list<SimpleWallet> new_list = static_cast<list <SimpleWallet> > (getContent());
		node = converttoJson(&new_list, "SimpleWallet", "array");
	} else {
		...
		for (list<SimpleWallet>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			SimpleWallet obj = *it;
...
std::list<SimpleWallet>
PageResource«SimpleWallet»::getContent()
{
	return content;
}

void
PageResource«SimpleWallet»::setContent(std::list <SimpleWallet> content)
{
	this->content = content;
}

bool
PageResource«SimpleWallet»::getFirst()
{
	return first;
}

void
PageResource«SimpleWallet»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«SimpleWallet»::getLast()
{
	return last;
}

void
PageResource«SimpleWallet»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«SimpleWallet»::getNumber()
{
	return number;
}

void
PageResource«SimpleWallet»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«SimpleWallet»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«SimpleWallet»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«SimpleWallet»::getSize()
{
	return size;
}

void
PageResource«SimpleWallet»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«SimpleWallet»::getSort()
{
	return sort;
}

void
PageResource«SimpleWallet»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«SimpleWallet»::getTotalElements()
{
	return total_elements;
}

void
PageResource«SimpleWallet»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«SimpleWallet»::getTotalPages()
{
	return total_pages;
}

void
PageResource«SimpleWallet»::setTotalPages(int  total_pages)
{
