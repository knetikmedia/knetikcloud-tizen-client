...
InvoiceItemResource::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("double")) {
			jsonToValue(&original_total_price, node, "double", "");
		} else {
	...
	if (node !=NULL) {
		...
		if (isprimitive("double")) {
			jsonToValue(&system_price, node, "double", "");
		} else {
	...
	if (node !=NULL) {
		...
		if (isprimitive("double")) {
			jsonToValue(&total_price, node, "double", "");
		} else {
...
InvoiceItemResource::toJson()
{
	...
	if (isprimitive("double")) {
		double obj = getOriginalTotalPrice();
...
void
InvoiceItemResource::setOriginalTotalPrice(double  original_total_price)
{
...
void
InvoiceItemResource::setOriginalUnitPrice(double  original_unit_price)
{
...
void
InvoiceItemResource::setSystemPrice(double  system_price)
{
...
void
InvoiceItemResource::setTotalPrice(double  total_price)
{
...
void
InvoiceItemResource::setUnitPrice(double  unit_price)
{
