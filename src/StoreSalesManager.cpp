...
StoreSalesManager::StoreSalesManager()
{
...
static gboolean __StoreSalesManagerresponseHandler(gpointer data)
{
...
static gpointer __StoreSalesManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__StoreSalesManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(StoreSalesManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (StoreSalesManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), createCatalogSaleProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __StoreSalesManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool StoreSalesManager::createCatalogSaleAsync(char * accessToken,
	CatalogSale catalogSale, 
	void(* handler)(CatalogSale, Error, void* )
	, void* userData)
{
...
bool StoreSalesManager::createCatalogSaleSync(char * accessToken,
	CatalogSale catalogSale, 
	void(* handler)(CatalogSale, Error, void* )
	, void* userData)
{
...
bool StoreSalesManager::deleteCatalogSaleAsync(char * accessToken,
	int id, 
...
bool StoreSalesManager::deleteCatalogSaleSync(char * accessToken,
	int id, 
...
bool StoreSalesManager::getCatalogSaleAsync(char * accessToken,
	int id, 
	void(* handler)(CatalogSale, Error, void* )
	, void* userData)
{
...
bool StoreSalesManager::getCatalogSaleSync(char * accessToken,
	int id, 
	void(* handler)(CatalogSale, Error, void* )
	, void* userData)
{
...
bool StoreSalesManager::getCatalogSalesAsync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«CatalogSale», Error, void* )
	, void* userData)
{
...
bool StoreSalesManager::getCatalogSalesSync(char * accessToken,
	int size, int page, std::string order, 
	void(* handler)(PageResource«CatalogSale», Error, void* )
	, void* userData)
{
...
bool StoreSalesManager::updateCatalogSaleAsync(char * accessToken,
	int id, CatalogSale catalogSale, 
	void(* handler)(CatalogSale, Error, void* )
	, void* userData)
{
...
bool StoreSalesManager::updateCatalogSaleSync(char * accessToken,
	int id, CatalogSale catalogSale, 
	void(* handler)(CatalogSale, Error, void* )
	, void* userData)
{
