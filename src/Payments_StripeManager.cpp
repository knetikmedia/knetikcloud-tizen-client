...
#include "Payments_StripeManager.h"
#include "NetClient.h"
#include "Helpers.h"
#include "Error.h"
...
Payments_StripeManager::Payments_StripeManager()
{
...
static gboolean __Payments_StripeManagerresponseHandler(gpointer data)
{
...
static gpointer __Payments_StripeManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__Payments_StripeManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(Payments_StripeManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (Payments_StripeManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), createStripePaymentMethodProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __Payments_StripeManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool Payments_StripeManager::createStripePaymentMethodAsync(char * accessToken,
	StripeCreatePaymentMethod request, 
	void(* handler)(PaymentMethodResource, Error, void* )
	, void* userData)
{
...
bool Payments_StripeManager::createStripePaymentMethodSync(char * accessToken,
	StripeCreatePaymentMethod request, 
	void(* handler)(PaymentMethodResource, Error, void* )
	, void* userData)
{
...
bool Payments_StripeManager::payStripeInvoiceAsync(char * accessToken,
	StripePaymentRequest request, 
...
bool Payments_StripeManager::payStripeInvoiceSync(char * accessToken,
	StripePaymentRequest request, 
