...
void
PageResource«BreEventLog»::__init()
{
	//
...
void
PageResource«BreEventLog»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«BreEventLog»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<BreEventLog> new_list;
			BreEventLog inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("BreEventLog")) {
					jsonToValue(&inst, temp_json, "BreEventLog", "");
				} else {
...
PageResource«BreEventLog»::PageResource«BreEventLog»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«BreEventLog»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("BreEventLog")) {
		list<BreEventLog> new_list = static_cast<list <BreEventLog> > (getContent());
		node = converttoJson(&new_list, "BreEventLog", "array");
	} else {
		...
		for (list<BreEventLog>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			BreEventLog obj = *it;
...
std::list<BreEventLog>
PageResource«BreEventLog»::getContent()
{
	return content;
}

void
PageResource«BreEventLog»::setContent(std::list <BreEventLog> content)
{
	this->content = content;
}

bool
PageResource«BreEventLog»::getFirst()
{
	return first;
}

void
PageResource«BreEventLog»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«BreEventLog»::getLast()
{
	return last;
}

void
PageResource«BreEventLog»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«BreEventLog»::getNumber()
{
	return number;
}

void
PageResource«BreEventLog»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«BreEventLog»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«BreEventLog»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«BreEventLog»::getSize()
{
	return size;
}

void
PageResource«BreEventLog»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«BreEventLog»::getSort()
{
	return sort;
}

void
PageResource«BreEventLog»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«BreEventLog»::getTotalElements()
{
	return total_elements;
}

void
PageResource«BreEventLog»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«BreEventLog»::getTotalPages()
{
	return total_pages;
}

void
PageResource«BreEventLog»::setTotalPages(int  total_pages)
{
