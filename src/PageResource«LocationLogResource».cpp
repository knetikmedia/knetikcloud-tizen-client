...
void
PageResource«LocationLogResource»::__init()
{
	//
...
void
PageResource«LocationLogResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«LocationLogResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<LocationLogResource> new_list;
			LocationLogResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("LocationLogResource")) {
					jsonToValue(&inst, temp_json, "LocationLogResource", "");
				} else {
...
PageResource«LocationLogResource»::PageResource«LocationLogResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«LocationLogResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("LocationLogResource")) {
		list<LocationLogResource> new_list = static_cast<list <LocationLogResource> > (getContent());
		node = converttoJson(&new_list, "LocationLogResource", "array");
	} else {
		...
		for (list<LocationLogResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			LocationLogResource obj = *it;
...
std::list<LocationLogResource>
PageResource«LocationLogResource»::getContent()
{
	return content;
}

void
PageResource«LocationLogResource»::setContent(std::list <LocationLogResource> content)
{
	this->content = content;
}

bool
PageResource«LocationLogResource»::getFirst()
{
	return first;
}

void
PageResource«LocationLogResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«LocationLogResource»::getLast()
{
	return last;
}

void
PageResource«LocationLogResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«LocationLogResource»::getNumber()
{
	return number;
}

void
PageResource«LocationLogResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«LocationLogResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«LocationLogResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«LocationLogResource»::getSize()
{
	return size;
}

void
PageResource«LocationLogResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«LocationLogResource»::getSort()
{
	return sort;
}

void
PageResource«LocationLogResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«LocationLogResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«LocationLogResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«LocationLogResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«LocationLogResource»::setTotalPages(int  total_pages)
{
