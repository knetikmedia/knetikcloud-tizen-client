...
void
PageResource«QuestionTemplateResource»::__init()
{
	//
...
void
PageResource«QuestionTemplateResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«QuestionTemplateResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<QuestionTemplateResource> new_list;
			QuestionTemplateResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("QuestionTemplateResource")) {
					jsonToValue(&inst, temp_json, "QuestionTemplateResource", "");
				} else {
...
PageResource«QuestionTemplateResource»::PageResource«QuestionTemplateResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«QuestionTemplateResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("QuestionTemplateResource")) {
		list<QuestionTemplateResource> new_list = static_cast<list <QuestionTemplateResource> > (getContent());
		node = converttoJson(&new_list, "QuestionTemplateResource", "array");
	} else {
		...
		for (list<QuestionTemplateResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			QuestionTemplateResource obj = *it;
...
std::list<QuestionTemplateResource>
PageResource«QuestionTemplateResource»::getContent()
{
	return content;
}

void
PageResource«QuestionTemplateResource»::setContent(std::list <QuestionTemplateResource> content)
{
	this->content = content;
}

bool
PageResource«QuestionTemplateResource»::getFirst()
{
	return first;
}

void
PageResource«QuestionTemplateResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«QuestionTemplateResource»::getLast()
{
	return last;
}

void
PageResource«QuestionTemplateResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«QuestionTemplateResource»::getNumber()
{
	return number;
}

void
PageResource«QuestionTemplateResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«QuestionTemplateResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«QuestionTemplateResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«QuestionTemplateResource»::getSize()
{
	return size;
}

void
PageResource«QuestionTemplateResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«QuestionTemplateResource»::getSort()
{
	return sort;
}

void
PageResource«QuestionTemplateResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«QuestionTemplateResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«QuestionTemplateResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«QuestionTemplateResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«QuestionTemplateResource»::setTotalPages(int  total_pages)
{
