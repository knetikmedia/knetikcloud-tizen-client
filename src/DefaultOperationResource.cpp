...
void
DefaultOperationResource::__init()
{
	//
...
void
DefaultOperationResource::__cleanup()
{
	//if(args != NULL) {
	//args.RemoveAll(true);
	//delete args;
...
void
DefaultOperationResource::fromJson(char* jsonStr)
{
...
DefaultOperationResource::DefaultOperationResource(char* json)
{
	this->fromJson(json);
}

char*
DefaultOperationResource::toJson()
{
...
DefaultOperationResource::getArgs()
{
	return args;
}

void
DefaultOperationResource::setArgs(std::list <ExpressionResource> args)
{
	this->args = args;
}

std::string
DefaultOperationResource::getDefinition()
{
	return definition;
}

void
DefaultOperationResource::setDefinition(std::string  definition)
{
	this->definition = definition;
}

std::string
DefaultOperationResource::getOp()
{
	return op;
}

void
DefaultOperationResource::setOp(std::string  op)
{
	this->op = op;
}

std::string
DefaultOperationResource::getReturnType()
{
	return return_type;
}

void
DefaultOperationResource::setReturnType(std::string  return_type)
{
	this->return_type = return_type;
}

std::list<OperationDefinitionResource>
DefaultOperationResource::getSupportedOperators()
{
	return supported_operators;
}

void
DefaultOperationResource::setSupportedOperators(std::list <OperationDefinitionResource> supported_operators)
{
	this->supported_operators = supported_operators;
}

std::string
DefaultOperationResource::getType()
{
	return type;
}

void
DefaultOperationResource::setType(std::string  type)
{
	this->type = type;
}
