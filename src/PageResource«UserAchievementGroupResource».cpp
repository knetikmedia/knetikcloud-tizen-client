...
void
PageResource«UserAchievementGroupResource»::__init()
{
	//
...
void
PageResource«UserAchievementGroupResource»::__cleanup()
{
	//if(content != NULL) {
...
void
PageResource«UserAchievementGroupResource»::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
	
		{
			...
			JsonNode*  temp_json;
			list<UserAchievementGroupResource> new_list;
			UserAchievementGroupResource inst;
			for (guint i=0;i<json_array_get_length(arr);i++) {
				temp_json = json_array_get_element(arr,i);
				if (isprimitive("UserAchievementGroupResource")) {
					jsonToValue(&inst, temp_json, "UserAchievementGroupResource", "");
				} else {
...
PageResource«UserAchievementGroupResource»::PageResource«UserAchievementGroupResource»(char* json)
{
	this->fromJson(json);
}

char*
PageResource«UserAchievementGroupResource»::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("UserAchievementGroupResource")) {
		list<UserAchievementGroupResource> new_list = static_cast<list <UserAchievementGroupResource> > (getContent());
		node = converttoJson(&new_list, "UserAchievementGroupResource", "array");
	} else {
		...
		for (list<UserAchievementGroupResource>::iterator it = new_list.begin(); it != new_list.end(); it++) {
			mygerror = NULL;
			UserAchievementGroupResource obj = *it;
...
std::list<UserAchievementGroupResource>
PageResource«UserAchievementGroupResource»::getContent()
{
	return content;
}

void
PageResource«UserAchievementGroupResource»::setContent(std::list <UserAchievementGroupResource> content)
{
	this->content = content;
}

bool
PageResource«UserAchievementGroupResource»::getFirst()
{
	return first;
}

void
PageResource«UserAchievementGroupResource»::setFirst(bool  first)
{
	this->first = first;
}

bool
PageResource«UserAchievementGroupResource»::getLast()
{
	return last;
}

void
PageResource«UserAchievementGroupResource»::setLast(bool  last)
{
	this->last = last;
}

int
PageResource«UserAchievementGroupResource»::getNumber()
{
	return number;
}

void
PageResource«UserAchievementGroupResource»::setNumber(int  number)
{
	this->number = number;
}

int
PageResource«UserAchievementGroupResource»::getNumberOfElements()
{
	return number_of_elements;
}

void
PageResource«UserAchievementGroupResource»::setNumberOfElements(int  number_of_elements)
{
	this->number_of_elements = number_of_elements;
}

int
PageResource«UserAchievementGroupResource»::getSize()
{
	return size;
}

void
PageResource«UserAchievementGroupResource»::setSize(int  size)
{
	this->size = size;
}

std::list<Order>
PageResource«UserAchievementGroupResource»::getSort()
{
	return sort;
}

void
PageResource«UserAchievementGroupResource»::setSort(std::list <Order> sort)
{
	this->sort = sort;
}

long long
PageResource«UserAchievementGroupResource»::getTotalElements()
{
	return total_elements;
}

void
PageResource«UserAchievementGroupResource»::setTotalElements(long long  total_elements)
{
	this->total_elements = total_elements;
}

int
PageResource«UserAchievementGroupResource»::getTotalPages()
{
	return total_pages;
}

void
PageResource«UserAchievementGroupResource»::setTotalPages(int  total_pages)
{
