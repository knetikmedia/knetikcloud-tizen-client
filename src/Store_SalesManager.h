#ifndef _Store_SalesManager_H_
#define _Store_SalesManager_H_
...
/** \addtogroup Store_Sales Store_Sales
 * \ingroup Operations
 *  @{
 */
class Store_SalesManager {
public:
	Store_SalesManager();
	virtual ~Store_SalesManager();
