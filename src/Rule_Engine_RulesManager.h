#ifndef _Rule_Engine_RulesManager_H_
#define _Rule_Engine_RulesManager_H_
...
/** \addtogroup Rule_Engine_Rules Rule_Engine_Rules
 * \ingroup Operations
 *  @{
 */
class Rule_Engine_RulesManager {
public:
	Rule_Engine_RulesManager();
	virtual ~Rule_Engine_RulesManager();
...
#endif /* Rule_Engine_RulesManager_H_ */
