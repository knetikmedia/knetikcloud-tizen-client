/*
 * SamiPage«CountryTaxResource».h
 * 
 * 
 */

#ifndef SamiPage«CountryTaxResource»_H_
#define SamiPage«CountryTaxResource»_H_
...
class SamiPage«CountryTaxResource»: public SamiObject {
public:
    SamiPage«CountryTaxResource»();
    SamiPage«CountryTaxResource»(String* json);
    virtual ~SamiPage«CountryTaxResource»();
    ...
    SamiPage«CountryTaxResource»* fromJson(String* obj);
...
#endif /* SamiPage«CountryTaxResource»_H_ */
