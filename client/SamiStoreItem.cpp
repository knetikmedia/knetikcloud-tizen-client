...
SamiStoreItem*
SamiStoreItem::fromJson(String* json) {
    this->cleanup();
...
void
SamiStoreItem::fromJsonObject(IJsonValue* pJson) {
...
SamiStoreItem::SamiStoreItem(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
HashMap*
SamiStoreItem::getPAdditionalProperties() {
    return pAdditional_properties;
}
void
SamiStoreItem::setPAdditionalProperties(HashMap* pAdditional_properties) {
    this->pAdditional_properties = pAdditional_properties;
}

IList*
SamiStoreItem::getPBehaviors() {
    return pBehaviors;
}
void
SamiStoreItem::setPBehaviors(IList* pBehaviors) {
    this->pBehaviors = pBehaviors;
}

String*
SamiStoreItem::getPCategory() {
    return pCategory;
}
void
SamiStoreItem::setPCategory(String* pCategory) {
    this->pCategory = pCategory;
}

Long*
SamiStoreItem::getPCreatedDate() {
    return pCreated_date;
}
void
SamiStoreItem::setPCreatedDate(Long* pCreated_date) {
    this->pCreated_date = pCreated_date;
}

Integer*
SamiStoreItem::getPId() {
    return pId;
}
void
SamiStoreItem::setPId(Integer* pId) {
    this->pId = pId;
}

String*
SamiStoreItem::getPLongDescription() {
    return pLong_description;
}
void
SamiStoreItem::setPLongDescription(String* pLong_description) {
    this->pLong_description = pLong_description;
}

String*
SamiStoreItem::getPName() {
    return pName;
}
void
SamiStoreItem::setPName(String* pName) {
    this->pName = pName;
}

String*
SamiStoreItem::getPShortDescription() {
    return pShort_description;
}
void
SamiStoreItem::setPShortDescription(String* pShort_description) {
    this->pShort_description = pShort_description;
}

Integer*
SamiStoreItem::getPSort() {
    return pSort;
}
void
SamiStoreItem::setPSort(Integer* pSort) {
    this->pSort = pSort;
}

IList*
SamiStoreItem::getPTags() {
    return pTags;
}
void
SamiStoreItem::setPTags(IList* pTags) {
    this->pTags = pTags;
}

String*
SamiStoreItem::getPTemplate() {
    return pTemplate;
}
void
SamiStoreItem::setPTemplate(String* pTemplate) {
    this->pTemplate = pTemplate;
}

String*
SamiStoreItem::getPTypeHint() {
    return pType_hint;
}
void
SamiStoreItem::setPTypeHint(String* pType_hint) {
    this->pType_hint = pType_hint;
}

String*
SamiStoreItem::getPUniqueKey() {
    return pUnique_key;
}
void
SamiStoreItem::setPUniqueKey(String* pUnique_key) {
    this->pUnique_key = pUnique_key;
}

Long*
SamiStoreItem::getPUpdatedDate() {
    return pUpdated_date;
}
void
SamiStoreItem::setPUpdatedDate(Long* pUpdated_date) {
    this->pUpdated_date = pUpdated_date;
}

Boolean*
SamiStoreItem::getPDisplayable() {
    return pDisplayable;
}
void
SamiStoreItem::setPDisplayable(Boolean* pDisplayable) {
    this->pDisplayable = pDisplayable;
}

IList*
SamiStoreItem::getPGeoCountryList() {
    return pGeo_country_list;
}
void
SamiStoreItem::setPGeoCountryList(IList* pGeo_country_list) {
    this->pGeo_country_list = pGeo_country_list;
}

String*
SamiStoreItem::getPGeoPolicyType() {
    return pGeo_policy_type;
}
void
SamiStoreItem::setPGeoPolicyType(String* pGeo_policy_type) {
    this->pGeo_policy_type = pGeo_policy_type;
}

Integer*
SamiStoreItem::getPShippingTier() {
    return pShipping_tier;
}
void
SamiStoreItem::setPShippingTier(Integer* pShipping_tier) {
    this->pShipping_tier = pShipping_tier;
}

IList*
SamiStoreItem::getPSkus() {
    return pSkus;
}
void
SamiStoreItem::setPSkus(IList* pSkus) {
    this->pSkus = pSkus;
}

Long*
SamiStoreItem::getPStoreEnd() {
    return pStore_end;
}
void
SamiStoreItem::setPStoreEnd(Long* pStore_end) {
    this->pStore_end = pStore_end;
}

Long*
SamiStoreItem::getPStoreStart() {
    return pStore_start;
}
void
SamiStoreItem::setPStoreStart(Long* pStore_start) {
    this->pStore_start = pStore_start;
}

Integer*
SamiStoreItem::getPVendorId() {
    return pVendor_id;
}
void
SamiStoreItem::setPVendorId(Integer* pVendor_id) {
