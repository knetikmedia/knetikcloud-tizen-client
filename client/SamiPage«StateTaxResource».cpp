...
SamiPage«StateTaxResource»::SamiPage«StateTaxResource»() {
    init();
}
...
void
SamiPage«StateTaxResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«StateTaxResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«StateTaxResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«StateTaxResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«StateTaxResource»::SamiPage«StateTaxResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«StateTaxResource»::asJson ()
{
...
JsonObject*
SamiPage«StateTaxResource»::asJsonObject() {
...
IList*
SamiPage«StateTaxResource»::getPContent() {
    return pContent;
}
void
SamiPage«StateTaxResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«StateTaxResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«StateTaxResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«StateTaxResource»::getPLast() {
    return pLast;
}
void
SamiPage«StateTaxResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«StateTaxResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«StateTaxResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«StateTaxResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«StateTaxResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«StateTaxResource»::getPSize() {
    return pSize;
}
void
SamiPage«StateTaxResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«StateTaxResource»::getPSort() {
    return pSort;
}
void
SamiPage«StateTaxResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«StateTaxResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«StateTaxResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«StateTaxResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«StateTaxResource»::setPTotalPages(Integer* pTotal_pages) {
