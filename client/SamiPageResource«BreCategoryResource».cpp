...
SamiPageResource«BreCategoryResource»::SamiPageResource«BreCategoryResource»() {
    init();
}
...
void
SamiPageResource«BreCategoryResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«BreCategoryResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«BreCategoryResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«BreCategoryResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiBreCategoryResource");
        }
        delete pContentKey;
...
SamiPageResource«BreCategoryResource»::SamiPageResource«BreCategoryResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«BreCategoryResource»::asJson ()
{
...
JsonObject*
SamiPageResource«BreCategoryResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiBreCategoryResource", "array"));
...
IList*
SamiPageResource«BreCategoryResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«BreCategoryResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«BreCategoryResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«BreCategoryResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«BreCategoryResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«BreCategoryResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«BreCategoryResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«BreCategoryResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«BreCategoryResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«BreCategoryResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«BreCategoryResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«BreCategoryResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«BreCategoryResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«BreCategoryResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«BreCategoryResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«BreCategoryResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«BreCategoryResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«BreCategoryResource»::setPTotalPages(Integer* pTotal_pages) {
