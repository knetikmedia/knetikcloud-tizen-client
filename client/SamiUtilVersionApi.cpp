...
void
getVersionProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
...
SamiVersion* 
SamiUtilVersionApi::getVersionWithCompletion( void (* success)(SamiVersion*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&getVersionProcessor, (void(*)(void*, SamiError*))success);
