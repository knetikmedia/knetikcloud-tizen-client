...
public:
  ...
  getFriendsWithCompletion(String* userId, Integer* size, Integer* page, void (* handler)(SamiPageResource«SimpleUserResource»*, SamiError*));
  String* 
  getInviteTokenWithCompletion(String* userId, void (* handler)(String*, SamiError*));
  SamiPageResource«SimpleUserResource»* 
  getInvitesWithCompletion(String* userId, Integer* size, Integer* page, void (* handler)(SamiPageResource«SimpleUserResource»*, SamiError*));
  void 
