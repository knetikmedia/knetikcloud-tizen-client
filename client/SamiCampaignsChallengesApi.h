...
public:
  ...
  getChallengeEventssUsingGETWithCompletion(String* filterStartDate, String* filterEndDate, Boolean* filterCampaigns, Long* filterChallenge, Integer* size, Integer* page, String* order, void (* handler)(SamiPage«ChallengeEventResource»*, SamiError*));
  SamiTemplateResource* 
