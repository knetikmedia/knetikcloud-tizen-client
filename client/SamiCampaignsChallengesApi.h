...
public:
  ...
  void 
  updateChallengeActivityWithCompletion(Long* activityId, Long* challengeId, SamiChallengeActivityResource* challengeActivityResource, void(* handler)(SamiError*));
  void 
  updateChallengeTemplateWithCompletion(String* _id, SamiTemplateResource* challengeTemplateResource, void(* handler)(SamiError*));
