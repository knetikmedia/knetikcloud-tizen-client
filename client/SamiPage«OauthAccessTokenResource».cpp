...
SamiPage«OauthAccessTokenResource»::SamiPage«OauthAccessTokenResource»() {
    init();
}
...
void
SamiPage«OauthAccessTokenResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«OauthAccessTokenResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«OauthAccessTokenResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«OauthAccessTokenResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«OauthAccessTokenResource»::SamiPage«OauthAccessTokenResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«OauthAccessTokenResource»::asJson ()
{
...
JsonObject*
SamiPage«OauthAccessTokenResource»::asJsonObject() {
...
IList*
SamiPage«OauthAccessTokenResource»::getPContent() {
    return pContent;
}
void
SamiPage«OauthAccessTokenResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«OauthAccessTokenResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«OauthAccessTokenResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«OauthAccessTokenResource»::getPLast() {
    return pLast;
}
void
SamiPage«OauthAccessTokenResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«OauthAccessTokenResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«OauthAccessTokenResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«OauthAccessTokenResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«OauthAccessTokenResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«OauthAccessTokenResource»::getPSize() {
    return pSize;
}
void
SamiPage«OauthAccessTokenResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«OauthAccessTokenResource»::getPSort() {
    return pSort;
}
void
SamiPage«OauthAccessTokenResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«OauthAccessTokenResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«OauthAccessTokenResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«OauthAccessTokenResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«OauthAccessTokenResource»::setPTotalPages(Integer* pTotal_pages) {
