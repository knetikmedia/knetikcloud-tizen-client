...
SamiPageResource«Config»::SamiPageResource«Config»() {
    init();
}
...
void
SamiPageResource«Config»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«Config»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«Config»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiConfig");
        }
        delete pContentKey;
...
SamiPageResource«Config»::SamiPageResource«Config»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«Config»::asJson ()
{
...
JsonObject*
SamiPageResource«Config»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiConfig", "array"));
...
IList*
SamiPageResource«Config»::getPContent() {
    return pContent;
}
void
SamiPageResource«Config»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«Config»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«Config»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«Config»::getPLast() {
    return pLast;
}
void
SamiPageResource«Config»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«Config»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«Config»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«Config»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«Config»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«Config»::getPSize() {
    return pSize;
}
void
SamiPageResource«Config»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«Config»::getPSort() {
    return pSort;
}
void
SamiPageResource«Config»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«Config»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«Config»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«Config»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«Config»::setPTotalPages(Integer* pTotal_pages) {
