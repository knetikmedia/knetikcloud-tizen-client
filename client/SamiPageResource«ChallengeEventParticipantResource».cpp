...
SamiPageResource«ChallengeEventParticipantResource»::SamiPageResource«ChallengeEventParticipantResource»() {
    init();
}
...
void
SamiPageResource«ChallengeEventParticipantResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«ChallengeEventParticipantResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«ChallengeEventParticipantResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«ChallengeEventParticipantResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiChallengeEventParticipantResource");
        }
        delete pContentKey;
...
SamiPageResource«ChallengeEventParticipantResource»::SamiPageResource«ChallengeEventParticipantResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«ChallengeEventParticipantResource»::asJson ()
{
...
JsonObject*
SamiPageResource«ChallengeEventParticipantResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiChallengeEventParticipantResource", "array"));
...
IList*
SamiPageResource«ChallengeEventParticipantResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«ChallengeEventParticipantResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«ChallengeEventParticipantResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«ChallengeEventParticipantResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«ChallengeEventParticipantResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«ChallengeEventParticipantResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«ChallengeEventParticipantResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«ChallengeEventParticipantResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«ChallengeEventParticipantResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«ChallengeEventParticipantResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«ChallengeEventParticipantResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«ChallengeEventParticipantResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«ChallengeEventParticipantResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«ChallengeEventParticipantResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«ChallengeEventParticipantResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«ChallengeEventParticipantResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«ChallengeEventParticipantResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«ChallengeEventParticipantResource»::setPTotalPages(Integer* pTotal_pages) {
