...
SamiPage«WalletTransactionResource»::SamiPage«WalletTransactionResource»() {
    init();
}
...
void
SamiPage«WalletTransactionResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«WalletTransactionResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«WalletTransactionResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«WalletTransactionResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«WalletTransactionResource»::SamiPage«WalletTransactionResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«WalletTransactionResource»::asJson ()
{
...
JsonObject*
SamiPage«WalletTransactionResource»::asJsonObject() {
...
IList*
SamiPage«WalletTransactionResource»::getPContent() {
    return pContent;
}
void
SamiPage«WalletTransactionResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«WalletTransactionResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«WalletTransactionResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«WalletTransactionResource»::getPLast() {
    return pLast;
}
void
SamiPage«WalletTransactionResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«WalletTransactionResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«WalletTransactionResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«WalletTransactionResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«WalletTransactionResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«WalletTransactionResource»::getPSize() {
    return pSize;
}
void
SamiPage«WalletTransactionResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«WalletTransactionResource»::getPSort() {
    return pSort;
}
void
SamiPage«WalletTransactionResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«WalletTransactionResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«WalletTransactionResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«WalletTransactionResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«WalletTransactionResource»::setPTotalPages(Integer* pTotal_pages) {
