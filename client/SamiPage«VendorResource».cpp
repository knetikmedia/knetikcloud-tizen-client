...
SamiPage«VendorResource»::SamiPage«VendorResource»() {
    init();
}
...
void
SamiPage«VendorResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«VendorResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«VendorResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«VendorResource»::SamiPage«VendorResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«VendorResource»::asJson ()
{
...
JsonObject*
SamiPage«VendorResource»::asJsonObject() {
...
IList*
SamiPage«VendorResource»::getPContent() {
    return pContent;
}
void
SamiPage«VendorResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«VendorResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«VendorResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«VendorResource»::getPLast() {
    return pLast;
}
void
SamiPage«VendorResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«VendorResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«VendorResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«VendorResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«VendorResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«VendorResource»::getPSize() {
    return pSize;
}
void
SamiPage«VendorResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«VendorResource»::getPSort() {
    return pSort;
}
void
SamiPage«VendorResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«VendorResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«VendorResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«VendorResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«VendorResource»::setPTotalPages(Integer* pTotal_pages) {
