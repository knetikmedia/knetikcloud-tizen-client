...
SamiPage«ForwardLog»::SamiPage«ForwardLog»() {
    init();
}
...
SamiPage«ForwardLog»*
SamiPage«ForwardLog»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«ForwardLog»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«ForwardLog»::SamiPage«ForwardLog»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
JsonObject*
SamiPage«ForwardLog»::asJsonObject() {
...
IList*
SamiPage«ForwardLog»::getPContent() {
    return pContent;
}
void
SamiPage«ForwardLog»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«ForwardLog»::getPFirst() {
    return pFirst;
}
void
SamiPage«ForwardLog»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«ForwardLog»::getPLast() {
    return pLast;
}
void
SamiPage«ForwardLog»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«ForwardLog»::getPNumber() {
    return pNumber;
}
void
SamiPage«ForwardLog»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«ForwardLog»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«ForwardLog»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«ForwardLog»::getPSize() {
    return pSize;
}
void
SamiPage«ForwardLog»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«ForwardLog»::getPSort() {
    return pSort;
}
void
SamiPage«ForwardLog»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«ForwardLog»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«ForwardLog»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«ForwardLog»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«ForwardLog»::setPTotalPages(Integer* pTotal_pages) {
