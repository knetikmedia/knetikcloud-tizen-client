/*
 * SamiPage«BreTriggerResource».h
 * 
 * 
 */

#ifndef SamiPage«BreTriggerResource»_H_
#define SamiPage«BreTriggerResource»_H_
...
class SamiPage«BreTriggerResource»: public SamiObject {
public:
    SamiPage«BreTriggerResource»();
    SamiPage«BreTriggerResource»(String* json);
    virtual ~SamiPage«BreTriggerResource»();
    ...
    SamiPage«BreTriggerResource»* fromJson(String* obj);
...
#endif /* SamiPage«BreTriggerResource»_H_ */
