...
public:
  ...
  SamiSubscriptionTemplateResource* 
  updateSubscriptionTemplateWithCompletion(String* _id, SamiSubscriptionTemplateResource* subscriptionTemplateResource, void (* handler)(SamiSubscriptionTemplateResource*, SamiError*));
