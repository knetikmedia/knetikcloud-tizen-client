/*
 * SamiPage«BreEventLog».h
 * 
 * 
 */

#ifndef SamiPage«BreEventLog»_H_
#define SamiPage«BreEventLog»_H_
...
class SamiPage«BreEventLog»: public SamiObject {
public:
    SamiPage«BreEventLog»();
    SamiPage«BreEventLog»(String* json);
    virtual ~SamiPage«BreEventLog»();
    ...
    SamiPage«BreEventLog»* fromJson(String* obj);
...
#endif /* SamiPage«BreEventLog»_H_ */
