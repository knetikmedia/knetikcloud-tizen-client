...
public:
  ...
  void 
  setUserSubscriptionPriceWithCompletion(Integer* userId, Integer* inventoryId, SamiSubscriptionPriceOverrideRequest* the override details, void(* handler)(SamiError*));
