...
SamiPageResource«UserActionLog»::SamiPageResource«UserActionLog»() {
    init();
}
...
void
SamiPageResource«UserActionLog»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«UserActionLog»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«UserActionLog»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«UserActionLog»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiUserActionLog");
        }
        delete pContentKey;
...
SamiPageResource«UserActionLog»::SamiPageResource«UserActionLog»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«UserActionLog»::asJson ()
{
...
JsonObject*
SamiPageResource«UserActionLog»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiUserActionLog", "array"));
...
IList*
SamiPageResource«UserActionLog»::getPContent() {
    return pContent;
}
void
SamiPageResource«UserActionLog»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«UserActionLog»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«UserActionLog»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«UserActionLog»::getPLast() {
    return pLast;
}
void
SamiPageResource«UserActionLog»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«UserActionLog»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«UserActionLog»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«UserActionLog»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«UserActionLog»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«UserActionLog»::getPSize() {
    return pSize;
}
void
SamiPageResource«UserActionLog»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«UserActionLog»::getPSort() {
    return pSort;
}
void
SamiPageResource«UserActionLog»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«UserActionLog»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«UserActionLog»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«UserActionLog»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«UserActionLog»::setPTotalPages(Integer* pTotal_pages) {
