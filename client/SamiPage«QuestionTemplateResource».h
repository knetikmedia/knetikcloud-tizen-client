/*
 * SamiPage«QuestionTemplateResource».h
 * 
 * 
 */

#ifndef SamiPage«QuestionTemplateResource»_H_
#define SamiPage«QuestionTemplateResource»_H_
...
class SamiPage«QuestionTemplateResource»: public SamiObject {
public:
    SamiPage«QuestionTemplateResource»();
    SamiPage«QuestionTemplateResource»(String* json);
    virtual ~SamiPage«QuestionTemplateResource»();
    ...
    SamiPage«QuestionTemplateResource»* fromJson(String* obj);
...
#endif /* SamiPage«QuestionTemplateResource»_H_ */
