...
SamiPage«UsageInfo»::SamiPage«UsageInfo»() {
    init();
}
...
SamiPage«UsageInfo»*
SamiPage«UsageInfo»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«UsageInfo»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«UsageInfo»::SamiPage«UsageInfo»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
JsonObject*
SamiPage«UsageInfo»::asJsonObject() {
...
IList*
SamiPage«UsageInfo»::getPContent() {
    return pContent;
}
void
SamiPage«UsageInfo»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«UsageInfo»::getPFirst() {
    return pFirst;
}
void
SamiPage«UsageInfo»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«UsageInfo»::getPLast() {
    return pLast;
}
void
SamiPage«UsageInfo»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«UsageInfo»::getPNumber() {
    return pNumber;
}
void
SamiPage«UsageInfo»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«UsageInfo»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«UsageInfo»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«UsageInfo»::getPSize() {
    return pSize;
}
void
SamiPage«UsageInfo»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«UsageInfo»::getPSort() {
    return pSort;
}
void
SamiPage«UsageInfo»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«UsageInfo»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«UsageInfo»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«UsageInfo»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«UsageInfo»::setPTotalPages(Integer* pTotal_pages) {
