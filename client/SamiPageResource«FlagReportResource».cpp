...
SamiPageResource«FlagReportResource»::SamiPageResource«FlagReportResource»() {
    init();
}
...
void
SamiPageResource«FlagReportResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«FlagReportResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«FlagReportResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«FlagReportResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiFlagReportResource");
        }
        delete pContentKey;
...
SamiPageResource«FlagReportResource»::SamiPageResource«FlagReportResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«FlagReportResource»::asJson ()
{
...
JsonObject*
SamiPageResource«FlagReportResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiFlagReportResource", "array"));
...
IList*
SamiPageResource«FlagReportResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«FlagReportResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«FlagReportResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«FlagReportResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«FlagReportResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«FlagReportResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«FlagReportResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«FlagReportResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«FlagReportResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«FlagReportResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«FlagReportResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«FlagReportResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«FlagReportResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«FlagReportResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«FlagReportResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«FlagReportResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«FlagReportResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«FlagReportResource»::setPTotalPages(Integer* pTotal_pages) {
