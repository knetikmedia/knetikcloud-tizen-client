...
SamiUsersGroupsApi::addMemberToGroupWithCompletion(String* uniqueName, SamiGroupMemberResource* user, void (* success)(SamiGroupMemberResource*, SamiError*)) {
...
void
addMembersToGroupProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
  ...
  if(code >= 200 && code < 300) {
    ...
    jsonToValue(out, pJson, L"IList*", L"SamiGroupMemberResource");
...
IList* 
SamiUsersGroupsApi::addMembersToGroupWithCompletion(String* uniqueName, IList* users, void (* success)(IList*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&addMembersToGroupProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
  ...
  if(users != null) {
    mBody = new String("");
    int sz = users->GetCount();
    for(int i = 0; i < sz; i++) {
      SamiObject * obj = (SamiObject*)users->GetAt(i);
  ...
  String url(L"/users/groups/{unique_name}/members/batch-add");
...
SamiUsersGroupsApi::updateGroupsWithCompletion(String* filterTemplate, String* filterMemberCount, String* filterName, String* filterUniqueName, String* filterParent, String* filterStatus, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«GroupResource»*, SamiError*)) {
  client = new SamiApiClient();
  ...
  queryParams->Construct();
    ...
    queryParams->Add(new String("filter_member_count"), filterMemberCount);
