...
void 
SamiUsersGroupsApi::deleteGroupUsingDELETEWithCompletion(String* uniqueName, Integer* userId, void(*success)(SamiError*)) {
  client = new SamiApiClient();
...
void
deleteGroupUsingDELETE1Processor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
void 
SamiUsersGroupsApi::deleteGroupUsingDELETE1WithCompletion(String* uniqueName, void(*success)(SamiError*)) {
  client = new SamiApiClient();

  client->success(&deleteGroupUsingDELETE1Processor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
...
SamiUsersGroupsApi::getGroupTemplatesUsingGETWithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPage«TemplateResource»*, SamiError*)) {
  client = new SamiApiClient();
...
searchGroupsUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiPage«GroupMemberResource»* out = new SamiPage«GroupMemberResource»();
    jsonToValue(out, pJson, L"SamiPage«GroupMemberResource»*", L"SamiPage«GroupMemberResource»");
...
SamiUsersGroupsApi::searchGroupsUsingGETWithCompletion(String* uniqueName, Integer* size, Integer* page, String* order, void (* success)(SamiPage«GroupMemberResource»*, SamiError*)) {
  client = new SamiApiClient();
...
searchGroupsUsingGET1Processor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiPage«GroupResource»* out = new SamiPage«GroupResource»();
    jsonToValue(out, pJson, L"SamiPage«GroupResource»*", L"SamiPage«GroupResource»");
...
SamiUsersGroupsApi::searchGroupsUsingGET1WithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPage«GroupResource»*, SamiError*)) {
  client = new SamiApiClient();
