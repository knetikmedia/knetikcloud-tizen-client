...
void 
SamiUsersGroupsApi::updateGroupTemplateWithCompletion(String* _id, SamiTemplateResource* groupTemplateResource, void(*success)(SamiError*)) {
  client = new SamiApiClient();
...
SamiUsersGroupsApi::updateGroupsWithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«GroupResource»*, SamiError*)) {
  client = new SamiApiClient();
