...
public:
  ...
  addMemberToGroupWithCompletion(String* uniqueName, SamiGroupMemberResource* user, void (* handler)(SamiGroupMemberResource*, SamiError*));
  IList* 
  addMembersToGroupWithCompletion(String* uniqueName, IList* users, void (* handler)(IList*, SamiError*));
  SamiGroupResource* 
  ...
  updateGroupsWithCompletion(String* filterTemplate, String* filterMemberCount, String* filterName, String* filterUniqueName, String* filterParent, String* filterStatus, Integer* size, Integer* page, String* order, void (* handler)(SamiPageResource«GroupResource»*, SamiError*));
