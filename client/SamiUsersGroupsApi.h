...
public:
  ...
  updateGroupsWithCompletion(String* filterName, String* filterUniqueName, String* filterParent, Integer* size, Integer* page, String* order, void (* handler)(SamiPageResource«GroupResource»*, SamiError*));
