...
SamiPageResource«BillingReport»::SamiPageResource«BillingReport»() {
    init();
}
...
void
SamiPageResource«BillingReport»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«BillingReport»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«BillingReport»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«BillingReport»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiBillingReport");
        }
        delete pContentKey;
...
SamiPageResource«BillingReport»::SamiPageResource«BillingReport»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«BillingReport»::asJson ()
{
...
JsonObject*
SamiPageResource«BillingReport»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiBillingReport", "array"));
...
IList*
SamiPageResource«BillingReport»::getPContent() {
    return pContent;
}
void
SamiPageResource«BillingReport»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«BillingReport»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«BillingReport»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«BillingReport»::getPLast() {
    return pLast;
}
void
SamiPageResource«BillingReport»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«BillingReport»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«BillingReport»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«BillingReport»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«BillingReport»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«BillingReport»::getPSize() {
    return pSize;
}
void
SamiPageResource«BillingReport»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«BillingReport»::getPSort() {
    return pSort;
}
void
SamiPageResource«BillingReport»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«BillingReport»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«BillingReport»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«BillingReport»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«BillingReport»::setPTotalPages(Integer* pTotal_pages) {
