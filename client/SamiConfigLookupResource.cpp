...
SamiConfigLookupResource::SamiConfigLookupResource() {
    init();
}
...
void
SamiConfigLookupResource::cleanup() {
    if(pLookup_key != null) {
...
SamiConfigLookupResource::fromJson(String* json) {
    this->cleanup();
...
void
SamiConfigLookupResource::fromJsonObject(IJsonValue* pJson) {
...
SamiConfigLookupResource::SamiConfigLookupResource(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiConfigLookupResource::asJson ()
{
...
JsonObject*
SamiConfigLookupResource::asJsonObject() {
...
SamiConfigLookupResource::getPLookupKey() {
    return pLookup_key;
}
void
SamiConfigLookupResource::setPLookupKey(SamiExpressionResource* pLookup_key) {
    this->pLookup_key = pLookup_key;
}

String*
SamiConfigLookupResource::getPType() {
    return pType;
}
void
SamiConfigLookupResource::setPType(String* pType) {
    this->pType = pType;
}

String*
SamiConfigLookupResource::getPValueType() {
    return pValue_type;
}
void
SamiConfigLookupResource::setPValueType(String* pValue_type) {
