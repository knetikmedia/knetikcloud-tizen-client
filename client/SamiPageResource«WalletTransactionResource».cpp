...
SamiPageResource«WalletTransactionResource»::SamiPageResource«WalletTransactionResource»() {
    init();
}
...
void
SamiPageResource«WalletTransactionResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«WalletTransactionResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«WalletTransactionResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«WalletTransactionResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiWalletTransactionResource");
        }
        delete pContentKey;
...
SamiPageResource«WalletTransactionResource»::SamiPageResource«WalletTransactionResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«WalletTransactionResource»::asJson ()
{
...
JsonObject*
SamiPageResource«WalletTransactionResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiWalletTransactionResource", "array"));
...
IList*
SamiPageResource«WalletTransactionResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«WalletTransactionResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«WalletTransactionResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«WalletTransactionResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«WalletTransactionResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«WalletTransactionResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«WalletTransactionResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«WalletTransactionResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«WalletTransactionResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«WalletTransactionResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«WalletTransactionResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«WalletTransactionResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«WalletTransactionResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«WalletTransactionResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«WalletTransactionResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«WalletTransactionResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«WalletTransactionResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«WalletTransactionResource»::setPTotalPages(Integer* pTotal_pages) {
