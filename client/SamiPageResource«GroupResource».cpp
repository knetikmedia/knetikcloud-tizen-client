...
SamiPageResource«GroupResource»::SamiPageResource«GroupResource»() {
    init();
}
...
void
SamiPageResource«GroupResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«GroupResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«GroupResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«GroupResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiGroupResource");
        }
        delete pContentKey;
...
SamiPageResource«GroupResource»::SamiPageResource«GroupResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«GroupResource»::asJson ()
{
...
JsonObject*
SamiPageResource«GroupResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiGroupResource", "array"));
...
IList*
SamiPageResource«GroupResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«GroupResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«GroupResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«GroupResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«GroupResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«GroupResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«GroupResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«GroupResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«GroupResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«GroupResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«GroupResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«GroupResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«GroupResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«GroupResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«GroupResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«GroupResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«GroupResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«GroupResource»::setPTotalPages(Integer* pTotal_pages) {
