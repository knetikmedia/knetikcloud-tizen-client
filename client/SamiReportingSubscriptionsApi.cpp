...
SamiReportingSubscriptionsApi::listBillingReportsUsingGETWithCompletion(Integer* size, Integer* page, void (* success)(SamiPageResource«BillingReport»*, SamiError*)) {
