...
SamiPage«LocationLogResource»::SamiPage«LocationLogResource»() {
    init();
}
...
void
SamiPage«LocationLogResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«LocationLogResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«LocationLogResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«LocationLogResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«LocationLogResource»::SamiPage«LocationLogResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«LocationLogResource»::asJson ()
{
...
JsonObject*
SamiPage«LocationLogResource»::asJsonObject() {
...
IList*
SamiPage«LocationLogResource»::getPContent() {
    return pContent;
}
void
SamiPage«LocationLogResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«LocationLogResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«LocationLogResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«LocationLogResource»::getPLast() {
    return pLast;
}
void
SamiPage«LocationLogResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«LocationLogResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«LocationLogResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«LocationLogResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«LocationLogResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«LocationLogResource»::getPSize() {
    return pSize;
}
void
SamiPage«LocationLogResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«LocationLogResource»::getPSort() {
    return pSort;
}
void
SamiPage«LocationLogResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«LocationLogResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«LocationLogResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«LocationLogResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«LocationLogResource»::setPTotalPages(Integer* pTotal_pages) {
