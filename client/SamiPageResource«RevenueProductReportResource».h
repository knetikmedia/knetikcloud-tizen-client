/*
 * SamiPageResource«RevenueProductReportResource».h
 * 
 * 
 */

#ifndef SamiPageResource«RevenueProductReportResource»_H_
#define SamiPageResource«RevenueProductReportResource»_H_
...
class SamiPageResource«RevenueProductReportResource»: public SamiObject {
public:
    SamiPageResource«RevenueProductReportResource»();
    SamiPageResource«RevenueProductReportResource»(String* json);
    virtual ~SamiPageResource«RevenueProductReportResource»();
    ...
    SamiPageResource«RevenueProductReportResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«RevenueProductReportResource»_H_ */
