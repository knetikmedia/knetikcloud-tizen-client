/*
 * SamiPage«RevenueProductReportResource».h
 * 
 * 
 */

#ifndef SamiPage«RevenueProductReportResource»_H_
#define SamiPage«RevenueProductReportResource»_H_
...
class SamiPage«RevenueProductReportResource»: public SamiObject {
public:
    SamiPage«RevenueProductReportResource»();
    SamiPage«RevenueProductReportResource»(String* json);
    virtual ~SamiPage«RevenueProductReportResource»();
    ...
    SamiPage«RevenueProductReportResource»* fromJson(String* obj);
...
#endif /* SamiPage«RevenueProductReportResource»_H_ */
