...
SamiPage«FulfillmentType»::SamiPage«FulfillmentType»() {
    init();
}
...
void
SamiPage«FulfillmentType»::cleanup() {
    if(pContent != null) {
...
SamiPage«FulfillmentType»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«FulfillmentType»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«FulfillmentType»::SamiPage«FulfillmentType»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«FulfillmentType»::asJson ()
{
...
JsonObject*
SamiPage«FulfillmentType»::asJsonObject() {
...
IList*
SamiPage«FulfillmentType»::getPContent() {
    return pContent;
}
void
SamiPage«FulfillmentType»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«FulfillmentType»::getPFirst() {
    return pFirst;
}
void
SamiPage«FulfillmentType»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«FulfillmentType»::getPLast() {
    return pLast;
}
void
SamiPage«FulfillmentType»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«FulfillmentType»::getPNumber() {
    return pNumber;
}
void
SamiPage«FulfillmentType»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«FulfillmentType»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«FulfillmentType»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«FulfillmentType»::getPSize() {
    return pSize;
}
void
SamiPage«FulfillmentType»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«FulfillmentType»::getPSort() {
    return pSort;
}
void
SamiPage«FulfillmentType»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«FulfillmentType»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«FulfillmentType»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«FulfillmentType»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«FulfillmentType»::setPTotalPages(Integer* pTotal_pages) {
