/*
 * SamiPage«BreGlobalResource».h
 * 
 * 
 */

#ifndef SamiPage«BreGlobalResource»_H_
#define SamiPage«BreGlobalResource»_H_
...
class SamiPage«BreGlobalResource»: public SamiObject {
public:
    SamiPage«BreGlobalResource»();
    SamiPage«BreGlobalResource»(String* json);
    virtual ~SamiPage«BreGlobalResource»();
    ...
    SamiPage«BreGlobalResource»* fromJson(String* obj);
...
#endif /* SamiPage«BreGlobalResource»_H_ */
