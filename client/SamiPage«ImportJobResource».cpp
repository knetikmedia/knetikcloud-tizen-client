...
SamiPage«ImportJobResource»::SamiPage«ImportJobResource»() {
    init();
}
...
void
SamiPage«ImportJobResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«ImportJobResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«ImportJobResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«ImportJobResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«ImportJobResource»::SamiPage«ImportJobResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«ImportJobResource»::asJson ()
{
...
JsonObject*
SamiPage«ImportJobResource»::asJsonObject() {
...
IList*
SamiPage«ImportJobResource»::getPContent() {
    return pContent;
}
void
SamiPage«ImportJobResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«ImportJobResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«ImportJobResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«ImportJobResource»::getPLast() {
    return pLast;
}
void
SamiPage«ImportJobResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«ImportJobResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«ImportJobResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«ImportJobResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«ImportJobResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«ImportJobResource»::getPSize() {
    return pSize;
}
void
SamiPage«ImportJobResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«ImportJobResource»::getPSort() {
    return pSort;
}
void
SamiPage«ImportJobResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«ImportJobResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«ImportJobResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«ImportJobResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«ImportJobResource»::setPTotalPages(Integer* pTotal_pages) {
