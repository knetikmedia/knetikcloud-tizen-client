...
SamiPageResource«UserItemLogResource»::SamiPageResource«UserItemLogResource»() {
    init();
}
...
void
SamiPageResource«UserItemLogResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«UserItemLogResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«UserItemLogResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«UserItemLogResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiUserItemLogResource");
        }
        delete pContentKey;
...
SamiPageResource«UserItemLogResource»::SamiPageResource«UserItemLogResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«UserItemLogResource»::asJson ()
{
...
JsonObject*
SamiPageResource«UserItemLogResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiUserItemLogResource", "array"));
...
IList*
SamiPageResource«UserItemLogResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«UserItemLogResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«UserItemLogResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«UserItemLogResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«UserItemLogResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«UserItemLogResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«UserItemLogResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«UserItemLogResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«UserItemLogResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«UserItemLogResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«UserItemLogResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«UserItemLogResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«UserItemLogResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«UserItemLogResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«UserItemLogResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«UserItemLogResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«UserItemLogResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«UserItemLogResource»::setPTotalPages(Integer* pTotal_pages) {
