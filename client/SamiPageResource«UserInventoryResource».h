/*
 * SamiPageResource«UserInventoryResource».h
 * 
 * 
 */

#ifndef SamiPageResource«UserInventoryResource»_H_
#define SamiPageResource«UserInventoryResource»_H_
...
class SamiPageResource«UserInventoryResource»: public SamiObject {
public:
    SamiPageResource«UserInventoryResource»();
    SamiPageResource«UserInventoryResource»(String* json);
    virtual ~SamiPageResource«UserInventoryResource»();
    ...
    SamiPageResource«UserInventoryResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«UserInventoryResource»_H_ */
