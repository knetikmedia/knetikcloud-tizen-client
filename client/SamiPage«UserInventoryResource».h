/*
 * SamiPage«UserInventoryResource».h
 * 
 * 
 */

#ifndef SamiPage«UserInventoryResource»_H_
#define SamiPage«UserInventoryResource»_H_
...
class SamiPage«UserInventoryResource»: public SamiObject {
public:
    SamiPage«UserInventoryResource»();
    SamiPage«UserInventoryResource»(String* json);
    virtual ~SamiPage«UserInventoryResource»();
    ...
    SamiPage«UserInventoryResource»* fromJson(String* obj);
...
#endif /* SamiPage«UserInventoryResource»_H_ */
