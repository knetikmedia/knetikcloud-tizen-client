...
SamiPage«CommentResource»::SamiPage«CommentResource»() {
    init();
}
...
void
SamiPage«CommentResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«CommentResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«CommentResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«CommentResource»::SamiPage«CommentResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«CommentResource»::asJson ()
{
...
JsonObject*
SamiPage«CommentResource»::asJsonObject() {
...
IList*
SamiPage«CommentResource»::getPContent() {
    return pContent;
}
void
SamiPage«CommentResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«CommentResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«CommentResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«CommentResource»::getPLast() {
    return pLast;
}
void
SamiPage«CommentResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«CommentResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«CommentResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«CommentResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«CommentResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«CommentResource»::getPSize() {
    return pSize;
}
void
SamiPage«CommentResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«CommentResource»::getPSort() {
    return pSort;
}
void
SamiPage«CommentResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«CommentResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«CommentResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«CommentResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«CommentResource»::setPTotalPages(Integer* pTotal_pages) {
