...
SamiVendorEmailLookupResource::SamiVendorEmailLookupResource() {
    init();
}
...
void
SamiVendorEmailLookupResource::init() {
    pLookup_key = null;
pType = null;
pValue_type = null;
}
...
void
SamiVendorEmailLookupResource::cleanup() {
    if(pLookup_key != null) {
...
SamiVendorEmailLookupResource::fromJson(String* json) {
    this->cleanup();
...
void
SamiVendorEmailLookupResource::fromJsonObject(IJsonValue* pJson) {
...
SamiVendorEmailLookupResource::SamiVendorEmailLookupResource(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiVendorEmailLookupResource::asJson ()
{
...
JsonObject*
SamiVendorEmailLookupResource::asJsonObject() {
...
SamiVendorEmailLookupResource::getPLookupKey() {
    return pLookup_key;
}
void
SamiVendorEmailLookupResource::setPLookupKey(SamiExpressionResource* pLookup_key) {
    this->pLookup_key = pLookup_key;
}

String*
SamiVendorEmailLookupResource::getPType() {
    return pType;
}
void
SamiVendorEmailLookupResource::setPType(String* pType) {
    this->pType = pType;
}

String*
SamiVendorEmailLookupResource::getPValueType() {
    return pValue_type;
}
void
SamiVendorEmailLookupResource::setPValueType(String* pValue_type) {
