/*
 * SamiPageResource«SubscriptionResource».h
 * 
 * 
 */

#ifndef SamiPageResource«SubscriptionResource»_H_
#define SamiPageResource«SubscriptionResource»_H_
...
class SamiPageResource«SubscriptionResource»: public SamiObject {
public:
    SamiPageResource«SubscriptionResource»();
    SamiPageResource«SubscriptionResource»(String* json);
    virtual ~SamiPageResource«SubscriptionResource»();
    ...
    SamiPageResource«SubscriptionResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«SubscriptionResource»_H_ */
