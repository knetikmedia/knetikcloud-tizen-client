...
SamiPage«SubscriptionTemplateResource»::SamiPage«SubscriptionTemplateResource»() {
    init();
}
...
void
SamiPage«SubscriptionTemplateResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«SubscriptionTemplateResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«SubscriptionTemplateResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«SubscriptionTemplateResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«SubscriptionTemplateResource»::SamiPage«SubscriptionTemplateResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«SubscriptionTemplateResource»::asJson ()
{
...
JsonObject*
SamiPage«SubscriptionTemplateResource»::asJsonObject() {
...
IList*
SamiPage«SubscriptionTemplateResource»::getPContent() {
    return pContent;
}
void
SamiPage«SubscriptionTemplateResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«SubscriptionTemplateResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«SubscriptionTemplateResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«SubscriptionTemplateResource»::getPLast() {
    return pLast;
}
void
SamiPage«SubscriptionTemplateResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«SubscriptionTemplateResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«SubscriptionTemplateResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«SubscriptionTemplateResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«SubscriptionTemplateResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«SubscriptionTemplateResource»::getPSize() {
    return pSize;
}
void
SamiPage«SubscriptionTemplateResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«SubscriptionTemplateResource»::getPSort() {
    return pSort;
}
void
SamiPage«SubscriptionTemplateResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«SubscriptionTemplateResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«SubscriptionTemplateResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«SubscriptionTemplateResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«SubscriptionTemplateResource»::setPTotalPages(Integer* pTotal_pages) {
