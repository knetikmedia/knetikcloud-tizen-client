...
SamiPage«VideoRelationshipResource»::SamiPage«VideoRelationshipResource»() {
    init();
}
...
void
SamiPage«VideoRelationshipResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«VideoRelationshipResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«VideoRelationshipResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«VideoRelationshipResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«VideoRelationshipResource»::SamiPage«VideoRelationshipResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«VideoRelationshipResource»::asJson ()
{
...
JsonObject*
SamiPage«VideoRelationshipResource»::asJsonObject() {
...
IList*
SamiPage«VideoRelationshipResource»::getPContent() {
    return pContent;
}
void
SamiPage«VideoRelationshipResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«VideoRelationshipResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«VideoRelationshipResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«VideoRelationshipResource»::getPLast() {
    return pLast;
}
void
SamiPage«VideoRelationshipResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«VideoRelationshipResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«VideoRelationshipResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«VideoRelationshipResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«VideoRelationshipResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«VideoRelationshipResource»::getPSize() {
    return pSize;
}
void
SamiPage«VideoRelationshipResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«VideoRelationshipResource»::getPSort() {
    return pSort;
}
void
SamiPage«VideoRelationshipResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«VideoRelationshipResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«VideoRelationshipResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«VideoRelationshipResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«VideoRelationshipResource»::setPTotalPages(Integer* pTotal_pages) {
