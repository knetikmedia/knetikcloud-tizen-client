...
public:
  ...
  getListUsingGET1WithCompletion(String* filterVendor, String* filterCategory, String* filterName, String* filterStatus, Integer* size, Integer* page, String* order, void (* handler)(SamiPageResource«ImportJobResource»*, SamiError*));
  SamiQuestionTemplateResource* 
  ...
  getQuestionTemplatesUsingGETWithCompletion(Integer* size, Integer* page, String* order, void (* handler)(SamiPageResource«QuestionTemplateResource»*, SamiError*));
  SamiQuestionResource* 
  ...
  getQuestionsUsingGETWithCompletion(Integer* size, Integer* page, String* order, String* filterSearch, String* filterIdset, String* filterCategory, String* filterTagset, String* filterType, Boolean* filterPublished, Long* filterImportId, void (* handler)(SamiPageResource«QuestionResource»*, SamiError*));
  IList* 
