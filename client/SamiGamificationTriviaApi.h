...
public:
  ...
  getQuestionsWithCompletion(Integer* size, Integer* page, String* order, String* filterSearch, String* filterIdset, String* filterCategory, String* filterTagset, String* filterTag, String* filterType, Boolean* filterPublished, Long* filterImportId, void (* handler)(SamiPageResource«QuestionResource»*, SamiError*));
  Long* 
  ...
  searchQuestionTagsWithCompletion(String* filterSearch, String* filterCategory, Long* filterImportId, void (* handler)(SamiCollection«string»*, SamiError*));
  SamiImportJobResource* 
  ...
  SamiQuestionTemplateResource* 
  updateQuestionTemplateWithCompletion(String* _id, SamiQuestionTemplateResource* questionTemplateResource, void (* handler)(SamiQuestionTemplateResource*, SamiError*));
  Integer* 
