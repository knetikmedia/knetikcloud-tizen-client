/*
 * SamiPage«StoreItem».h
 * 
 * 
 */

#ifndef SamiPage«StoreItem»_H_
#define SamiPage«StoreItem»_H_
...
class SamiPage«StoreItem»: public SamiObject {
public:
    SamiPage«StoreItem»();
    SamiPage«StoreItem»(String* json);
    virtual ~SamiPage«StoreItem»();
    ...
    SamiPage«StoreItem»* fromJson(String* obj);
