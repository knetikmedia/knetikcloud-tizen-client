...
SamiGamificationAchievementsApi::getUserAchievementsProgressWithCompletion(Integer* userId, Boolean* filterAchievementDerived, String* filterAchievementTagset, String* filterAchievementName, Boolean* filterAchievementHidden, Integer* size, Integer* page, void (* success)(SamiPageResource«UserAchievementGroupResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiPageResource«UserAchievementGroupResource»* 
SamiGamificationAchievementsApi::getUsersAchievementProgressWithCompletion(String* achievementName, Boolean* filterAchievementDerived, String* filterAchievementTagset, Boolean* filterAchievementHidden, Integer* size, Integer* page, void (* success)(SamiPageResource«UserAchievementGroupResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiPageResource«UserAchievementGroupResource»* 
SamiGamificationAchievementsApi::getUsersAchievementsProgressWithCompletion(Boolean* filterAchievementDerived, String* filterAchievementTagset, String* filterAchievementName, Boolean* filterAchievementHidden, Integer* size, Integer* page, void (* success)(SamiPageResource«UserAchievementGroupResource»*, SamiError*)) {
  client = new SamiApiClient();
...
void 
SamiGamificationAchievementsApi::updateAchievementWithCompletion(String* name, SamiAchievementDefinitionResource* achievement, void(*success)(SamiError*)) {
  client = new SamiApiClient();
...
void 
SamiGamificationAchievementsApi::updateAchievementTemplateWithCompletion(String* _id, SamiTemplateResource* template, void(*success)(SamiError*)) {
  client = new SamiApiClient();
