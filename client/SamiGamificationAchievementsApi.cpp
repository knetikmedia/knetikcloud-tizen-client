...
SamiGamificationAchievementsApi::getAchievementTemplatesUsingGETWithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPage«TemplateResource»*, SamiError*)) {
  client = new SamiApiClient();
...
getAchievementsUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiPage«AchievementDefinitionResource»* out = new SamiPage«AchievementDefinitionResource»();
    jsonToValue(out, pJson, L"SamiPage«AchievementDefinitionResource»*", L"SamiPage«AchievementDefinitionResource»");
...
SamiGamificationAchievementsApi::getAchievementsUsingGETWithCompletion(String* filterTagset, String* filterName, Boolean* filterHidden, Integer* size, Integer* page, String* order, void (* success)(SamiPage«AchievementDefinitionResource»*, SamiError*)) {
  client = new SamiApiClient();
...
getAllUserProgressForAchievementUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiPage«UserAchievementResource»* out = new SamiPage«UserAchievementResource»();
    jsonToValue(out, pJson, L"SamiPage«UserAchievementResource»*", L"SamiPage«UserAchievementResource»");
...
SamiGamificationAchievementsApi::getAllUserProgressForAchievementUsingGETWithCompletion(String* achievementName, String* filterAchievementTagset, Boolean* filterAchievementHidden, Integer* size, Integer* page, void (* success)(SamiPage«UserAchievementResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiPage«UserAchievementResource»* 
SamiGamificationAchievementsApi::getAllUserProgressUsingGETWithCompletion(String* filterAchievementTagset, String* filterAchievementName, Boolean* filterAchievementHidden, Integer* size, Integer* page, void (* success)(SamiPage«UserAchievementResource»*, SamiError*)) {
  client = new SamiApiClient();
...
getUserProgressForAchievementUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiUserAchievementResource* out = new SamiUserAchievementResource();
    jsonToValue(out, pJson, L"SamiUserAchievementResource*", L"SamiUserAchievementResource");
...
SamiGamificationAchievementsApi::getUserProgressForAchievementUsingGETWithCompletion(Integer* userId, String* achievementName, void (* success)(SamiUserAchievementResource*, SamiError*)) {
  client = new SamiApiClient();
...
SamiPage«UserAchievementResource»* 
SamiGamificationAchievementsApi::getUserProgressUsingGETWithCompletion(Integer* userId, String* filterAchievementTagset, String* filterAchievementName, Boolean* filterAchievementHidden, Integer* size, Integer* page, void (* success)(SamiPage«UserAchievementResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiUserAchievementResource* 
SamiGamificationAchievementsApi::updateProgressUsingPUTWithCompletion(Integer* userId, String* achievementName, SamiAchievementProgressUpdateRequest* request, void (* success)(SamiUserAchievementResource*, SamiError*)) {
  client = new SamiApiClient();
