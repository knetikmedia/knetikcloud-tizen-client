...
SamiGamificationAchievementsApi::getAchievementsWithCompletion(String* filterTagset, String* filterName, Boolean* filterHidden, Integer* size, Integer* page, String* order, Boolean* filterDerived, void (* success)(SamiPageResource«AchievementDefinitionResource»*, SamiError*)) {
  client = new SamiApiClient();
...
void
incrementAchievementProgressProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
SamiUserAchievementGroupResource* 
SamiGamificationAchievementsApi::incrementAchievementProgressWithCompletion(Integer* userId, String* achievementName, Integer* progress, void (* success)(SamiUserAchievementGroupResource*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&incrementAchievementProgressProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
  ...
  String url(L"/users/{user_id}/achievements/{achievement_name}/progress");
...
void
setAchievementProgressProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
SamiUserAchievementGroupResource* 
SamiGamificationAchievementsApi::setAchievementProgressWithCompletion(Integer* userId, String* achievementName, Integer* progress, void (* success)(SamiUserAchievementGroupResource*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&setAchievementProgressProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
