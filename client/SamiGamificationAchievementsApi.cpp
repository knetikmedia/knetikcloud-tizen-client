...
SamiGamificationAchievementsApi::getAchievementsUsingGETWithCompletion(String* filterTagset, String* filterName, Boolean* filterHidden, Boolean* filterDerived, Integer* size, Integer* page, String* order, void (* success)(SamiPage«AchievementDefinitionResource»*, SamiError*)) {
  client = new SamiApiClient();
...
getAllUserProgressForAchievementUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiPage«UserAchievementGroupResource»* out = new SamiPage«UserAchievementGroupResource»();
    jsonToValue(out, pJson, L"SamiPage«UserAchievementGroupResource»*", L"SamiPage«UserAchievementGroupResource»");
...
SamiGamificationAchievementsApi::getAllUserProgressForAchievementUsingGETWithCompletion(String* achievementName, Boolean* filterAchievementDerived, String* filterAchievementTagset, Boolean* filterAchievementHidden, Integer* size, Integer* page, void (* success)(SamiPage«UserAchievementGroupResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiPage«UserAchievementGroupResource»* 
SamiGamificationAchievementsApi::getAllUserProgressUsingGETWithCompletion(Boolean* filterAchievementDerived, String* filterAchievementTagset, String* filterAchievementName, Boolean* filterAchievementHidden, Integer* size, Integer* page, void (* success)(SamiPage«UserAchievementGroupResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiPage«UserAchievementGroupResource»* 
SamiGamificationAchievementsApi::getUserProgressUsingGETWithCompletion(Integer* userId, Boolean* filterAchievementDerived, String* filterAchievementTagset, String* filterAchievementName, Boolean* filterAchievementHidden, Integer* size, Integer* page, void (* success)(SamiPage«UserAchievementGroupResource»*, SamiError*)) {
  client = new SamiApiClient();
