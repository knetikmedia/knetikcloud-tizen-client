/*
 * SamiPageResource«SimpleWallet».h
 * 
 * 
 */

#ifndef SamiPageResource«SimpleWallet»_H_
#define SamiPageResource«SimpleWallet»_H_
...
class SamiPageResource«SimpleWallet»: public SamiObject {
public:
    SamiPageResource«SimpleWallet»();
    SamiPageResource«SimpleWallet»(String* json);
    virtual ~SamiPageResource«SimpleWallet»();
    ...
    SamiPageResource«SimpleWallet»* fromJson(String* obj);
...
#endif /* SamiPageResource«SimpleWallet»_H_ */
