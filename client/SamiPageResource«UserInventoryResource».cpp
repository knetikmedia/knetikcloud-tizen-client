...
SamiPageResource«UserInventoryResource»::SamiPageResource«UserInventoryResource»() {
    init();
}
...
void
SamiPageResource«UserInventoryResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«UserInventoryResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«UserInventoryResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«UserInventoryResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiUserInventoryResource");
        }
        delete pContentKey;
...
SamiPageResource«UserInventoryResource»::SamiPageResource«UserInventoryResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«UserInventoryResource»::asJson ()
{
...
JsonObject*
SamiPageResource«UserInventoryResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiUserInventoryResource", "array"));
...
IList*
SamiPageResource«UserInventoryResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«UserInventoryResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«UserInventoryResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«UserInventoryResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«UserInventoryResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«UserInventoryResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«UserInventoryResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«UserInventoryResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«UserInventoryResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«UserInventoryResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«UserInventoryResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«UserInventoryResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«UserInventoryResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«UserInventoryResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«UserInventoryResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«UserInventoryResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«UserInventoryResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«UserInventoryResource»::setPTotalPages(Integer* pTotal_pages) {
