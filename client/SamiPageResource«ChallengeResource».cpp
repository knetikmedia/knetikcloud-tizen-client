...
SamiPageResource«ChallengeResource»::SamiPageResource«ChallengeResource»() {
    init();
}
...
void
SamiPageResource«ChallengeResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«ChallengeResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«ChallengeResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«ChallengeResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiChallengeResource");
        }
        delete pContentKey;
...
SamiPageResource«ChallengeResource»::SamiPageResource«ChallengeResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«ChallengeResource»::asJson ()
{
...
JsonObject*
SamiPageResource«ChallengeResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiChallengeResource", "array"));
...
IList*
SamiPageResource«ChallengeResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«ChallengeResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«ChallengeResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«ChallengeResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«ChallengeResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«ChallengeResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«ChallengeResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«ChallengeResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«ChallengeResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«ChallengeResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«ChallengeResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«ChallengeResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«ChallengeResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«ChallengeResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«ChallengeResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«ChallengeResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«ChallengeResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«ChallengeResource»::setPTotalPages(Integer* pTotal_pages) {
