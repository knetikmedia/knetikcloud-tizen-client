...
SamiPage«FlagReportResource»::SamiPage«FlagReportResource»() {
    init();
}
...
void
SamiPage«FlagReportResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«FlagReportResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«FlagReportResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«FlagReportResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«FlagReportResource»::SamiPage«FlagReportResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«FlagReportResource»::asJson ()
{
...
JsonObject*
SamiPage«FlagReportResource»::asJsonObject() {
...
IList*
SamiPage«FlagReportResource»::getPContent() {
    return pContent;
}
void
SamiPage«FlagReportResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«FlagReportResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«FlagReportResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«FlagReportResource»::getPLast() {
    return pLast;
}
void
SamiPage«FlagReportResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«FlagReportResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«FlagReportResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«FlagReportResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«FlagReportResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«FlagReportResource»::getPSize() {
    return pSize;
}
void
SamiPage«FlagReportResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«FlagReportResource»::getPSort() {
    return pSort;
}
void
SamiPage«FlagReportResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«FlagReportResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«FlagReportResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«FlagReportResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«FlagReportResource»::setPTotalPages(Integer* pTotal_pages) {
