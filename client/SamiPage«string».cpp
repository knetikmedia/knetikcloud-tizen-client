...
SamiPage«string»::SamiPage«string»() {
    init();
}
...
SamiPage«string»*
SamiPage«string»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«string»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«string»::SamiPage«string»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
IList*
SamiPage«string»::getPContent() {
    return pContent;
}
void
SamiPage«string»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«string»::getPFirst() {
    return pFirst;
}
void
SamiPage«string»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«string»::getPLast() {
    return pLast;
}
void
SamiPage«string»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«string»::getPNumber() {
    return pNumber;
}
void
SamiPage«string»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«string»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«string»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«string»::getPSize() {
    return pSize;
}
void
SamiPage«string»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«string»::getPSort() {
    return pSort;
}
void
SamiPage«string»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«string»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«string»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«string»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«string»::setPTotalPages(Integer* pTotal_pages) {
