...
getRewardSetsUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiPage«RewardSetResource»* out = new SamiPage«RewardSetResource»();
    jsonToValue(out, pJson, L"SamiPage«RewardSetResource»*", L"SamiPage«RewardSetResource»");
...
SamiCampaignsRewardsApi::getRewardSetsUsingGETWithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPage«RewardSetResource»*, SamiError*)) {
  client = new SamiApiClient();
