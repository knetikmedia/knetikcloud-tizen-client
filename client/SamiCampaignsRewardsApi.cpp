...
SamiRewardSetResource* 
SamiCampaignsRewardsApi::updateRewardSetWithCompletion(Integer* _id, SamiRewardSetResource* rewardSetResource, void (* success)(SamiRewardSetResource*, SamiError*)) {
  client = new SamiApiClient();
