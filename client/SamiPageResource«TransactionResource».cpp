...
SamiPageResource«TransactionResource»::SamiPageResource«TransactionResource»() {
    init();
}
...
void
SamiPageResource«TransactionResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«TransactionResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«TransactionResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«TransactionResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiTransactionResource");
        }
        delete pContentKey;
...
SamiPageResource«TransactionResource»::SamiPageResource«TransactionResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«TransactionResource»::asJson ()
{
...
JsonObject*
SamiPageResource«TransactionResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiTransactionResource", "array"));
...
IList*
SamiPageResource«TransactionResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«TransactionResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«TransactionResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«TransactionResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«TransactionResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«TransactionResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«TransactionResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«TransactionResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«TransactionResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«TransactionResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«TransactionResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«TransactionResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«TransactionResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«TransactionResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«TransactionResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«TransactionResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«TransactionResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«TransactionResource»::setPTotalPages(Integer* pTotal_pages) {
