...
SamiPageResource«ClientResource»::SamiPageResource«ClientResource»() {
    init();
}
...
void
SamiPageResource«ClientResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«ClientResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«ClientResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«ClientResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiClientResource");
        }
        delete pContentKey;
...
SamiPageResource«ClientResource»::SamiPageResource«ClientResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«ClientResource»::asJson ()
{
...
JsonObject*
SamiPageResource«ClientResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiClientResource", "array"));
...
IList*
SamiPageResource«ClientResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«ClientResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«ClientResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«ClientResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«ClientResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«ClientResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«ClientResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«ClientResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«ClientResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«ClientResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«ClientResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«ClientResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«ClientResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«ClientResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«ClientResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«ClientResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«ClientResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«ClientResource»::setPTotalPages(Integer* pTotal_pages) {
