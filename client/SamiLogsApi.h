...
public:
  ...
  getBREEventLogsWithCompletion(String* filterStartDate, String* filterEventName, String* filterEventId, Integer* size, Integer* page, String* order, void (* handler)(SamiPageResource«BreEventLog»*, SamiError*));
  SamiForwardLog* 
  ...
  getUserLogsWithCompletion(Integer* filterUser, String* filterActionName, Integer* size, Integer* page, String* order, void (* handler)(SamiPageResource«UserActionLog»*, SamiError*));
