...
SamiPageResource«AggregateCountResource»::SamiPageResource«AggregateCountResource»() {
    init();
}
...
void
SamiPageResource«AggregateCountResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«AggregateCountResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«AggregateCountResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«AggregateCountResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiAggregateCountResource");
        }
        delete pContentKey;
...
SamiPageResource«AggregateCountResource»::SamiPageResource«AggregateCountResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«AggregateCountResource»::asJson ()
{
...
JsonObject*
SamiPageResource«AggregateCountResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiAggregateCountResource", "array"));
...
IList*
SamiPageResource«AggregateCountResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«AggregateCountResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«AggregateCountResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«AggregateCountResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«AggregateCountResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«AggregateCountResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«AggregateCountResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«AggregateCountResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«AggregateCountResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«AggregateCountResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«AggregateCountResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«AggregateCountResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«AggregateCountResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«AggregateCountResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«AggregateCountResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«AggregateCountResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«AggregateCountResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«AggregateCountResource»::setPTotalPages(Integer* pTotal_pages) {
