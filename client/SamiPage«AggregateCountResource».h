/*
 * SamiPage«AggregateCountResource».h
 * 
 * 
 */

#ifndef SamiPage«AggregateCountResource»_H_
#define SamiPage«AggregateCountResource»_H_
...
class SamiPage«AggregateCountResource»: public SamiObject {
public:
    SamiPage«AggregateCountResource»();
    SamiPage«AggregateCountResource»(String* json);
    virtual ~SamiPage«AggregateCountResource»();
    ...
    SamiPage«AggregateCountResource»* fromJson(String* obj);
...
#endif /* SamiPage«AggregateCountResource»_H_ */
