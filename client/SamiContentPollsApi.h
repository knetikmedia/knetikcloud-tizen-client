...
public:
  ...
  void 
  updatePollWithCompletion(String* _id, SamiPollResource* pollResource, void(* handler)(SamiError*));
  void 
  updatePollTemplateWithCompletion(String* _id, SamiTemplateResource* pollTemplateResource, void(* handler)(SamiError*));
