...
public:
  ...
  SamiPage«BreRule»* 
  getRulesUsingGETWithCompletion(String* filterName, Boolean* filterEnabled, Boolean* filterSystem, String* filterTrigger, String* filterAction, String* filterCondition, Integer* size, Integer* page, void (* handler)(SamiPage«BreRule»*, SamiError*));
  void 
