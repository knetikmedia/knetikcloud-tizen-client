...
SamiSubscription::SamiSubscription() {
    init();
}
...
pSubscription_plans = null;
}

void
SamiSubscription::cleanup() {
...
if(pSubscription_plans != null) {
        pSubscription_plans->RemoveAll(true);
        delete pSubscription_plans;
        pSubscription_plans = null;
    }
}
...
SamiSubscription*
SamiSubscription::fromJson(String* json) {
    this->cleanup();
...
void
SamiSubscription::fromJsonObject(IJsonValue* pJson) {
...
JsonString* pSubscription_plansKey = new JsonString(L"subscription_plans");
        IJsonValue* pSubscription_plansVal = null;
        pJsonObject->GetValue(pSubscription_plansKey, pSubscription_plansVal);
        if(pSubscription_plansVal != null) {
            pSubscription_plans = new ArrayList();
            
            jsonToValue(pSubscription_plans, pSubscription_plansVal, L"IList", L"SamiSubscriptionPlan");
        }
        delete pSubscription_plansKey;
    }
}

SamiSubscription::SamiSubscription(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
SamiSubscription::asJsonObject() {
    ...
    JsonString *pSubscription_plansKey = new JsonString(L"subscription_plans");
    pJsonObject->Add(pSubscription_plansKey, toJson(getPSubscriptionPlans(), "SamiSubscriptionPlan", "array"));

    return pJsonObject;
}

HashMap*
SamiSubscription::getPAdditionalProperties() {
    return pAdditional_properties;
}
void
SamiSubscription::setPAdditionalProperties(HashMap* pAdditional_properties) {
    this->pAdditional_properties = pAdditional_properties;
}

IList*
SamiSubscription::getPBehaviors() {
    return pBehaviors;
}
void
SamiSubscription::setPBehaviors(IList* pBehaviors) {
    this->pBehaviors = pBehaviors;
}

String*
SamiSubscription::getPCategory() {
    return pCategory;
}
void
SamiSubscription::setPCategory(String* pCategory) {
    this->pCategory = pCategory;
}

Long*
SamiSubscription::getPCreatedDate() {
    return pCreated_date;
}
void
SamiSubscription::setPCreatedDate(Long* pCreated_date) {
    this->pCreated_date = pCreated_date;
}

Integer*
SamiSubscription::getPId() {
    return pId;
}
void
SamiSubscription::setPId(Integer* pId) {
    this->pId = pId;
}

String*
SamiSubscription::getPLongDescription() {
    return pLong_description;
}
void
SamiSubscription::setPLongDescription(String* pLong_description) {
    this->pLong_description = pLong_description;
}

String*
SamiSubscription::getPName() {
    return pName;
}
void
SamiSubscription::setPName(String* pName) {
    this->pName = pName;
}

String*
SamiSubscription::getPShortDescription() {
    return pShort_description;
}
void
SamiSubscription::setPShortDescription(String* pShort_description) {
    this->pShort_description = pShort_description;
}

Integer*
SamiSubscription::getPSort() {
    return pSort;
}
void
SamiSubscription::setPSort(Integer* pSort) {
    this->pSort = pSort;
}

IList*
SamiSubscription::getPTags() {
    return pTags;
}
void
SamiSubscription::setPTags(IList* pTags) {
    this->pTags = pTags;
}

String*
SamiSubscription::getPTemplate() {
    return pTemplate;
}
void
SamiSubscription::setPTemplate(String* pTemplate) {
    this->pTemplate = pTemplate;
}

String*
SamiSubscription::getPTypeHint() {
    return pType_hint;
}
void
SamiSubscription::setPTypeHint(String* pType_hint) {
    this->pType_hint = pType_hint;
}

String*
SamiSubscription::getPUniqueKey() {
    return pUnique_key;
}
void
SamiSubscription::setPUniqueKey(String* pUnique_key) {
    this->pUnique_key = pUnique_key;
}

Long*
SamiSubscription::getPUpdatedDate() {
    return pUpdated_date;
}
void
SamiSubscription::setPUpdatedDate(Long* pUpdated_date) {
    this->pUpdated_date = pUpdated_date;
}

Boolean*
SamiSubscription::getPDisplayable() {
    return pDisplayable;
}
void
SamiSubscription::setPDisplayable(Boolean* pDisplayable) {
    this->pDisplayable = pDisplayable;
}

IList*
SamiSubscription::getPGeoCountryList() {
    return pGeo_country_list;
}
void
SamiSubscription::setPGeoCountryList(IList* pGeo_country_list) {
    this->pGeo_country_list = pGeo_country_list;
}

String*
SamiSubscription::getPGeoPolicyType() {
    return pGeo_policy_type;
}
void
SamiSubscription::setPGeoPolicyType(String* pGeo_policy_type) {
    this->pGeo_policy_type = pGeo_policy_type;
}

Integer*
SamiSubscription::getPShippingTier() {
    return pShipping_tier;
}
void
SamiSubscription::setPShippingTier(Integer* pShipping_tier) {
    this->pShipping_tier = pShipping_tier;
}

IList*
SamiSubscription::getPSkus() {
    return pSkus;
}
void
SamiSubscription::setPSkus(IList* pSkus) {
    this->pSkus = pSkus;
}

Long*
SamiSubscription::getPStoreEnd() {
    return pStore_end;
}
void
SamiSubscription::setPStoreEnd(Long* pStore_end) {
    this->pStore_end = pStore_end;
}

Long*
SamiSubscription::getPStoreStart() {
    return pStore_start;
}
void
SamiSubscription::setPStoreStart(Long* pStore_start) {
    this->pStore_start = pStore_start;
}

Integer*
SamiSubscription::getPVendorId() {
    return pVendor_id;
}
void
SamiSubscription::setPVendorId(Integer* pVendor_id) {
    this->pVendor_id = pVendor_id;
}

String*
SamiSubscription::getPAvailability() {
    return pAvailability;
}
void
SamiSubscription::setPAvailability(String* pAvailability) {
    this->pAvailability = pAvailability;
}

Integer*
SamiSubscription::getPConsolidationDayOfMonth() {
    return pConsolidation_day_of_month;
}
void
SamiSubscription::setPConsolidationDayOfMonth(Integer* pConsolidation_day_of_month) {
    this->pConsolidation_day_of_month = pConsolidation_day_of_month;
}

IList*
SamiSubscription::getPSubscriptionPlans() {
    return pSubscription_plans;
}
void
SamiSubscription::setPSubscriptionPlans(IList* pSubscription_plans) {
    this->pSubscription_plans = pSubscription_plans;
}
