...
SamiPage«PollResource»::SamiPage«PollResource»() {
    init();
}
...
SamiPage«PollResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«PollResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«PollResource»::SamiPage«PollResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
JsonObject*
SamiPage«PollResource»::asJsonObject() {
...
IList*
SamiPage«PollResource»::getPContent() {
    return pContent;
}
void
SamiPage«PollResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«PollResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«PollResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«PollResource»::getPLast() {
    return pLast;
}
void
SamiPage«PollResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«PollResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«PollResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«PollResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«PollResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«PollResource»::getPSize() {
    return pSize;
}
void
SamiPage«PollResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«PollResource»::getPSort() {
    return pSort;
}
void
SamiPage«PollResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«PollResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«PollResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«PollResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«PollResource»::setPTotalPages(Integer* pTotal_pages) {
