...
SamiStoreVendorsApi::getVendorsUsingGETWithCompletion(String* filterName, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«VendorResource»*, SamiError*)) {
  client = new SamiApiClient();
