...
SamiPageResource«ChallengeEventResource»::SamiPageResource«ChallengeEventResource»() {
    init();
}
...
void
SamiPageResource«ChallengeEventResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«ChallengeEventResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«ChallengeEventResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«ChallengeEventResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiChallengeEventResource");
        }
        delete pContentKey;
...
SamiPageResource«ChallengeEventResource»::SamiPageResource«ChallengeEventResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«ChallengeEventResource»::asJson ()
{
...
JsonObject*
SamiPageResource«ChallengeEventResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiChallengeEventResource", "array"));
...
IList*
SamiPageResource«ChallengeEventResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«ChallengeEventResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«ChallengeEventResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«ChallengeEventResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«ChallengeEventResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«ChallengeEventResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«ChallengeEventResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«ChallengeEventResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«ChallengeEventResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«ChallengeEventResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«ChallengeEventResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«ChallengeEventResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«ChallengeEventResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«ChallengeEventResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«ChallengeEventResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«ChallengeEventResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«ChallengeEventResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«ChallengeEventResource»::setPTotalPages(Integer* pTotal_pages) {
