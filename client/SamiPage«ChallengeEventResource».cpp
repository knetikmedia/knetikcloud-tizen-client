...
SamiPage«ChallengeEventResource»::SamiPage«ChallengeEventResource»() {
    init();
}
...
void
SamiPage«ChallengeEventResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«ChallengeEventResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«ChallengeEventResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«ChallengeEventResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«ChallengeEventResource»::SamiPage«ChallengeEventResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«ChallengeEventResource»::asJson ()
{
...
JsonObject*
SamiPage«ChallengeEventResource»::asJsonObject() {
...
IList*
SamiPage«ChallengeEventResource»::getPContent() {
    return pContent;
}
void
SamiPage«ChallengeEventResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«ChallengeEventResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«ChallengeEventResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«ChallengeEventResource»::getPLast() {
    return pLast;
}
void
SamiPage«ChallengeEventResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«ChallengeEventResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«ChallengeEventResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«ChallengeEventResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«ChallengeEventResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«ChallengeEventResource»::getPSize() {
    return pSize;
}
void
SamiPage«ChallengeEventResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«ChallengeEventResource»::getPSort() {
    return pSort;
}
void
SamiPage«ChallengeEventResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«ChallengeEventResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«ChallengeEventResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«ChallengeEventResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«ChallengeEventResource»::setPTotalPages(Integer* pTotal_pages) {
