...
SamiPageResource«string»::SamiPageResource«string»() {
    init();
}
...
void
SamiPageResource«string»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«string»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«string»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"String");
        }
        delete pContentKey;
...
SamiPageResource«string»::SamiPageResource«string»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«string»::asJson ()
{
...
JsonObject*
SamiPageResource«string»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "String", "array"));
...
IList*
SamiPageResource«string»::getPContent() {
    return pContent;
}
void
SamiPageResource«string»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«string»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«string»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«string»::getPLast() {
    return pLast;
}
void
SamiPageResource«string»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«string»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«string»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«string»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«string»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«string»::getPSize() {
    return pSize;
}
void
SamiPageResource«string»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«string»::getPSort() {
    return pSort;
}
void
SamiPageResource«string»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«string»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«string»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«string»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«string»::setPTotalPages(Integer* pTotal_pages) {
