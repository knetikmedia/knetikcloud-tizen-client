...
public:
  ...
  getDispositionsUsingGETWithCompletion(String* filterContext, String* filterOwner, Integer* size, Integer* page, String* order, void (* handler)(SamiPageResource«DispositionResource»*, SamiError*));
