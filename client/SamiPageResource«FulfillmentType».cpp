...
SamiPageResource«FulfillmentType»::SamiPageResource«FulfillmentType»() {
    init();
}
...
void
SamiPageResource«FulfillmentType»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«FulfillmentType»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«FulfillmentType»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«FulfillmentType»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiFulfillmentType");
        }
        delete pContentKey;
...
SamiPageResource«FulfillmentType»::SamiPageResource«FulfillmentType»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«FulfillmentType»::asJson ()
{
...
JsonObject*
SamiPageResource«FulfillmentType»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiFulfillmentType", "array"));
...
IList*
SamiPageResource«FulfillmentType»::getPContent() {
    return pContent;
}
void
SamiPageResource«FulfillmentType»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«FulfillmentType»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«FulfillmentType»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«FulfillmentType»::getPLast() {
    return pLast;
}
void
SamiPageResource«FulfillmentType»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«FulfillmentType»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«FulfillmentType»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«FulfillmentType»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«FulfillmentType»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«FulfillmentType»::getPSize() {
    return pSize;
}
void
SamiPageResource«FulfillmentType»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«FulfillmentType»::getPSort() {
    return pSort;
}
void
SamiPageResource«FulfillmentType»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«FulfillmentType»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«FulfillmentType»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«FulfillmentType»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«FulfillmentType»::setPTotalPages(Integer* pTotal_pages) {
