...
SamiPage«LevelingResource»::SamiPage«LevelingResource»() {
    init();
}
...
void
SamiPage«LevelingResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«LevelingResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«LevelingResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«LevelingResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«LevelingResource»::SamiPage«LevelingResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«LevelingResource»::asJson ()
{
...
JsonObject*
SamiPage«LevelingResource»::asJsonObject() {
...
IList*
SamiPage«LevelingResource»::getPContent() {
    return pContent;
}
void
SamiPage«LevelingResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«LevelingResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«LevelingResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«LevelingResource»::getPLast() {
    return pLast;
}
void
SamiPage«LevelingResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«LevelingResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«LevelingResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«LevelingResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«LevelingResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«LevelingResource»::getPSize() {
    return pSize;
}
void
SamiPage«LevelingResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«LevelingResource»::getPSort() {
    return pSort;
}
void
SamiPage«LevelingResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«LevelingResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«LevelingResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«LevelingResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«LevelingResource»::setPTotalPages(Integer* pTotal_pages) {
