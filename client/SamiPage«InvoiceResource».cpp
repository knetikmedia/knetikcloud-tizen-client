...
SamiPage«InvoiceResource»::SamiPage«InvoiceResource»() {
    init();
}
...
void
SamiPage«InvoiceResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«InvoiceResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«InvoiceResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«InvoiceResource»::SamiPage«InvoiceResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«InvoiceResource»::asJson ()
{
...
JsonObject*
SamiPage«InvoiceResource»::asJsonObject() {
...
IList*
SamiPage«InvoiceResource»::getPContent() {
    return pContent;
}
void
SamiPage«InvoiceResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«InvoiceResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«InvoiceResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«InvoiceResource»::getPLast() {
    return pLast;
}
void
SamiPage«InvoiceResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«InvoiceResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«InvoiceResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«InvoiceResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«InvoiceResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«InvoiceResource»::getPSize() {
    return pSize;
}
void
SamiPage«InvoiceResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«InvoiceResource»::getPSort() {
    return pSort;
}
void
SamiPage«InvoiceResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«InvoiceResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«InvoiceResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«InvoiceResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«InvoiceResource»::setPTotalPages(Integer* pTotal_pages) {
