...
JsonString* pResultKey = new JsonString(L"result");
        ...
        if(pResultVal != null) {
            ...
            jsonToValue(pResult, pResultVal, L"IList", L"SamiErrorResource");
        }
        delete pResultKey;
    }
}
...
SamiResult::asJsonObject() {
    ...
    JsonString *pResultKey = new JsonString(L"result");
    pJsonObject->Add(pResultKey, toJson(getPResult(), "SamiErrorResource", "array"));
...
void
SamiResult::setPResult(IList* pResult) {
