/*
 * SamiPage«PollResource».h
 * 
 * 
 */

#ifndef SamiPage«PollResource»_H_
#define SamiPage«PollResource»_H_
...
class SamiPage«PollResource»: public SamiObject {
public:
    SamiPage«PollResource»();
    SamiPage«PollResource»(String* json);
    virtual ~SamiPage«PollResource»();
    ...
    SamiPage«PollResource»* fromJson(String* obj);
...
#endif /* SamiPage«PollResource»_H_ */
