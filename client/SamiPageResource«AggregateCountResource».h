/*
 * SamiPageResource«AggregateCountResource».h
 * 
 * 
 */

#ifndef SamiPageResource«AggregateCountResource»_H_
#define SamiPageResource«AggregateCountResource»_H_
...
class SamiPageResource«AggregateCountResource»: public SamiObject {
public:
    SamiPageResource«AggregateCountResource»();
    SamiPageResource«AggregateCountResource»(String* json);
    virtual ~SamiPageResource«AggregateCountResource»();
    ...
    SamiPageResource«AggregateCountResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«AggregateCountResource»_H_ */
