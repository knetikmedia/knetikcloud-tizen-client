...
SamiPageResource«CategoryResource»::SamiPageResource«CategoryResource»() {
    init();
}
...
void
SamiPageResource«CategoryResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«CategoryResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«CategoryResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«CategoryResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiCategoryResource");
        }
        delete pContentKey;
...
SamiPageResource«CategoryResource»::SamiPageResource«CategoryResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«CategoryResource»::asJson ()
{
...
JsonObject*
SamiPageResource«CategoryResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiCategoryResource", "array"));
...
IList*
SamiPageResource«CategoryResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«CategoryResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«CategoryResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«CategoryResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«CategoryResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«CategoryResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«CategoryResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«CategoryResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«CategoryResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«CategoryResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«CategoryResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«CategoryResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«CategoryResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«CategoryResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«CategoryResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«CategoryResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«CategoryResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«CategoryResource»::setPTotalPages(Integer* pTotal_pages) {
