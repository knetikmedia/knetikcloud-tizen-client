...
SamiPageResource«VideoResource»::SamiPageResource«VideoResource»() {
    init();
}
...
void
SamiPageResource«VideoResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«VideoResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«VideoResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«VideoResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiVideoResource");
        }
        delete pContentKey;
...
SamiPageResource«VideoResource»::SamiPageResource«VideoResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«VideoResource»::asJson ()
{
...
JsonObject*
SamiPageResource«VideoResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiVideoResource", "array"));
...
IList*
SamiPageResource«VideoResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«VideoResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«VideoResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«VideoResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«VideoResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«VideoResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«VideoResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«VideoResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«VideoResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«VideoResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«VideoResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«VideoResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«VideoResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«VideoResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«VideoResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«VideoResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«VideoResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«VideoResource»::setPTotalPages(Integer* pTotal_pages) {
