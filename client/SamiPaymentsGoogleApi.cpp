...
void
handleGooglePaymentProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
...
Integer* 
SamiPaymentsGoogleApi::handleGooglePaymentWithCompletion(SamiGooglePaymentRequest* request, void (* success)(Integer*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&handleGooglePaymentProcessor, (void(*)(void*, SamiError*))success);
