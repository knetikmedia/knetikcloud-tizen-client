...
SamiPageResource«BreRule»::SamiPageResource«BreRule»() {
    init();
}
...
void
SamiPageResource«BreRule»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«BreRule»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«BreRule»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiBreRule");
        }
        delete pContentKey;
...
SamiPageResource«BreRule»::SamiPageResource«BreRule»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«BreRule»::asJson ()
{
...
JsonObject*
SamiPageResource«BreRule»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiBreRule", "array"));
...
IList*
SamiPageResource«BreRule»::getPContent() {
    return pContent;
}
void
SamiPageResource«BreRule»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«BreRule»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«BreRule»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«BreRule»::getPLast() {
    return pLast;
}
void
SamiPageResource«BreRule»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«BreRule»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«BreRule»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«BreRule»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«BreRule»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«BreRule»::getPSize() {
    return pSize;
}
void
SamiPageResource«BreRule»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«BreRule»::getPSort() {
    return pSort;
}
void
SamiPageResource«BreRule»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«BreRule»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«BreRule»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«BreRule»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«BreRule»::setPTotalPages(Integer* pTotal_pages) {
