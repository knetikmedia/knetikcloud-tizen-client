/*
 * SamiPageResource«ClientResource».h
 * 
 * 
 */

#ifndef SamiPageResource«ClientResource»_H_
#define SamiPageResource«ClientResource»_H_
...
class SamiPageResource«ClientResource»: public SamiObject {
public:
    SamiPageResource«ClientResource»();
    SamiPageResource«ClientResource»(String* json);
    virtual ~SamiPageResource«ClientResource»();
    ...
    SamiPageResource«ClientResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«ClientResource»_H_ */
