...
SamiPageResource«BreGlobalResource»::SamiPageResource«BreGlobalResource»() {
    init();
}
...
void
SamiPageResource«BreGlobalResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«BreGlobalResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«BreGlobalResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«BreGlobalResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiBreGlobalResource");
        }
        delete pContentKey;
...
SamiPageResource«BreGlobalResource»::SamiPageResource«BreGlobalResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«BreGlobalResource»::asJson ()
{
...
JsonObject*
SamiPageResource«BreGlobalResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiBreGlobalResource", "array"));
...
IList*
SamiPageResource«BreGlobalResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«BreGlobalResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«BreGlobalResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«BreGlobalResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«BreGlobalResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«BreGlobalResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«BreGlobalResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«BreGlobalResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«BreGlobalResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«BreGlobalResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«BreGlobalResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«BreGlobalResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«BreGlobalResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«BreGlobalResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«BreGlobalResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«BreGlobalResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«BreGlobalResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«BreGlobalResource»::setPTotalPages(Integer* pTotal_pages) {
