...
SamiGamificationLevelingApi::getLevelsUsingGETWithCompletion(String* filterName, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«LevelingResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiGamificationLevelingApi::getUserLevelsUsingGETWithCompletion(Integer* userId, void (* success)(SamiPageResource«UserLevelingResource»*, SamiError*)) {
  client = new SamiApiClient();
