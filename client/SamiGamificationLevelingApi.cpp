...
SamiGamificationLevelingApi::getUserLevelsWithCompletion(Integer* userId, void (* success)(SamiPageResource«UserLevelingResource»*, SamiError*)) {
  client = new SamiApiClient();
...
void 
SamiGamificationLevelingApi::updateLevelWithCompletion(String* name, SamiLevelingResource* newLevel, void(*success)(SamiError*)) {
  client = new SamiApiClient();
...
void
updateUserLevelProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
void 
SamiGamificationLevelingApi::updateUserLevelWithCompletion(Integer* userId, String* name, Integer* progress, void(*success)(SamiError*)) {
  client = new SamiApiClient();

  client->success(&updateUserLevelProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
