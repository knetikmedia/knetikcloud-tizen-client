/*
 * SamiPageResource«TransactionResource».h
 * 
 * 
 */

#ifndef SamiPageResource«TransactionResource»_H_
#define SamiPageResource«TransactionResource»_H_
...
class SamiPageResource«TransactionResource»: public SamiObject {
public:
    SamiPageResource«TransactionResource»();
    SamiPageResource«TransactionResource»(String* json);
    virtual ~SamiPageResource«TransactionResource»();
    ...
    SamiPageResource«TransactionResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«TransactionResource»_H_ */
