...
SamiUsersInventoryApi::getUserInventoriesWithCompletion(Integer* _id, Boolean* inactive, Integer* size, Integer* page, String* filterItemName, Long* filterMinDate, Long* filterMaxDate, void (* success)(SamiPageResource«UserInventoryResource»*, SamiError*)) {
  client = new SamiApiClient();
