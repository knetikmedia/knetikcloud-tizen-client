...
void
grantEntitlementUsingPOSTProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
void 
SamiUsersInventoryApi::grantEntitlementUsingPOSTWithCompletion(Integer* userId, SamiEntitlementGrantRequest* grantRequest, void(*success)(SamiError*)) {
  client = new SamiApiClient();

  client->success(&grantEntitlementUsingPOSTProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
