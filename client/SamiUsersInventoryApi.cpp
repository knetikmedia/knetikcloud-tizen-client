...
SamiEntitlementItem* 
SamiUsersInventoryApi::createEntitlementItemWithCompletion(SamiEntitlementItem* entitlementItem, void (* success)(SamiEntitlementItem*, SamiError*)) {
  client = new SamiApiClient();
...
void
getUserInventory1Processor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
SamiUsersInventoryApi::getUserInventory1WithCompletion(Integer* _id, Boolean* inactive, Integer* size, Integer* page, String* filterItemName, Long* filterMinDate, Long* filterMaxDate, void (* success)(SamiPageResource«UserInventoryResource»*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&getUserInventory1Processor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
...
void
getUserInventoryLog1Processor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
void 
SamiUsersInventoryApi::getUserInventoryLog1WithCompletion(Integer* userId, Integer* _id, Long* timestamp, void(*success)(SamiError*)) {
  client = new SamiApiClient();

  client->success(&getUserInventoryLog1Processor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
...
SamiPageResource«UserInventoryResource»* 
SamiUsersInventoryApi::getUsersInventoryWithCompletion(Boolean* inactive, Integer* size, Integer* page, String* filterItemName, String* filterUsername, String* filterGroup, String* filterDate, void (* success)(SamiPageResource«UserInventoryResource»*, SamiError*)) {
  client = new SamiApiClient();
...
void 
SamiUsersInventoryApi::updateEntitlementItemWithCompletion(Integer* entitlementId, SamiEntitlementItem* entitlementItem, void(*success)(SamiError*)) {
  client = new SamiApiClient();
...
void 
SamiUsersInventoryApi::updateEntitlementTemplateWithCompletion(String* _id, SamiItemTemplateResource* template, void(*success)(SamiError*)) {
  client = new SamiApiClient();
