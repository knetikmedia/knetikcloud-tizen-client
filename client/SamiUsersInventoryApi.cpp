...
SamiUsersInventoryApi::getEntitlementTemplatesUsingGETWithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPage«ItemTemplateResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiUsersInventoryApi::getInventoryListUsingGETWithCompletion(Boolean* inactive, Integer* size, Integer* page, String* filterItemName, String* filterUsername, String* filterGroup, String* filterDate, void (* success)(SamiPage«UserInventoryResource»*, SamiError*)) {
  client = new SamiApiClient();
