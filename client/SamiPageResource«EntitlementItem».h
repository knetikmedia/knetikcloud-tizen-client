/*
 * SamiPageResource«EntitlementItem».h
 * 
 * 
 */

#ifndef SamiPageResource«EntitlementItem»_H_
#define SamiPageResource«EntitlementItem»_H_
...
class SamiPageResource«EntitlementItem»: public SamiObject {
public:
    SamiPageResource«EntitlementItem»();
    SamiPageResource«EntitlementItem»(String* json);
    virtual ~SamiPageResource«EntitlementItem»();
    ...
    SamiPageResource«EntitlementItem»* fromJson(String* obj);
...
#endif /* SamiPageResource«EntitlementItem»_H_ */
