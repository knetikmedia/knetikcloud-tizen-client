/*
 * SamiPage«UsageInfo».h
 * 
 * 
 */

#ifndef SamiPage«UsageInfo»_H_
#define SamiPage«UsageInfo»_H_
...
class SamiPage«UsageInfo»: public SamiObject {
public:
    SamiPage«UsageInfo»();
    SamiPage«UsageInfo»(String* json);
    virtual ~SamiPage«UsageInfo»();
    ...
    SamiPage«UsageInfo»* fromJson(String* obj);
