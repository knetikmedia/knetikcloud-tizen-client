...
HashMap*
SamiEntitlementItem::getPAdditionalProperties() {
    return pAdditional_properties;
}
void
SamiEntitlementItem::setPAdditionalProperties(HashMap* pAdditional_properties) {
...
String*
SamiEntitlementItem::getPCategory() {
    return pCategory;
}
void
SamiEntitlementItem::setPCategory(String* pCategory) {
...
IList*
SamiEntitlementItem::getPTags() {
    return pTags;
}
void
SamiEntitlementItem::setPTags(IList* pTags) {
    this->pTags = pTags;
}

String*
SamiEntitlementItem::getPTemplate() {
    return pTemplate;
}
void
SamiEntitlementItem::setPTemplate(String* pTemplate) {
