/*
 * SamiPage«CampaignResource».h
 * 
 * 
 */

#ifndef SamiPage«CampaignResource»_H_
#define SamiPage«CampaignResource»_H_
...
class SamiPage«CampaignResource»: public SamiObject {
public:
    SamiPage«CampaignResource»();
    SamiPage«CampaignResource»(String* json);
    virtual ~SamiPage«CampaignResource»();
    ...
    SamiPage«CampaignResource»* fromJson(String* obj);
...
#endif /* SamiPage«CampaignResource»_H_ */
