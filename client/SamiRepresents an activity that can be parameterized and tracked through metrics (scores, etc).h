/*
 * SamiRepresents an activity that can be parameterized and tracked through metrics (scores, etc).h
 * 
 * 
 */

#ifndef SamiRepresents an activity that can be parameterized and tracked through metrics (scores, etc)_H_
#define SamiRepresents an activity that can be parameterized and tracked through metrics (scores, etc)_H_
...
class SamiRepresents an activity that can be parameterized and tracked through metrics (scores, etc): public SamiObject {
public:
    SamiRepresents an activity that can be parameterized and tracked through metrics (scores, etc)();
    SamiRepresents an activity that can be parameterized and tracked through metrics (scores, etc)(String* json);
    virtual ~SamiRepresents an activity that can be parameterized and tracked through metrics (scores, etc)();
    ...
    SamiRepresents an activity that can be parameterized and tracked through metrics (scores, etc)* fromJson(String* obj);
...
#endif /* SamiRepresents an activity that can be parameterized and tracked through metrics (scores, etc)_H_ */
