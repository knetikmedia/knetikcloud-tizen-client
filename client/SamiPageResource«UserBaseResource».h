/*
 * SamiPageResource«UserBaseResource».h
 * 
 * 
 */

#ifndef SamiPageResource«UserBaseResource»_H_
#define SamiPageResource«UserBaseResource»_H_
...
class SamiPageResource«UserBaseResource»: public SamiObject {
public:
    SamiPageResource«UserBaseResource»();
    SamiPageResource«UserBaseResource»(String* json);
    virtual ~SamiPageResource«UserBaseResource»();
    ...
    SamiPageResource«UserBaseResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«UserBaseResource»_H_ */
