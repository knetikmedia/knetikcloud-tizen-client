...
SamiPageResource«InvoiceLogEntry»::SamiPageResource«InvoiceLogEntry»() {
    init();
}
...
void
SamiPageResource«InvoiceLogEntry»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«InvoiceLogEntry»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«InvoiceLogEntry»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«InvoiceLogEntry»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiInvoiceLogEntry");
        }
        delete pContentKey;
...
SamiPageResource«InvoiceLogEntry»::SamiPageResource«InvoiceLogEntry»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«InvoiceLogEntry»::asJson ()
{
...
JsonObject*
SamiPageResource«InvoiceLogEntry»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiInvoiceLogEntry", "array"));
...
IList*
SamiPageResource«InvoiceLogEntry»::getPContent() {
    return pContent;
}
void
SamiPageResource«InvoiceLogEntry»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«InvoiceLogEntry»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«InvoiceLogEntry»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«InvoiceLogEntry»::getPLast() {
    return pLast;
}
void
SamiPageResource«InvoiceLogEntry»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«InvoiceLogEntry»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«InvoiceLogEntry»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«InvoiceLogEntry»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«InvoiceLogEntry»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«InvoiceLogEntry»::getPSize() {
    return pSize;
}
void
SamiPageResource«InvoiceLogEntry»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«InvoiceLogEntry»::getPSort() {
    return pSort;
}
void
SamiPageResource«InvoiceLogEntry»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«InvoiceLogEntry»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«InvoiceLogEntry»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«InvoiceLogEntry»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«InvoiceLogEntry»::setPTotalPages(Integer* pTotal_pages) {
