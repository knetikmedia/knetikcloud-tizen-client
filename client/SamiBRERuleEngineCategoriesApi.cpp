...
getCategoriesUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiPage«BreCategoryResource»* out = new SamiPage«BreCategoryResource»();
    jsonToValue(out, pJson, L"SamiPage«BreCategoryResource»*", L"SamiPage«BreCategoryResource»");
...
SamiBRERuleEngineCategoriesApi::getCategoriesUsingGETWithCompletion(Integer* size, Integer* page, void (* success)(SamiPage«BreCategoryResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiBRERuleEngineCategoriesApi::getTemplatesUsingGETWithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPage«TemplateResource»*, SamiError*)) {
  client = new SamiApiClient();
