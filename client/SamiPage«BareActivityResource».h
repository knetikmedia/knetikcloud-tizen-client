/*
 * SamiPage«BareActivityResource».h
 * 
 * 
 */

#ifndef SamiPage«BareActivityResource»_H_
#define SamiPage«BareActivityResource»_H_
...
class SamiPage«BareActivityResource»: public SamiObject {
public:
    SamiPage«BareActivityResource»();
    SamiPage«BareActivityResource»(String* json);
    virtual ~SamiPage«BareActivityResource»();
    ...
    SamiPage«BareActivityResource»* fromJson(String* obj);
...
#endif /* SamiPage«BareActivityResource»_H_ */
