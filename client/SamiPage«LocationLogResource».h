/*
 * SamiPage«LocationLogResource».h
 * 
 * 
 */

#ifndef SamiPage«LocationLogResource»_H_
#define SamiPage«LocationLogResource»_H_
...
class SamiPage«LocationLogResource»: public SamiObject {
public:
    SamiPage«LocationLogResource»();
    SamiPage«LocationLogResource»(String* json);
    virtual ~SamiPage«LocationLogResource»();
    ...
    SamiPage«LocationLogResource»* fromJson(String* obj);
...
#endif /* SamiPage«LocationLogResource»_H_ */
