/*
 * SamiPage«UserActionLog».h
 * 
 * 
 */

#ifndef SamiPage«UserActionLog»_H_
#define SamiPage«UserActionLog»_H_
...
class SamiPage«UserActionLog»: public SamiObject {
public:
    SamiPage«UserActionLog»();
    SamiPage«UserActionLog»(String* json);
    virtual ~SamiPage«UserActionLog»();
    ...
    SamiPage«UserActionLog»* fromJson(String* obj);
...
#endif /* SamiPage«UserActionLog»_H_ */
