/*
 * SamiPage«BillingReport».h
 * 
 * 
 */

#ifndef SamiPage«BillingReport»_H_
#define SamiPage«BillingReport»_H_
...
class SamiPage«BillingReport»: public SamiObject {
public:
    SamiPage«BillingReport»();
    SamiPage«BillingReport»(String* json);
    virtual ~SamiPage«BillingReport»();
    ...
    SamiPage«BillingReport»* fromJson(String* obj);
...
#endif /* SamiPage«BillingReport»_H_ */
