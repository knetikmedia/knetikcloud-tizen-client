...
if(pConnection_string != null) {
        
        delete pConnection_string;
        pConnection_string = null;
    }
if(pDb_name != null) {
...
JsonString* pConnection_stringKey = new JsonString(L"connection_string");
        IJsonValue* pConnection_stringVal = null;
        pJsonObject->GetValue(pConnection_stringKey, pConnection_stringVal);
        if(pConnection_stringVal != null) {
            
            pConnection_string = new String();
            jsonToValue(pConnection_string, pConnection_stringVal, L"String", L"String");
        }
        delete pConnection_stringKey;
...
SamiSqlDatabaseConfig::asJsonObject() {
    ...
    JsonString *pConnection_stringKey = new JsonString(L"connection_string");
    pJsonObject->Add(pConnection_stringKey, toJson(getPConnectionString(), "String", ""));
...
String*
SamiSqlDatabaseConfig::getPConnectionString() {
    return pConnection_string;
}
void
SamiSqlDatabaseConfig::setPConnectionString(String* pConnection_string) {
    this->pConnection_string = pConnection_string;
}
