/*
 * SamiPageResource«StateTaxResource».h
 * 
 * 
 */

#ifndef SamiPageResource«StateTaxResource»_H_
#define SamiPageResource«StateTaxResource»_H_
...
class SamiPageResource«StateTaxResource»: public SamiObject {
public:
    SamiPageResource«StateTaxResource»();
    SamiPageResource«StateTaxResource»(String* json);
    virtual ~SamiPageResource«StateTaxResource»();
    ...
    SamiPageResource«StateTaxResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«StateTaxResource»_H_ */
