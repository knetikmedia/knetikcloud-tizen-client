...
SamiPageResource«QuestionTemplateResource»::SamiPageResource«QuestionTemplateResource»() {
    init();
}
...
void
SamiPageResource«QuestionTemplateResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«QuestionTemplateResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«QuestionTemplateResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«QuestionTemplateResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiQuestionTemplateResource");
        }
        delete pContentKey;
...
SamiPageResource«QuestionTemplateResource»::SamiPageResource«QuestionTemplateResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«QuestionTemplateResource»::asJson ()
{
...
JsonObject*
SamiPageResource«QuestionTemplateResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiQuestionTemplateResource", "array"));
...
IList*
SamiPageResource«QuestionTemplateResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«QuestionTemplateResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«QuestionTemplateResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«QuestionTemplateResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«QuestionTemplateResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«QuestionTemplateResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«QuestionTemplateResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«QuestionTemplateResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«QuestionTemplateResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«QuestionTemplateResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«QuestionTemplateResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«QuestionTemplateResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«QuestionTemplateResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«QuestionTemplateResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«QuestionTemplateResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«QuestionTemplateResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«QuestionTemplateResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«QuestionTemplateResource»::setPTotalPages(Integer* pTotal_pages) {
