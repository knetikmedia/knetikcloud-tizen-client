...
SamiPage«QuestionResource»::SamiPage«QuestionResource»() {
    init();
}
...
void
SamiPage«QuestionResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«QuestionResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«QuestionResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«QuestionResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«QuestionResource»::SamiPage«QuestionResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«QuestionResource»::asJson ()
{
...
JsonObject*
SamiPage«QuestionResource»::asJsonObject() {
...
IList*
SamiPage«QuestionResource»::getPContent() {
    return pContent;
}
void
SamiPage«QuestionResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«QuestionResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«QuestionResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«QuestionResource»::getPLast() {
    return pLast;
}
void
SamiPage«QuestionResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«QuestionResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«QuestionResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«QuestionResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«QuestionResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«QuestionResource»::getPSize() {
    return pSize;
}
void
SamiPage«QuestionResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«QuestionResource»::getPSort() {
    return pSort;
}
void
SamiPage«QuestionResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«QuestionResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«QuestionResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«QuestionResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«QuestionResource»::setPTotalPages(Integer* pTotal_pages) {
