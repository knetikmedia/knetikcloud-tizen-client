...
SamiPageResource«WalletTotalResponse»::SamiPageResource«WalletTotalResponse»() {
    init();
}
...
void
SamiPageResource«WalletTotalResponse»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«WalletTotalResponse»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«WalletTotalResponse»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«WalletTotalResponse»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiWalletTotalResponse");
        }
        delete pContentKey;
...
SamiPageResource«WalletTotalResponse»::SamiPageResource«WalletTotalResponse»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«WalletTotalResponse»::asJson ()
{
...
JsonObject*
SamiPageResource«WalletTotalResponse»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiWalletTotalResponse", "array"));
...
IList*
SamiPageResource«WalletTotalResponse»::getPContent() {
    return pContent;
}
void
SamiPageResource«WalletTotalResponse»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«WalletTotalResponse»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«WalletTotalResponse»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«WalletTotalResponse»::getPLast() {
    return pLast;
}
void
SamiPageResource«WalletTotalResponse»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«WalletTotalResponse»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«WalletTotalResponse»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«WalletTotalResponse»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«WalletTotalResponse»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«WalletTotalResponse»::getPSize() {
    return pSize;
}
void
SamiPageResource«WalletTotalResponse»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«WalletTotalResponse»::getPSort() {
    return pSort;
}
void
SamiPageResource«WalletTotalResponse»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«WalletTotalResponse»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«WalletTotalResponse»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«WalletTotalResponse»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«WalletTotalResponse»::setPTotalPages(Integer* pTotal_pages) {
