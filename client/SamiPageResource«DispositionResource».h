/*
 * SamiPageResource«DispositionResource».h
 * 
 * 
 */

#ifndef SamiPageResource«DispositionResource»_H_
#define SamiPageResource«DispositionResource»_H_
...
class SamiPageResource«DispositionResource»: public SamiObject {
public:
    SamiPageResource«DispositionResource»();
    SamiPageResource«DispositionResource»(String* json);
    virtual ~SamiPageResource«DispositionResource»();
    ...
    SamiPageResource«DispositionResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«DispositionResource»_H_ */
