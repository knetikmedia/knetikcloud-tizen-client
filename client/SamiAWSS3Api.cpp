...
void
preSignUrlUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
...
SamiAWSS3Api::preSignUrlUsingGETWithCompletion(String* filename, String* contentType, void (* success)(SamiAmazonS3Activity*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&preSignUrlUsingGETProcessor, (void(*)(void*, SamiError*))success);
