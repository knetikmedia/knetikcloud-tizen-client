...
SamiPage«TransactionResource»::SamiPage«TransactionResource»() {
    init();
}
...
void
SamiPage«TransactionResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«TransactionResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«TransactionResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«TransactionResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«TransactionResource»::SamiPage«TransactionResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«TransactionResource»::asJson ()
{
...
JsonObject*
SamiPage«TransactionResource»::asJsonObject() {
...
IList*
SamiPage«TransactionResource»::getPContent() {
    return pContent;
}
void
SamiPage«TransactionResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«TransactionResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«TransactionResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«TransactionResource»::getPLast() {
    return pLast;
}
void
SamiPage«TransactionResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«TransactionResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«TransactionResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«TransactionResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«TransactionResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«TransactionResource»::getPSize() {
    return pSize;
}
void
SamiPage«TransactionResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«TransactionResource»::getPSort() {
    return pSort;
}
void
SamiPage«TransactionResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«TransactionResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«TransactionResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«TransactionResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«TransactionResource»::setPTotalPages(Integer* pTotal_pages) {
