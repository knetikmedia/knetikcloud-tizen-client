...
SamiPage«UserLevelingResource»::SamiPage«UserLevelingResource»() {
    init();
}
...
void
SamiPage«UserLevelingResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«UserLevelingResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«UserLevelingResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«UserLevelingResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«UserLevelingResource»::SamiPage«UserLevelingResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«UserLevelingResource»::asJson ()
{
...
JsonObject*
SamiPage«UserLevelingResource»::asJsonObject() {
...
IList*
SamiPage«UserLevelingResource»::getPContent() {
    return pContent;
}
void
SamiPage«UserLevelingResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«UserLevelingResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«UserLevelingResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«UserLevelingResource»::getPLast() {
    return pLast;
}
void
SamiPage«UserLevelingResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«UserLevelingResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«UserLevelingResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«UserLevelingResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«UserLevelingResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«UserLevelingResource»::getPSize() {
    return pSize;
}
void
SamiPage«UserLevelingResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«UserLevelingResource»::getPSort() {
    return pSort;
}
void
SamiPage«UserLevelingResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«UserLevelingResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«UserLevelingResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«UserLevelingResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«UserLevelingResource»::setPTotalPages(Integer* pTotal_pages) {
