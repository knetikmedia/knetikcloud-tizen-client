...
#ifndef SamiPage«Config»_H_
#define SamiPage«Config»_H_
...
class SamiPage«Config»: public SamiObject {
public:
    SamiPage«Config»();
    SamiPage«Config»(String* json);
    virtual ~SamiPage«Config»();
    ...
    SamiPage«Config»* fromJson(String* obj);
