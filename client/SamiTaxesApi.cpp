...
SamiTaxesApi::getAllTaxesUsingGETWithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«StateTaxResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiTaxesApi::getTaxesUsingGETWithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«CountryTaxResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiPageResource«StateTaxResource»* 
SamiTaxesApi::getTaxesUsingGET1WithCompletion(String* countryCodeIso3, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«StateTaxResource»*, SamiError*)) {
  client = new SamiApiClient();
