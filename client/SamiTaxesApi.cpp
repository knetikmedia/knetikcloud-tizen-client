...
SamiTaxesApi::createCountryTaxWithCompletion(SamiCountryTaxResource* taxResource, void (* success)(SamiCountryTaxResource*, SamiError*)) {
...
SamiTaxesApi::createStateTaxWithCompletion(String* countryCodeIso3, SamiStateTaxResource* taxResource, void (* success)(SamiStateTaxResource*, SamiError*)) {
  client = new SamiApiClient();
...
void
getCountryTaxProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
SamiCountryTaxResource* 
SamiTaxesApi::getCountryTaxWithCompletion(String* countryCodeIso3, void (* success)(SamiCountryTaxResource*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&getCountryTaxProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
...
SamiCountryTaxResource* 
SamiTaxesApi::updateCountryTaxWithCompletion(String* countryCodeIso3, SamiCountryTaxResource* taxResource, void (* success)(SamiCountryTaxResource*, SamiError*)) {
  client = new SamiApiClient();
...
SamiStateTaxResource* 
SamiTaxesApi::updateStateTaxWithCompletion(String* countryCodeIso3, String* stateCode, SamiStateTaxResource* taxResource, void (* success)(SamiStateTaxResource*, SamiError*)) {
  client = new SamiApiClient();
