...
SamiPageResource«AggregateInvoiceReportResource»::SamiPageResource«AggregateInvoiceReportResource»() {
    init();
}
...
void
SamiPageResource«AggregateInvoiceReportResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«AggregateInvoiceReportResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«AggregateInvoiceReportResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«AggregateInvoiceReportResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiAggregateInvoiceReportResource");
        }
        delete pContentKey;
...
SamiPageResource«AggregateInvoiceReportResource»::SamiPageResource«AggregateInvoiceReportResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«AggregateInvoiceReportResource»::asJson ()
{
...
JsonObject*
SamiPageResource«AggregateInvoiceReportResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiAggregateInvoiceReportResource", "array"));
...
IList*
SamiPageResource«AggregateInvoiceReportResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«AggregateInvoiceReportResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«AggregateInvoiceReportResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«AggregateInvoiceReportResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«AggregateInvoiceReportResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«AggregateInvoiceReportResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«AggregateInvoiceReportResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«AggregateInvoiceReportResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«AggregateInvoiceReportResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«AggregateInvoiceReportResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«AggregateInvoiceReportResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«AggregateInvoiceReportResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«AggregateInvoiceReportResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«AggregateInvoiceReportResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«AggregateInvoiceReportResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«AggregateInvoiceReportResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«AggregateInvoiceReportResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«AggregateInvoiceReportResource»::setPTotalPages(Integer* pTotal_pages) {
