...
SamiPage«CampaignResource»::SamiPage«CampaignResource»() {
    init();
}
...
void
SamiPage«CampaignResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«CampaignResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«CampaignResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«CampaignResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«CampaignResource»::SamiPage«CampaignResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«CampaignResource»::asJson ()
{
...
JsonObject*
SamiPage«CampaignResource»::asJsonObject() {
...
IList*
SamiPage«CampaignResource»::getPContent() {
    return pContent;
}
void
SamiPage«CampaignResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«CampaignResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«CampaignResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«CampaignResource»::getPLast() {
    return pLast;
}
void
SamiPage«CampaignResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«CampaignResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«CampaignResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«CampaignResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«CampaignResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«CampaignResource»::getPSize() {
    return pSize;
}
void
SamiPage«CampaignResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«CampaignResource»::getPSort() {
    return pSort;
}
void
SamiPage«CampaignResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«CampaignResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«CampaignResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«CampaignResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«CampaignResource»::setPTotalPages(Integer* pTotal_pages) {
