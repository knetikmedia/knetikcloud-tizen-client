/*
 * SamiPageResource«BillingReport».h
 * 
 * 
 */

#ifndef SamiPageResource«BillingReport»_H_
#define SamiPageResource«BillingReport»_H_
...
class SamiPageResource«BillingReport»: public SamiObject {
public:
    SamiPageResource«BillingReport»();
    SamiPageResource«BillingReport»(String* json);
    virtual ~SamiPageResource«BillingReport»();
    ...
    SamiPageResource«BillingReport»* fromJson(String* obj);
...
#endif /* SamiPageResource«BillingReport»_H_ */
