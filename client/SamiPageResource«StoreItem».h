/*
 * SamiPageResource«StoreItem».h
 * 
 * 
 */

#ifndef SamiPageResource«StoreItem»_H_
#define SamiPageResource«StoreItem»_H_
...
class SamiPageResource«StoreItem»: public SamiObject {
public:
    SamiPageResource«StoreItem»();
    SamiPageResource«StoreItem»(String* json);
    virtual ~SamiPageResource«StoreItem»();
    ...
    SamiPageResource«StoreItem»* fromJson(String* obj);
...
#endif /* SamiPageResource«StoreItem»_H_ */
