/*
 * SamiPageResource«RewardSetResource».h
 * 
 * 
 */

#ifndef SamiPageResource«RewardSetResource»_H_
#define SamiPageResource«RewardSetResource»_H_
...
class SamiPageResource«RewardSetResource»: public SamiObject {
public:
    SamiPageResource«RewardSetResource»();
    SamiPageResource«RewardSetResource»(String* json);
    virtual ~SamiPageResource«RewardSetResource»();
    ...
    SamiPageResource«RewardSetResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«RewardSetResource»_H_ */
