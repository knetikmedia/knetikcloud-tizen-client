...
SamiPageResource«TemplateResource»::SamiPageResource«TemplateResource»() {
    init();
}
...
void
SamiPageResource«TemplateResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«TemplateResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«TemplateResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«TemplateResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiTemplateResource");
        }
        delete pContentKey;
...
SamiPageResource«TemplateResource»::SamiPageResource«TemplateResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«TemplateResource»::asJson ()
{
...
JsonObject*
SamiPageResource«TemplateResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiTemplateResource", "array"));
...
IList*
SamiPageResource«TemplateResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«TemplateResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«TemplateResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«TemplateResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«TemplateResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«TemplateResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«TemplateResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«TemplateResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«TemplateResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«TemplateResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«TemplateResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«TemplateResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«TemplateResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«TemplateResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«TemplateResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«TemplateResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«TemplateResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«TemplateResource»::setPTotalPages(Integer* pTotal_pages) {
