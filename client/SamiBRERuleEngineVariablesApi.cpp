...
void
getListUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
...
IList* 
SamiBRERuleEngineVariablesApi::getListUsingGETWithCompletion( void (* success)(IList*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&getListUsingGETProcessor, (void(*)(void*, SamiError*))success);
