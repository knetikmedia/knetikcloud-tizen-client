...
getUsageByDayUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiPage«UsageInfo»* out = new SamiPage«UsageInfo»();
    jsonToValue(out, pJson, L"SamiPage«UsageInfo»*", L"SamiPage«UsageInfo»");
...
SamiPage«UsageInfo»* 
SamiReportingUsageApi::getUsageByDayUsingGETWithCompletion(Long* startDate, Long* endDate, Boolean* combineEndpoints, Integer* size, Integer* page, void (* success)(SamiPage«UsageInfo»*, SamiError*)) {
...
SamiPage«UsageInfo»* 
SamiReportingUsageApi::getUsageByHourUsingGETWithCompletion(Long* startDate, Long* endDate, Boolean* combineEndpoints, Integer* size, Integer* page, void (* success)(SamiPage«UsageInfo»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiPage«UsageInfo»* 
SamiReportingUsageApi::getUsageByMinuteUsingGETWithCompletion(Long* startDate, Long* endDate, Boolean* combineEndpoints, Integer* size, Integer* page, void (* success)(SamiPage«UsageInfo»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiPage«UsageInfo»* 
SamiReportingUsageApi::getUsageByMonthUsingGETWithCompletion(Long* startDate, Long* endDate, Boolean* combineEndpoints, Integer* size, Integer* page, void (* success)(SamiPage«UsageInfo»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiPage«UsageInfo»* 
SamiReportingUsageApi::getUsageByYearUsingGETWithCompletion(Long* startDate, Long* endDate, Boolean* combineEndpoints, Integer* size, Integer* page, void (* success)(SamiPage«UsageInfo»*, SamiError*)) {
  client = new SamiApiClient();
