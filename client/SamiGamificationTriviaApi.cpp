...
getListUsingGET1Processor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiPage«ImportJobResource»* out = new SamiPage«ImportJobResource»();
    jsonToValue(out, pJson, L"SamiPage«ImportJobResource»*", L"SamiPage«ImportJobResource»");
...
SamiGamificationTriviaApi::getListUsingGET1WithCompletion(String* filterVendor, String* filterCategory, String* filterName, String* filterStatus, Integer* size, Integer* page, String* order, void (* success)(SamiPage«ImportJobResource»*, SamiError*)) {
  client = new SamiApiClient();
...
getQuestionTemplatesUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiPage«QuestionTemplateResource»* out = new SamiPage«QuestionTemplateResource»();
    jsonToValue(out, pJson, L"SamiPage«QuestionTemplateResource»*", L"SamiPage«QuestionTemplateResource»");
...
SamiGamificationTriviaApi::getQuestionTemplatesUsingGETWithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPage«QuestionTemplateResource»*, SamiError*)) {
  client = new SamiApiClient();
...
getQuestionsUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiPage«QuestionResource»* out = new SamiPage«QuestionResource»();
    jsonToValue(out, pJson, L"SamiPage«QuestionResource»*", L"SamiPage«QuestionResource»");
...
SamiGamificationTriviaApi::getQuestionsUsingGETWithCompletion(Integer* size, Integer* page, String* order, String* filterSearch, String* filterIdset, String* filterCategory, String* filterTagset, String* filterType, Boolean* filterPublished, Long* filterImportId, void (* success)(SamiPage«QuestionResource»*, SamiError*)) {
  client = new SamiApiClient();
