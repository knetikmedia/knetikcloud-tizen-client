...
void
getQuestionTags1Processor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
SamiGamificationTriviaApi::getQuestionTags1WithCompletion(String* filterSearch, String* filterCategory, Long* filterImportId, void (* success)(SamiCollection«string»*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&getQuestionTags1Processor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
