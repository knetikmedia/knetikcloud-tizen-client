...
SamiGamificationTriviaApi::getQuestionsWithCompletion(Integer* size, Integer* page, String* order, String* filterSearch, String* filterIdset, String* filterCategory, String* filterTagset, String* filterTag, String* filterType, Boolean* filterPublished, Long* filterImportId, void (* success)(SamiPageResource«QuestionResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiQuestionTemplateResource* 
SamiGamificationTriviaApi::updateQuestionTemplateWithCompletion(String* _id, SamiQuestionTemplateResource* questionTemplateResource, void (* success)(SamiQuestionTemplateResource*, SamiError*)) {
  client = new SamiApiClient();
