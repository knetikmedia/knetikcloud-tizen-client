...
SamiPage«RevenueProductReportResource»::SamiPage«RevenueProductReportResource»() {
    init();
}
...
void
SamiPage«RevenueProductReportResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«RevenueProductReportResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«RevenueProductReportResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«RevenueProductReportResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«RevenueProductReportResource»::SamiPage«RevenueProductReportResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«RevenueProductReportResource»::asJson ()
{
...
JsonObject*
SamiPage«RevenueProductReportResource»::asJsonObject() {
...
IList*
SamiPage«RevenueProductReportResource»::getPContent() {
    return pContent;
}
void
SamiPage«RevenueProductReportResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«RevenueProductReportResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«RevenueProductReportResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«RevenueProductReportResource»::getPLast() {
    return pLast;
}
void
SamiPage«RevenueProductReportResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«RevenueProductReportResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«RevenueProductReportResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«RevenueProductReportResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«RevenueProductReportResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«RevenueProductReportResource»::getPSize() {
    return pSize;
}
void
SamiPage«RevenueProductReportResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«RevenueProductReportResource»::getPSort() {
    return pSort;
}
void
SamiPage«RevenueProductReportResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«RevenueProductReportResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«RevenueProductReportResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«RevenueProductReportResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«RevenueProductReportResource»::setPTotalPages(Integer* pTotal_pages) {
