...
SamiPage«InvoiceLogEntry»::SamiPage«InvoiceLogEntry»() {
    init();
}
...
void
SamiPage«InvoiceLogEntry»::cleanup() {
    if(pContent != null) {
...
SamiPage«InvoiceLogEntry»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«InvoiceLogEntry»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«InvoiceLogEntry»::SamiPage«InvoiceLogEntry»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«InvoiceLogEntry»::asJson ()
{
...
JsonObject*
SamiPage«InvoiceLogEntry»::asJsonObject() {
...
IList*
SamiPage«InvoiceLogEntry»::getPContent() {
    return pContent;
}
void
SamiPage«InvoiceLogEntry»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«InvoiceLogEntry»::getPFirst() {
    return pFirst;
}
void
SamiPage«InvoiceLogEntry»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«InvoiceLogEntry»::getPLast() {
    return pLast;
}
void
SamiPage«InvoiceLogEntry»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«InvoiceLogEntry»::getPNumber() {
    return pNumber;
}
void
SamiPage«InvoiceLogEntry»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«InvoiceLogEntry»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«InvoiceLogEntry»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«InvoiceLogEntry»::getPSize() {
    return pSize;
}
void
SamiPage«InvoiceLogEntry»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«InvoiceLogEntry»::getPSort() {
    return pSort;
}
void
SamiPage«InvoiceLogEntry»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«InvoiceLogEntry»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«InvoiceLogEntry»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«InvoiceLogEntry»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«InvoiceLogEntry»::setPTotalPages(Integer* pTotal_pages) {
