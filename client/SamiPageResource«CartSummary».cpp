...
SamiPageResource«CartSummary»::SamiPageResource«CartSummary»() {
    init();
}
...
void
SamiPageResource«CartSummary»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«CartSummary»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«CartSummary»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«CartSummary»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiCartSummary");
        }
        delete pContentKey;
...
SamiPageResource«CartSummary»::SamiPageResource«CartSummary»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«CartSummary»::asJson ()
{
...
JsonObject*
SamiPageResource«CartSummary»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiCartSummary", "array"));
...
IList*
SamiPageResource«CartSummary»::getPContent() {
    return pContent;
}
void
SamiPageResource«CartSummary»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«CartSummary»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«CartSummary»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«CartSummary»::getPLast() {
    return pLast;
}
void
SamiPageResource«CartSummary»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«CartSummary»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«CartSummary»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«CartSummary»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«CartSummary»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«CartSummary»::getPSize() {
    return pSize;
}
void
SamiPageResource«CartSummary»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«CartSummary»::getPSort() {
    return pSort;
}
void
SamiPageResource«CartSummary»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«CartSummary»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«CartSummary»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«CartSummary»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«CartSummary»::setPTotalPages(Integer* pTotal_pages) {
