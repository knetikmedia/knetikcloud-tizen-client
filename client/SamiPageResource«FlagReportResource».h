/*
 * SamiPageResource«FlagReportResource».h
 * 
 * 
 */

#ifndef SamiPageResource«FlagReportResource»_H_
#define SamiPageResource«FlagReportResource»_H_
...
class SamiPageResource«FlagReportResource»: public SamiObject {
public:
    SamiPageResource«FlagReportResource»();
    SamiPageResource«FlagReportResource»(String* json);
    virtual ~SamiPageResource«FlagReportResource»();
    ...
    SamiPageResource«FlagReportResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«FlagReportResource»_H_ */
