/*
 * SamiPageResource«UserRelationshipResource».h
 * 
 * 
 */

#ifndef SamiPageResource«UserRelationshipResource»_H_
#define SamiPageResource«UserRelationshipResource»_H_
...
class SamiPageResource«UserRelationshipResource»: public SamiObject {
public:
    SamiPageResource«UserRelationshipResource»();
    SamiPageResource«UserRelationshipResource»(String* json);
    virtual ~SamiPageResource«UserRelationshipResource»();
    ...
    SamiPageResource«UserRelationshipResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«UserRelationshipResource»_H_ */
