...
SamiPageResource«DeviceResource»::SamiPageResource«DeviceResource»() {
    init();
}
...
void
SamiPageResource«DeviceResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«DeviceResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«DeviceResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«DeviceResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiDeviceResource");
        }
        delete pContentKey;
...
SamiPageResource«DeviceResource»::SamiPageResource«DeviceResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«DeviceResource»::asJson ()
{
...
JsonObject*
SamiPageResource«DeviceResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiDeviceResource", "array"));
...
IList*
SamiPageResource«DeviceResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«DeviceResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«DeviceResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«DeviceResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«DeviceResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«DeviceResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«DeviceResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«DeviceResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«DeviceResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«DeviceResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«DeviceResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«DeviceResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«DeviceResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«DeviceResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«DeviceResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«DeviceResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«DeviceResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«DeviceResource»::setPTotalPages(Integer* pTotal_pages) {
