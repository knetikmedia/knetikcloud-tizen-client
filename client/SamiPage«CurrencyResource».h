/*
 * SamiPage«CurrencyResource».h
 * 
 * 
 */

#ifndef SamiPage«CurrencyResource»_H_
#define SamiPage«CurrencyResource»_H_
...
class SamiPage«CurrencyResource»: public SamiObject {
public:
    SamiPage«CurrencyResource»();
    SamiPage«CurrencyResource»(String* json);
    virtual ~SamiPage«CurrencyResource»();
    ...
    SamiPage«CurrencyResource»* fromJson(String* obj);
...
#endif /* SamiPage«CurrencyResource»_H_ */
