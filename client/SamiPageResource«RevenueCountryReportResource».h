/*
 * SamiPageResource«RevenueCountryReportResource».h
 * 
 * 
 */

#ifndef SamiPageResource«RevenueCountryReportResource»_H_
#define SamiPageResource«RevenueCountryReportResource»_H_
...
class SamiPageResource«RevenueCountryReportResource»: public SamiObject {
public:
    SamiPageResource«RevenueCountryReportResource»();
    SamiPageResource«RevenueCountryReportResource»(String* json);
    virtual ~SamiPageResource«RevenueCountryReportResource»();
    ...
    SamiPageResource«RevenueCountryReportResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«RevenueCountryReportResource»_H_ */
