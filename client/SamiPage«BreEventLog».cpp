...
SamiPage«BreEventLog»::SamiPage«BreEventLog»() {
    init();
}
...
SamiPage«BreEventLog»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«BreEventLog»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«BreEventLog»::SamiPage«BreEventLog»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
JsonObject*
SamiPage«BreEventLog»::asJsonObject() {
...
IList*
SamiPage«BreEventLog»::getPContent() {
    return pContent;
}
void
SamiPage«BreEventLog»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«BreEventLog»::getPFirst() {
    return pFirst;
}
void
SamiPage«BreEventLog»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«BreEventLog»::getPLast() {
    return pLast;
}
void
SamiPage«BreEventLog»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«BreEventLog»::getPNumber() {
    return pNumber;
}
void
SamiPage«BreEventLog»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«BreEventLog»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«BreEventLog»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«BreEventLog»::getPSize() {
    return pSize;
}
void
SamiPage«BreEventLog»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«BreEventLog»::getPSort() {
    return pSort;
}
void
SamiPage«BreEventLog»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«BreEventLog»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«BreEventLog»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«BreEventLog»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«BreEventLog»::setPTotalPages(Integer* pTotal_pages) {
