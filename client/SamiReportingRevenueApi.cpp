...
executiveRevenueCountrySalesUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiPage«RevenueCountryReportResource»* out = new SamiPage«RevenueCountryReportResource»();
    jsonToValue(out, pJson, L"SamiPage«RevenueCountryReportResource»*", L"SamiPage«RevenueCountryReportResource»");
...
SamiReportingRevenueApi::executiveRevenueCountrySalesUsingGETWithCompletion(String* currencyCode, Long* startDate, Long* endDate, Integer* size, Integer* page, void (* success)(SamiPage«RevenueCountryReportResource»*, SamiError*)) {
...
executiveRevenueProductSalesUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiPage«RevenueProductReportResource»* out = new SamiPage«RevenueProductReportResource»();
    jsonToValue(out, pJson, L"SamiPage«RevenueProductReportResource»*", L"SamiPage«RevenueProductReportResource»");
...
SamiReportingRevenueApi::executiveRevenueProductSalesUsingGETWithCompletion(String* currencyCode, Long* startDate, Long* endDate, Integer* size, Integer* page, void (* success)(SamiPage«RevenueProductReportResource»*, SamiError*)) {
  client = new SamiApiClient();
