...
SamiClientResource* 
SamiAuthRolesApi::setClientRolesWithCompletion(String* clientKey, IList* rolesList, void (* success)(SamiClientResource*, SamiError*)) {
  client = new SamiApiClient();
...
SamiRoleResource* 
SamiAuthRolesApi::setPermissionsForRoleWithCompletion(String* role, IList* permissionsList, void (* success)(SamiRoleResource*, SamiError*)) {
  client = new SamiApiClient();
...
SamiUserResource* 
SamiAuthRolesApi::setUserRolesWithCompletion(Integer* userId, IList* rolesList, void (* success)(SamiUserResource*, SamiError*)) {
  client = new SamiApiClient();
...
SamiRoleResource* 
SamiAuthRolesApi::updateRoleWithCompletion(String* role, SamiRoleResource* roleResource, void (* success)(SamiRoleResource*, SamiError*)) {
  client = new SamiApiClient();
