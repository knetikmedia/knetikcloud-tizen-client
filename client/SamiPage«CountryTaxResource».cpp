...
SamiPage«CountryTaxResource»::SamiPage«CountryTaxResource»() {
    init();
}
...
void
SamiPage«CountryTaxResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«CountryTaxResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«CountryTaxResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«CountryTaxResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«CountryTaxResource»::SamiPage«CountryTaxResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«CountryTaxResource»::asJson ()
{
...
JsonObject*
SamiPage«CountryTaxResource»::asJsonObject() {
...
IList*
SamiPage«CountryTaxResource»::getPContent() {
    return pContent;
}
void
SamiPage«CountryTaxResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«CountryTaxResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«CountryTaxResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«CountryTaxResource»::getPLast() {
    return pLast;
}
void
SamiPage«CountryTaxResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«CountryTaxResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«CountryTaxResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«CountryTaxResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«CountryTaxResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«CountryTaxResource»::getPSize() {
    return pSize;
}
void
SamiPage«CountryTaxResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«CountryTaxResource»::getPSort() {
    return pSort;
}
void
SamiPage«CountryTaxResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«CountryTaxResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«CountryTaxResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«CountryTaxResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«CountryTaxResource»::setPTotalPages(Integer* pTotal_pages) {
