...
SamiPage«RewardSetResource»::SamiPage«RewardSetResource»() {
    init();
}
...
void
SamiPage«RewardSetResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«RewardSetResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«RewardSetResource»*
SamiPage«RewardSetResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«RewardSetResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«RewardSetResource»::SamiPage«RewardSetResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«RewardSetResource»::asJson ()
{
...
JsonObject*
SamiPage«RewardSetResource»::asJsonObject() {
...
IList*
SamiPage«RewardSetResource»::getPContent() {
    return pContent;
}
void
SamiPage«RewardSetResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«RewardSetResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«RewardSetResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«RewardSetResource»::getPLast() {
    return pLast;
}
void
SamiPage«RewardSetResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«RewardSetResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«RewardSetResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«RewardSetResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«RewardSetResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«RewardSetResource»::getPSize() {
    return pSize;
}
void
SamiPage«RewardSetResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«RewardSetResource»::getPSort() {
    return pSort;
}
void
SamiPage«RewardSetResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«RewardSetResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«RewardSetResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«RewardSetResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«RewardSetResource»::setPTotalPages(Integer* pTotal_pages) {
