...
SamiPage«CatalogSale»::SamiPage«CatalogSale»() {
    init();
}
...
SamiPage«CatalogSale»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«CatalogSale»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«CatalogSale»::SamiPage«CatalogSale»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
JsonObject*
SamiPage«CatalogSale»::asJsonObject() {
...
IList*
SamiPage«CatalogSale»::getPContent() {
    return pContent;
}
void
SamiPage«CatalogSale»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«CatalogSale»::getPFirst() {
    return pFirst;
}
void
SamiPage«CatalogSale»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«CatalogSale»::getPLast() {
    return pLast;
}
void
SamiPage«CatalogSale»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«CatalogSale»::getPNumber() {
    return pNumber;
}
void
SamiPage«CatalogSale»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«CatalogSale»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«CatalogSale»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«CatalogSale»::getPSize() {
    return pSize;
}
void
SamiPage«CatalogSale»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«CatalogSale»::getPSort() {
    return pSort;
}
void
SamiPage«CatalogSale»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«CatalogSale»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«CatalogSale»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«CatalogSale»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«CatalogSale»::setPTotalPages(Integer* pTotal_pages) {
