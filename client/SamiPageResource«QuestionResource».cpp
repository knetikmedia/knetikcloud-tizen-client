...
SamiPageResource«QuestionResource»::SamiPageResource«QuestionResource»() {
    init();
}
...
void
SamiPageResource«QuestionResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«QuestionResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«QuestionResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«QuestionResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiQuestionResource");
        }
        delete pContentKey;
...
SamiPageResource«QuestionResource»::SamiPageResource«QuestionResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«QuestionResource»::asJson ()
{
...
JsonObject*
SamiPageResource«QuestionResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiQuestionResource", "array"));
...
IList*
SamiPageResource«QuestionResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«QuestionResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«QuestionResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«QuestionResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«QuestionResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«QuestionResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«QuestionResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«QuestionResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«QuestionResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«QuestionResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«QuestionResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«QuestionResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«QuestionResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«QuestionResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«QuestionResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«QuestionResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«QuestionResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«QuestionResource»::setPTotalPages(Integer* pTotal_pages) {
