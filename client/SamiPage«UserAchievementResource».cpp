...
SamiPage«UserAchievementResource»::SamiPage«UserAchievementResource»() {
    init();
}
...
void
SamiPage«UserAchievementResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«UserAchievementResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«UserAchievementResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«UserAchievementResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiUserAchievementResource");
        }
        delete pContentKey;
...
SamiPage«UserAchievementResource»::SamiPage«UserAchievementResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«UserAchievementResource»::asJson ()
{
...
JsonObject*
SamiPage«UserAchievementResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiUserAchievementResource", "array"));
...
IList*
SamiPage«UserAchievementResource»::getPContent() {
    return pContent;
}
void
SamiPage«UserAchievementResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«UserAchievementResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«UserAchievementResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«UserAchievementResource»::getPLast() {
    return pLast;
}
void
SamiPage«UserAchievementResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«UserAchievementResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«UserAchievementResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«UserAchievementResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«UserAchievementResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«UserAchievementResource»::getPSize() {
    return pSize;
}
void
SamiPage«UserAchievementResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«UserAchievementResource»::getPSort() {
    return pSort;
}
void
SamiPage«UserAchievementResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«UserAchievementResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«UserAchievementResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«UserAchievementResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«UserAchievementResource»::setPTotalPages(Integer* pTotal_pages) {
