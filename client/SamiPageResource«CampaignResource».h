/*
 * SamiPageResource«CampaignResource».h
 * 
 * 
 */

#ifndef SamiPageResource«CampaignResource»_H_
#define SamiPageResource«CampaignResource»_H_
...
class SamiPageResource«CampaignResource»: public SamiObject {
public:
    SamiPageResource«CampaignResource»();
    SamiPageResource«CampaignResource»(String* json);
    virtual ~SamiPageResource«CampaignResource»();
    ...
    SamiPageResource«CampaignResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«CampaignResource»_H_ */
