...
SamiPageResource«ItemTemplateResource»::SamiPageResource«ItemTemplateResource»() {
    init();
}
...
void
SamiPageResource«ItemTemplateResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«ItemTemplateResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«ItemTemplateResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«ItemTemplateResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiItemTemplateResource");
        }
        delete pContentKey;
...
SamiPageResource«ItemTemplateResource»::SamiPageResource«ItemTemplateResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«ItemTemplateResource»::asJson ()
{
...
JsonObject*
SamiPageResource«ItemTemplateResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiItemTemplateResource", "array"));
...
IList*
SamiPageResource«ItemTemplateResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«ItemTemplateResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«ItemTemplateResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«ItemTemplateResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«ItemTemplateResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«ItemTemplateResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«ItemTemplateResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«ItemTemplateResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«ItemTemplateResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«ItemTemplateResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«ItemTemplateResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«ItemTemplateResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«ItemTemplateResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«ItemTemplateResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«ItemTemplateResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«ItemTemplateResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«ItemTemplateResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«ItemTemplateResource»::setPTotalPages(Integer* pTotal_pages) {
