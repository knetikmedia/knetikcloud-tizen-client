...
SamiPage«EntitlementItem»::SamiPage«EntitlementItem»() {
    init();
}
...
void
SamiPage«EntitlementItem»::cleanup() {
    if(pContent != null) {
...
SamiPage«EntitlementItem»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«EntitlementItem»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«EntitlementItem»::SamiPage«EntitlementItem»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«EntitlementItem»::asJson ()
{
...
JsonObject*
SamiPage«EntitlementItem»::asJsonObject() {
...
IList*
SamiPage«EntitlementItem»::getPContent() {
    return pContent;
}
void
SamiPage«EntitlementItem»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«EntitlementItem»::getPFirst() {
    return pFirst;
}
void
SamiPage«EntitlementItem»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«EntitlementItem»::getPLast() {
    return pLast;
}
void
SamiPage«EntitlementItem»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«EntitlementItem»::getPNumber() {
    return pNumber;
}
void
SamiPage«EntitlementItem»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«EntitlementItem»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«EntitlementItem»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«EntitlementItem»::getPSize() {
    return pSize;
}
void
SamiPage«EntitlementItem»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«EntitlementItem»::getPSort() {
    return pSort;
}
void
SamiPage«EntitlementItem»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«EntitlementItem»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«EntitlementItem»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«EntitlementItem»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«EntitlementItem»::setPTotalPages(Integer* pTotal_pages) {
