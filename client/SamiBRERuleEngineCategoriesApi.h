...
public:
  ...
  SamiBreCategoryResource* 
  updateBRECategoryWithCompletion(String* name, SamiBreCategoryResource* category, void (* handler)(SamiBreCategoryResource*, SamiError*));
  SamiTemplateResource* 
  updateBRECategoryTemplateWithCompletion(String* _id, SamiTemplateResource* template, void (* handler)(SamiTemplateResource*, SamiError*));
