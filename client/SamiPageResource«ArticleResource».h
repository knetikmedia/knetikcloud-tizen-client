/*
 * SamiPageResource«ArticleResource».h
 * 
 * 
 */

#ifndef SamiPageResource«ArticleResource»_H_
#define SamiPageResource«ArticleResource»_H_
...
class SamiPageResource«ArticleResource»: public SamiObject {
public:
    SamiPageResource«ArticleResource»();
    SamiPageResource«ArticleResource»(String* json);
    virtual ~SamiPageResource«ArticleResource»();
    ...
    SamiPageResource«ArticleResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«ArticleResource»_H_ */
