/*
 * SamiPage«AggregateInvoiceReportResource».h
 * 
 * 
 */

#ifndef SamiPage«AggregateInvoiceReportResource»_H_
#define SamiPage«AggregateInvoiceReportResource»_H_
...
class SamiPage«AggregateInvoiceReportResource»: public SamiObject {
public:
    SamiPage«AggregateInvoiceReportResource»();
    SamiPage«AggregateInvoiceReportResource»(String* json);
    virtual ~SamiPage«AggregateInvoiceReportResource»();
    ...
    SamiPage«AggregateInvoiceReportResource»* fromJson(String* obj);
...
#endif /* SamiPage«AggregateInvoiceReportResource»_H_ */
