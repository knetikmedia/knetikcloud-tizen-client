/*
 * SamiPage«CatalogSale».h
 * 
 * 
 */

#ifndef SamiPage«CatalogSale»_H_
#define SamiPage«CatalogSale»_H_
...
class SamiPage«CatalogSale»: public SamiObject {
public:
    SamiPage«CatalogSale»();
    SamiPage«CatalogSale»(String* json);
    virtual ~SamiPage«CatalogSale»();
    ...
    SamiPage«CatalogSale»* fromJson(String* obj);
...
#endif /* SamiPage«CatalogSale»_H_ */
