/*
 * SamiPage«FlagReportResource».h
 * 
 * 
 */

#ifndef SamiPage«FlagReportResource»_H_
#define SamiPage«FlagReportResource»_H_
...
class SamiPage«FlagReportResource»: public SamiObject {
public:
    SamiPage«FlagReportResource»();
    SamiPage«FlagReportResource»(String* json);
    virtual ~SamiPage«FlagReportResource»();
    ...
    SamiPage«FlagReportResource»* fromJson(String* obj);
...
#endif /* SamiPage«FlagReportResource»_H_ */
