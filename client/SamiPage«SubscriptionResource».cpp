...
SamiPage«SubscriptionResource»::SamiPage«SubscriptionResource»() {
    init();
}
...
void
SamiPage«SubscriptionResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«SubscriptionResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«SubscriptionResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«SubscriptionResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«SubscriptionResource»::SamiPage«SubscriptionResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«SubscriptionResource»::asJson ()
{
...
JsonObject*
SamiPage«SubscriptionResource»::asJsonObject() {
...
IList*
SamiPage«SubscriptionResource»::getPContent() {
    return pContent;
}
void
SamiPage«SubscriptionResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«SubscriptionResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«SubscriptionResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«SubscriptionResource»::getPLast() {
    return pLast;
}
void
SamiPage«SubscriptionResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«SubscriptionResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«SubscriptionResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«SubscriptionResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«SubscriptionResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«SubscriptionResource»::getPSize() {
    return pSize;
}
void
SamiPage«SubscriptionResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«SubscriptionResource»::getPSort() {
    return pSort;
}
void
SamiPage«SubscriptionResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«SubscriptionResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«SubscriptionResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«SubscriptionResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«SubscriptionResource»::setPTotalPages(Integer* pTotal_pages) {
