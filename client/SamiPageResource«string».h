/*
 * SamiPageResource«string».h
 * 
 * 
 */

#ifndef SamiPageResource«string»_H_
#define SamiPageResource«string»_H_
...
class SamiPageResource«string»: public SamiObject {
public:
    SamiPageResource«string»();
    SamiPageResource«string»(String* json);
    virtual ~SamiPageResource«string»();
    ...
    SamiPageResource«string»* fromJson(String* obj);
...
#endif /* SamiPageResource«string»_H_ */
