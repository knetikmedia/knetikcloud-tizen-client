/*
 * SamiPageResource«AchievementDefinitionResource».h
 * 
 * 
 */

#ifndef SamiPageResource«AchievementDefinitionResource»_H_
#define SamiPageResource«AchievementDefinitionResource»_H_
...
class SamiPageResource«AchievementDefinitionResource»: public SamiObject {
public:
    SamiPageResource«AchievementDefinitionResource»();
    SamiPageResource«AchievementDefinitionResource»(String* json);
    virtual ~SamiPageResource«AchievementDefinitionResource»();
    ...
    SamiPageResource«AchievementDefinitionResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«AchievementDefinitionResource»_H_ */
