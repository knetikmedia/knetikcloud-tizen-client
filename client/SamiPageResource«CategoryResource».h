/*
 * SamiPageResource«CategoryResource».h
 * 
 * 
 */

#ifndef SamiPageResource«CategoryResource»_H_
#define SamiPageResource«CategoryResource»_H_
...
class SamiPageResource«CategoryResource»: public SamiObject {
public:
    SamiPageResource«CategoryResource»();
    SamiPageResource«CategoryResource»(String* json);
    virtual ~SamiPageResource«CategoryResource»();
    ...
    SamiPageResource«CategoryResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«CategoryResource»_H_ */
