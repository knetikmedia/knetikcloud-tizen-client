...
SamiMediaArtistsApi::getArtistTemplatesUsingGETWithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«TemplateResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiMediaArtistsApi::searchArtistsUsingGETWithCompletion(String* filterArtistsByName, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«ArtistResource»*, SamiError*)) {
  client = new SamiApiClient();
