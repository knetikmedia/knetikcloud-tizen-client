...
SamiBRERuleEngineRulesApi::getRulesUsingGETWithCompletion(String* filterName, Boolean* filterEnabled, Boolean* filterSystem, String* filterTrigger, String* filterAction, String* filterCondition, Integer* size, Integer* page, void (* success)(SamiPageResource«BreRule»*, SamiError*)) {
  client = new SamiApiClient();
