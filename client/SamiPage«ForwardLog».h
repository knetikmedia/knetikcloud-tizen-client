/*
 * SamiPage«ForwardLog».h
 * 
 * 
 */

#ifndef SamiPage«ForwardLog»_H_
#define SamiPage«ForwardLog»_H_
...
class SamiPage«ForwardLog»: public SamiObject {
public:
    SamiPage«ForwardLog»();
    SamiPage«ForwardLog»(String* json);
    virtual ~SamiPage«ForwardLog»();
    ...
    SamiPage«ForwardLog»* fromJson(String* obj);
