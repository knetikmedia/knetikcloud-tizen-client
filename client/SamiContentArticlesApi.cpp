...
SamiContentArticlesApi::getArticleTemplatesUsingGETWithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«TemplateResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiContentArticlesApi::getArticlesUsingGETWithCompletion(String* filterCategory, String* filterTagset, String* filterTitle, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«ArticleResource»*, SamiError*)) {
  client = new SamiApiClient();
