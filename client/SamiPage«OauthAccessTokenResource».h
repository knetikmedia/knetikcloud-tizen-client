/*
 * SamiPage«OauthAccessTokenResource».h
 * 
 * 
 */

#ifndef SamiPage«OauthAccessTokenResource»_H_
#define SamiPage«OauthAccessTokenResource»_H_
...
class SamiPage«OauthAccessTokenResource»: public SamiObject {
public:
    SamiPage«OauthAccessTokenResource»();
    SamiPage«OauthAccessTokenResource»(String* json);
    virtual ~SamiPage«OauthAccessTokenResource»();
    ...
    SamiPage«OauthAccessTokenResource»* fromJson(String* obj);
...
#endif /* SamiPage«OauthAccessTokenResource»_H_ */
