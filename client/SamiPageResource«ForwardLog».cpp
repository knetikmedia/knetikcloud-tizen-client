...
SamiPageResource«ForwardLog»::SamiPageResource«ForwardLog»() {
    init();
}
...
void
SamiPageResource«ForwardLog»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«ForwardLog»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«ForwardLog»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«ForwardLog»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiForwardLog");
        }
        delete pContentKey;
...
SamiPageResource«ForwardLog»::SamiPageResource«ForwardLog»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«ForwardLog»::asJson ()
{
...
JsonObject*
SamiPageResource«ForwardLog»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiForwardLog", "array"));
...
IList*
SamiPageResource«ForwardLog»::getPContent() {
    return pContent;
}
void
SamiPageResource«ForwardLog»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«ForwardLog»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«ForwardLog»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«ForwardLog»::getPLast() {
    return pLast;
}
void
SamiPageResource«ForwardLog»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«ForwardLog»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«ForwardLog»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«ForwardLog»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«ForwardLog»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«ForwardLog»::getPSize() {
    return pSize;
}
void
SamiPageResource«ForwardLog»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«ForwardLog»::getPSort() {
    return pSort;
}
void
SamiPageResource«ForwardLog»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«ForwardLog»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«ForwardLog»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«ForwardLog»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«ForwardLog»::setPTotalPages(Integer* pTotal_pages) {
