...
SamiPage«StoreItem»::SamiPage«StoreItem»() {
    init();
}
...
SamiPage«StoreItem»*
SamiPage«StoreItem»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«StoreItem»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«StoreItem»::SamiPage«StoreItem»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
JsonObject*
SamiPage«StoreItem»::asJsonObject() {
...
IList*
SamiPage«StoreItem»::getPContent() {
    return pContent;
}
void
SamiPage«StoreItem»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«StoreItem»::getPFirst() {
    return pFirst;
}
void
SamiPage«StoreItem»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«StoreItem»::getPLast() {
    return pLast;
}
void
SamiPage«StoreItem»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«StoreItem»::getPNumber() {
    return pNumber;
}
void
SamiPage«StoreItem»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«StoreItem»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«StoreItem»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«StoreItem»::getPSize() {
    return pSize;
}
void
SamiPage«StoreItem»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«StoreItem»::getPSort() {
    return pSort;
}
void
SamiPage«StoreItem»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«StoreItem»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«StoreItem»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«StoreItem»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«StoreItem»::setPTotalPages(Integer* pTotal_pages) {
