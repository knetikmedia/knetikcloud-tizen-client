...
getConfigsUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiPage«Config»* out = new SamiPage«Config»();
    jsonToValue(out, pJson, L"SamiPage«Config»*", L"SamiPage«Config»");
...
SamiPage«Config»* 
SamiConfigsApi::getConfigsUsingGETWithCompletion(String* filterSearch, Integer* size, Integer* page, String* order, void (* success)(SamiPage«Config»*, SamiError*)) {
  client = new SamiApiClient();
