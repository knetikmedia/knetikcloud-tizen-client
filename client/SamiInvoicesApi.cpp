...
SamiInvoicesApi::getInvoicesWithCompletion(Integer* filterUser, String* filterEmail, String* filterFulfillmentStatus, String* filterPaymentStatus, String* filterItemName, String* filterExternalRef, String* filterCreatedDate, String* filterVendorIds, String* filterCurrency, String* filterShippingStateName, String* filterShippingCountryName, String* filterShipping, String* filterVendorName, String* filterSku, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«InvoiceResource»*, SamiError*)) {
  client = new SamiApiClient();
  ...
  queryParams->Construct();
    ...
    queryParams->Add(new String("filter_vendor_ids"), filterVendorIds);

    queryParams->Add(new String("filter_currency"), filterCurrency);

    queryParams->Add(new String("filter_shipping_state_name"), filterShippingStateName);

    queryParams->Add(new String("filter_shipping_country_name"), filterShippingCountryName);

    queryParams->Add(new String("filter_shipping"), filterShipping);

    queryParams->Add(new String("filter_vendor_name"), filterVendorName);
...
void
setBundledInvoiceItemFulfillmentStatusProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
void 
SamiInvoicesApi::setBundledInvoiceItemFulfillmentStatusWithCompletion(Integer* _id, String* bundleSku, String* sku, String* status, void(*success)(SamiError*)) {
  client = new SamiApiClient();

  client->success(&setBundledInvoiceItemFulfillmentStatusProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
  ...
  String url(L"/invoices/{id}/items/{bundleSku}/bundled-skus/{sku}/fulfillment-status");

  String s__id(L"{");
  s__id.Append(L"id");
  s__id.Append(L"}");
  url.Replace(s__id, stringify(_id, L"Integer*"));
  String s_bundleSku(L"{");
  s_bundleSku.Append(L"bundleSku");
  s_bundleSku.Append(L"}");
  url.Replace(s_bundleSku, stringify(bundleSku, L"String*"));
  String s_sku(L"{");
  s_sku.Append(L"sku");
  s_sku.Append(L"}");
