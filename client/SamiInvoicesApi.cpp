...
SamiInvoicesApi::getInvoicesWithCompletion(Integer* filterUser, String* filterEmail, String* filterFulfillmentStatus, String* filterPaymentStatus, String* filterItemName, String* filterCreatedDate, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«InvoiceResource»*, SamiError*)) {
  client = new SamiApiClient();
...
void
listFulFillmentStatusesProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
IList* 
SamiInvoicesApi::listFulFillmentStatusesWithCompletion( void (* success)(IList*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&listFulFillmentStatusesProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
...
void
listPaymentStatusesProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
IList* 
SamiInvoicesApi::listPaymentStatusesWithCompletion( void (* success)(IList*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&listPaymentStatusesProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
