...
SamiInvoicesApi::getInvoiceHistoryUsingGETWithCompletion(Integer* filterUser, String* filterEmail, String* filterFulfillmentStatus, String* filterPaymentStatus, String* filterItemName, String* filterCreatedDate, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«InvoiceResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInvoiceResource* 
SamiInvoicesApi::getInvoiceUsingGETWithCompletion(Integer* _id, void (* success)(SamiInvoiceResource*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInvoicesApi::getLogsUsingGETWithCompletion(Integer* _id, Integer* size, Integer* page, void (* success)(SamiPageResource«InvoiceLogEntry»*, SamiError*)) {
  client = new SamiApiClient();
...
void
setOrderNotesUsingPUTProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
void 
SamiInvoicesApi::setOrderNotesUsingPUTWithCompletion(Integer* _id, String* orderNotes, void(*success)(SamiError*)) {
  client = new SamiApiClient();

  client->success(&setOrderNotesUsingPUTProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
