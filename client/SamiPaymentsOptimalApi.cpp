...
void
silentPostOptimalProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
...
String* 
SamiPaymentsOptimalApi::silentPostOptimalWithCompletion(SamiOptimalPaymentRequest* request, void (* success)(String*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&silentPostOptimalProcessor, (void(*)(void*, SamiError*))success);
