/*
 * SamiPageResource«ChallengeEventResource».h
 * 
 * 
 */

#ifndef SamiPageResource«ChallengeEventResource»_H_
#define SamiPageResource«ChallengeEventResource»_H_
...
class SamiPageResource«ChallengeEventResource»: public SamiObject {
public:
    SamiPageResource«ChallengeEventResource»();
    SamiPageResource«ChallengeEventResource»(String* json);
    virtual ~SamiPageResource«ChallengeEventResource»();
    ...
    SamiPageResource«ChallengeEventResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«ChallengeEventResource»_H_ */
