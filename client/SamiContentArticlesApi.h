...
public:
  ...
  getArticlesWithCompletion(String* filterCategory, String* filterTagset, String* filterTagIntersection, String* filterTagExclusion, String* filterTitle, Integer* size, Integer* page, String* order, void (* handler)(SamiPageResource«ArticleResource»*, SamiError*));
  SamiArticleResource* 
