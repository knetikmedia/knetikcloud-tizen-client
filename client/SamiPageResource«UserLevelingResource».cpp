...
SamiPageResource«UserLevelingResource»::SamiPageResource«UserLevelingResource»() {
    init();
}
...
void
SamiPageResource«UserLevelingResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«UserLevelingResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«UserLevelingResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«UserLevelingResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiUserLevelingResource");
        }
        delete pContentKey;
...
SamiPageResource«UserLevelingResource»::SamiPageResource«UserLevelingResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«UserLevelingResource»::asJson ()
{
...
JsonObject*
SamiPageResource«UserLevelingResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiUserLevelingResource", "array"));
...
IList*
SamiPageResource«UserLevelingResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«UserLevelingResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«UserLevelingResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«UserLevelingResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«UserLevelingResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«UserLevelingResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«UserLevelingResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«UserLevelingResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«UserLevelingResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«UserLevelingResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«UserLevelingResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«UserLevelingResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«UserLevelingResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«UserLevelingResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«UserLevelingResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«UserLevelingResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«UserLevelingResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«UserLevelingResource»::setPTotalPages(Integer* pTotal_pages) {
