...
SamiBundleItem* 
SamiStoreBundlesApi::createBundleItemWithCompletion(Boolean* cascade, SamiBundleItem* bundleItem, void (* success)(SamiBundleItem*, SamiError*)) {
...
SamiBundleItem* 
SamiStoreBundlesApi::updateBundleItemWithCompletion(Integer* _id, Boolean* cascade, SamiBundleItem* bundleItem, void (* success)(SamiBundleItem*, SamiError*)) {
  client = new SamiApiClient();
...
SamiItemTemplateResource* 
SamiStoreBundlesApi::updateBundleTemplateWithCompletion(String* _id, SamiItemTemplateResource* bundleTemplateResource, void (* success)(SamiItemTemplateResource*, SamiError*)) {
  client = new SamiApiClient();
