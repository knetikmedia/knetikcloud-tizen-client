...
SamiPageResource«SubscriptionResource»::SamiPageResource«SubscriptionResource»() {
    init();
}
...
void
SamiPageResource«SubscriptionResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«SubscriptionResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«SubscriptionResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«SubscriptionResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiSubscriptionResource");
        }
        delete pContentKey;
...
SamiPageResource«SubscriptionResource»::SamiPageResource«SubscriptionResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«SubscriptionResource»::asJson ()
{
...
JsonObject*
SamiPageResource«SubscriptionResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiSubscriptionResource", "array"));
...
IList*
SamiPageResource«SubscriptionResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«SubscriptionResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«SubscriptionResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«SubscriptionResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«SubscriptionResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«SubscriptionResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«SubscriptionResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«SubscriptionResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«SubscriptionResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«SubscriptionResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«SubscriptionResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«SubscriptionResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«SubscriptionResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«SubscriptionResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«SubscriptionResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«SubscriptionResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«SubscriptionResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«SubscriptionResource»::setPTotalPages(Integer* pTotal_pages) {
