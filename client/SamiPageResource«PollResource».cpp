...
SamiPageResource«PollResource»::SamiPageResource«PollResource»() {
    init();
}
...
void
SamiPageResource«PollResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«PollResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«PollResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«PollResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiPollResource");
        }
        delete pContentKey;
...
SamiPageResource«PollResource»::SamiPageResource«PollResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«PollResource»::asJson ()
{
...
JsonObject*
SamiPageResource«PollResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiPollResource", "array"));
...
IList*
SamiPageResource«PollResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«PollResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«PollResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«PollResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«PollResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«PollResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«PollResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«PollResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«PollResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«PollResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«PollResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«PollResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«PollResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«PollResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«PollResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«PollResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«PollResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«PollResource»::setPTotalPages(Integer* pTotal_pages) {
