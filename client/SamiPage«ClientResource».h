/*
 * SamiPage«ClientResource».h
 * 
 * 
 */

#ifndef SamiPage«ClientResource»_H_
#define SamiPage«ClientResource»_H_
...
class SamiPage«ClientResource»: public SamiObject {
public:
    SamiPage«ClientResource»();
    SamiPage«ClientResource»(String* json);
    virtual ~SamiPage«ClientResource»();
    ...
    SamiPage«ClientResource»* fromJson(String* obj);
...
#endif /* SamiPage«ClientResource»_H_ */
