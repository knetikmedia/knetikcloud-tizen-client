/*
 * SamiPage«DeviceResource».h
 * 
 * 
 */

#ifndef SamiPage«DeviceResource»_H_
#define SamiPage«DeviceResource»_H_
...
class SamiPage«DeviceResource»: public SamiObject {
public:
    SamiPage«DeviceResource»();
    SamiPage«DeviceResource»(String* json);
    virtual ~SamiPage«DeviceResource»();
    ...
    SamiPage«DeviceResource»* fromJson(String* obj);
...
#endif /* SamiPage«DeviceResource»_H_ */
