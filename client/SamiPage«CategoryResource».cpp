...
SamiPage«CategoryResource»::SamiPage«CategoryResource»() {
    init();
}
...
void
SamiPage«CategoryResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«CategoryResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«CategoryResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«CategoryResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«CategoryResource»::SamiPage«CategoryResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«CategoryResource»::asJson ()
{
...
JsonObject*
SamiPage«CategoryResource»::asJsonObject() {
...
IList*
SamiPage«CategoryResource»::getPContent() {
    return pContent;
}
void
SamiPage«CategoryResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«CategoryResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«CategoryResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«CategoryResource»::getPLast() {
    return pLast;
}
void
SamiPage«CategoryResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«CategoryResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«CategoryResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«CategoryResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«CategoryResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«CategoryResource»::getPSize() {
    return pSize;
}
void
SamiPage«CategoryResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«CategoryResource»::getPSort() {
    return pSort;
}
void
SamiPage«CategoryResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«CategoryResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«CategoryResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«CategoryResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«CategoryResource»::setPTotalPages(Integer* pTotal_pages) {
