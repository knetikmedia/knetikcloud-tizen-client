...
public:
  ...
  getActivitiesUsingGETWithCompletion(Boolean* filterTemplate, Integer* size, Integer* page, String* order, void (* handler)(SamiPageResource«BareActivityResource»*, SamiError*));
  SamiActivityResource* 
