...
public:
  ...
  getActivitiesWithCompletion(Boolean* filterTemplate, Integer* size, Integer* page, String* order, void (* handler)(SamiPageResource«BareActivityResource»*, SamiError*));
  SamiActivityResource* 
  ...
  void 
  updateActivityWithCompletion(Long* _id, SamiActivityResource* activityResource, void(* handler)(SamiError*));
  void 
