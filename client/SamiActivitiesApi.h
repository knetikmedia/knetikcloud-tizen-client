...
public:
  ...
  setActivityOccurrenceResultsWithCompletion(Long* activityOccurrenceId, SamiActivityOccurrenceResultsResource* activityOccurrenceResults, void (* handler)(SamiActivityOccurrenceResults*, SamiError*));
  SamiActivityResource* 
