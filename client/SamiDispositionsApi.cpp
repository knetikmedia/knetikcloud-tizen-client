...
SamiDispositionsApi::getDispositionsUsingGETWithCompletion(String* filterContext, String* filterOwner, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«DispositionResource»*, SamiError*)) {
  client = new SamiApiClient();
