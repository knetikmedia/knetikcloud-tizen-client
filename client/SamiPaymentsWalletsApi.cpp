...
SamiPaymentsWalletsApi::getWalletTotalsUsingGETWithCompletion( void (* success)(SamiPageResource«WalletTotalResponse»*, SamiError*)) {
...
SamiPaymentsWalletsApi::getWalletsUsingGET1WithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«SimpleWallet»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiPaymentsWalletsApi::transactionHistoryUsingGETWithCompletion(Integer* filterInvoice, String* filterType, Long* filterMaxDate, Long* filterMinDate, String* filterSign, Integer* filterUserId, String* filterUsername, String* filterDetails, String* filterCurrencyCode, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«WalletTransactionResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiPageResource«WalletTransactionResource»* 
SamiPaymentsWalletsApi::userTransactionHistoryUsingGETWithCompletion(Integer* userId, String* currencyCode, String* filterType, Long* filterMaxDate, Long* filterMinDate, String* filterSign, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«WalletTransactionResource»*, SamiError*)) {
  client = new SamiApiClient();
