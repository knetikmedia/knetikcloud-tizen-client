...
SamiLogsApi::getEventsLogsUsingGETWithCompletion(String* filterStartDate, String* filterEventName, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«BreEventLog»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiLogsApi::getForwardLogsUsingGETWithCompletion(String* filterStartDate, String* filterEndDate, Integer* filterStatusCode, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«ForwardLog»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiLogsApi::getUserLogsUsingGET1WithCompletion(Integer* filterUser, String* filterActionName, Integer* size, Integer* page, void (* success)(SamiPageResource«UserActionLog»*, SamiError*)) {
  client = new SamiApiClient();
