...
SamiLogsApi::getBREEventLogsWithCompletion(String* filterStartDate, String* filterEventName, String* filterEventId, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«BreEventLog»*, SamiError*)) {
  client = new SamiApiClient();
  ...
  queryParams->Construct();
    ...
    queryParams->Add(new String("filter_event_id"), filterEventId);
...
SamiLogsApi::getUserLogsWithCompletion(Integer* filterUser, String* filterActionName, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«UserActionLog»*, SamiError*)) {
  client = new SamiApiClient();
