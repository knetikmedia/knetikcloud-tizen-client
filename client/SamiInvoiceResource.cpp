...
if(pExternal_ref != null) {
        
        delete pExternal_ref;
        pExternal_ref = null;
    }
if(pFed_tax != null) {
...
JsonString* pEmailKey = new JsonString(L"email");
        ...
        delete pEmailKey;
JsonString* pExternal_refKey = new JsonString(L"external_ref");
        IJsonValue* pExternal_refVal = null;
        pJsonObject->GetValue(pExternal_refKey, pExternal_refVal);
        if(pExternal_refVal != null) {
            
            pExternal_ref = new String();
            jsonToValue(pExternal_ref, pExternal_refVal, L"String", L"String");
        }
        delete pExternal_refKey;
...
SamiInvoiceResource::asJsonObject() {
    ...
    JsonString *pExternal_refKey = new JsonString(L"external_ref");
    pJsonObject->Add(pExternal_refKey, toJson(getPExternalRef(), "String", ""));
...
String*
SamiInvoiceResource::getPExternalRef() {
    return pExternal_ref;
}
void
SamiInvoiceResource::setPExternalRef(String* pExternal_ref) {
    this->pExternal_ref = pExternal_ref;
}
