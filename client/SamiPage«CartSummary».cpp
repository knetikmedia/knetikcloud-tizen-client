...
SamiPage«CartSummary»::SamiPage«CartSummary»() {
    init();
}
...
SamiPage«CartSummary»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«CartSummary»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«CartSummary»::SamiPage«CartSummary»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
JsonObject*
SamiPage«CartSummary»::asJsonObject() {
...
IList*
SamiPage«CartSummary»::getPContent() {
    return pContent;
}
void
SamiPage«CartSummary»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«CartSummary»::getPFirst() {
    return pFirst;
}
void
SamiPage«CartSummary»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«CartSummary»::getPLast() {
    return pLast;
}
void
SamiPage«CartSummary»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«CartSummary»::getPNumber() {
    return pNumber;
}
void
SamiPage«CartSummary»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«CartSummary»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«CartSummary»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«CartSummary»::getPSize() {
    return pSize;
}
void
SamiPage«CartSummary»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«CartSummary»::getPSort() {
    return pSort;
}
void
SamiPage«CartSummary»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«CartSummary»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«CartSummary»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«CartSummary»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«CartSummary»::setPTotalPages(Integer* pTotal_pages) {
