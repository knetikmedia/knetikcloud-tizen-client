...
SamiPageResource«UserAchievementGroupResource»::SamiPageResource«UserAchievementGroupResource»() {
    init();
}
...
void
SamiPageResource«UserAchievementGroupResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«UserAchievementGroupResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«UserAchievementGroupResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«UserAchievementGroupResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiUserAchievementGroupResource");
        }
        delete pContentKey;
...
SamiPageResource«UserAchievementGroupResource»::SamiPageResource«UserAchievementGroupResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«UserAchievementGroupResource»::asJson ()
{
...
JsonObject*
SamiPageResource«UserAchievementGroupResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiUserAchievementGroupResource", "array"));
...
IList*
SamiPageResource«UserAchievementGroupResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«UserAchievementGroupResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«UserAchievementGroupResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«UserAchievementGroupResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«UserAchievementGroupResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«UserAchievementGroupResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«UserAchievementGroupResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«UserAchievementGroupResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«UserAchievementGroupResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«UserAchievementGroupResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«UserAchievementGroupResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«UserAchievementGroupResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«UserAchievementGroupResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«UserAchievementGroupResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«UserAchievementGroupResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«UserAchievementGroupResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«UserAchievementGroupResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«UserAchievementGroupResource»::setPTotalPages(Integer* pTotal_pages) {
