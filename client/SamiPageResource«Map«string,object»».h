/*
 * SamiPageResource«Map«string,object»».h
 * 
 * 
 */

#ifndef SamiPageResource«Map«string,object»»_H_
#define SamiPageResource«Map«string,object»»_H_
...
class SamiPageResource«Map«string,object»»: public SamiObject {
public:
    SamiPageResource«Map«string,object»»();
    SamiPageResource«Map«string,object»»(String* json);
    virtual ~SamiPageResource«Map«string,object»»();
    ...
    SamiPageResource«Map«string,object»»* fromJson(String* obj);
...
#endif /* SamiPageResource«Map«string,object»»_H_ */
