/*
 * SamiPage«RevenueCountryReportResource».h
 * 
 * 
 */

#ifndef SamiPage«RevenueCountryReportResource»_H_
#define SamiPage«RevenueCountryReportResource»_H_
...
class SamiPage«RevenueCountryReportResource»: public SamiObject {
public:
    SamiPage«RevenueCountryReportResource»();
    SamiPage«RevenueCountryReportResource»(String* json);
    virtual ~SamiPage«RevenueCountryReportResource»();
    ...
    SamiPage«RevenueCountryReportResource»* fromJson(String* obj);
...
#endif /* SamiPage«RevenueCountryReportResource»_H_ */
