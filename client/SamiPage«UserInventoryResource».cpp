...
SamiPage«UserInventoryResource»::SamiPage«UserInventoryResource»() {
    init();
}
...
void
SamiPage«UserInventoryResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«UserInventoryResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«UserInventoryResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«UserInventoryResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«UserInventoryResource»::SamiPage«UserInventoryResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«UserInventoryResource»::asJson ()
{
...
JsonObject*
SamiPage«UserInventoryResource»::asJsonObject() {
...
IList*
SamiPage«UserInventoryResource»::getPContent() {
    return pContent;
}
void
SamiPage«UserInventoryResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«UserInventoryResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«UserInventoryResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«UserInventoryResource»::getPLast() {
    return pLast;
}
void
SamiPage«UserInventoryResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«UserInventoryResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«UserInventoryResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«UserInventoryResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«UserInventoryResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«UserInventoryResource»::getPSize() {
    return pSize;
}
void
SamiPage«UserInventoryResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«UserInventoryResource»::getPSort() {
    return pSort;
}
void
SamiPage«UserInventoryResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«UserInventoryResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«UserInventoryResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«UserInventoryResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«UserInventoryResource»::setPTotalPages(Integer* pTotal_pages) {
