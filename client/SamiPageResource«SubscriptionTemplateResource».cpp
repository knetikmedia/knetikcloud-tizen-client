...
SamiPageResource«SubscriptionTemplateResource»::SamiPageResource«SubscriptionTemplateResource»() {
    init();
}
...
void
SamiPageResource«SubscriptionTemplateResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«SubscriptionTemplateResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«SubscriptionTemplateResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«SubscriptionTemplateResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiSubscriptionTemplateResource");
        }
        delete pContentKey;
...
SamiPageResource«SubscriptionTemplateResource»::SamiPageResource«SubscriptionTemplateResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«SubscriptionTemplateResource»::asJson ()
{
...
JsonObject*
SamiPageResource«SubscriptionTemplateResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiSubscriptionTemplateResource", "array"));
...
IList*
SamiPageResource«SubscriptionTemplateResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«SubscriptionTemplateResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«SubscriptionTemplateResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«SubscriptionTemplateResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«SubscriptionTemplateResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«SubscriptionTemplateResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«SubscriptionTemplateResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«SubscriptionTemplateResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«SubscriptionTemplateResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«SubscriptionTemplateResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«SubscriptionTemplateResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«SubscriptionTemplateResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«SubscriptionTemplateResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«SubscriptionTemplateResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«SubscriptionTemplateResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«SubscriptionTemplateResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«SubscriptionTemplateResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«SubscriptionTemplateResource»::setPTotalPages(Integer* pTotal_pages) {
