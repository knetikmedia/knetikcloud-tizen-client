/*
 * SamiPage«DispositionResource».h
 * 
 * 
 */

#ifndef SamiPage«DispositionResource»_H_
#define SamiPage«DispositionResource»_H_
...
class SamiPage«DispositionResource»: public SamiObject {
public:
    SamiPage«DispositionResource»();
    SamiPage«DispositionResource»(String* json);
    virtual ~SamiPage«DispositionResource»();
    ...
    SamiPage«DispositionResource»* fromJson(String* obj);
...
#endif /* SamiPage«DispositionResource»_H_ */
