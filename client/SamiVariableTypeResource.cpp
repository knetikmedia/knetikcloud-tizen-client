...
SamiVariableTypeResource::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        delete pBaseKey;
JsonString* pEnumerableKey = new JsonString(L"enumerable");
        IJsonValue* pEnumerableVal = null;
        pJsonObject->GetValue(pEnumerableKey, pEnumerableVal);
        if(pEnumerableVal != null) {
            
            pEnumerable = new Boolean(false);
            jsonToValue(pEnumerable, pEnumerableVal, L"Boolean", L"Boolean");
        }
        delete pEnumerableKey;
...
SamiVariableTypeResource::asJsonObject() {
    ...
    JsonString *pEnumerableKey = new JsonString(L"enumerable");
    pJsonObject->Add(pEnumerableKey, toJson(getPEnumerable(), "Boolean", ""));
...
Boolean*
SamiVariableTypeResource::getPEnumerable() {
    return pEnumerable;
}
void
SamiVariableTypeResource::setPEnumerable(Boolean* pEnumerable) {
    this->pEnumerable = pEnumerable;
}
