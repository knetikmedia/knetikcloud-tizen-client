...
SamiPage«BareChallengeActivityResource»::SamiPage«BareChallengeActivityResource»() {
    init();
}
...
void
SamiPage«BareChallengeActivityResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«BareChallengeActivityResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«BareChallengeActivityResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«BareChallengeActivityResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«BareChallengeActivityResource»::SamiPage«BareChallengeActivityResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«BareChallengeActivityResource»::asJson ()
{
...
JsonObject*
SamiPage«BareChallengeActivityResource»::asJsonObject() {
...
IList*
SamiPage«BareChallengeActivityResource»::getPContent() {
    return pContent;
}
void
SamiPage«BareChallengeActivityResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«BareChallengeActivityResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«BareChallengeActivityResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«BareChallengeActivityResource»::getPLast() {
    return pLast;
}
void
SamiPage«BareChallengeActivityResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«BareChallengeActivityResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«BareChallengeActivityResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«BareChallengeActivityResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«BareChallengeActivityResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«BareChallengeActivityResource»::getPSize() {
    return pSize;
}
void
SamiPage«BareChallengeActivityResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«BareChallengeActivityResource»::getPSort() {
    return pSort;
}
void
SamiPage«BareChallengeActivityResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«BareChallengeActivityResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«BareChallengeActivityResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«BareChallengeActivityResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«BareChallengeActivityResource»::setPTotalPages(Integer* pTotal_pages) {
