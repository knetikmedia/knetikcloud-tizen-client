/*
 * SamiPageResource«UserAchievementGroupResource».h
 * 
 * 
 */

#ifndef SamiPageResource«UserAchievementGroupResource»_H_
#define SamiPageResource«UserAchievementGroupResource»_H_
...
class SamiPageResource«UserAchievementGroupResource»: public SamiObject {
public:
    SamiPageResource«UserAchievementGroupResource»();
    SamiPageResource«UserAchievementGroupResource»(String* json);
    virtual ~SamiPageResource«UserAchievementGroupResource»();
    ...
    SamiPageResource«UserAchievementGroupResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«UserAchievementGroupResource»_H_ */
