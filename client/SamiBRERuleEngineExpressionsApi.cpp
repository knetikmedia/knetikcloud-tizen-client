...
void
getBREExpressionsProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
...
IList* 
SamiBRERuleEngineExpressionsApi::getBREExpressionsWithCompletion( void (* success)(IList*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&getBREExpressionsProcessor, (void(*)(void*, SamiError*))success);
