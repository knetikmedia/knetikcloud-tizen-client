...
SamiPageResource«CampaignResource»::SamiPageResource«CampaignResource»() {
    init();
}
...
void
SamiPageResource«CampaignResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«CampaignResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«CampaignResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«CampaignResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiCampaignResource");
        }
        delete pContentKey;
...
SamiPageResource«CampaignResource»::SamiPageResource«CampaignResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«CampaignResource»::asJson ()
{
...
JsonObject*
SamiPageResource«CampaignResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiCampaignResource", "array"));
...
IList*
SamiPageResource«CampaignResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«CampaignResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«CampaignResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«CampaignResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«CampaignResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«CampaignResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«CampaignResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«CampaignResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«CampaignResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«CampaignResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«CampaignResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«CampaignResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«CampaignResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«CampaignResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«CampaignResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«CampaignResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«CampaignResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«CampaignResource»::setPTotalPages(Integer* pTotal_pages) {
