...
SamiPage«SimpleWallet»::SamiPage«SimpleWallet»() {
    init();
}
...
SamiPage«SimpleWallet»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«SimpleWallet»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«SimpleWallet»::SamiPage«SimpleWallet»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
JsonObject*
SamiPage«SimpleWallet»::asJsonObject() {
...
IList*
SamiPage«SimpleWallet»::getPContent() {
    return pContent;
}
void
SamiPage«SimpleWallet»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«SimpleWallet»::getPFirst() {
    return pFirst;
}
void
SamiPage«SimpleWallet»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«SimpleWallet»::getPLast() {
    return pLast;
}
void
SamiPage«SimpleWallet»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«SimpleWallet»::getPNumber() {
    return pNumber;
}
void
SamiPage«SimpleWallet»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«SimpleWallet»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«SimpleWallet»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«SimpleWallet»::getPSize() {
    return pSize;
}
void
SamiPage«SimpleWallet»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«SimpleWallet»::getPSort() {
    return pSort;
}
void
SamiPage«SimpleWallet»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«SimpleWallet»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«SimpleWallet»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«SimpleWallet»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«SimpleWallet»::setPTotalPages(Integer* pTotal_pages) {
