...
SamiPage«WalletTotalResponse»::SamiPage«WalletTotalResponse»() {
    init();
}
...
void
SamiPage«WalletTotalResponse»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«WalletTotalResponse»::cleanup() {
    if(pContent != null) {
...
SamiPage«WalletTotalResponse»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«WalletTotalResponse»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«WalletTotalResponse»::SamiPage«WalletTotalResponse»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«WalletTotalResponse»::asJson ()
{
...
JsonObject*
SamiPage«WalletTotalResponse»::asJsonObject() {
...
IList*
SamiPage«WalletTotalResponse»::getPContent() {
    return pContent;
}
void
SamiPage«WalletTotalResponse»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«WalletTotalResponse»::getPFirst() {
    return pFirst;
}
void
SamiPage«WalletTotalResponse»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«WalletTotalResponse»::getPLast() {
    return pLast;
}
void
SamiPage«WalletTotalResponse»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«WalletTotalResponse»::getPNumber() {
    return pNumber;
}
void
SamiPage«WalletTotalResponse»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«WalletTotalResponse»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«WalletTotalResponse»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«WalletTotalResponse»::getPSize() {
    return pSize;
}
void
SamiPage«WalletTotalResponse»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«WalletTotalResponse»::getPSort() {
    return pSort;
}
void
SamiPage«WalletTotalResponse»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«WalletTotalResponse»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«WalletTotalResponse»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«WalletTotalResponse»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«WalletTotalResponse»::setPTotalPages(Integer* pTotal_pages) {
