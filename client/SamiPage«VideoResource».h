/*
 * SamiPage«VideoResource».h
 * 
 * 
 */

#ifndef SamiPage«VideoResource»_H_
#define SamiPage«VideoResource»_H_
...
class SamiPage«VideoResource»: public SamiObject {
public:
    SamiPage«VideoResource»();
    SamiPage«VideoResource»(String* json);
    virtual ~SamiPage«VideoResource»();
    ...
    SamiPage«VideoResource»* fromJson(String* obj);
...
#endif /* SamiPage«VideoResource»_H_ */
