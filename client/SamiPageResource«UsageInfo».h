/*
 * SamiPageResource«UsageInfo».h
 * 
 * 
 */

#ifndef SamiPageResource«UsageInfo»_H_
#define SamiPageResource«UsageInfo»_H_
...
class SamiPageResource«UsageInfo»: public SamiObject {
public:
    SamiPageResource«UsageInfo»();
    SamiPageResource«UsageInfo»(String* json);
    virtual ~SamiPageResource«UsageInfo»();
    ...
    SamiPageResource«UsageInfo»* fromJson(String* obj);
...
#endif /* SamiPageResource«UsageInfo»_H_ */
