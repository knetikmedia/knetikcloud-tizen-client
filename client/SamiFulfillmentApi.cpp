...
SamiFulfillmentApi::getFulfillmentsUsingGETWithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«FulfillmentType»*, SamiError*)) {
  client = new SamiApiClient();
