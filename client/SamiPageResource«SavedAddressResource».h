/*
 * SamiPageResource«SavedAddressResource».h
 * 
 * 
 */

#ifndef SamiPageResource«SavedAddressResource»_H_
#define SamiPageResource«SavedAddressResource»_H_
...
class SamiPageResource«SavedAddressResource»: public SamiObject {
public:
    SamiPageResource«SavedAddressResource»();
    SamiPageResource«SavedAddressResource»(String* json);
    virtual ~SamiPageResource«SavedAddressResource»();
    ...
    SamiPageResource«SavedAddressResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«SavedAddressResource»_H_ */
