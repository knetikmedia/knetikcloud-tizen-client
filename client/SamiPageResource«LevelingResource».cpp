...
SamiPageResource«LevelingResource»::SamiPageResource«LevelingResource»() {
    init();
}
...
void
SamiPageResource«LevelingResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«LevelingResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«LevelingResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«LevelingResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiLevelingResource");
        }
        delete pContentKey;
...
SamiPageResource«LevelingResource»::SamiPageResource«LevelingResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«LevelingResource»::asJson ()
{
...
JsonObject*
SamiPageResource«LevelingResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiLevelingResource", "array"));
...
IList*
SamiPageResource«LevelingResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«LevelingResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«LevelingResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«LevelingResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«LevelingResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«LevelingResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«LevelingResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«LevelingResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«LevelingResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«LevelingResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«LevelingResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«LevelingResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«LevelingResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«LevelingResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«LevelingResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«LevelingResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«LevelingResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«LevelingResource»::setPTotalPages(Integer* pTotal_pages) {
