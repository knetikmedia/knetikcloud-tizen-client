/*
 * SamiPageResource«UserActionLog».h
 * 
 * 
 */

#ifndef SamiPageResource«UserActionLog»_H_
#define SamiPageResource«UserActionLog»_H_
...
class SamiPageResource«UserActionLog»: public SamiObject {
public:
    SamiPageResource«UserActionLog»();
    SamiPageResource«UserActionLog»(String* json);
    virtual ~SamiPageResource«UserActionLog»();
    ...
    SamiPageResource«UserActionLog»* fromJson(String* obj);
...
#endif /* SamiPageResource«UserActionLog»_H_ */
