/*
 * SamiPage«SimpleWallet».h
 * 
 * 
 */

#ifndef SamiPage«SimpleWallet»_H_
#define SamiPage«SimpleWallet»_H_
...
class SamiPage«SimpleWallet»: public SamiObject {
public:
    SamiPage«SimpleWallet»();
    SamiPage«SimpleWallet»(String* json);
    virtual ~SamiPage«SimpleWallet»();
    ...
    SamiPage«SimpleWallet»* fromJson(String* obj);
...
#endif /* SamiPage«SimpleWallet»_H_ */
