...
SamiPage«UserItemLogResource»::SamiPage«UserItemLogResource»() {
    init();
}
...
void
SamiPage«UserItemLogResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«UserItemLogResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«UserItemLogResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«UserItemLogResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«UserItemLogResource»::SamiPage«UserItemLogResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«UserItemLogResource»::asJson ()
{
...
JsonObject*
SamiPage«UserItemLogResource»::asJsonObject() {
...
IList*
SamiPage«UserItemLogResource»::getPContent() {
    return pContent;
}
void
SamiPage«UserItemLogResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«UserItemLogResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«UserItemLogResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«UserItemLogResource»::getPLast() {
    return pLast;
}
void
SamiPage«UserItemLogResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«UserItemLogResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«UserItemLogResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«UserItemLogResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«UserItemLogResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«UserItemLogResource»::getPSize() {
    return pSize;
}
void
SamiPage«UserItemLogResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«UserItemLogResource»::getPSort() {
    return pSort;
}
void
SamiPage«UserItemLogResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«UserItemLogResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«UserItemLogResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«UserItemLogResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«UserItemLogResource»::setPTotalPages(Integer* pTotal_pages) {
