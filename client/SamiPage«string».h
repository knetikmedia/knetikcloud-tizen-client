...
#ifndef SamiPage«string»_H_
#define SamiPage«string»_H_
...
class SamiPage«string»: public SamiObject {
public:
    SamiPage«string»();
    SamiPage«string»(String* json);
    virtual ~SamiPage«string»();
    ...
    SamiPage«string»* fromJson(String* obj);
