...
SamiBRERuleEngineTriggersApi::getBRETriggersWithCompletion(Boolean* filterSystem, String* filterCategory, String* filterTags, String* filterName, String* filterSearch, Integer* size, Integer* page, void (* success)(SamiPageResource«BreTriggerResource»*, SamiError*)) {
  client = new SamiApiClient();
