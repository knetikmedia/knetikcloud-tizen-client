...
SamiBRERuleEngineTriggersApi::getTriggersUsingGETWithCompletion(Boolean* filterSystem, String* filterCategory, String* filterName, Integer* size, Integer* page, void (* success)(SamiPageResource«BreTriggerResource»*, SamiError*)) {
  client = new SamiApiClient();
