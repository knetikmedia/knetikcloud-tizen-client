...
SamiPage«BreCategoryResource»::SamiPage«BreCategoryResource»() {
    init();
}
...
void
SamiPage«BreCategoryResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«BreCategoryResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«BreCategoryResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«BreCategoryResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«BreCategoryResource»::SamiPage«BreCategoryResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«BreCategoryResource»::asJson ()
{
...
JsonObject*
SamiPage«BreCategoryResource»::asJsonObject() {
...
IList*
SamiPage«BreCategoryResource»::getPContent() {
    return pContent;
}
void
SamiPage«BreCategoryResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«BreCategoryResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«BreCategoryResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«BreCategoryResource»::getPLast() {
    return pLast;
}
void
SamiPage«BreCategoryResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«BreCategoryResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«BreCategoryResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«BreCategoryResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«BreCategoryResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«BreCategoryResource»::getPSize() {
    return pSize;
}
void
SamiPage«BreCategoryResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«BreCategoryResource»::getPSort() {
    return pSort;
}
void
SamiPage«BreCategoryResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«BreCategoryResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«BreCategoryResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«BreCategoryResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«BreCategoryResource»::setPTotalPages(Integer* pTotal_pages) {
