...
SamiPage«ChallengeResource»::SamiPage«ChallengeResource»() {
    init();
}
...
void
SamiPage«ChallengeResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«ChallengeResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«ChallengeResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«ChallengeResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«ChallengeResource»::SamiPage«ChallengeResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«ChallengeResource»::asJson ()
{
...
JsonObject*
SamiPage«ChallengeResource»::asJsonObject() {
...
IList*
SamiPage«ChallengeResource»::getPContent() {
    return pContent;
}
void
SamiPage«ChallengeResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«ChallengeResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«ChallengeResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«ChallengeResource»::getPLast() {
    return pLast;
}
void
SamiPage«ChallengeResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«ChallengeResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«ChallengeResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«ChallengeResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«ChallengeResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«ChallengeResource»::getPSize() {
    return pSize;
}
void
SamiPage«ChallengeResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«ChallengeResource»::getPSort() {
    return pSort;
}
void
SamiPage«ChallengeResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«ChallengeResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«ChallengeResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«ChallengeResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«ChallengeResource»::setPTotalPages(Integer* pTotal_pages) {
