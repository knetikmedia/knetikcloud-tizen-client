...
SamiContentPollsApi::getPollTemplatesUsingGETWithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«TemplateResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiContentPollsApi::getPollsUsingGETWithCompletion(String* filterCategory, String* filterTagset, String* filterText, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«PollResource»*, SamiError*)) {
  client = new SamiApiClient();
