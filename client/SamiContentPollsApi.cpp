...
void 
SamiContentPollsApi::updatePollWithCompletion(String* _id, SamiPollResource* pollResource, void(*success)(SamiError*)) {
  client = new SamiApiClient();
...
void 
SamiContentPollsApi::updatePollTemplateWithCompletion(String* _id, SamiTemplateResource* pollTemplateResource, void(*success)(SamiError*)) {
  client = new SamiApiClient();
