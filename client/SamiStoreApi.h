...
public:
  ...
  SamiPageResource«StoreItem»* 
  getStoreItemsWithCompletion(String* filterNameSearch, String* filterUniqueKey, Boolean* filterPublished, Boolean* filterDisplayable, String* filterStart, String* filterEnd, String* filterStartDate, String* filterStopDate, String* filterSku, String* filterPrice, String* filterTag, String* filterItemsByType, String* filterBundledSkus, Integer* filterVendor, Integer* size, Integer* page, String* order, void (* handler)(SamiPageResource«StoreItem»*, SamiError*));
  SamiStoreItemTemplateResource* 
