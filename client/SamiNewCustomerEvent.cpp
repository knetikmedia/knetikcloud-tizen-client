...
SamiNewCustomerEvent::SamiNewCustomerEvent() {
    init();
}
...
SamiNewCustomerEvent::fromJson(String* json) {
    this->cleanup();
...
void
SamiNewCustomerEvent::fromJsonObject(IJsonValue* pJson) {
...
SamiNewCustomerEvent::SamiNewCustomerEvent(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
JsonObject*
SamiNewCustomerEvent::asJsonObject() {
...
String*
SamiNewCustomerEvent::getPClient() {
    return pClient;
}
void
SamiNewCustomerEvent::setPClient(String* pClient) {
    this->pClient = pClient;
}

String*
SamiNewCustomerEvent::getPCustomer() {
    return pCustomer;
}
void
SamiNewCustomerEvent::setPCustomer(String* pCustomer) {
    this->pCustomer = pCustomer;
}

Boolean*
SamiNewCustomerEvent::getPDoNotBroadcast() {
    return pDo_not_broadcast;
}
void
SamiNewCustomerEvent::setPDoNotBroadcast(Boolean* pDo_not_broadcast) {
    this->pDo_not_broadcast = pDo_not_broadcast;
}

String*
SamiNewCustomerEvent::getPSection() {
    return pSection;
}
void
SamiNewCustomerEvent::setPSection(String* pSection) {
    this->pSection = pSection;
}

SamiObject*
SamiNewCustomerEvent::getPSource() {
    return pSource;
}
void
SamiNewCustomerEvent::setPSource(SamiObject* pSource) {
    this->pSource = pSource;
}

String*
SamiNewCustomerEvent::getPSpecifics() {
    return pSpecifics;
}
void
SamiNewCustomerEvent::setPSpecifics(String* pSpecifics) {
    this->pSpecifics = pSpecifics;
}

Boolean*
SamiNewCustomerEvent::getPSynchronous() {
    return pSynchronous;
}
void
SamiNewCustomerEvent::setPSynchronous(Boolean* pSynchronous) {
    this->pSynchronous = pSynchronous;
}

Long*
SamiNewCustomerEvent::getPTimestamp() {
    return pTimestamp;
}
void
SamiNewCustomerEvent::setPTimestamp(Long* pTimestamp) {
    this->pTimestamp = pTimestamp;
}

String*
SamiNewCustomerEvent::getPType() {
    return pType;
}
void
SamiNewCustomerEvent::setPType(String* pType) {
    this->pType = pType;
}

SamiCustomerConfig*
SamiNewCustomerEvent::getPCustomerConfig() {
    return pCustomer_config;
}
void
SamiNewCustomerEvent::setPCustomerConfig(SamiCustomerConfig* pCustomer_config) {
