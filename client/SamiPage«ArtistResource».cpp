...
SamiPage«ArtistResource»::SamiPage«ArtistResource»() {
    init();
}
...
void
SamiPage«ArtistResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«ArtistResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«ArtistResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«ArtistResource»::SamiPage«ArtistResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«ArtistResource»::asJson ()
{
...
JsonObject*
SamiPage«ArtistResource»::asJsonObject() {
...
IList*
SamiPage«ArtistResource»::getPContent() {
    return pContent;
}
void
SamiPage«ArtistResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«ArtistResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«ArtistResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«ArtistResource»::getPLast() {
    return pLast;
}
void
SamiPage«ArtistResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«ArtistResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«ArtistResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«ArtistResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«ArtistResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«ArtistResource»::getPSize() {
    return pSize;
}
void
SamiPage«ArtistResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«ArtistResource»::getPSort() {
    return pSort;
}
void
SamiPage«ArtistResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«ArtistResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«ArtistResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«ArtistResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«ArtistResource»::setPTotalPages(Integer* pTotal_pages) {
