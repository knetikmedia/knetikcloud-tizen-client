...
void
getCountriesProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
...
IList* 
SamiLocationsApi::getCountriesWithCompletion( void (* success)(IList*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&getCountriesProcessor, (void(*)(void*, SamiError*))success);
...
void
getCountryStatesProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
IList* 
SamiLocationsApi::getCountryStatesWithCompletion(String* countryCodeIso3, void (* success)(IList*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&getCountryStatesProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
