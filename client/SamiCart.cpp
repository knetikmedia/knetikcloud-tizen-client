...
void
SamiCart::init() {
    pAvailable_shipping_options = null;
pCountry_tax = null;
pCoupons = null;
pCreated = null;
pCurrency_code = null;
...
void
SamiCart::cleanup() {
    if(pAvailable_shipping_options != null) {
        pAvailable_shipping_options->RemoveAll(true);
        delete pAvailable_shipping_options;
        pAvailable_shipping_options = null;
    }
...
SamiCart::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        JsonString* pAvailable_shipping_optionsKey = new JsonString(L"available_shipping_options");
        IJsonValue* pAvailable_shipping_optionsVal = null;
        pJsonObject->GetValue(pAvailable_shipping_optionsKey, pAvailable_shipping_optionsVal);
        if(pAvailable_shipping_optionsVal != null) {
            pAvailable_shipping_options = new ArrayList();
            
            jsonToValue(pAvailable_shipping_options, pAvailable_shipping_optionsVal, L"IList", L"SamiCartShippingOption");
        }
        delete pAvailable_shipping_optionsKey;
...
SamiCart::asJsonObject() {
    ...
    JsonString *pAvailable_shipping_optionsKey = new JsonString(L"available_shipping_options");
    pJsonObject->Add(pAvailable_shipping_optionsKey, toJson(getPAvailableShippingOptions(), "SamiCartShippingOption", "array"));
...
IList*
SamiCart::getPAvailableShippingOptions() {
    return pAvailable_shipping_options;
}
void
SamiCart::setPAvailableShippingOptions(IList* pAvailable_shipping_options) {
    this->pAvailable_shipping_options = pAvailable_shipping_options;
}
