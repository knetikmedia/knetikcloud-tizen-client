...
void
updateMaintenance1Processor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
void 
SamiUtilMaintenanceApi::updateMaintenance1WithCompletion(SamiMaintenance* maintenance, void(*success)(SamiError*)) {
  client = new SamiApiClient();

  client->success(&updateMaintenance1Processor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
