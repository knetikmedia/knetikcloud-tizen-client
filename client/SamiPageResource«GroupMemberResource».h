/*
 * SamiPageResource«GroupMemberResource».h
 * 
 * 
 */

#ifndef SamiPageResource«GroupMemberResource»_H_
#define SamiPageResource«GroupMemberResource»_H_
...
class SamiPageResource«GroupMemberResource»: public SamiObject {
public:
    SamiPageResource«GroupMemberResource»();
    SamiPageResource«GroupMemberResource»(String* json);
    virtual ~SamiPageResource«GroupMemberResource»();
    ...
    SamiPageResource«GroupMemberResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«GroupMemberResource»_H_ */
