...
void
addMetricUsingPOSTProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
...
void 
SamiGamificationMetricsApi::addMetricUsingPOSTWithCompletion(SamiMetricResource* metric, void(*success)(SamiError*)) {
  client = new SamiApiClient();

  client->success(&addMetricUsingPOSTProcessor, (void(*)(void*, SamiError*))success);
