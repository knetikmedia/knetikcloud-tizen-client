/*
 * SamiPageResource«GroupResource».h
 * 
 * 
 */

#ifndef SamiPageResource«GroupResource»_H_
#define SamiPageResource«GroupResource»_H_
...
class SamiPageResource«GroupResource»: public SamiObject {
public:
    SamiPageResource«GroupResource»();
    SamiPageResource«GroupResource»(String* json);
    virtual ~SamiPageResource«GroupResource»();
    ...
    SamiPageResource«GroupResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«GroupResource»_H_ */
