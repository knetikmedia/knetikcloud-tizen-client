/*
 * SamiPageResource«CountryTaxResource».h
 * 
 * 
 */

#ifndef SamiPageResource«CountryTaxResource»_H_
#define SamiPageResource«CountryTaxResource»_H_
...
class SamiPageResource«CountryTaxResource»: public SamiObject {
public:
    SamiPageResource«CountryTaxResource»();
    SamiPageResource«CountryTaxResource»(String* json);
    virtual ~SamiPageResource«CountryTaxResource»();
    ...
    SamiPageResource«CountryTaxResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«CountryTaxResource»_H_ */
