...
public:
  ...
  getUserLevelsWithCompletion(Integer* userId, String* filterName, Integer* size, Integer* page, String* order, void (* handler)(SamiPageResource«UserLevelingResource»*, SamiError*));
  void 
  incrementProgressWithCompletion(Integer* userId, String* name, Integer* progress, void(* handler)(SamiError*));
  void 
  setProgressWithCompletion(Integer* userId, String* name, Integer* progress, void(* handler)(SamiError*));
  SamiLevelingResource* 
