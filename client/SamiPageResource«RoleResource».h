/*
 * SamiPageResource«RoleResource».h
 * 
 * 
 */

#ifndef SamiPageResource«RoleResource»_H_
#define SamiPageResource«RoleResource»_H_
...
class SamiPageResource«RoleResource»: public SamiObject {
public:
    SamiPageResource«RoleResource»();
    SamiPageResource«RoleResource»(String* json);
    virtual ~SamiPageResource«RoleResource»();
    ...
    SamiPageResource«RoleResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«RoleResource»_H_ */
