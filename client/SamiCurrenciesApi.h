...
public:
  ...
  getCurrenciesUsingGETWithCompletion(Boolean* filterEnabledCurrencies, String* filterType, Integer* size, Integer* page, String* order, void (* handler)(SamiPage«CurrencyResource»*, SamiError*));
  SamiCurrencyResource* 
