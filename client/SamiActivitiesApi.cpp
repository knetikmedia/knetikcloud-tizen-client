...
SamiActivitiesApi::getActivitiesUsingGETWithCompletion(Boolean* filterTemplate, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«BareActivityResource»*, SamiError*)) {
  client = new SamiApiClient();
