...
SamiActivitiesApi::getActivitiesWithCompletion(Boolean* filterTemplate, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«BareActivityResource»*, SamiError*)) {
  client = new SamiApiClient();
...
void 
SamiActivitiesApi::updateActivityWithCompletion(Long* _id, SamiActivityResource* activityResource, void(*success)(SamiError*)) {
  client = new SamiApiClient();
