...
SamiActivitiesApi::setActivityOccurrenceResultsWithCompletion(Long* activityOccurrenceId, SamiActivityOccurrenceResultsResource* activityOccurrenceResults, void (* success)(SamiActivityOccurrenceResults*, SamiError*)) {
  client = new SamiApiClient();
