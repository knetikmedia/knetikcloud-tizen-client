...
SamiPage«BreGlobalResource»::SamiPage«BreGlobalResource»() {
    init();
}
...
void
SamiPage«BreGlobalResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«BreGlobalResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«BreGlobalResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«BreGlobalResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«BreGlobalResource»::SamiPage«BreGlobalResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«BreGlobalResource»::asJson ()
{
...
JsonObject*
SamiPage«BreGlobalResource»::asJsonObject() {
...
IList*
SamiPage«BreGlobalResource»::getPContent() {
    return pContent;
}
void
SamiPage«BreGlobalResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«BreGlobalResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«BreGlobalResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«BreGlobalResource»::getPLast() {
    return pLast;
}
void
SamiPage«BreGlobalResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«BreGlobalResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«BreGlobalResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«BreGlobalResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«BreGlobalResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«BreGlobalResource»::getPSize() {
    return pSize;
}
void
SamiPage«BreGlobalResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«BreGlobalResource»::getPSort() {
    return pSort;
}
void
SamiPage«BreGlobalResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«BreGlobalResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«BreGlobalResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«BreGlobalResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«BreGlobalResource»::setPTotalPages(Integer* pTotal_pages) {
