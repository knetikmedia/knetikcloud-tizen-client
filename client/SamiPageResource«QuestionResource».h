/*
 * SamiPageResource«QuestionResource».h
 * 
 * 
 */

#ifndef SamiPageResource«QuestionResource»_H_
#define SamiPageResource«QuestionResource»_H_
...
class SamiPageResource«QuestionResource»: public SamiObject {
public:
    SamiPageResource«QuestionResource»();
    SamiPageResource«QuestionResource»(String* json);
    virtual ~SamiPageResource«QuestionResource»();
    ...
    SamiPageResource«QuestionResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«QuestionResource»_H_ */
