/*
 * SamiPage«SavedAddressResource».h
 * 
 * 
 */

#ifndef SamiPage«SavedAddressResource»_H_
#define SamiPage«SavedAddressResource»_H_
...
class SamiPage«SavedAddressResource»: public SamiObject {
public:
    SamiPage«SavedAddressResource»();
    SamiPage«SavedAddressResource»(String* json);
    virtual ~SamiPage«SavedAddressResource»();
    ...
    SamiPage«SavedAddressResource»* fromJson(String* obj);
...
#endif /* SamiPage«SavedAddressResource»_H_ */
