...
SamiPage«TemplateResource»::SamiPage«TemplateResource»() {
    init();
}
...
void
SamiPage«TemplateResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«TemplateResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«TemplateResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«TemplateResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«TemplateResource»::SamiPage«TemplateResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«TemplateResource»::asJson ()
{
...
JsonObject*
SamiPage«TemplateResource»::asJsonObject() {
...
IList*
SamiPage«TemplateResource»::getPContent() {
    return pContent;
}
void
SamiPage«TemplateResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«TemplateResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«TemplateResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«TemplateResource»::getPLast() {
    return pLast;
}
void
SamiPage«TemplateResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«TemplateResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«TemplateResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«TemplateResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«TemplateResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«TemplateResource»::getPSize() {
    return pSize;
}
void
SamiPage«TemplateResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«TemplateResource»::getPSort() {
    return pSort;
}
void
SamiPage«TemplateResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«TemplateResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«TemplateResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«TemplateResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«TemplateResource»::setPTotalPages(Integer* pTotal_pages) {
