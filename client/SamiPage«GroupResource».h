/*
 * SamiPage«GroupResource».h
 * 
 * 
 */

#ifndef SamiPage«GroupResource»_H_
#define SamiPage«GroupResource»_H_
...
class SamiPage«GroupResource»: public SamiObject {
public:
    SamiPage«GroupResource»();
    SamiPage«GroupResource»(String* json);
    virtual ~SamiPage«GroupResource»();
    ...
    SamiPage«GroupResource»* fromJson(String* obj);
...
#endif /* SamiPage«GroupResource»_H_ */
