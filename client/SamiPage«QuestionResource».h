/*
 * SamiPage«QuestionResource».h
 * 
 * 
 */

#ifndef SamiPage«QuestionResource»_H_
#define SamiPage«QuestionResource»_H_
...
class SamiPage«QuestionResource»: public SamiObject {
public:
    SamiPage«QuestionResource»();
    SamiPage«QuestionResource»(String* json);
    virtual ~SamiPage«QuestionResource»();
    ...
    SamiPage«QuestionResource»* fromJson(String* obj);
...
#endif /* SamiPage«QuestionResource»_H_ */
