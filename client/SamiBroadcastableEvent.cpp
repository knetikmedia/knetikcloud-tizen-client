...
SamiBroadcastableEvent::SamiBroadcastableEvent() {
    init();
}
...
void
SamiBroadcastableEvent::cleanup() {
    if(pClient != null) {
...
SamiBroadcastableEvent::fromJson(String* json) {
    this->cleanup();
...
void
SamiBroadcastableEvent::fromJsonObject(IJsonValue* pJson) {
...
SamiBroadcastableEvent::SamiBroadcastableEvent(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
JsonObject*
SamiBroadcastableEvent::asJsonObject() {
...
String*
SamiBroadcastableEvent::getPClient() {
    return pClient;
}
void
SamiBroadcastableEvent::setPClient(String* pClient) {
    this->pClient = pClient;
}

String*
SamiBroadcastableEvent::getPCustomer() {
    return pCustomer;
}
void
SamiBroadcastableEvent::setPCustomer(String* pCustomer) {
    this->pCustomer = pCustomer;
}

Boolean*
SamiBroadcastableEvent::getPDoNotBroadcast() {
    return pDo_not_broadcast;
}
void
SamiBroadcastableEvent::setPDoNotBroadcast(Boolean* pDo_not_broadcast) {
    this->pDo_not_broadcast = pDo_not_broadcast;
}

String*
SamiBroadcastableEvent::getPSection() {
    return pSection;
}
void
SamiBroadcastableEvent::setPSection(String* pSection) {
    this->pSection = pSection;
}

SamiObject*
SamiBroadcastableEvent::getPSource() {
    return pSource;
}
void
SamiBroadcastableEvent::setPSource(SamiObject* pSource) {
    this->pSource = pSource;
}

String*
SamiBroadcastableEvent::getPSpecifics() {
    return pSpecifics;
}
void
SamiBroadcastableEvent::setPSpecifics(String* pSpecifics) {
    this->pSpecifics = pSpecifics;
}

Boolean*
SamiBroadcastableEvent::getPSynchronous() {
    return pSynchronous;
}
void
SamiBroadcastableEvent::setPSynchronous(Boolean* pSynchronous) {
    this->pSynchronous = pSynchronous;
}

Long*
SamiBroadcastableEvent::getPTimestamp() {
    return pTimestamp;
}
void
SamiBroadcastableEvent::setPTimestamp(Long* pTimestamp) {
    this->pTimestamp = pTimestamp;
}

String*
SamiBroadcastableEvent::getPType() {
    return pType;
}
void
SamiBroadcastableEvent::setPType(String* pType) {
    this->pType = pType;
}
