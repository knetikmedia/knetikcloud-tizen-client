...
SamiCurrenciesApi::getCurrenciesUsingGETWithCompletion(Boolean* filterEnabledCurrencies, String* filterType, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«CurrencyResource»*, SamiError*)) {
  client = new SamiApiClient();
