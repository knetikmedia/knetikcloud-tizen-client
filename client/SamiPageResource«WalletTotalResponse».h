/*
 * SamiPageResource«WalletTotalResponse».h
 * 
 * 
 */

#ifndef SamiPageResource«WalletTotalResponse»_H_
#define SamiPageResource«WalletTotalResponse»_H_
...
class SamiPageResource«WalletTotalResponse»: public SamiObject {
public:
    SamiPageResource«WalletTotalResponse»();
    SamiPageResource«WalletTotalResponse»(String* json);
    virtual ~SamiPageResource«WalletTotalResponse»();
    ...
    SamiPageResource«WalletTotalResponse»* fromJson(String* obj);
...
#endif /* SamiPageResource«WalletTotalResponse»_H_ */
