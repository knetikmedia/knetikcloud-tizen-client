/*
 * SamiPageResource«VideoResource».h
 * 
 * 
 */

#ifndef SamiPageResource«VideoResource»_H_
#define SamiPageResource«VideoResource»_H_
...
class SamiPageResource«VideoResource»: public SamiObject {
public:
    SamiPageResource«VideoResource»();
    SamiPageResource«VideoResource»(String* json);
    virtual ~SamiPageResource«VideoResource»();
    ...
    SamiPageResource«VideoResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«VideoResource»_H_ */
