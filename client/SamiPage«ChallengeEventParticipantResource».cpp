...
SamiPage«ChallengeEventParticipantResource»::SamiPage«ChallengeEventParticipantResource»() {
    init();
}
...
void
SamiPage«ChallengeEventParticipantResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«ChallengeEventParticipantResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«ChallengeEventParticipantResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«ChallengeEventParticipantResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«ChallengeEventParticipantResource»::SamiPage«ChallengeEventParticipantResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«ChallengeEventParticipantResource»::asJson ()
{
...
JsonObject*
SamiPage«ChallengeEventParticipantResource»::asJsonObject() {
...
IList*
SamiPage«ChallengeEventParticipantResource»::getPContent() {
    return pContent;
}
void
SamiPage«ChallengeEventParticipantResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«ChallengeEventParticipantResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«ChallengeEventParticipantResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«ChallengeEventParticipantResource»::getPLast() {
    return pLast;
}
void
SamiPage«ChallengeEventParticipantResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«ChallengeEventParticipantResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«ChallengeEventParticipantResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«ChallengeEventParticipantResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«ChallengeEventParticipantResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«ChallengeEventParticipantResource»::getPSize() {
    return pSize;
}
void
SamiPage«ChallengeEventParticipantResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«ChallengeEventParticipantResource»::getPSort() {
    return pSort;
}
void
SamiPage«ChallengeEventParticipantResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«ChallengeEventParticipantResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«ChallengeEventParticipantResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«ChallengeEventParticipantResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«ChallengeEventParticipantResource»::setPTotalPages(Integer* pTotal_pages) {
