...
getRelationshipsUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiPage«UserRelationshipResource»* out = new SamiPage«UserRelationshipResource»();
    jsonToValue(out, pJson, L"SamiPage«UserRelationshipResource»*", L"SamiPage«UserRelationshipResource»");
...
SamiUsersRelationshipsApi::getRelationshipsUsingGETWithCompletion( void (* success)(SamiPage«UserRelationshipResource»*, SamiError*)) {
  client = new SamiApiClient();
