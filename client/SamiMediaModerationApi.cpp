...
SamiMediaModerationApi::getFlagsReportUsingGETWithCompletion(Boolean* excludeResolved, String* filterContext, Integer* size, Integer* page, void (* success)(SamiPageResource«FlagReportResource»*, SamiError*)) {
  client = new SamiApiClient();
