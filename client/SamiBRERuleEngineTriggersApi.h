...
public:
  ...
  getBRETriggersWithCompletion(Boolean* filterSystem, String* filterCategory, String* filterTags, String* filterName, String* filterSearch, Integer* size, Integer* page, void (* handler)(SamiPageResource«BreTriggerResource»*, SamiError*));
  SamiBreTriggerResource* 
