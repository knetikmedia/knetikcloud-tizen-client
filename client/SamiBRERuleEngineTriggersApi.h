...
public:
  ...
  getTriggersUsingGETWithCompletion(Boolean* filterSystem, String* filterCategory, String* filterName, Integer* size, Integer* page, void (* handler)(SamiPageResource«BreTriggerResource»*, SamiError*));
  void 
