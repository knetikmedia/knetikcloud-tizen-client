...
void
getActionsUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
...
IList* 
SamiBRERuleEngineActionsApi::getActionsUsingGETWithCompletion(String* filterCategory, String* filterName, void (* success)(IList*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&getActionsUsingGETProcessor, (void(*)(void*, SamiError*))success);
