...
public:
  ...
  getUserRegistrationsWithCompletion(String* granularity, Long* startDate, Long* endDate, Integer* size, Integer* page, void (* handler)(SamiPageResource«AggregateCountResource»*, SamiError*));
