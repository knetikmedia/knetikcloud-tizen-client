...
HashMap*
SamiVendorResource::getPAdditionalProperties() {
    return pAdditional_properties;
}
void
SamiVendorResource::setPAdditionalProperties(HashMap* pAdditional_properties) {
...
String*
SamiVendorResource::getPTemplate() {
    return pTemplate;
}
void
SamiVendorResource::setPTemplate(String* pTemplate) {
