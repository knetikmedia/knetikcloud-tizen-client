/*
 * SamiPage«BareChallengeActivityResource».h
 * 
 * 
 */

#ifndef SamiPage«BareChallengeActivityResource»_H_
#define SamiPage«BareChallengeActivityResource»_H_
...
class SamiPage«BareChallengeActivityResource»: public SamiObject {
public:
    SamiPage«BareChallengeActivityResource»();
    SamiPage«BareChallengeActivityResource»(String* json);
    virtual ~SamiPage«BareChallengeActivityResource»();
    ...
    SamiPage«BareChallengeActivityResource»* fromJson(String* obj);
...
#endif /* SamiPage«BareChallengeActivityResource»_H_ */
