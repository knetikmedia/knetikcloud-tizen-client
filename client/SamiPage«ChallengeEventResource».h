/*
 * SamiPage«ChallengeEventResource».h
 * 
 * 
 */

#ifndef SamiPage«ChallengeEventResource»_H_
#define SamiPage«ChallengeEventResource»_H_
...
class SamiPage«ChallengeEventResource»: public SamiObject {
public:
    SamiPage«ChallengeEventResource»();
    SamiPage«ChallengeEventResource»(String* json);
    virtual ~SamiPage«ChallengeEventResource»();
    ...
    SamiPage«ChallengeEventResource»* fromJson(String* obj);
...
#endif /* SamiPage«ChallengeEventResource»_H_ */
