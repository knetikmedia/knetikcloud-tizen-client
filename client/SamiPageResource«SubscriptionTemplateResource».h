/*
 * SamiPageResource«SubscriptionTemplateResource».h
 * 
 * 
 */

#ifndef SamiPageResource«SubscriptionTemplateResource»_H_
#define SamiPageResource«SubscriptionTemplateResource»_H_
...
class SamiPageResource«SubscriptionTemplateResource»: public SamiObject {
public:
    SamiPageResource«SubscriptionTemplateResource»();
    SamiPageResource«SubscriptionTemplateResource»(String* json);
    virtual ~SamiPageResource«SubscriptionTemplateResource»();
    ...
    SamiPageResource«SubscriptionTemplateResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«SubscriptionTemplateResource»_H_ */
