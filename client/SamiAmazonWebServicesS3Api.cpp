#include "SamiAmazonWebServicesS3Api.h"
...
SamiAmazonWebServicesS3Api::SamiAmazonWebServicesS3Api() {
...
SamiAmazonWebServicesS3Api::getSignedS3URLWithCompletion(String* filename, String* contentType, void (* success)(SamiAmazonS3Activity*, SamiError*)) {
  ...
  client->execute(SamiAmazonWebServicesS3Api::getBasePath(), url, "GET", (IMap*)queryParams, mBody, (IMap*)headerParams, null, L"application/json");
  return null;
}
