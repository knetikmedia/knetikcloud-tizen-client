/*
 * SamiPage«ChallengeEventParticipantResource».h
 * 
 * 
 */

#ifndef SamiPage«ChallengeEventParticipantResource»_H_
#define SamiPage«ChallengeEventParticipantResource»_H_
...
class SamiPage«ChallengeEventParticipantResource»: public SamiObject {
public:
    SamiPage«ChallengeEventParticipantResource»();
    SamiPage«ChallengeEventParticipantResource»(String* json);
    virtual ~SamiPage«ChallengeEventParticipantResource»();
    ...
    SamiPage«ChallengeEventParticipantResource»* fromJson(String* obj);
...
#endif /* SamiPage«ChallengeEventParticipantResource»_H_ */
