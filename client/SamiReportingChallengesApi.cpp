...
SamiReportingChallengesApi::getChallengeEventLeaderboardWithCompletion(Long* filterEvent, void (* success)(SamiPageResource«ChallengeEventParticipantResource»*, SamiError*)) {
...
SamiPageResource«ChallengeEventParticipantResource»* 
SamiReportingChallengesApi::getChallengeEventParticipantsWithCompletion(Long* filterEvent, void (* success)(SamiPageResource«ChallengeEventParticipantResource»*, SamiError*)) {
  client = new SamiApiClient();
