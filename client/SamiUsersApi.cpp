...
SamiUsersApi::getUsersWithCompletion(String* filterDisplayname, String* filterEmail, String* filterFirstname, String* filterFullname, String* filterLastname, String* filterUsername, String* filterTag, String* filterGroup, String* filterRole, String* filterSearch, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«UserBaseResource»*, SamiError*)) {
  client = new SamiApiClient();
...
void
submitPasswordResetProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
void 
SamiUsersApi::submitPasswordResetWithCompletion(SamiPasswordResetRequest* passwordReset, void(*success)(SamiError*)) {
  client = new SamiApiClient();

  client->success(&submitPasswordResetProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
  ...
  String url(L"/users/password-reset");
...
SamiTemplateResource* 
SamiUsersApi::updateUserTemplateWithCompletion(String* _id, SamiTemplateResource* userTemplateResource, void (* success)(SamiTemplateResource*, SamiError*)) {
  client = new SamiApiClient();
