...
SamiPage«CurrencyResource»::SamiPage«CurrencyResource»() {
    init();
}
...
void
SamiPage«CurrencyResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«CurrencyResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«CurrencyResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«CurrencyResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«CurrencyResource»::SamiPage«CurrencyResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«CurrencyResource»::asJson ()
{
...
JsonObject*
SamiPage«CurrencyResource»::asJsonObject() {
...
IList*
SamiPage«CurrencyResource»::getPContent() {
    return pContent;
}
void
SamiPage«CurrencyResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«CurrencyResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«CurrencyResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«CurrencyResource»::getPLast() {
    return pLast;
}
void
SamiPage«CurrencyResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«CurrencyResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«CurrencyResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«CurrencyResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«CurrencyResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«CurrencyResource»::getPSize() {
    return pSize;
}
void
SamiPage«CurrencyResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«CurrencyResource»::getPSort() {
    return pSort;
}
void
SamiPage«CurrencyResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«CurrencyResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«CurrencyResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«CurrencyResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«CurrencyResource»::setPTotalPages(Integer* pTotal_pages) {
