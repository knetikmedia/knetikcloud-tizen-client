...
public:
  ...
  getAchievementsWithCompletion(String* filterTagset, String* filterName, Boolean* filterHidden, Integer* size, Integer* page, String* order, Boolean* filterDerived, void (* handler)(SamiPageResource«AchievementDefinitionResource»*, SamiError*));
  IList* 
  ...
  SamiUserAchievementGroupResource* 
  incrementAchievementProgressWithCompletion(Integer* userId, String* achievementName, Integer* progress, void (* handler)(SamiUserAchievementGroupResource*, SamiError*));
  SamiUserAchievementGroupResource* 
  setAchievementProgressWithCompletion(Integer* userId, String* achievementName, Integer* progress, void (* handler)(SamiUserAchievementGroupResource*, SamiError*));
  SamiAchievementDefinitionResource* 
