...
public:
  ...
  getUserAchievementsProgressWithCompletion(Integer* userId, Boolean* filterAchievementDerived, String* filterAchievementTagset, String* filterAchievementName, Boolean* filterAchievementHidden, Integer* size, Integer* page, void (* handler)(SamiPageResource«UserAchievementGroupResource»*, SamiError*));
  SamiPageResource«UserAchievementGroupResource»* 
  getUsersAchievementProgressWithCompletion(String* achievementName, Boolean* filterAchievementDerived, String* filterAchievementTagset, Boolean* filterAchievementHidden, Integer* size, Integer* page, void (* handler)(SamiPageResource«UserAchievementGroupResource»*, SamiError*));
  SamiPageResource«UserAchievementGroupResource»* 
  getUsersAchievementsProgressWithCompletion(Boolean* filterAchievementDerived, String* filterAchievementTagset, String* filterAchievementName, Boolean* filterAchievementHidden, Integer* size, Integer* page, void (* handler)(SamiPageResource«UserAchievementGroupResource»*, SamiError*));
  void 
  updateAchievementWithCompletion(String* name, SamiAchievementDefinitionResource* achievement, void(* handler)(SamiError*));
  SamiUserAchievementGroupResource* 
  ...
  void 
  updateAchievementTemplateWithCompletion(String* _id, SamiTemplateResource* template, void(* handler)(SamiError*));
