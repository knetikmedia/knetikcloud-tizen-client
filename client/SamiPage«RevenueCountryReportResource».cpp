...
SamiPage«RevenueCountryReportResource»::SamiPage«RevenueCountryReportResource»() {
    init();
}
...
void
SamiPage«RevenueCountryReportResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«RevenueCountryReportResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«RevenueCountryReportResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«RevenueCountryReportResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«RevenueCountryReportResource»::SamiPage«RevenueCountryReportResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«RevenueCountryReportResource»::asJson ()
{
...
JsonObject*
SamiPage«RevenueCountryReportResource»::asJsonObject() {
...
IList*
SamiPage«RevenueCountryReportResource»::getPContent() {
    return pContent;
}
void
SamiPage«RevenueCountryReportResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«RevenueCountryReportResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«RevenueCountryReportResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«RevenueCountryReportResource»::getPLast() {
    return pLast;
}
void
SamiPage«RevenueCountryReportResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«RevenueCountryReportResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«RevenueCountryReportResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«RevenueCountryReportResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«RevenueCountryReportResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«RevenueCountryReportResource»::getPSize() {
    return pSize;
}
void
SamiPage«RevenueCountryReportResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«RevenueCountryReportResource»::getPSort() {
    return pSort;
}
void
SamiPage«RevenueCountryReportResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«RevenueCountryReportResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«RevenueCountryReportResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«RevenueCountryReportResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«RevenueCountryReportResource»::setPTotalPages(Integer* pTotal_pages) {
