/*
 * SamiPage«RoleResource».h
 * 
 * 
 */

#ifndef SamiPage«RoleResource»_H_
#define SamiPage«RoleResource»_H_
...
class SamiPage«RoleResource»: public SamiObject {
public:
    SamiPage«RoleResource»();
    SamiPage«RoleResource»(String* json);
    virtual ~SamiPage«RoleResource»();
    ...
    SamiPage«RoleResource»* fromJson(String* obj);
...
#endif /* SamiPage«RoleResource»_H_ */
