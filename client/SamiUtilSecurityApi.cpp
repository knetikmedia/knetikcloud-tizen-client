...
SamiUtilSecurityApi::getUserLocationLogUsingGETWithCompletion(Integer* userId, void (* success)(SamiPageResource«LocationLogResource»*, SamiError*)) {
...
SamiUtilSecurityApi::userUsingGETWithCompletion( void (* success)(SamiTokenDetailsResource*, SamiError*)) {
  client = new SamiApiClient();
