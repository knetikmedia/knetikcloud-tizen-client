/*
 * SamiPageResource«InvoiceLogEntry».h
 * 
 * 
 */

#ifndef SamiPageResource«InvoiceLogEntry»_H_
#define SamiPageResource«InvoiceLogEntry»_H_
...
class SamiPageResource«InvoiceLogEntry»: public SamiObject {
public:
    SamiPageResource«InvoiceLogEntry»();
    SamiPageResource«InvoiceLogEntry»(String* json);
    virtual ~SamiPageResource«InvoiceLogEntry»();
    ...
    SamiPageResource«InvoiceLogEntry»* fromJson(String* obj);
...
#endif /* SamiPageResource«InvoiceLogEntry»_H_ */
