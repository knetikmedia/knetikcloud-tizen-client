...
SamiPage«ClientResource»::SamiPage«ClientResource»() {
    init();
}
...
void
SamiPage«ClientResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«ClientResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«ClientResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«ClientResource»::SamiPage«ClientResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«ClientResource»::asJson ()
{
...
JsonObject*
SamiPage«ClientResource»::asJsonObject() {
...
IList*
SamiPage«ClientResource»::getPContent() {
    return pContent;
}
void
SamiPage«ClientResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«ClientResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«ClientResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«ClientResource»::getPLast() {
    return pLast;
}
void
SamiPage«ClientResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«ClientResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«ClientResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«ClientResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«ClientResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«ClientResource»::getPSize() {
    return pSize;
}
void
SamiPage«ClientResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«ClientResource»::getPSort() {
    return pSort;
}
void
SamiPage«ClientResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«ClientResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«ClientResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«ClientResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«ClientResource»::setPTotalPages(Integer* pTotal_pages) {
