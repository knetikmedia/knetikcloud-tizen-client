...
HashMap*
SamiChallengeActivityResource::getPAdditionalProperties() {
    return pAdditional_properties;
}
void
SamiChallengeActivityResource::setPAdditionalProperties(HashMap* pAdditional_properties) {
...
String*
SamiChallengeActivityResource::getPTemplate() {
    return pTemplate;
}
void
SamiChallengeActivityResource::setPTemplate(String* pTemplate) {
