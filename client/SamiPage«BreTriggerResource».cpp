...
SamiPage«BreTriggerResource»::SamiPage«BreTriggerResource»() {
    init();
}
...
void
SamiPage«BreTriggerResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«BreTriggerResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«BreTriggerResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«BreTriggerResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«BreTriggerResource»::SamiPage«BreTriggerResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«BreTriggerResource»::asJson ()
{
...
JsonObject*
SamiPage«BreTriggerResource»::asJsonObject() {
...
IList*
SamiPage«BreTriggerResource»::getPContent() {
    return pContent;
}
void
SamiPage«BreTriggerResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«BreTriggerResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«BreTriggerResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«BreTriggerResource»::getPLast() {
    return pLast;
}
void
SamiPage«BreTriggerResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«BreTriggerResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«BreTriggerResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«BreTriggerResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«BreTriggerResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«BreTriggerResource»::getPSize() {
    return pSize;
}
void
SamiPage«BreTriggerResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«BreTriggerResource»::getPSort() {
    return pSort;
}
void
SamiPage«BreTriggerResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«BreTriggerResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«BreTriggerResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«BreTriggerResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«BreTriggerResource»::setPTotalPages(Integer* pTotal_pages) {
