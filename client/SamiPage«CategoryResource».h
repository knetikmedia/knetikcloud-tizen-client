/*
 * SamiPage«CategoryResource».h
 * 
 * 
 */

#ifndef SamiPage«CategoryResource»_H_
#define SamiPage«CategoryResource»_H_
...
class SamiPage«CategoryResource»: public SamiObject {
public:
    SamiPage«CategoryResource»();
    SamiPage«CategoryResource»(String* json);
    virtual ~SamiPage«CategoryResource»();
    ...
    SamiPage«CategoryResource»* fromJson(String* obj);
...
#endif /* SamiPage«CategoryResource»_H_ */
