...
SamiPage«UserRelationshipResource»::SamiPage«UserRelationshipResource»() {
    init();
}
...
void
SamiPage«UserRelationshipResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«UserRelationshipResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«UserRelationshipResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«UserRelationshipResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«UserRelationshipResource»::SamiPage«UserRelationshipResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«UserRelationshipResource»::asJson ()
{
...
JsonObject*
SamiPage«UserRelationshipResource»::asJsonObject() {
...
IList*
SamiPage«UserRelationshipResource»::getPContent() {
    return pContent;
}
void
SamiPage«UserRelationshipResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«UserRelationshipResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«UserRelationshipResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«UserRelationshipResource»::getPLast() {
    return pLast;
}
void
SamiPage«UserRelationshipResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«UserRelationshipResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«UserRelationshipResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«UserRelationshipResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«UserRelationshipResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«UserRelationshipResource»::getPSize() {
    return pSize;
}
void
SamiPage«UserRelationshipResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«UserRelationshipResource»::getPSort() {
    return pSort;
}
void
SamiPage«UserRelationshipResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«UserRelationshipResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«UserRelationshipResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«UserRelationshipResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«UserRelationshipResource»::setPTotalPages(Integer* pTotal_pages) {
