...
SamiPageResource«ImportJobResource»::SamiPageResource«ImportJobResource»() {
    init();
}
...
void
SamiPageResource«ImportJobResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«ImportJobResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«ImportJobResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«ImportJobResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiImportJobResource");
        }
        delete pContentKey;
...
SamiPageResource«ImportJobResource»::SamiPageResource«ImportJobResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«ImportJobResource»::asJson ()
{
...
JsonObject*
SamiPageResource«ImportJobResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiImportJobResource", "array"));
...
IList*
SamiPageResource«ImportJobResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«ImportJobResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«ImportJobResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«ImportJobResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«ImportJobResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«ImportJobResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«ImportJobResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«ImportJobResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«ImportJobResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«ImportJobResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«ImportJobResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«ImportJobResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«ImportJobResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«ImportJobResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«ImportJobResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«ImportJobResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«ImportJobResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«ImportJobResource»::setPTotalPages(Integer* pTotal_pages) {
