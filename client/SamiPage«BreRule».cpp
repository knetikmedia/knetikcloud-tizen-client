...
SamiPage«BreRule»::SamiPage«BreRule»() {
    init();
}
...
SamiPage«BreRule»*
SamiPage«BreRule»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«BreRule»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«BreRule»::SamiPage«BreRule»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
IList*
SamiPage«BreRule»::getPContent() {
    return pContent;
}
void
SamiPage«BreRule»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«BreRule»::getPFirst() {
    return pFirst;
}
void
SamiPage«BreRule»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«BreRule»::getPLast() {
    return pLast;
}
void
SamiPage«BreRule»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«BreRule»::getPNumber() {
    return pNumber;
}
void
SamiPage«BreRule»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«BreRule»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«BreRule»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«BreRule»::getPSize() {
    return pSize;
}
void
SamiPage«BreRule»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«BreRule»::getPSort() {
    return pSort;
}
void
SamiPage«BreRule»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«BreRule»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«BreRule»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«BreRule»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«BreRule»::setPTotalPages(Integer* pTotal_pages) {
