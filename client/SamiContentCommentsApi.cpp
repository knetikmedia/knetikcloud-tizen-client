...
SamiContentCommentsApi::getCommentsUsingGETWithCompletion(String* context, Integer* contextId, Integer* size, Integer* page, void (* success)(SamiPageResource«CommentResource»*, SamiError*)) {
  client = new SamiApiClient();
