...
void
getLeaderboardProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
...
SamiGamificationLeaderboardsApi::getLeaderboardWithCompletion(String* contextType, String* contextId, Integer* size, Integer* page, String* order, void (* success)(SamiLeaderboardResource*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&getLeaderboardProcessor, (void(*)(void*, SamiError*))success);
...
void
getLeaderboardRankProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
SamiGamificationLeaderboardsApi::getLeaderboardRankWithCompletion(String* contextType, String* contextId, String* _id, void (* success)(SamiLeaderboardEntryResource*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&getLeaderboardRankProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
...
void
getLeaderboardStrategiesProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
IList* 
SamiGamificationLeaderboardsApi::getLeaderboardStrategiesWithCompletion( void (* success)(IList*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&getLeaderboardStrategiesProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
