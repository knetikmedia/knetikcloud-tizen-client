/*
 * SamiPageResource«StoreItemTemplateResource».h
 * 
 * 
 */

#ifndef SamiPageResource«StoreItemTemplateResource»_H_
#define SamiPageResource«StoreItemTemplateResource»_H_
...
class SamiPageResource«StoreItemTemplateResource»: public SamiObject {
public:
    SamiPageResource«StoreItemTemplateResource»();
    SamiPageResource«StoreItemTemplateResource»(String* json);
    virtual ~SamiPageResource«StoreItemTemplateResource»();
    ...
    SamiPageResource«StoreItemTemplateResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«StoreItemTemplateResource»_H_ */
