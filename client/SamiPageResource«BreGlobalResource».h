/*
 * SamiPageResource«BreGlobalResource».h
 * 
 * 
 */

#ifndef SamiPageResource«BreGlobalResource»_H_
#define SamiPageResource«BreGlobalResource»_H_
...
class SamiPageResource«BreGlobalResource»: public SamiObject {
public:
    SamiPageResource«BreGlobalResource»();
    SamiPageResource«BreGlobalResource»(String* json);
    virtual ~SamiPageResource«BreGlobalResource»();
    ...
    SamiPageResource«BreGlobalResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«BreGlobalResource»_H_ */
