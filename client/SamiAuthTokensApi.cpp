...
SamiAuthTokensApi::getTokensUsingGETWithCompletion(String* filterClientId, String* filterUsername, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«OauthAccessTokenResource»*, SamiError*)) {
  client = new SamiApiClient();
