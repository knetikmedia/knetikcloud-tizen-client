...
void
deleteTokenProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
...
void 
SamiAuthTokensApi::deleteTokenWithCompletion(String* username, String* clientId, void(*success)(SamiError*)) {
  client = new SamiApiClient();

  client->success(&deleteTokenProcessor, (void(*)(void*, SamiError*))success);
...
void 
SamiAuthTokensApi::deleteTokensWithCompletion(String* username, void(*success)(SamiError*)) {
  client = new SamiApiClient();
