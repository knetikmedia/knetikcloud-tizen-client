/*
 * SamiPageResource«UserItemLogResource».h
 * 
 * 
 */

#ifndef SamiPageResource«UserItemLogResource»_H_
#define SamiPageResource«UserItemLogResource»_H_
...
class SamiPageResource«UserItemLogResource»: public SamiObject {
public:
    SamiPageResource«UserItemLogResource»();
    SamiPageResource«UserItemLogResource»(String* json);
    virtual ~SamiPageResource«UserItemLogResource»();
    ...
    SamiPageResource«UserItemLogResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«UserItemLogResource»_H_ */
