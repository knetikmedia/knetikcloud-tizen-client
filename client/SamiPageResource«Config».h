/*
 * SamiPageResource«Config».h
 * 
 * 
 */

#ifndef SamiPageResource«Config»_H_
#define SamiPageResource«Config»_H_
...
class SamiPageResource«Config»: public SamiObject {
public:
    SamiPageResource«Config»();
    SamiPageResource«Config»(String* json);
    virtual ~SamiPageResource«Config»();
    ...
    SamiPageResource«Config»* fromJson(String* obj);
...
#endif /* SamiPageResource«Config»_H_ */
