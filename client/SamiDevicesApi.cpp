...
void
addDeviceUsersProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
...
SamiDeviceResource* 
SamiDevicesApi::addDeviceUsersWithCompletion(IList* userResources, Integer* _id, void (* success)(SamiDeviceResource*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&addDeviceUsersProcessor, (void(*)(void*, SamiError*))success);
  ...
  if(userResources != null) {
    mBody = new String("");
    int sz = userResources->GetCount();
    for(int i = 0; i < sz; i++) {
      SamiObject * obj = (SamiObject*)userResources->GetAt(i);
...
void
deleteDeviceUserProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
void 
SamiDevicesApi::deleteDeviceUserWithCompletion(Integer* _id, Integer* userId, void(*success)(SamiError*)) {
  client = new SamiApiClient();

  client->success(&deleteDeviceUserProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
  ...
  String url(L"/devices/{id}/users/{user_id}");
...
void
deleteDeviceUsersProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
void 
SamiDevicesApi::deleteDeviceUsersWithCompletion(Integer* _id, String* filterId, void(*success)(SamiError*)) {
  client = new SamiApiClient();

  client->success(&deleteDeviceUsersProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
