...
SamiDevicesApi::getDevicesUsingGETWithCompletion(String* filterMake, String* filterModel, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«DeviceResource»*, SamiError*)) {
  client = new SamiApiClient();
