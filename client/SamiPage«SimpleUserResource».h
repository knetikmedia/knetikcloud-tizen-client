/*
 * SamiPage«SimpleUserResource».h
 * 
 * 
 */

#ifndef SamiPage«SimpleUserResource»_H_
#define SamiPage«SimpleUserResource»_H_
...
class SamiPage«SimpleUserResource»: public SamiObject {
public:
    SamiPage«SimpleUserResource»();
    SamiPage«SimpleUserResource»(String* json);
    virtual ~SamiPage«SimpleUserResource»();
    ...
    SamiPage«SimpleUserResource»* fromJson(String* obj);
...
#endif /* SamiPage«SimpleUserResource»_H_ */
