/*
 * SamiPageResource«QuestionTemplateResource».h
 * 
 * 
 */

#ifndef SamiPageResource«QuestionTemplateResource»_H_
#define SamiPageResource«QuestionTemplateResource»_H_
...
class SamiPageResource«QuestionTemplateResource»: public SamiObject {
public:
    SamiPageResource«QuestionTemplateResource»();
    SamiPageResource«QuestionTemplateResource»(String* json);
    virtual ~SamiPageResource«QuestionTemplateResource»();
    ...
    SamiPageResource«QuestionTemplateResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«QuestionTemplateResource»_H_ */
