...
void
getInvoiceReportsProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
...
SamiReportingOrdersApi::getInvoiceReportsWithCompletion(String* currencyCode, String* granularity, String* filterPaymentStatus, String* filterFulfillmentStatus, Long* startDate, Long* endDate, Integer* size, Integer* page, void (* success)(SamiPageResource«AggregateInvoiceReportResource»*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&getInvoiceReportsProcessor, (void(*)(void*, SamiError*))success);
