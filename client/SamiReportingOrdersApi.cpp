...
SamiReportingOrdersApi::getInvoiceReportsWithCompletion(String* currencyCode, String* granularity, String* filterPaymentStatus, String* filterFulfillmentStatus, Long* startDate, Long* endDate, void (* success)(SamiPageResource«AggregateInvoiceReportResource»*, SamiError*)) {
