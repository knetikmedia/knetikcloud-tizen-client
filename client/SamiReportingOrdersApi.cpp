...
getDailyInvoicesUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiPage«AggregateInvoiceReportResource»* out = new SamiPage«AggregateInvoiceReportResource»();
    jsonToValue(out, pJson, L"SamiPage«AggregateInvoiceReportResource»*", L"SamiPage«AggregateInvoiceReportResource»");
...
SamiReportingOrdersApi::getDailyInvoicesUsingGETWithCompletion(String* currencyCode, String* granularity, String* filterPaymentStatus, String* filterFulfillmentStatus, Long* startDate, Long* endDate, void (* success)(SamiPage«AggregateInvoiceReportResource»*, SamiError*)) {
