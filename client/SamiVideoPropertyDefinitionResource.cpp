...
SamiVideoPropertyDefinitionResource::SamiVideoPropertyDefinitionResource() {
    init();
}
...
void
SamiVideoPropertyDefinitionResource::init() {
    pField_list = null;
pName = null;
pRequired = null;
pType = null;
...
void
SamiVideoPropertyDefinitionResource::cleanup() {
    if(pField_list != null) {
...
SamiVideoPropertyDefinitionResource::fromJson(String* json) {
    this->cleanup();
...
void
SamiVideoPropertyDefinitionResource::fromJsonObject(IJsonValue* pJson) {
...
SamiVideoPropertyDefinitionResource::SamiVideoPropertyDefinitionResource(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiVideoPropertyDefinitionResource::asJson ()
{
...
JsonObject*
SamiVideoPropertyDefinitionResource::asJsonObject() {
...
SamiVideoPropertyDefinitionResource::getPFieldList() {
    return pField_list;
}
void
SamiVideoPropertyDefinitionResource::setPFieldList(SamiPropertyFieldListResource* pField_list) {
    this->pField_list = pField_list;
}

String*
SamiVideoPropertyDefinitionResource::getPName() {
    return pName;
}
void
SamiVideoPropertyDefinitionResource::setPName(String* pName) {
    this->pName = pName;
}

Boolean*
SamiVideoPropertyDefinitionResource::getPRequired() {
    return pRequired;
}
void
SamiVideoPropertyDefinitionResource::setPRequired(Boolean* pRequired) {
    this->pRequired = pRequired;
}

String*
SamiVideoPropertyDefinitionResource::getPType() {
    return pType;
}
void
SamiVideoPropertyDefinitionResource::setPType(String* pType) {
    this->pType = pType;
}

String*
SamiVideoPropertyDefinitionResource::getPFileType() {
    return pFile_type;
}
void
SamiVideoPropertyDefinitionResource::setPFileType(String* pFile_type) {
    this->pFile_type = pFile_type;
}

Integer*
SamiVideoPropertyDefinitionResource::getPMaxHeight() {
    return pMax_height;
}
void
SamiVideoPropertyDefinitionResource::setPMaxHeight(Integer* pMax_height) {
    this->pMax_height = pMax_height;
}

Integer*
SamiVideoPropertyDefinitionResource::getPMaxLength() {
    return pMax_length;
}
void
SamiVideoPropertyDefinitionResource::setPMaxLength(Integer* pMax_length) {
    this->pMax_length = pMax_length;
}

Integer*
SamiVideoPropertyDefinitionResource::getPMaxWidth() {
    return pMax_width;
}
void
SamiVideoPropertyDefinitionResource::setPMaxWidth(Integer* pMax_width) {
    this->pMax_width = pMax_width;
}

Integer*
SamiVideoPropertyDefinitionResource::getPMinHeight() {
    return pMin_height;
}
void
SamiVideoPropertyDefinitionResource::setPMinHeight(Integer* pMin_height) {
    this->pMin_height = pMin_height;
}

Integer*
SamiVideoPropertyDefinitionResource::getPMinLength() {
    return pMin_length;
}
void
SamiVideoPropertyDefinitionResource::setPMinLength(Integer* pMin_length) {
    this->pMin_length = pMin_length;
}

Integer*
SamiVideoPropertyDefinitionResource::getPMinWidth() {
    return pMin_width;
}
void
SamiVideoPropertyDefinitionResource::setPMinWidth(Integer* pMin_width) {
