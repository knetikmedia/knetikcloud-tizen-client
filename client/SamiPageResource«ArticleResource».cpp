...
SamiPageResource«ArticleResource»::SamiPageResource«ArticleResource»() {
    init();
}
...
void
SamiPageResource«ArticleResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«ArticleResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«ArticleResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«ArticleResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPageResource«ArticleResource»::SamiPageResource«ArticleResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«ArticleResource»::asJson ()
{
...
JsonObject*
SamiPageResource«ArticleResource»::asJsonObject() {
...
IList*
SamiPageResource«ArticleResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«ArticleResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«ArticleResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«ArticleResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«ArticleResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«ArticleResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«ArticleResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«ArticleResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«ArticleResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«ArticleResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«ArticleResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«ArticleResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«ArticleResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«ArticleResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«ArticleResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«ArticleResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«ArticleResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«ArticleResource»::setPTotalPages(Integer* pTotal_pages) {
