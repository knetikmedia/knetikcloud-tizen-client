...
public:
  ...
  getLeaderboardWithCompletion(String* contextType, String* contextId, Integer* size, Integer* page, String* order, void (* handler)(SamiLeaderboardResource*, SamiError*));
