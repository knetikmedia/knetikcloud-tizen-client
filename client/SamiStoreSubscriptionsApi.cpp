...
getSubscriptionTemplatesUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiPage«SubscriptionTemplateResource»* out = new SamiPage«SubscriptionTemplateResource»();
    jsonToValue(out, pJson, L"SamiPage«SubscriptionTemplateResource»*", L"SamiPage«SubscriptionTemplateResource»");
...
SamiStoreSubscriptionsApi::getSubscriptionTemplatesUsingGETWithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPage«SubscriptionTemplateResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiStoreSubscriptionsApi::listBillingReportsUsingGETWithCompletion(Integer* size, Integer* page, void (* success)(SamiPage«BillingReport»*, SamiError*)) {
  client = new SamiApiClient();
  ...
  String url(L"/subscriptions/reports");
...
listSubscriptionsUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiPage«SubscriptionResource»* out = new SamiPage«SubscriptionResource»();
    jsonToValue(out, pJson, L"SamiPage«SubscriptionResource»*", L"SamiPage«SubscriptionResource»");
...
SamiStoreSubscriptionsApi::listSubscriptionsUsingGETWithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPage«SubscriptionResource»*, SamiError*)) {
  client = new SamiApiClient();
