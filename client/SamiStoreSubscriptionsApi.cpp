...
SamiSubscriptionTemplateResource* 
SamiStoreSubscriptionsApi::updateSubscriptionTemplateWithCompletion(String* _id, SamiSubscriptionTemplateResource* subscriptionTemplateResource, void (* success)(SamiSubscriptionTemplateResource*, SamiError*)) {
  client = new SamiApiClient();
