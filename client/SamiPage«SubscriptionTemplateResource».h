/*
 * SamiPage«SubscriptionTemplateResource».h
 * 
 * 
 */

#ifndef SamiPage«SubscriptionTemplateResource»_H_
#define SamiPage«SubscriptionTemplateResource»_H_
...
class SamiPage«SubscriptionTemplateResource»: public SamiObject {
public:
    SamiPage«SubscriptionTemplateResource»();
    SamiPage«SubscriptionTemplateResource»(String* json);
    virtual ~SamiPage«SubscriptionTemplateResource»();
    ...
    SamiPage«SubscriptionTemplateResource»* fromJson(String* obj);
...
#endif /* SamiPage«SubscriptionTemplateResource»_H_ */
