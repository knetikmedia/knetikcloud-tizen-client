...
SamiPageResource«SimpleReferenceResource«object»»::SamiPageResource«SimpleReferenceResource«object»»() {
    init();
}
...
void
SamiPageResource«SimpleReferenceResource«object»»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«SimpleReferenceResource«object»»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«SimpleReferenceResource«object»»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«SimpleReferenceResource«object»»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiSimpleReferenceResource«object»");
        }
        delete pContentKey;
...
SamiPageResource«SimpleReferenceResource«object»»::SamiPageResource«SimpleReferenceResource«object»»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«SimpleReferenceResource«object»»::asJson ()
{
...
JsonObject*
SamiPageResource«SimpleReferenceResource«object»»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiSimpleReferenceResource«object»", "array"));
...
IList*
SamiPageResource«SimpleReferenceResource«object»»::getPContent() {
    return pContent;
}
void
SamiPageResource«SimpleReferenceResource«object»»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«SimpleReferenceResource«object»»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«SimpleReferenceResource«object»»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«SimpleReferenceResource«object»»::getPLast() {
    return pLast;
}
void
SamiPageResource«SimpleReferenceResource«object»»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«SimpleReferenceResource«object»»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«SimpleReferenceResource«object»»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«SimpleReferenceResource«object»»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«SimpleReferenceResource«object»»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«SimpleReferenceResource«object»»::getPSize() {
    return pSize;
}
void
SamiPageResource«SimpleReferenceResource«object»»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«SimpleReferenceResource«object»»::getPSort() {
    return pSort;
}
void
SamiPageResource«SimpleReferenceResource«object»»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«SimpleReferenceResource«object»»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«SimpleReferenceResource«object»»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«SimpleReferenceResource«object»»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«SimpleReferenceResource«object»»::setPTotalPages(Integer* pTotal_pages) {
