/*
 * SamiPageResource«ForwardLog».h
 * 
 * 
 */

#ifndef SamiPageResource«ForwardLog»_H_
#define SamiPageResource«ForwardLog»_H_
...
class SamiPageResource«ForwardLog»: public SamiObject {
public:
    SamiPageResource«ForwardLog»();
    SamiPageResource«ForwardLog»(String* json);
    virtual ~SamiPageResource«ForwardLog»();
    ...
    SamiPageResource«ForwardLog»* fromJson(String* obj);
...
#endif /* SamiPageResource«ForwardLog»_H_ */
