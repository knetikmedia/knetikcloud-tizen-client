...
SamiPage«VideoResource»::SamiPage«VideoResource»() {
    init();
}
...
void
SamiPage«VideoResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«VideoResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«VideoResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«VideoResource»::SamiPage«VideoResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
JsonObject*
SamiPage«VideoResource»::asJsonObject() {
...
IList*
SamiPage«VideoResource»::getPContent() {
    return pContent;
}
void
SamiPage«VideoResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«VideoResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«VideoResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«VideoResource»::getPLast() {
    return pLast;
}
void
SamiPage«VideoResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«VideoResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«VideoResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«VideoResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«VideoResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«VideoResource»::getPSize() {
    return pSize;
}
void
SamiPage«VideoResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«VideoResource»::getPSort() {
    return pSort;
}
void
SamiPage«VideoResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«VideoResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«VideoResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«VideoResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«VideoResource»::setPTotalPages(Integer* pTotal_pages) {
