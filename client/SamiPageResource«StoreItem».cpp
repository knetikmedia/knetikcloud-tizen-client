...
SamiPageResource«StoreItem»::SamiPageResource«StoreItem»() {
    init();
}
...
void
SamiPageResource«StoreItem»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«StoreItem»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«StoreItem»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«StoreItem»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiStoreItem");
        }
        delete pContentKey;
...
SamiPageResource«StoreItem»::SamiPageResource«StoreItem»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«StoreItem»::asJson ()
{
...
JsonObject*
SamiPageResource«StoreItem»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiStoreItem", "array"));
...
IList*
SamiPageResource«StoreItem»::getPContent() {
    return pContent;
}
void
SamiPageResource«StoreItem»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«StoreItem»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«StoreItem»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«StoreItem»::getPLast() {
    return pLast;
}
void
SamiPageResource«StoreItem»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«StoreItem»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«StoreItem»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«StoreItem»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«StoreItem»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«StoreItem»::getPSize() {
    return pSize;
}
void
SamiPageResource«StoreItem»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«StoreItem»::getPSort() {
    return pSort;
}
void
SamiPageResource«StoreItem»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«StoreItem»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«StoreItem»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«StoreItem»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«StoreItem»::setPTotalPages(Integer* pTotal_pages) {
