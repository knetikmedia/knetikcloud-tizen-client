...
SamiImageProperty::SamiImageProperty() {
    init();
}
...
SamiImageProperty*
SamiImageProperty::fromJson(String* json) {
    this->cleanup();
...
void
SamiImageProperty::fromJsonObject(IJsonValue* pJson) {
...
SamiImageProperty::SamiImageProperty(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
JsonObject*
SamiImageProperty::asJsonObject() {
...
String*
SamiImageProperty::getPType() {
    return pType;
}
void
SamiImageProperty::setPType(String* pType) {
    this->pType = pType;
}

String*
SamiImageProperty::getPCrc() {
    return pCrc;
}
void
SamiImageProperty::setPCrc(String* pCrc) {
    this->pCrc = pCrc;
}

String*
SamiImageProperty::getPDescription() {
    return pDescription;
}
void
SamiImageProperty::setPDescription(String* pDescription) {
    this->pDescription = pDescription;
}

String*
SamiImageProperty::getPFileType() {
    return pFile_type;
}
void
SamiImageProperty::setPFileType(String* pFile_type) {
    this->pFile_type = pFile_type;
}

String*
SamiImageProperty::getPUrl() {
    return pUrl;
}
void
SamiImageProperty::setPUrl(String* pUrl) {
    this->pUrl = pUrl;
}
