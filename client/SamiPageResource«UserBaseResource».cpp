...
SamiPageResource«UserBaseResource»::SamiPageResource«UserBaseResource»() {
    init();
}
...
void
SamiPageResource«UserBaseResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«UserBaseResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«UserBaseResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«UserBaseResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPageResource«UserBaseResource»::SamiPageResource«UserBaseResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«UserBaseResource»::asJson ()
{
...
JsonObject*
SamiPageResource«UserBaseResource»::asJsonObject() {
...
IList*
SamiPageResource«UserBaseResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«UserBaseResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«UserBaseResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«UserBaseResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«UserBaseResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«UserBaseResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«UserBaseResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«UserBaseResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«UserBaseResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«UserBaseResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«UserBaseResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«UserBaseResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«UserBaseResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«UserBaseResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«UserBaseResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«UserBaseResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«UserBaseResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«UserBaseResource»::setPTotalPages(Integer* pTotal_pages) {
