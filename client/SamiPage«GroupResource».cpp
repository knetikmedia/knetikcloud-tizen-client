...
SamiPage«GroupResource»::SamiPage«GroupResource»() {
    init();
}
...
void
SamiPage«GroupResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«GroupResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«GroupResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«GroupResource»::SamiPage«GroupResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
JsonObject*
SamiPage«GroupResource»::asJsonObject() {
...
IList*
SamiPage«GroupResource»::getPContent() {
    return pContent;
}
void
SamiPage«GroupResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«GroupResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«GroupResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«GroupResource»::getPLast() {
    return pLast;
}
void
SamiPage«GroupResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«GroupResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«GroupResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«GroupResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«GroupResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«GroupResource»::getPSize() {
    return pSize;
}
void
SamiPage«GroupResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«GroupResource»::getPSort() {
    return pSort;
}
void
SamiPage«GroupResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«GroupResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«GroupResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«GroupResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«GroupResource»::setPTotalPages(Integer* pTotal_pages) {
