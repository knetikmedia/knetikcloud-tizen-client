...
SamiCategoriesApi::getArticleTemplatesUsingGET1WithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«TemplateResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiCategoriesApi::getCategoriesUsingGET1WithCompletion(String* filterSearch, Boolean* filterActive, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«CategoryResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiCategoriesApi::getTagsUsingGETWithCompletion(Integer* size, Integer* page, void (* success)(SamiPageResource«string»*, SamiError*)) {
  client = new SamiApiClient();
