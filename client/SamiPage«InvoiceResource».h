/*
 * SamiPage«InvoiceResource».h
 * 
 * 
 */

#ifndef SamiPage«InvoiceResource»_H_
#define SamiPage«InvoiceResource»_H_
...
class SamiPage«InvoiceResource»: public SamiObject {
public:
    SamiPage«InvoiceResource»();
    SamiPage«InvoiceResource»(String* json);
    virtual ~SamiPage«InvoiceResource»();
    ...
    SamiPage«InvoiceResource»* fromJson(String* obj);
...
#endif /* SamiPage«InvoiceResource»_H_ */
