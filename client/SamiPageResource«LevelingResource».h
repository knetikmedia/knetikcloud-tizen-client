/*
 * SamiPageResource«LevelingResource».h
 * 
 * 
 */

#ifndef SamiPageResource«LevelingResource»_H_
#define SamiPageResource«LevelingResource»_H_
...
class SamiPageResource«LevelingResource»: public SamiObject {
public:
    SamiPageResource«LevelingResource»();
    SamiPageResource«LevelingResource»(String* json);
    virtual ~SamiPageResource«LevelingResource»();
    ...
    SamiPageResource«LevelingResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«LevelingResource»_H_ */
