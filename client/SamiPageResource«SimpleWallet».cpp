...
SamiPageResource«SimpleWallet»::SamiPageResource«SimpleWallet»() {
    init();
}
...
void
SamiPageResource«SimpleWallet»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«SimpleWallet»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«SimpleWallet»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«SimpleWallet»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiSimpleWallet");
        }
        delete pContentKey;
...
SamiPageResource«SimpleWallet»::SamiPageResource«SimpleWallet»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«SimpleWallet»::asJson ()
{
...
JsonObject*
SamiPageResource«SimpleWallet»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiSimpleWallet", "array"));
...
IList*
SamiPageResource«SimpleWallet»::getPContent() {
    return pContent;
}
void
SamiPageResource«SimpleWallet»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«SimpleWallet»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«SimpleWallet»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«SimpleWallet»::getPLast() {
    return pLast;
}
void
SamiPageResource«SimpleWallet»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«SimpleWallet»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«SimpleWallet»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«SimpleWallet»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«SimpleWallet»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«SimpleWallet»::getPSize() {
    return pSize;
}
void
SamiPageResource«SimpleWallet»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«SimpleWallet»::getPSort() {
    return pSort;
}
void
SamiPageResource«SimpleWallet»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«SimpleWallet»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«SimpleWallet»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«SimpleWallet»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«SimpleWallet»::setPTotalPages(Integer* pTotal_pages) {
