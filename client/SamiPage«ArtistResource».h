/*
 * SamiPage«ArtistResource».h
 * 
 * 
 */

#ifndef SamiPage«ArtistResource»_H_
#define SamiPage«ArtistResource»_H_
...
class SamiPage«ArtistResource»: public SamiObject {
public:
    SamiPage«ArtistResource»();
    SamiPage«ArtistResource»(String* json);
    virtual ~SamiPage«ArtistResource»();
    ...
    SamiPage«ArtistResource»* fromJson(String* obj);
...
#endif /* SamiPage«ArtistResource»_H_ */
