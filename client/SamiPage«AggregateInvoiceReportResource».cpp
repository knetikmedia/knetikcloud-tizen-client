...
SamiPage«AggregateInvoiceReportResource»::SamiPage«AggregateInvoiceReportResource»() {
    init();
}
...
void
SamiPage«AggregateInvoiceReportResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«AggregateInvoiceReportResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«AggregateInvoiceReportResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«AggregateInvoiceReportResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«AggregateInvoiceReportResource»::SamiPage«AggregateInvoiceReportResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«AggregateInvoiceReportResource»::asJson ()
{
...
JsonObject*
SamiPage«AggregateInvoiceReportResource»::asJsonObject() {
...
IList*
SamiPage«AggregateInvoiceReportResource»::getPContent() {
    return pContent;
}
void
SamiPage«AggregateInvoiceReportResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«AggregateInvoiceReportResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«AggregateInvoiceReportResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«AggregateInvoiceReportResource»::getPLast() {
    return pLast;
}
void
SamiPage«AggregateInvoiceReportResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«AggregateInvoiceReportResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«AggregateInvoiceReportResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«AggregateInvoiceReportResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«AggregateInvoiceReportResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«AggregateInvoiceReportResource»::getPSize() {
    return pSize;
}
void
SamiPage«AggregateInvoiceReportResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«AggregateInvoiceReportResource»::getPSort() {
    return pSort;
}
void
SamiPage«AggregateInvoiceReportResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«AggregateInvoiceReportResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«AggregateInvoiceReportResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«AggregateInvoiceReportResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«AggregateInvoiceReportResource»::setPTotalPages(Integer* pTotal_pages) {
