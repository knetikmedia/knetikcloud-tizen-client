...
SamiBRERuleEngineGlobalsApi::getGlobalsUsingGETWithCompletion(Boolean* filterSystem, Integer* size, Integer* page, void (* success)(SamiPageResource«BreGlobalResource»*, SamiError*)) {
  client = new SamiApiClient();
