/*
 * SamiPage«RewardSetResource».h
 * 
 * 
 */

#ifndef SamiPage«RewardSetResource»_H_
#define SamiPage«RewardSetResource»_H_
...
class SamiPage«RewardSetResource»: public SamiObject {
public:
    SamiPage«RewardSetResource»();
    SamiPage«RewardSetResource»(String* json);
    virtual ~SamiPage«RewardSetResource»();
    ...
    SamiPage«RewardSetResource»* fromJson(String* obj);
...
#endif /* SamiPage«RewardSetResource»_H_ */
