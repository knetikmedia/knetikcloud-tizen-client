/*
 * SamiPageResource«ChallengeEventParticipantResource».h
 * 
 * 
 */

#ifndef SamiPageResource«ChallengeEventParticipantResource»_H_
#define SamiPageResource«ChallengeEventParticipantResource»_H_
...
class SamiPageResource«ChallengeEventParticipantResource»: public SamiObject {
public:
    SamiPageResource«ChallengeEventParticipantResource»();
    SamiPageResource«ChallengeEventParticipantResource»(String* json);
    virtual ~SamiPageResource«ChallengeEventParticipantResource»();
    ...
    SamiPageResource«ChallengeEventParticipantResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«ChallengeEventParticipantResource»_H_ */
