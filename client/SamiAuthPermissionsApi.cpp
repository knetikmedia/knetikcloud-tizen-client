...
SamiPermissionResource* 
SamiAuthPermissionsApi::updatePermissionWithCompletion(String* permission, SamiPermissionResource* permissionResource, void (* success)(SamiPermissionResource*, SamiError*)) {
  client = new SamiApiClient();
