...
getPermissionUsingGET1Processor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiPage«PermissionResource»* out = new SamiPage«PermissionResource»();
    jsonToValue(out, pJson, L"SamiPage«PermissionResource»*", L"SamiPage«PermissionResource»");
...
SamiAuthPermissionsApi::getPermissionUsingGET1WithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPage«PermissionResource»*, SamiError*)) {
  client = new SamiApiClient();
