/*
 * SamiPageResource«OauthAccessTokenResource».h
 * 
 * 
 */

#ifndef SamiPageResource«OauthAccessTokenResource»_H_
#define SamiPageResource«OauthAccessTokenResource»_H_
...
class SamiPageResource«OauthAccessTokenResource»: public SamiObject {
public:
    SamiPageResource«OauthAccessTokenResource»();
    SamiPageResource«OauthAccessTokenResource»(String* json);
    virtual ~SamiPageResource«OauthAccessTokenResource»();
    ...
    SamiPageResource«OauthAccessTokenResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«OauthAccessTokenResource»_H_ */
