...
SamiPage«Map«string,object»»::SamiPage«Map«string,object»»() {
    init();
}
...
void
SamiPage«Map«string,object»»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«Map«string,object»»::cleanup() {
    if(pContent != null) {
...
SamiPage«Map«string,object»»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«Map«string,object»»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«Map«string,object»»::SamiPage«Map«string,object»»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«Map«string,object»»::asJson ()
{
...
JsonObject*
SamiPage«Map«string,object»»::asJsonObject() {
...
IList*
SamiPage«Map«string,object»»::getPContent() {
    return pContent;
}
void
SamiPage«Map«string,object»»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«Map«string,object»»::getPFirst() {
    return pFirst;
}
void
SamiPage«Map«string,object»»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«Map«string,object»»::getPLast() {
    return pLast;
}
void
SamiPage«Map«string,object»»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«Map«string,object»»::getPNumber() {
    return pNumber;
}
void
SamiPage«Map«string,object»»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«Map«string,object»»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«Map«string,object»»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«Map«string,object»»::getPSize() {
    return pSize;
}
void
SamiPage«Map«string,object»»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«Map«string,object»»::getPSort() {
    return pSort;
}
void
SamiPage«Map«string,object»»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«Map«string,object»»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«Map«string,object»»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«Map«string,object»»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«Map«string,object»»::setPTotalPages(Integer* pTotal_pages) {
