/*
 * SamiPageResource«DeviceResource».h
 * 
 * 
 */

#ifndef SamiPageResource«DeviceResource»_H_
#define SamiPageResource«DeviceResource»_H_
...
class SamiPageResource«DeviceResource»: public SamiObject {
public:
    SamiPageResource«DeviceResource»();
    SamiPageResource«DeviceResource»(String* json);
    virtual ~SamiPageResource«DeviceResource»();
    ...
    SamiPageResource«DeviceResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«DeviceResource»_H_ */
