...
SamiStoreItem* 
SamiStoreApi::createStoreItemWithCompletion(SamiStoreItem* storeItem, void (* success)(SamiStoreItem*, SamiError*)) {
  client = new SamiApiClient();
...
SamiPageResource«StoreItem»* 
SamiStoreApi::getStoreItemsWithCompletion(String* filterNameSearch, String* filterUniqueKey, Boolean* filterPublished, Boolean* filterDisplayable, String* filterStart, String* filterEnd, String* filterStartDate, String* filterStopDate, String* filterSku, String* filterPrice, String* filterTag, String* filterItemsByType, String* filterBundledSkus, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«StoreItem»*, SamiError*)) {
  client = new SamiApiClient();
...
void 
SamiStoreApi::updateItemTemplateWithCompletion(String* _id, SamiStoreItemTemplateResource* itemTemplateResource, void(*success)(SamiError*)) {
  client = new SamiApiClient();
...
void 
SamiStoreApi::updateStoreItemWithCompletion(Integer* _id, SamiStoreItem* storeItem, void(*success)(SamiError*)) {
  client = new SamiApiClient();
