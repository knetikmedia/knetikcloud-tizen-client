...
SamiStoreApi::createItemTemplateUsingPOSTWithCompletion(SamiItemTemplateResource* itemTemplateResource, void (* success)(SamiItemTemplateResource*, SamiError*)) {
...
SamiItemTemplateResource* 
SamiStoreApi::getItemTemplateUsingGETWithCompletion(String* _id, void (* success)(SamiItemTemplateResource*, SamiError*)) {
  client = new SamiApiClient();
...
SamiStoreApi::getItemTemplatesUsingGETWithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPage«ItemTemplateResource»*, SamiError*)) {
  client = new SamiApiClient();
...
void 
SamiStoreApi::updateItemTemplateUsingPUTWithCompletion(String* _id, SamiItemTemplateResource* itemTemplateResource, void(*success)(SamiError*)) {
  client = new SamiApiClient();
