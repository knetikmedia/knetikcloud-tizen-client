...
SamiStoreApi::getItemTemplatesUsingGETWithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«StoreItemTemplateResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiPageResource«StoreItem»* 
SamiStoreApi::getUsingGET2WithCompletion(Integer* limit, Integer* page, Boolean* useCatalog, Boolean* ignoreLocation, Boolean* inStockOnly, void (* success)(SamiPageResource«StoreItem»*, SamiError*)) {
  client = new SamiApiClient();
