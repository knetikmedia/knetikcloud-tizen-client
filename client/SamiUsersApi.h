...
public:
  ...
  getUsersUsingGETWithCompletion(String* filterRole, String* filterDisplayname, String* filterEmail, String* filterFirstname, String* filterFullname, String* filterLastname, String* filterUsername, String* filterTag, String* filterGroup, Integer* size, Integer* page, String* order, void (* handler)(SamiPage«UserBaseResource»*, SamiError*));
  void 
