...
public:
  ...
  getUsersWithCompletion(String* filterDisplayname, String* filterEmail, String* filterFirstname, String* filterFullname, String* filterLastname, String* filterUsername, String* filterTag, String* filterGroup, Integer* size, Integer* page, String* order, void (* handler)(SamiPageResource«UserBaseResource»*, SamiError*));
  void 
  ...
  void 
  updateUserTemplateWithCompletion(String* _id, SamiTemplateResource* userTemplateResource, void(* handler)(SamiError*));
