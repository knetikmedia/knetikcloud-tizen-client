...
SamiPage«UserActionLog»::SamiPage«UserActionLog»() {
    init();
}
...
void
SamiPage«UserActionLog»::cleanup() {
    if(pContent != null) {
...
SamiPage«UserActionLog»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«UserActionLog»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«UserActionLog»::SamiPage«UserActionLog»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
JsonObject*
SamiPage«UserActionLog»::asJsonObject() {
...
IList*
SamiPage«UserActionLog»::getPContent() {
    return pContent;
}
void
SamiPage«UserActionLog»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«UserActionLog»::getPFirst() {
    return pFirst;
}
void
SamiPage«UserActionLog»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«UserActionLog»::getPLast() {
    return pLast;
}
void
SamiPage«UserActionLog»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«UserActionLog»::getPNumber() {
    return pNumber;
}
void
SamiPage«UserActionLog»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«UserActionLog»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«UserActionLog»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«UserActionLog»::getPSize() {
    return pSize;
}
void
SamiPage«UserActionLog»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«UserActionLog»::getPSort() {
    return pSort;
}
void
SamiPage«UserActionLog»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«UserActionLog»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«UserActionLog»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«UserActionLog»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«UserActionLog»::setPTotalPages(Integer* pTotal_pages) {
