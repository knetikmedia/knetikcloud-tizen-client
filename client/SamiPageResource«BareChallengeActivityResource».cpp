...
SamiPageResource«BareChallengeActivityResource»::SamiPageResource«BareChallengeActivityResource»() {
    init();
}
...
void
SamiPageResource«BareChallengeActivityResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«BareChallengeActivityResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«BareChallengeActivityResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«BareChallengeActivityResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiBareChallengeActivityResource");
        }
        delete pContentKey;
...
SamiPageResource«BareChallengeActivityResource»::SamiPageResource«BareChallengeActivityResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«BareChallengeActivityResource»::asJson ()
{
...
JsonObject*
SamiPageResource«BareChallengeActivityResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiBareChallengeActivityResource", "array"));
...
IList*
SamiPageResource«BareChallengeActivityResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«BareChallengeActivityResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«BareChallengeActivityResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«BareChallengeActivityResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«BareChallengeActivityResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«BareChallengeActivityResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«BareChallengeActivityResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«BareChallengeActivityResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«BareChallengeActivityResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«BareChallengeActivityResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«BareChallengeActivityResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«BareChallengeActivityResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«BareChallengeActivityResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«BareChallengeActivityResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«BareChallengeActivityResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«BareChallengeActivityResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«BareChallengeActivityResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«BareChallengeActivityResource»::setPTotalPages(Integer* pTotal_pages) {
