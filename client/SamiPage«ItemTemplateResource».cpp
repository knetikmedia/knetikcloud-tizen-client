...
SamiPage«ItemTemplateResource»::SamiPage«ItemTemplateResource»() {
    init();
}
...
void
SamiPage«ItemTemplateResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«ItemTemplateResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«ItemTemplateResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«ItemTemplateResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«ItemTemplateResource»::SamiPage«ItemTemplateResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«ItemTemplateResource»::asJson ()
{
...
JsonObject*
SamiPage«ItemTemplateResource»::asJsonObject() {
...
IList*
SamiPage«ItemTemplateResource»::getPContent() {
    return pContent;
}
void
SamiPage«ItemTemplateResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«ItemTemplateResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«ItemTemplateResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«ItemTemplateResource»::getPLast() {
    return pLast;
}
void
SamiPage«ItemTemplateResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«ItemTemplateResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«ItemTemplateResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«ItemTemplateResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«ItemTemplateResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«ItemTemplateResource»::getPSize() {
    return pSize;
}
void
SamiPage«ItemTemplateResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«ItemTemplateResource»::getPSort() {
    return pSort;
}
void
SamiPage«ItemTemplateResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«ItemTemplateResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«ItemTemplateResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«ItemTemplateResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«ItemTemplateResource»::setPTotalPages(Integer* pTotal_pages) {
