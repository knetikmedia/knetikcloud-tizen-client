/*
 * SamiPage«InvoiceLogEntry».h
 * 
 * 
 */

#ifndef SamiPage«InvoiceLogEntry»_H_
#define SamiPage«InvoiceLogEntry»_H_
...
class SamiPage«InvoiceLogEntry»: public SamiObject {
public:
    SamiPage«InvoiceLogEntry»();
    SamiPage«InvoiceLogEntry»(String* json);
    virtual ~SamiPage«InvoiceLogEntry»();
    ...
    SamiPage«InvoiceLogEntry»* fromJson(String* obj);
...
#endif /* SamiPage«InvoiceLogEntry»_H_ */
