/*
 * SamiPageResource«VideoRelationshipResource».h
 * 
 * 
 */

#ifndef SamiPageResource«VideoRelationshipResource»_H_
#define SamiPageResource«VideoRelationshipResource»_H_
...
class SamiPageResource«VideoRelationshipResource»: public SamiObject {
public:
    SamiPageResource«VideoRelationshipResource»();
    SamiPageResource«VideoRelationshipResource»(String* json);
    virtual ~SamiPageResource«VideoRelationshipResource»();
    ...
    SamiPageResource«VideoRelationshipResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«VideoRelationshipResource»_H_ */
