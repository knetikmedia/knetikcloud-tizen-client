...
SamiPageResource«OauthAccessTokenResource»::SamiPageResource«OauthAccessTokenResource»() {
    init();
}
...
void
SamiPageResource«OauthAccessTokenResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«OauthAccessTokenResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«OauthAccessTokenResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«OauthAccessTokenResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiOauthAccessTokenResource");
        }
        delete pContentKey;
...
SamiPageResource«OauthAccessTokenResource»::SamiPageResource«OauthAccessTokenResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«OauthAccessTokenResource»::asJson ()
{
...
JsonObject*
SamiPageResource«OauthAccessTokenResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiOauthAccessTokenResource", "array"));
...
IList*
SamiPageResource«OauthAccessTokenResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«OauthAccessTokenResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«OauthAccessTokenResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«OauthAccessTokenResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«OauthAccessTokenResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«OauthAccessTokenResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«OauthAccessTokenResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«OauthAccessTokenResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«OauthAccessTokenResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«OauthAccessTokenResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«OauthAccessTokenResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«OauthAccessTokenResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«OauthAccessTokenResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«OauthAccessTokenResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«OauthAccessTokenResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«OauthAccessTokenResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«OauthAccessTokenResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«OauthAccessTokenResource»::setPTotalPages(Integer* pTotal_pages) {
