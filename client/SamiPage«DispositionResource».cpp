...
SamiPage«DispositionResource»::SamiPage«DispositionResource»() {
    init();
}
...
void
SamiPage«DispositionResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«DispositionResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«DispositionResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«DispositionResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«DispositionResource»::SamiPage«DispositionResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«DispositionResource»::asJson ()
{
...
JsonObject*
SamiPage«DispositionResource»::asJsonObject() {
...
IList*
SamiPage«DispositionResource»::getPContent() {
    return pContent;
}
void
SamiPage«DispositionResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«DispositionResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«DispositionResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«DispositionResource»::getPLast() {
    return pLast;
}
void
SamiPage«DispositionResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«DispositionResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«DispositionResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«DispositionResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«DispositionResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«DispositionResource»::getPSize() {
    return pSize;
}
void
SamiPage«DispositionResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«DispositionResource»::getPSort() {
    return pSort;
}
void
SamiPage«DispositionResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«DispositionResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«DispositionResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«DispositionResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«DispositionResource»::setPTotalPages(Integer* pTotal_pages) {
