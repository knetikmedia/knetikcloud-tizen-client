...
public:
  ...
  getInvoiceReportsWithCompletion(String* currencyCode, String* granularity, String* filterPaymentStatus, String* filterFulfillmentStatus, Long* startDate, Long* endDate, Integer* size, Integer* page, void (* handler)(SamiPageResource«AggregateInvoiceReportResource»*, SamiError*));
