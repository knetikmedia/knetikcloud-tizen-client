...
public:
  ...
  getDailyInvoicesUsingGETWithCompletion(String* currencyCode, String* granularity, String* filterPaymentStatus, String* filterFulfillmentStatus, Long* startDate, Long* endDate, void (* handler)(SamiPageResource«AggregateInvoiceReportResource»*, SamiError*));
