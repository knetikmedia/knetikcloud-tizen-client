/*
 * SamiPageResource«AggregateInvoiceReportResource».h
 * 
 * 
 */

#ifndef SamiPageResource«AggregateInvoiceReportResource»_H_
#define SamiPageResource«AggregateInvoiceReportResource»_H_
...
class SamiPageResource«AggregateInvoiceReportResource»: public SamiObject {
public:
    SamiPageResource«AggregateInvoiceReportResource»();
    SamiPageResource«AggregateInvoiceReportResource»(String* json);
    virtual ~SamiPageResource«AggregateInvoiceReportResource»();
    ...
    SamiPageResource«AggregateInvoiceReportResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«AggregateInvoiceReportResource»_H_ */
