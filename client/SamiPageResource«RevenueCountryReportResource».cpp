...
SamiPageResource«RevenueCountryReportResource»::SamiPageResource«RevenueCountryReportResource»() {
    init();
}
...
void
SamiPageResource«RevenueCountryReportResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«RevenueCountryReportResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«RevenueCountryReportResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«RevenueCountryReportResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiRevenueCountryReportResource");
        }
        delete pContentKey;
...
SamiPageResource«RevenueCountryReportResource»::SamiPageResource«RevenueCountryReportResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«RevenueCountryReportResource»::asJson ()
{
...
JsonObject*
SamiPageResource«RevenueCountryReportResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiRevenueCountryReportResource", "array"));
...
IList*
SamiPageResource«RevenueCountryReportResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«RevenueCountryReportResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«RevenueCountryReportResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«RevenueCountryReportResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«RevenueCountryReportResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«RevenueCountryReportResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«RevenueCountryReportResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«RevenueCountryReportResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«RevenueCountryReportResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«RevenueCountryReportResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«RevenueCountryReportResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«RevenueCountryReportResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«RevenueCountryReportResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«RevenueCountryReportResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«RevenueCountryReportResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«RevenueCountryReportResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«RevenueCountryReportResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«RevenueCountryReportResource»::setPTotalPages(Integer* pTotal_pages) {
