/*
 * SamiPage«UserItemLogResource».h
 * 
 * 
 */

#ifndef SamiPage«UserItemLogResource»_H_
#define SamiPage«UserItemLogResource»_H_
...
class SamiPage«UserItemLogResource»: public SamiObject {
public:
    SamiPage«UserItemLogResource»();
    SamiPage«UserItemLogResource»(String* json);
    virtual ~SamiPage«UserItemLogResource»();
    ...
    SamiPage«UserItemLogResource»* fromJson(String* obj);
...
#endif /* SamiPage«UserItemLogResource»_H_ */
