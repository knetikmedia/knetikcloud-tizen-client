/*
 * SamiPage«BreCategoryResource».h
 * 
 * 
 */

#ifndef SamiPage«BreCategoryResource»_H_
#define SamiPage«BreCategoryResource»_H_
...
class SamiPage«BreCategoryResource»: public SamiObject {
public:
    SamiPage«BreCategoryResource»();
    SamiPage«BreCategoryResource»(String* json);
    virtual ~SamiPage«BreCategoryResource»();
    ...
    SamiPage«BreCategoryResource»* fromJson(String* obj);
...
#endif /* SamiPage«BreCategoryResource»_H_ */
