...
SamiPage«UserAchievementGroupResource»::SamiPage«UserAchievementGroupResource»() {
    init();
}
...
void
SamiPage«UserAchievementGroupResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«UserAchievementGroupResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«UserAchievementGroupResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«UserAchievementGroupResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«UserAchievementGroupResource»::SamiPage«UserAchievementGroupResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«UserAchievementGroupResource»::asJson ()
{
...
JsonObject*
SamiPage«UserAchievementGroupResource»::asJsonObject() {
...
IList*
SamiPage«UserAchievementGroupResource»::getPContent() {
    return pContent;
}
void
SamiPage«UserAchievementGroupResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«UserAchievementGroupResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«UserAchievementGroupResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«UserAchievementGroupResource»::getPLast() {
    return pLast;
}
void
SamiPage«UserAchievementGroupResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«UserAchievementGroupResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«UserAchievementGroupResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«UserAchievementGroupResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«UserAchievementGroupResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«UserAchievementGroupResource»::getPSize() {
    return pSize;
}
void
SamiPage«UserAchievementGroupResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«UserAchievementGroupResource»::getPSort() {
    return pSort;
}
void
SamiPage«UserAchievementGroupResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«UserAchievementGroupResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«UserAchievementGroupResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«UserAchievementGroupResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«UserAchievementGroupResource»::setPTotalPages(Integer* pTotal_pages) {
