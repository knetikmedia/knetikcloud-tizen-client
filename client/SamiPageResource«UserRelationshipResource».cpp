...
SamiPageResource«UserRelationshipResource»::SamiPageResource«UserRelationshipResource»() {
    init();
}
...
void
SamiPageResource«UserRelationshipResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«UserRelationshipResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«UserRelationshipResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«UserRelationshipResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiUserRelationshipResource");
        }
        delete pContentKey;
...
SamiPageResource«UserRelationshipResource»::SamiPageResource«UserRelationshipResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«UserRelationshipResource»::asJson ()
{
...
JsonObject*
SamiPageResource«UserRelationshipResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiUserRelationshipResource", "array"));
...
IList*
SamiPageResource«UserRelationshipResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«UserRelationshipResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«UserRelationshipResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«UserRelationshipResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«UserRelationshipResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«UserRelationshipResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«UserRelationshipResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«UserRelationshipResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«UserRelationshipResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«UserRelationshipResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«UserRelationshipResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«UserRelationshipResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«UserRelationshipResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«UserRelationshipResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«UserRelationshipResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«UserRelationshipResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«UserRelationshipResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«UserRelationshipResource»::setPTotalPages(Integer* pTotal_pages) {
