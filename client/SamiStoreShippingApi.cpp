...
SamiShippingItem* 
SamiStoreShippingApi::createShippingItemWithCompletion(Boolean* cascade, SamiShippingItem* shippingItem, void (* success)(SamiShippingItem*, SamiError*)) {
...
SamiShippingItem* 
SamiStoreShippingApi::updateShippingItemWithCompletion(Integer* _id, Boolean* cascade, SamiShippingItem* shippingItem, void (* success)(SamiShippingItem*, SamiError*)) {
  client = new SamiApiClient();
...
SamiItemTemplateResource* 
SamiStoreShippingApi::updateShippingTemplateWithCompletion(String* _id, SamiItemTemplateResource* shippingTemplateResource, void (* success)(SamiItemTemplateResource*, SamiError*)) {
  client = new SamiApiClient();
