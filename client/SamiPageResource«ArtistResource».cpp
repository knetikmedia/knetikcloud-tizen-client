...
SamiPageResource«ArtistResource»::SamiPageResource«ArtistResource»() {
    init();
}
...
void
SamiPageResource«ArtistResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«ArtistResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«ArtistResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«ArtistResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiArtistResource");
        }
        delete pContentKey;
...
SamiPageResource«ArtistResource»::SamiPageResource«ArtistResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«ArtistResource»::asJson ()
{
...
JsonObject*
SamiPageResource«ArtistResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiArtistResource", "array"));
...
IList*
SamiPageResource«ArtistResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«ArtistResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«ArtistResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«ArtistResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«ArtistResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«ArtistResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«ArtistResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«ArtistResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«ArtistResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«ArtistResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«ArtistResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«ArtistResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«ArtistResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«ArtistResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«ArtistResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«ArtistResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«ArtistResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«ArtistResource»::setPTotalPages(Integer* pTotal_pages) {
