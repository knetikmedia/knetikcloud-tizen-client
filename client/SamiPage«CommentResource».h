/*
 * SamiPage«CommentResource».h
 * 
 * 
 */

#ifndef SamiPage«CommentResource»_H_
#define SamiPage«CommentResource»_H_
...
class SamiPage«CommentResource»: public SamiObject {
public:
    SamiPage«CommentResource»();
    SamiPage«CommentResource»(String* json);
    virtual ~SamiPage«CommentResource»();
    ...
    SamiPage«CommentResource»* fromJson(String* obj);
...
#endif /* SamiPage«CommentResource»_H_ */
