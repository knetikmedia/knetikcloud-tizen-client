...
SamiPage«GroupMemberResource»::SamiPage«GroupMemberResource»() {
    init();
}
...
void
SamiPage«GroupMemberResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«GroupMemberResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«GroupMemberResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«GroupMemberResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«GroupMemberResource»::SamiPage«GroupMemberResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«GroupMemberResource»::asJson ()
{
...
JsonObject*
SamiPage«GroupMemberResource»::asJsonObject() {
...
IList*
SamiPage«GroupMemberResource»::getPContent() {
    return pContent;
}
void
SamiPage«GroupMemberResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«GroupMemberResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«GroupMemberResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«GroupMemberResource»::getPLast() {
    return pLast;
}
void
SamiPage«GroupMemberResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«GroupMemberResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«GroupMemberResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«GroupMemberResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«GroupMemberResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«GroupMemberResource»::getPSize() {
    return pSize;
}
void
SamiPage«GroupMemberResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«GroupMemberResource»::getPSort() {
    return pSort;
}
void
SamiPage«GroupMemberResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«GroupMemberResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«GroupMemberResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«GroupMemberResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«GroupMemberResource»::setPTotalPages(Integer* pTotal_pages) {
