...
SamiPageResource«EntitlementItem»::SamiPageResource«EntitlementItem»() {
    init();
}
...
void
SamiPageResource«EntitlementItem»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«EntitlementItem»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«EntitlementItem»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«EntitlementItem»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiEntitlementItem");
        }
        delete pContentKey;
...
SamiPageResource«EntitlementItem»::SamiPageResource«EntitlementItem»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«EntitlementItem»::asJson ()
{
...
JsonObject*
SamiPageResource«EntitlementItem»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiEntitlementItem", "array"));
...
IList*
SamiPageResource«EntitlementItem»::getPContent() {
    return pContent;
}
void
SamiPageResource«EntitlementItem»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«EntitlementItem»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«EntitlementItem»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«EntitlementItem»::getPLast() {
    return pLast;
}
void
SamiPageResource«EntitlementItem»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«EntitlementItem»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«EntitlementItem»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«EntitlementItem»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«EntitlementItem»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«EntitlementItem»::getPSize() {
    return pSize;
}
void
SamiPageResource«EntitlementItem»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«EntitlementItem»::getPSort() {
    return pSort;
}
void
SamiPageResource«EntitlementItem»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«EntitlementItem»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«EntitlementItem»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«EntitlementItem»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«EntitlementItem»::setPTotalPages(Integer* pTotal_pages) {
