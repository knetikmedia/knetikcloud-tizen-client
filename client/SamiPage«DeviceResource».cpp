...
SamiPage«DeviceResource»::SamiPage«DeviceResource»() {
    init();
}
...
void
SamiPage«DeviceResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«DeviceResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«DeviceResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«DeviceResource»::SamiPage«DeviceResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«DeviceResource»::asJson ()
{
...
JsonObject*
SamiPage«DeviceResource»::asJsonObject() {
...
IList*
SamiPage«DeviceResource»::getPContent() {
    return pContent;
}
void
SamiPage«DeviceResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«DeviceResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«DeviceResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«DeviceResource»::getPLast() {
    return pLast;
}
void
SamiPage«DeviceResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«DeviceResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«DeviceResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«DeviceResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«DeviceResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«DeviceResource»::getPSize() {
    return pSize;
}
void
SamiPage«DeviceResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«DeviceResource»::getPSort() {
    return pSort;
}
void
SamiPage«DeviceResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«DeviceResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«DeviceResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«DeviceResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«DeviceResource»::setPTotalPages(Integer* pTotal_pages) {
