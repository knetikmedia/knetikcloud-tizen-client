...
searchCartsUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiPage«CartSummary»* out = new SamiPage«CartSummary»();
    jsonToValue(out, pJson, L"SamiPage«CartSummary»*", L"SamiPage«CartSummary»");
...
SamiStoreShoppingCartsApi::searchCartsUsingGETWithCompletion(Integer* filterOwnerId, Integer* size, Integer* page, String* order, void (* success)(SamiPage«CartSummary»*, SamiError*)) {
  client = new SamiApiClient();
