...
SamiPage«AggregateCountResource»::SamiPage«AggregateCountResource»() {
    init();
}
...
void
SamiPage«AggregateCountResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«AggregateCountResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«AggregateCountResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«AggregateCountResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«AggregateCountResource»::SamiPage«AggregateCountResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«AggregateCountResource»::asJson ()
{
...
JsonObject*
SamiPage«AggregateCountResource»::asJsonObject() {
...
IList*
SamiPage«AggregateCountResource»::getPContent() {
    return pContent;
}
void
SamiPage«AggregateCountResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«AggregateCountResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«AggregateCountResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«AggregateCountResource»::getPLast() {
    return pLast;
}
void
SamiPage«AggregateCountResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«AggregateCountResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«AggregateCountResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«AggregateCountResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«AggregateCountResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«AggregateCountResource»::getPSize() {
    return pSize;
}
void
SamiPage«AggregateCountResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«AggregateCountResource»::getPSort() {
    return pSort;
}
void
SamiPage«AggregateCountResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«AggregateCountResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«AggregateCountResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«AggregateCountResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«AggregateCountResource»::setPTotalPages(Integer* pTotal_pages) {
