...
SamiPageResource«VendorResource»::SamiPageResource«VendorResource»() {
    init();
}
...
void
SamiPageResource«VendorResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«VendorResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«VendorResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«VendorResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiVendorResource");
        }
        delete pContentKey;
...
SamiPageResource«VendorResource»::SamiPageResource«VendorResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«VendorResource»::asJson ()
{
...
JsonObject*
SamiPageResource«VendorResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiVendorResource", "array"));
...
IList*
SamiPageResource«VendorResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«VendorResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«VendorResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«VendorResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«VendorResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«VendorResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«VendorResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«VendorResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«VendorResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«VendorResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«VendorResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«VendorResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«VendorResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«VendorResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«VendorResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«VendorResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«VendorResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«VendorResource»::setPTotalPages(Integer* pTotal_pages) {
