...
SamiPage«QuestionTemplateResource»::SamiPage«QuestionTemplateResource»() {
    init();
}
...
void
SamiPage«QuestionTemplateResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPage«QuestionTemplateResource»::cleanup() {
    if(pContent != null) {
...
SamiPage«QuestionTemplateResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«QuestionTemplateResource»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«QuestionTemplateResource»::SamiPage«QuestionTemplateResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPage«QuestionTemplateResource»::asJson ()
{
...
JsonObject*
SamiPage«QuestionTemplateResource»::asJsonObject() {
...
IList*
SamiPage«QuestionTemplateResource»::getPContent() {
    return pContent;
}
void
SamiPage«QuestionTemplateResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«QuestionTemplateResource»::getPFirst() {
    return pFirst;
}
void
SamiPage«QuestionTemplateResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«QuestionTemplateResource»::getPLast() {
    return pLast;
}
void
SamiPage«QuestionTemplateResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«QuestionTemplateResource»::getPNumber() {
    return pNumber;
}
void
SamiPage«QuestionTemplateResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«QuestionTemplateResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«QuestionTemplateResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«QuestionTemplateResource»::getPSize() {
    return pSize;
}
void
SamiPage«QuestionTemplateResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«QuestionTemplateResource»::getPSort() {
    return pSort;
}
void
SamiPage«QuestionTemplateResource»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«QuestionTemplateResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«QuestionTemplateResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«QuestionTemplateResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«QuestionTemplateResource»::setPTotalPages(Integer* pTotal_pages) {
