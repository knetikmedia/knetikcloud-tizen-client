...
SamiReportingUsersApi::executiveRevenueItemSalesUsingGET1WithCompletion(String* granularity, Long* startDate, Long* endDate, void (* success)(SamiPageResource«AggregateCountResource»*, SamiError*)) {
