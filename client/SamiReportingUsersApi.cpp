...
SamiReportingUsersApi::getUserRegistrationsWithCompletion(String* granularity, Long* startDate, Long* endDate, void (* success)(SamiPageResource«AggregateCountResource»*, SamiError*)) {
