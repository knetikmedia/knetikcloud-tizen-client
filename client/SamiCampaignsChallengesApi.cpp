...
SamiCampaignsChallengesApi::getActivitiesUsingGET1WithCompletion(Long* challengeId, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«BareChallengeActivityResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiCampaignsChallengesApi::getChallengeEventssUsingGETWithCompletion(String* filterStartDate, String* filterEndDate, Boolean* filterCampaigns, Long* filterChallenge, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«ChallengeEventResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiCampaignsChallengesApi::getChallengeTemplatesUsingGETWithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«TemplateResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiCampaignsChallengesApi::getChallengesUsingGET1WithCompletion(Boolean* filterTemplate, Boolean* filterActiveCampaign, void (* success)(SamiPageResource«ChallengeResource»*, SamiError*)) {
  client = new SamiApiClient();
