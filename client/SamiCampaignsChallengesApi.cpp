...
void 
SamiCampaignsChallengesApi::updateChallengeActivityWithCompletion(Long* activityId, Long* challengeId, SamiChallengeActivityResource* challengeActivityResource, void(*success)(SamiError*)) {
  client = new SamiApiClient();
...
void 
SamiCampaignsChallengesApi::updateChallengeTemplateWithCompletion(String* _id, SamiTemplateResource* challengeTemplateResource, void(*success)(SamiError*)) {
  client = new SamiApiClient();
