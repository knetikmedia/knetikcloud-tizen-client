...
SamiCampaignsChallengesApi::getChallengeEventssUsingGETWithCompletion(String* filterStartDate, String* filterEndDate, Boolean* filterCampaigns, Long* filterChallenge, Integer* size, Integer* page, String* order, void (* success)(SamiPage«ChallengeEventResource»*, SamiError*)) {
  client = new SamiApiClient();
