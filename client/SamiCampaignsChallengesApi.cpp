...
void 
SamiCampaignsChallengesApi::deleteChallengeActivityWithCompletion(Long* _id, Long* challengeId, void(*success)(SamiError*)) {
  client = new SamiApiClient();
  ...
  String url(L"/challenges/{challenge_id}/activities/{id}");
...
SamiChallengeActivityResource* 
SamiCampaignsChallengesApi::getChallengeActivityWithCompletion(Long* _id, Long* challengeId, void (* success)(SamiChallengeActivityResource*, SamiError*)) {
  client = new SamiApiClient();
...
SamiCampaignsChallengesApi::getChallengesWithCompletion(Boolean* filterTemplate, Boolean* filterActiveCampaign, String* filterStartDate, String* filterEndDate, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«ChallengeResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiChallengeActivityResource* 
SamiCampaignsChallengesApi::updateChallengeActivityWithCompletion(Long* _id, Long* challengeId, SamiChallengeActivityResource* challengeActivityResource, void (* success)(SamiChallengeActivityResource*, SamiError*)) {
  client = new SamiApiClient();
