/*
 * SamiPageResource«ChallengeResource».h
 * 
 * 
 */

#ifndef SamiPageResource«ChallengeResource»_H_
#define SamiPageResource«ChallengeResource»_H_
...
class SamiPageResource«ChallengeResource»: public SamiObject {
public:
    SamiPageResource«ChallengeResource»();
    SamiPageResource«ChallengeResource»(String* json);
    virtual ~SamiPageResource«ChallengeResource»();
    ...
    SamiPageResource«ChallengeResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«ChallengeResource»_H_ */
