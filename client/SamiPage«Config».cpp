...
SamiPage«Config»::SamiPage«Config»() {
    init();
}
...
SamiPage«Config»*
SamiPage«Config»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«Config»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«Config»::SamiPage«Config»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
IList*
SamiPage«Config»::getPContent() {
    return pContent;
}
void
SamiPage«Config»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«Config»::getPFirst() {
    return pFirst;
}
void
SamiPage«Config»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«Config»::getPLast() {
    return pLast;
}
void
SamiPage«Config»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«Config»::getPNumber() {
    return pNumber;
}
void
SamiPage«Config»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«Config»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«Config»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«Config»::getPSize() {
    return pSize;
}
void
SamiPage«Config»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«Config»::getPSort() {
    return pSort;
}
void
SamiPage«Config»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«Config»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«Config»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«Config»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«Config»::setPTotalPages(Integer* pTotal_pages) {
