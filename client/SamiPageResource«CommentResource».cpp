...
SamiPageResource«CommentResource»::SamiPageResource«CommentResource»() {
    init();
}
...
void
SamiPageResource«CommentResource»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«CommentResource»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«CommentResource»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«CommentResource»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiCommentResource");
        }
        delete pContentKey;
...
SamiPageResource«CommentResource»::SamiPageResource«CommentResource»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«CommentResource»::asJson ()
{
...
JsonObject*
SamiPageResource«CommentResource»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiCommentResource", "array"));
...
IList*
SamiPageResource«CommentResource»::getPContent() {
    return pContent;
}
void
SamiPageResource«CommentResource»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«CommentResource»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«CommentResource»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«CommentResource»::getPLast() {
    return pLast;
}
void
SamiPageResource«CommentResource»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«CommentResource»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«CommentResource»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«CommentResource»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«CommentResource»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«CommentResource»::getPSize() {
    return pSize;
}
void
SamiPageResource«CommentResource»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«CommentResource»::getPSort() {
    return pSort;
}
void
SamiPageResource«CommentResource»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«CommentResource»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«CommentResource»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«CommentResource»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«CommentResource»::setPTotalPages(Integer* pTotal_pages) {
