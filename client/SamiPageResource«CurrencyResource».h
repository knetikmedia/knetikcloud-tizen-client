/*
 * SamiPageResource«CurrencyResource».h
 * 
 * 
 */

#ifndef SamiPageResource«CurrencyResource»_H_
#define SamiPageResource«CurrencyResource»_H_
...
class SamiPageResource«CurrencyResource»: public SamiObject {
public:
    SamiPageResource«CurrencyResource»();
    SamiPageResource«CurrencyResource»(String* json);
    virtual ~SamiPageResource«CurrencyResource»();
    ...
    SamiPageResource«CurrencyResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«CurrencyResource»_H_ */
