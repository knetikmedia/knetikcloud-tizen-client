...
public:
  ...
  getInvoicesWithCompletion(Integer* filterUser, String* filterEmail, String* filterFulfillmentStatus, String* filterPaymentStatus, String* filterItemName, String* filterExternalRef, String* filterCreatedDate, String* filterVendorIds, String* filterCurrency, String* filterShippingStateName, String* filterShippingCountryName, Float* filterShipping, String* filterVendorName, String* filterSku, Integer* size, Integer* page, String* order, void (* handler)(SamiPageResource«InvoiceResource»*, SamiError*));
  IList* 
