...
public:
  ...
  getInvoicesWithCompletion(Integer* filterUser, String* filterEmail, String* filterFulfillmentStatus, String* filterPaymentStatus, String* filterItemName, String* filterExternalRef, String* filterCreatedDate, Integer* size, Integer* page, String* order, void (* handler)(SamiPageResource«InvoiceResource»*, SamiError*));
  IList* 
