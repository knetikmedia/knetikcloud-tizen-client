/*
 * SamiPageResource«BreCategoryResource».h
 * 
 * 
 */

#ifndef SamiPageResource«BreCategoryResource»_H_
#define SamiPageResource«BreCategoryResource»_H_
...
class SamiPageResource«BreCategoryResource»: public SamiObject {
public:
    SamiPageResource«BreCategoryResource»();
    SamiPageResource«BreCategoryResource»(String* json);
    virtual ~SamiPageResource«BreCategoryResource»();
    ...
    SamiPageResource«BreCategoryResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«BreCategoryResource»_H_ */
