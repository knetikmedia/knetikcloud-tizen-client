/*
 * SamiPageResource«BreEventLog».h
 * 
 * 
 */

#ifndef SamiPageResource«BreEventLog»_H_
#define SamiPageResource«BreEventLog»_H_
...
class SamiPageResource«BreEventLog»: public SamiObject {
public:
    SamiPageResource«BreEventLog»();
    SamiPageResource«BreEventLog»(String* json);
    virtual ~SamiPageResource«BreEventLog»();
    ...
    SamiPageResource«BreEventLog»* fromJson(String* obj);
...
#endif /* SamiPageResource«BreEventLog»_H_ */
