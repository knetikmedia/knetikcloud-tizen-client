/*
 * SamiPageResource«BreRule».h
 * 
 * 
 */

#ifndef SamiPageResource«BreRule»_H_
#define SamiPageResource«BreRule»_H_
...
class SamiPageResource«BreRule»: public SamiObject {
public:
    SamiPageResource«BreRule»();
    SamiPageResource«BreRule»(String* json);
    virtual ~SamiPageResource«BreRule»();
    ...
    SamiPageResource«BreRule»* fromJson(String* obj);
...
#endif /* SamiPageResource«BreRule»_H_ */
