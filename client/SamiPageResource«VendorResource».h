/*
 * SamiPageResource«VendorResource».h
 * 
 * 
 */

#ifndef SamiPageResource«VendorResource»_H_
#define SamiPageResource«VendorResource»_H_
...
class SamiPageResource«VendorResource»: public SamiObject {
public:
    SamiPageResource«VendorResource»();
    SamiPageResource«VendorResource»(String* json);
    virtual ~SamiPageResource«VendorResource»();
    ...
    SamiPageResource«VendorResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«VendorResource»_H_ */
