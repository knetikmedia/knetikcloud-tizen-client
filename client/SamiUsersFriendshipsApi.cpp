...
SamiUsersFriendshipsApi::getFriendsUsingGETWithCompletion(String* userId, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«SimpleUserResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiPageResource«SimpleUserResource»* 
SamiUsersFriendshipsApi::getInvitesUsingGETWithCompletion(String* userId, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«SimpleUserResource»*, SamiError*)) {
  client = new SamiApiClient();
