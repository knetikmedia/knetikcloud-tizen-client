...
SamiUsersFriendshipsApi::getFriendsWithCompletion(String* userId, Integer* size, Integer* page, void (* success)(SamiPageResource«SimpleUserResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiPageResource«SimpleUserResource»* 
SamiUsersFriendshipsApi::getInvitesWithCompletion(String* userId, Integer* size, Integer* page, void (* success)(SamiPageResource«SimpleUserResource»*, SamiError*)) {
  client = new SamiApiClient();
