...
public:
  ...
  SamiCategoryResource* 
  updateCategoryWithCompletion(String* _id, SamiCategoryResource* category, void (* handler)(SamiCategoryResource*, SamiError*));
  SamiTemplateResource* 
  updateCategoryTemplateWithCompletion(String* _id, SamiTemplateResource* template, void (* handler)(SamiTemplateResource*, SamiError*));
