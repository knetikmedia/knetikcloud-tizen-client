...
SamiCampaignsApi::getCampaignChallengesWithCompletion(Long* _id, void (* success)(SamiPageResource«ChallengeResource»*, SamiError*)) {
  client = new SamiApiClient();
...
void 
SamiCampaignsApi::updateCampaignWithCompletion(Long* _id, SamiCampaignResource* campaignResource, void(*success)(SamiError*)) {
  client = new SamiApiClient();
...
void 
SamiCampaignsApi::updateCampaignTemplateWithCompletion(String* _id, SamiTemplateResource* campaignTemplateResource, void(*success)(SamiError*)) {
  client = new SamiApiClient();
