...
SamiCampaignsApi::getCampaignTemplatesUsingGETWithCompletion(Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«TemplateResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiCampaignsApi::getCampaignsUsingGETWithCompletion(Boolean* filterActive, Integer* size, Integer* page, String* order, void (* success)(SamiPageResource«CampaignResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiCampaignsApi::getChallengesUsingGETWithCompletion(Long* _id, void (* success)(SamiPageResource«ChallengeResource»*, SamiError*)) {
  client = new SamiApiClient();
