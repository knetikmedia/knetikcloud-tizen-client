...
SamiPage«BillingReport»::SamiPage«BillingReport»() {
    init();
}
...
void
SamiPage«BillingReport»::cleanup() {
    if(pContent != null) {
...
SamiPage«BillingReport»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPage«BillingReport»::fromJsonObject(IJsonValue* pJson) {
...
SamiPage«BillingReport»::SamiPage«BillingReport»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
JsonObject*
SamiPage«BillingReport»::asJsonObject() {
...
IList*
SamiPage«BillingReport»::getPContent() {
    return pContent;
}
void
SamiPage«BillingReport»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPage«BillingReport»::getPFirst() {
    return pFirst;
}
void
SamiPage«BillingReport»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPage«BillingReport»::getPLast() {
    return pLast;
}
void
SamiPage«BillingReport»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPage«BillingReport»::getPNumber() {
    return pNumber;
}
void
SamiPage«BillingReport»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPage«BillingReport»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPage«BillingReport»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPage«BillingReport»::getPSize() {
    return pSize;
}
void
SamiPage«BillingReport»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

SamiSort*
SamiPage«BillingReport»::getPSort() {
    return pSort;
}
void
SamiPage«BillingReport»::setPSort(SamiSort* pSort) {
    this->pSort = pSort;
}

Long*
SamiPage«BillingReport»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPage«BillingReport»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPage«BillingReport»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPage«BillingReport»::setPTotalPages(Integer* pTotal_pages) {
