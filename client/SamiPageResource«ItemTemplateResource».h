/*
 * SamiPageResource«ItemTemplateResource».h
 * 
 * 
 */

#ifndef SamiPageResource«ItemTemplateResource»_H_
#define SamiPageResource«ItemTemplateResource»_H_
...
class SamiPageResource«ItemTemplateResource»: public SamiObject {
public:
    SamiPageResource«ItemTemplateResource»();
    SamiPageResource«ItemTemplateResource»(String* json);
    virtual ~SamiPageResource«ItemTemplateResource»();
    ...
    SamiPageResource«ItemTemplateResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«ItemTemplateResource»_H_ */
