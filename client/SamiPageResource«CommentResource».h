/*
 * SamiPageResource«CommentResource».h
 * 
 * 
 */

#ifndef SamiPageResource«CommentResource»_H_
#define SamiPageResource«CommentResource»_H_
...
class SamiPageResource«CommentResource»: public SamiObject {
public:
    SamiPageResource«CommentResource»();
    SamiPageResource«CommentResource»(String* json);
    virtual ~SamiPageResource«CommentResource»();
    ...
    SamiPageResource«CommentResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«CommentResource»_H_ */
