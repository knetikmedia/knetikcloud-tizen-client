/*
 * SamiPage«ChallengeResource».h
 * 
 * 
 */

#ifndef SamiPage«ChallengeResource»_H_
#define SamiPage«ChallengeResource»_H_
...
class SamiPage«ChallengeResource»: public SamiObject {
public:
    SamiPage«ChallengeResource»();
    SamiPage«ChallengeResource»(String* json);
    virtual ~SamiPage«ChallengeResource»();
    ...
    SamiPage«ChallengeResource»* fromJson(String* obj);
...
#endif /* SamiPage«ChallengeResource»_H_ */
