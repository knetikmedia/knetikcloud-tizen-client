/*
 * SamiPageResource«PollResource».h
 * 
 * 
 */

#ifndef SamiPageResource«PollResource»_H_
#define SamiPageResource«PollResource»_H_
...
class SamiPageResource«PollResource»: public SamiObject {
public:
    SamiPageResource«PollResource»();
    SamiPageResource«PollResource»(String* json);
    virtual ~SamiPageResource«PollResource»();
    ...
    SamiPageResource«PollResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«PollResource»_H_ */
