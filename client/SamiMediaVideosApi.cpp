...
void 
SamiMediaVideosApi::deleteRelationshipUsingDELETEWithCompletion(Long* videoId, Long* _id, void(*success)(SamiError*)) {
  client = new SamiApiClient();
...
SamiMediaVideosApi::getCommentsUsingGET1WithCompletion(Integer* videoId, Integer* size, Integer* page, void (* success)(SamiPage«CommentResource»*, SamiError*)) {
  client = new SamiApiClient();
...
SamiMediaVideosApi::getDispositionsUsingGET1WithCompletion(Integer* videoId, Integer* size, Integer* page, void (* success)(SamiPage«DispositionResource»*, SamiError*)) {
  client = new SamiApiClient();
...
getRelatedUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiPage«VideoRelationshipResource»* out = new SamiPage«VideoRelationshipResource»();
    jsonToValue(out, pJson, L"SamiPage«VideoRelationshipResource»*", L"SamiPage«VideoRelationshipResource»");
...
SamiMediaVideosApi::getRelatedUsingGETWithCompletion(Long* videoId, Integer* size, Integer* page, void (* success)(SamiPage«VideoRelationshipResource»*, SamiError*)) {
  client = new SamiApiClient();
...
getUserVideosUsingGETProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiPage«VideoResource»* out = new SamiPage«VideoResource»();
    jsonToValue(out, pJson, L"SamiPage«VideoResource»*", L"SamiPage«VideoResource»");
...
SamiMediaVideosApi::getUserVideosUsingGETWithCompletion(Integer* userId, Boolean* excludeFlagged, Integer* size, Integer* page, void (* success)(SamiPage«VideoResource»*, SamiError*)) {
  client = new SamiApiClient();
...
void 
SamiMediaVideosApi::updateRelationshipUsingPUTWithCompletion(Long* videoId, Long* relationshipId, String* details, void(*success)(SamiError*)) {
  client = new SamiApiClient();
