...
SamiPageResource«BreEventLog»::SamiPageResource«BreEventLog»() {
    init();
}
...
void
SamiPageResource«BreEventLog»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«BreEventLog»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«BreEventLog»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«BreEventLog»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiBreEventLog");
        }
        delete pContentKey;
...
SamiPageResource«BreEventLog»::SamiPageResource«BreEventLog»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«BreEventLog»::asJson ()
{
...
JsonObject*
SamiPageResource«BreEventLog»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiBreEventLog", "array"));
...
IList*
SamiPageResource«BreEventLog»::getPContent() {
    return pContent;
}
void
SamiPageResource«BreEventLog»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«BreEventLog»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«BreEventLog»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«BreEventLog»::getPLast() {
    return pLast;
}
void
SamiPageResource«BreEventLog»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«BreEventLog»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«BreEventLog»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«BreEventLog»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«BreEventLog»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«BreEventLog»::getPSize() {
    return pSize;
}
void
SamiPageResource«BreEventLog»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«BreEventLog»::getPSort() {
    return pSort;
}
void
SamiPageResource«BreEventLog»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«BreEventLog»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«BreEventLog»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«BreEventLog»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«BreEventLog»::setPTotalPages(Integer* pTotal_pages) {
