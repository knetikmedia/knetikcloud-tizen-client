...
public:
  ...
  IList* 
  getPaymentMethodsWithCompletion(Integer* userId, String* filterName, String* filterPaymentType, Integer* filterPaymentMethodTypeId, String* filterPaymentMethodTypeName, Integer* size, Integer* page, String* order, void (* handler)(IList*, SamiError*));
