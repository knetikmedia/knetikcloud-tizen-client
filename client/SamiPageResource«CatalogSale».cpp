...
SamiPageResource«CatalogSale»::SamiPageResource«CatalogSale»() {
    init();
}
...
void
SamiPageResource«CatalogSale»::init() {
    pContent = null;
pFirst = null;
pLast = null;
pNumber = null;
...
void
SamiPageResource«CatalogSale»::cleanup() {
    if(pContent != null) {
...
SamiPageResource«CatalogSale»::fromJson(String* json) {
    this->cleanup();
...
void
SamiPageResource«CatalogSale»::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pContentVal != null) {
            ...
            jsonToValue(pContent, pContentVal, L"IList", L"SamiCatalogSale");
        }
        delete pContentKey;
...
SamiPageResource«CatalogSale»::SamiPageResource«CatalogSale»(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiPageResource«CatalogSale»::asJson ()
{
...
JsonObject*
SamiPageResource«CatalogSale»::asJsonObject() {
    JsonObject *pJsonObject = new JsonObject();
    pJsonObject->Construct();

    JsonString *pContentKey = new JsonString(L"content");
    pJsonObject->Add(pContentKey, toJson(getPContent(), "SamiCatalogSale", "array"));
...
IList*
SamiPageResource«CatalogSale»::getPContent() {
    return pContent;
}
void
SamiPageResource«CatalogSale»::setPContent(IList* pContent) {
    this->pContent = pContent;
}

Boolean*
SamiPageResource«CatalogSale»::getPFirst() {
    return pFirst;
}
void
SamiPageResource«CatalogSale»::setPFirst(Boolean* pFirst) {
    this->pFirst = pFirst;
}

Boolean*
SamiPageResource«CatalogSale»::getPLast() {
    return pLast;
}
void
SamiPageResource«CatalogSale»::setPLast(Boolean* pLast) {
    this->pLast = pLast;
}

Integer*
SamiPageResource«CatalogSale»::getPNumber() {
    return pNumber;
}
void
SamiPageResource«CatalogSale»::setPNumber(Integer* pNumber) {
    this->pNumber = pNumber;
}

Integer*
SamiPageResource«CatalogSale»::getPNumberOfElements() {
    return pNumber_of_elements;
}
void
SamiPageResource«CatalogSale»::setPNumberOfElements(Integer* pNumber_of_elements) {
    this->pNumber_of_elements = pNumber_of_elements;
}

Integer*
SamiPageResource«CatalogSale»::getPSize() {
    return pSize;
}
void
SamiPageResource«CatalogSale»::setPSize(Integer* pSize) {
    this->pSize = pSize;
}

IList*
SamiPageResource«CatalogSale»::getPSort() {
    return pSort;
}
void
SamiPageResource«CatalogSale»::setPSort(IList* pSort) {
    this->pSort = pSort;
}

Long*
SamiPageResource«CatalogSale»::getPTotalElements() {
    return pTotal_elements;
}
void
SamiPageResource«CatalogSale»::setPTotalElements(Long* pTotal_elements) {
    this->pTotal_elements = pTotal_elements;
}

Integer*
SamiPageResource«CatalogSale»::getPTotalPages() {
    return pTotal_pages;
}
void
SamiPageResource«CatalogSale»::setPTotalPages(Integer* pTotal_pages) {
