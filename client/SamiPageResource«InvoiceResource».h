/*
 * SamiPageResource«InvoiceResource».h
 * 
 * 
 */

#ifndef SamiPageResource«InvoiceResource»_H_
#define SamiPageResource«InvoiceResource»_H_
...
class SamiPageResource«InvoiceResource»: public SamiObject {
public:
    SamiPageResource«InvoiceResource»();
    SamiPageResource«InvoiceResource»(String* json);
    virtual ~SamiPageResource«InvoiceResource»();
    ...
    SamiPageResource«InvoiceResource»* fromJson(String* obj);
...
#endif /* SamiPageResource«InvoiceResource»_H_ */
